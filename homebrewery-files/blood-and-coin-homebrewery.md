...
![bc_banner](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/all_artwork/banners/tirvandor-banner-blood-and-coin.png){position:absolute,top:250px,left:0px,height:500px,width:110%}
...
- ### [{{ Introduction}}{{ 9}}](#p11)
  - #### [{{ Campaign Overview}}{{ 9}}](#p11)
    - [{{ Campaign Themes}}{{ 9}}](#p11)
    - [{{ Tone}}{{ 9}}](#p11)
    - [{{ Level Progression}}{{ 9}}](#p11)
    - [{{ The Western Conflict}}{{ 9}}](#p11)
    - [{{ Relationship to Shattered Oaths Campaign}}{{ 9}}](#p11)
- ### [{{ Blood & Coin: Act I - Blood for Coin}}{{ 10}}](#p12)
  - #### [{{ The Morally Gray Campaign - Levels 1-5}}{{ 10}}](#p12)
  - #### [{{ Act I Overview}}{{ 10}}](#p12)
    - [{{ The Premise}}{{ 10}}](#p12)
    - [{{ What Act I Teaches}}{{ 10}}](#p12)
    - [{{ Starting Setup}}{{ 10}}](#p12)
  - #### [{{ Crossroads - The Mercenary Town}}{{ 10}}](#p12)
    - [{{ Overview}}{{ 10}}](#p12)
    - [{{ Key Locations}}{{ 11}}](#p13)
    - [{{ Factions in Crossroads}}{{ 11}}](#p13)
  - #### [{{ Quest 1.1: Welcome to Crossroads}}{{ 12}}](#p14)
    ...
    - [{{ Moral Choice}}{{ 14}}](#p16)
    - [{{ Returning to VARAK}}{{ 15}}](#p17)
    - [{{ Quest 1.1B: Debt Collection}}{{ 15}}](#p17)
    - [{{ Returning to Vareth}}{{ 17}}](#p19)
    - [{{ Returning to Varak}}{{ 17}}](#p19)
    - [{{ Quest 1.1C: Caravan Guard}}{{ 17}}](#p19)
    - [{{ The Journey}}{{ 17}}](#p19)
    - [{{ Combat Tactics (If Fight Occurs)}}{{ 18}}](#p20)
    - [{{ Returning to Varak}}{{ 19}}](#p21)
  - #### [{{ Iron Guild Membership}}{{ 19}}](#p21)
    - [{{ Membership Benefits:}}{{ 19}}](#p21)
    - [{{ Alternative: Decline Membership}}{{ 19}}](#p21)
  - #### [{{ Transition to Quest 1.2}}{{ 20}}](#p22)
    - [{{ The Next Contract}}{{ 20}}](#p22)
  - #### [{{ DM Guidance Notes}}{{ 20}}](#p22)
    - [{{ Quest 1.1 Design Philosophy}}{{ 20}}](#p22)
    - [{{ Adapting to Player Choices}}{{ 20}}](#p22)
    - [{{ Pacing Notes}}{{ 20}}](#p22)
    - [{{ Difficulty Adjustments}}{{ 20}}](#p22)
    - [{{ Branching Consequences}}{{ 21}}](#p23)
  - #### [{{ Quest 1.2: The PRICE OF LOYALTY}}{{ 21}}](#p23)
    - [{{ Quest SETUP}}{{ 21}}](#p23)
    - [{{ The Competing Clients}}{{ 21}}](#p23)
    - [{{ Client A: Baron Darius Thornhill}}{{ 21}}](#p23)
    - [{{ Client B: THOMAS REDWOOD}}{{ 22}}](#p24)
    - [{{ The Decision Moment}}{{ 22}}](#p24)
    - [{{ The CHOICE}}{{ 23}}](#p25)
    - [{{ Investigating The Truth}}{{ 23}}](#p25)
    - [{{ The Truth Revealed}}{{ 24}}](#p26)
  - #### [{{ Branching Paths}}{{ 24}}](#p26)
    - [{{ Path A: Working For The Baron}}{{ 24}}](#p26)
    - [{{ Path B: Working For Thomas}}{{ 25}}](#p27)
  ...
  - #### [{{ Aftermath & Epilogue}}{{ 28}}](#p30)
    ...
    - [{{ Level Up}}{{ 28}}](#p30)
  - #### [{{ DM Guidance: QUEST 1.2}}{{ 28}}](#p30)
    - [{{ Key Themes}}{{ 28}}](#p30)
    - [{{ Running the Negotiation Scene}}{{ 28}}](#p30)
    - [{{ Combat Difficulty}}{{ 28}}](#p30)
    - [{{ Adjusting Difficulty}}{{ 29}}](#p31)
    - [{{ Moral Complexity Notes}}{{ 29}}](#p31)
    - [{{ Player Agency}}{{ 29}}](#p31)
  - #### [{{ Quest 1.3: BLOOD MONEY}}{{ 29}}](#p31)
    - [{{ Quest SETUP}}{{ 29}}](#p31)
    - [{{ Client PRESENTATION}}{{ 30}}](#p32)
    - [{{ The Military Advisor}}{{ 30}}](#p32)
    - [{{ The Decision Point}}{{ 31}}](#p33)
    - [{{ Investigation Phase}}{{ 31}}](#p33)
  - #### [{{ Branching Paths}}{{ 33}}](#p35)
    - [{{ Path A: Complete Contract AS Written}}{{ 33}}](#p35)
    - [{{ Negotiation Paths}}{{ 34}}](#p36)
    - [{{ Combat ENCOUNTER (If Attacked)}}{{ 34}}](#p36)
    - [{{ Path B: REFUSE CONTRACT (Walk Away)}}{{ 35}}](#p37)
    - [{{ Path C: Expose The Consortium}}{{ 35}}](#p37)
    - [{{ Path D: COMPLETE CONTRACT (Deliver Her Head)}}{{ 36}}](#p38)
  - #### [{{ Aftermath & Rewards}}{{ 36}}](#p38)
    - [{{ Quest Completion Summary}}{{ 36}}](#p38)
    - [{{ Experience & Level Up}}{{ 36}}](#p38)
    - [{{ Reputation Tracking}}{{ 36}}](#p38)
    - [{{ Npc Outcomes}}{{ 36}}](#p38)
    - [{{ Long-Term Consequences (Act II)}}{{ 37}}](#p39)
  - #### [{{ DM Guidance: QUEST 1.3}}{{ 37}}](#p39)
    - [{{ Key Themes}}{{ 37}}](#p39)
    - [{{ Running the Investigation}}{{ 37}}](#p39)
    - [{{ The Moral Dilemma}}{{ 37}}](#p39)
    - [{{ Combat Adjustments}}{{ 37}}](#p39)
    - [{{ Non-Combat Resolution}}{{ 37}}](#p39)
    - [{{ The Weight of Choice}}{{ 37}}](#p39)
  - #### [{{ Quest 1.3 - DM Guidance}}{{ 38}}](#p40)
    - [{{ Design Philosophy}}{{ 38}}](#p40)
    - [{{ Key DMing Points}}{{ 38}}](#p40)
    - [{{ Difficulty Adjustments}}{{ 38}}](#p40)
    - [{{ Roleplaying Elara}}{{ 38}}](#p40)
    - [{{ Common Player Questions}}{{ 38}}](#p40)
    - [{{ This Quest Tests:}}{{ 39}}](#p41)
...
## Contents
   ...
   - [{{ Infiltration Options}}{{ 40}}](#p42)
   - [{{ The Complication: Whisper}}{{ 40}}](#p42)
   - [{{ The Black Ledger}}{{ 40}}](#p42)
   - [{{ Escape and Consequences}}{{ 40}}](#p42)
   - [{{ Quest Resolution}}{{ 41}}](#p43)
  ...
  - #### [{{ Blood & Coin Campaign - Act I Finale}}{{ 41}}](#p43)
    ...
    - [{{ Verdict and Consequences}}{{ 43}}](#p45)
    - [{{ Alternative Paths}}{{ 43}}](#p45)
    - [{{ Quest Resolution}}{{ 43}}](#p45)
  - #### [{{ Quest 2.1: The Recruiters}}{{ 44}}](#p46)
  - #### [{{ Blood & Coin Campaign - Act II Opening}}{{ 44}}](#p46)
  - #### [{{ Quest Setup}}{{ 44}}](#p46)
  - #### [{{ The Three Messages}}{{ 44}}](#p46)
    - [{{ Message 1: Royal Seal}}{{ 44}}](#p46)
    - [{{ Message 2: Republican Paper}}{{ 44}}](#p46)
    - [{{ Message 3: Blank Envelope}}{{ 44}}](#p46)
  - #### [{{ The Wayward Inn}}{{ 44}}](#p46)
    - [{{ Location}}{{ 44}}](#p46)
  ...
  - #### [{{ The Investigation Phase}}{{ 51}}](#p53)
    ...
    - [{{ Talking TO Act I Npcs}}{{ 51}}](#p53)
  - #### [{{ The Choice}}{{ 52}}](#p54)
    - [{{ Option 1: JOIN THALDROS}}{{ 52}}](#p54)
    - [{{ Option 2: JOIN AETHORIA}}{{ 52}}](#p54)
    - [{{ Option 3: Join The Unbound}}{{ 52}}](#p54)
    - [{{ Option 4: PLAY MULTIPLE SIDES (Double/Triple Agent)}}{{ 52}}](#p54)
    - [{{ Option 5: REFUSE ALL}}{{ 52}}](#p54)
  - #### [{{ Rewards}}{{ 53}}](#p55)
  - #### [{{ DM Guidance}}{{ 53}}](#p55)
  ...
  - #### [{{ Quest Structure}}{{ 53}}](#p55)
  - #### [{{ Quest 2.2-T: The Convoy}}{{ 53}}](#p55)
  - #### [{{ Thaldros Mission}}{{ 53}}](#p55)
    - [{{ Mission Briefing}}{{ 53}}](#p55)
    - [{{ The Payment}}{{ 54}}](#p56)
    - [{{ Travel to Greymarch Valley}}{{ 54}}](#p56)
    - [{{ The Truth}}{{ 54}}](#p56)
    - [{{ Confrontation}}{{ 55}}](#p57)
    - [{{ The Moral Choice}}{{ 55}}](#p57)
    - [{{ Aftermath}}{{ 56}}](#p58)
  - #### [{{ Quest 2.2-A: The Defector}}{{ 57}}](#p59)
  - #### [{{ Aethoria Mission}}{{ 57}}](#p59)
    - [{{ Mission Briefing}}{{ 57}}](#p59)
    - [{{ The Payment}}{{ 57}}](#p59)
    - [{{ Travel to Thornfield Manor}}{{ 57}}](#p59)
    - [{{ Thornfield Manor}}{{ 58}}](#p60)
    - [{{ Meeting General Thorne}}{{ 58}}](#p60)
    - [{{ General Marcus Thorne}}{{ 58}}](#p60)
    - [{{ The Escape}}{{ 58}}](#p60)
    - [{{ The Riverside Survivors}}{{ 59}}](#p61)
    - [{{ The Moral Choice}}{{ 59}}](#p61)
    - [{{ Aftermath}}{{ 60}}](#p62)
  - #### [{{ Quest 2.2-U: The Component}}{{ 61}}](#p63)
  - #### [{{ Unbound Mission}}{{ 61}}](#p63)
    - [{{ Mission Briefing}}{{ 61}}](#p63)
    - [{{ The Payment}}{{ 61}}](#p63)
    - [{{ Travel to the Vault of Whispers}}{{ 61}}](#p63)
    - [{{ The Vault of Whispers}}{{ 62}}](#p64)
    - [{{ Vault Entry}}{{ 62}}](#p64)
    - [{{ Vault Interior - The Halls of Whispers}}{{ 62}}](#p64)
    - [{{ The Vault Guardian}}{{ 63}}](#p65)
    - [{{ The Component}}{{ 63}}](#p65)
    - [{{ The Moral Choice}}{{ 63}}](#p65)
    - [{{ Aftermath}}{{ 64}}](#p66)
  - #### [{{ Multiple Factions Option}}{{ 65}}](#p67)
    - [{{ The Juggling Act}}{{ 65}}](#p67)
  - #### [{{ Quest COMPLETION}}{{ 65}}](#p67)
    - [{{ Experience & Rewards}}{{ 65}}](#p67)
  - #### [{{ DM Guidance}}{{ 65}}](#p67)
    - [{{ Running Parallel Missions}}{{ 65}}](#p67)
    - [{{ No Right Answers}}{{ 65}}](#p67)
    - [{{ Consequences Matter}}{{ 65}}](#p67)
  - #### [{{ Transition to QUEST 2.3}}{{ 65}}](#p67)
  - #### [{{ New Items For Compendium}}{{ 66}}](#p68)
    - [{{ World-Splitter Component #2}}{{ 66}}](#p68)
    - [{{ Ancient Vault Artifacts}}{{ 66}}](#p68)
  - #### [{{ Quest 2.3: The Double Cross}}{{ 66}}](#p68)
  - #### [{{ Blood & Coin Campaign - Act II}}{{ 66}}](#p68)
  - #### [{{ Quest Setup}}{{ 66}}](#p68)
  - #### [{{ The Revelation}}{{ 66}}](#p68)
}}
{{skipCounting}}
\page
{{toc,wide
## Contents
  ...
  - #### [{{ If Working For Thaldros}}{{ 66}}](#p68)
  - #### [{{ The Document}}{{ 66}}](#p68)
  - #### [{{ The Meeting}}{{ 67}}](#p69)
    - [{{ Confrontation With Dawnblade}}{{ 68}}](#p70)
    - [{{ The CHOICE (Thaldros Path)}}{{ 68}}](#p70)
  - #### [{{ If working For Aethoria}}{{ 69}}](#p71)
  - #### [{{ The Document}}{{ 69}}](#p71)
  - #### [{{ The Meeting}}{{ 69}}](#p71)
    - [{{ Confrontation With Valen}}{{ 69}}](#p71)
    - [{{ The CHOICE (Aethoria Path)}}{{ 69}}](#p71)    
  - #### [{{ If Working For The Unbound}}{{ 70}}](#p72)
  - #### [{{ The Document}}{{ 70}}](#p72)
  - #### [{{ The Meeting}}{{ 71}}](#p73)
    - [{{ Confrontation With Corvus}}{{ 71}}](#p73)
    - [{{ The CHOICE (Unbound Path)}}{{ 72}}](#p74)
  - #### [{{ Universal Elements (All Paths)}}{{ 73}}](#p75)
    - [{{ Regardless of faction, this quest includes:}}{{ 73}}](#p75)
  - #### [{{ Aftermath}}{{ 73}}](#p75)
  - #### [{{ Level Up}}{{ 74}}](#p76)
  - #### [{{ New Npcs For Compendium}}{{ 74}}](#p76)
  - #### [{{ DM Guidance}}{{ 74}}](#p76)
    - [{{ Running The Betrayal}}{{ 74}}](#p76)
    - [{{ The Confrontation Scene}}{{ 74}}](#p76)
    - [{{ Player Agency}}{{ 74}}](#p76)
    - [{{ Consequences}}{{ 74}}](#p76)
  - #### [{{ Transition to QUEST 2.4}}{{ 74}}](#p76)
  - #### [{{ Quest 2.4: The Heist}}{{ 74}}](#p76)
  - #### [{{ Blood & Coin Campaign - Act II}}{{ 74}}](#p76)
  - #### [{{ Quest Setup}}{{ 75}}](#p77)
  - #### [{{ The Royal Vault}}{{ 75}}](#p77)  
    - [{{ Location}}{{ 75}}](#p77)
  - #### [{{ The Mission Briefing}}{{ 75}}](#p77)
    - [{{ If Working For Thaldros:}}{{ 75}}](#p77)
    - [{{ If Working For Aethoria:}}{{ 75}}](#p77)
    - [{{ If Working For Unbound:}}{{ 75}}](#p77)
    - [{{ IF INDEPENDENT:}}{{ 75}}](#p77)
  - #### [{{ Phase 1: Intelligence Gathering}}{{ 75}}](#p77)
    - [{{ Research Checks}}{{ 75}}](#p77)
    - [{{ Casing The Vault}}{{ 76}}](#p78)
    - [{{ Gathering Specialists}}{{ 76}}](#p78)
  - #### [{{ The Rival Teams}}{{ 76}}](#p78)
    - [{{ Team 1: The Shadows (Professional Thieves)}}{{ 76}}](#p78)
    - [{{ Team 2: The Fanatics (Unbound Cultists)}}{{ 76}}](#p78)
    - [{{ Team 3: The Betrayers (Your Former Faction)}}{{ 76}}](#p78)
  - #### [{{ Phase 2: The Plan}}{{ 77}}](#p79)
    - [{{ Three Approaches}}{{ 77}}](#p79)
  - #### [{{ Phase 3: The Infiltration}}{{ 77}}](#p79)
    - [{{ Getting Inside}}{{ 77}}](#p79)
  - #### [{{ Phase 4: The Vault}}{{ 78}}](#p80)
    - [{{ Level 1-4: Descended Levels}}{{ 78}}](#p80)
    - [{{ Level 5: The Inner Vault}}{{ 78}}](#p80)
  - #### [{{ The Three-Way Encounter}}{{ 78}}](#p80)
  - #### [{{ Multi-Faction Combat}}{{ 78}}](#p80)
    - [{{ Enemy: The Shadows}}{{ 78}}](#p80)
    - [{{ Enemy: The Fanatics}}{{ 78}}](#p80)
    - [{{ Enemy: The Revenge Squad}}{{ 78}}](#p80)
    - [{{ Enemy: The Vault Guardian}}{{ 79}}](#p81)
  - #### [{{ The Heist Chaos}}{{ 79}}](#p81)
    - [{{ Possible Actions}}{{ 79}}](#p81)
  - #### [{{ The Targets}}{{ 80}}](#p82)
    - [{{ Primary Targets}}{{ 80}}](#p82)
    - [{{ Secondary Targets}}{{ 80}}](#p82)
    - [{{ Magic Items Available}}{{ 80}}](#p82)
  - #### [{{ The Discovery}}{{ 80}}](#p82)
  - #### [{{ The Choice}}{{ 80}}](#p82)
  - #### [{{ The Escape}}{{ 81}}](#p83)
    - [{{ Getting Out}}{{ 81}}](#p83)
  - #### [{{ Aftermath}}{{ 81}}](#p83)
  ...
  - #### [{{ Rewards}}{{ 81}}](#p83)
  - #### [{{ Level Up}}{{ 82}}](#p84)
  - #### [{{ Transition to QUEST 2.5}}{{ 82}}](#p84)
  - #### [{{ Quest 2.5: The Breaking Point}}{{ 82}}](#p84)
  - #### [{{ Blood & Coin Campaign - Act II Finale}}{{ 82}}](#p84)
  - #### [{{ Quest Setup}}{{ 82}}](#p84)
  - #### [{{ The Five Possible Outcomes}}{{ 82}}](#p84)
  - #### [{{ Opening Scene: The Summons}}{{ 82}}](#p84)
    - [{{ Message From Thaldros}}{{ 82}}](#p84)
    - [{{ Message From Aethoria}}{{ 83}}](#p85)
    - [{{ Message From The Unbound}}{{ 83}}](#p85)
  - #### [{{ The Choice Point}}{{ 83}}](#p85)
  - #### [{{ Path 1: Thaldros Victory}}{{ 83}}](#p85)
  - #### [{{ The Battle}}{{ 83}}](#p85)
    - [{{ Deployment}}{{ 83}}](#p85)
    - [{{ Phase 1: The CHARGE}}{{ 83}}](#p85)
    - [{{ Phase 2: The PURSUIT}}{{ 83}}](#p85)
    - [{{ Phase 3: The Final Stand}}{{ 83}}](#p85)
    - [{{ Outcome: Thaldros Victory}}{{ 84}}](#p86)
  - #### [{{ Path 2: Aethoria Victory}}{{ 84}}](#p86)
  - #### [{{ The Defense}}{{ 84}}](#p86)
    - [{{ Deployment}}{{ 84}}](#p86)
    - [{{ Phase 1: The DEFENSE}}{{ 84}}](#p86)
    - [{{ Phase 2: The COUNTER-ATTACK}}{{ 84}}](#p86)
    - [{{ Phase 3: The ROUT}}{{ 84}}](#p86)
    - [{{ Outcome: Aethoria Victory}}{{ 85}}](#p87)
  - #### [{{ Path 3: Unbound Apocalypse}}{{ 85}}](#p87)
  - #### [{{ The Heist During Battle}}{{ 85}}](#p87)
    - [{{ The Plan}}{{ 85}}](#p87)
    - [{{ Phase 1: STEAL COMPONENT #4 (Thaldros King)}}{{ 85}}](#p87)
    - [{{ Phase 2: STEAL COMPONENT #5 (Aethoria General)}}{{ 85}}](#p87)
    - [{{ Phase 3: The RITUAL}}{{ 85}}](#p87)
    - [{{ The Final Choice}}{{ 85}}](#p87)
}}
{{skipCounting}}
\page
{{toc,wide
## Contents
  ...
  - #### [{{ Path 4: Peace Achieved}}{{ 87}}](#p89)
  - #### [{{ The Diplomatic Mission}}{{ 87}}](#p89)  
    - [{{ The CHALLENGE}}{{ 87}}](#p89)
    - [{{ Phase 1: Expose The Conspiracy}}{{ 87}}](#p89)
    - [{{ Phase 2: Negotiation}}{{ 87}}](#p89)
    - [{{ Negotiation Rounds}}{{ 87}}](#p89)
    - [{{ Phase 3: Assassination Attempts}}{{ 87}}](#p89)
    - [{{ Outcome: Peace Achieved}}{{ 88}}](#p90)
  - #### [{{ Path 5: Total War}}{{ 88}}](#p90)
  - #### [{{ The Stalemate}}{{ 88}}](#p90)
    - [{{ Phase 1-3: Endless Battle}}{{ 88}}](#p90)
    - [{{ Outcome: Total War}}{{ 88}}](#p90)
  - #### [{{ Act II Ending}}{{ 88}}](#p90)
  - #### [{{ Level Up & Transition}}{{ 88}}](#p90)
  - #### [{{ Act II Complete Summary}}{{ 89}}](#p91)
    - [{{ What PCs Accomplished:}}{{ 89}}](#p91)
    - [{{ Total Possible Gold (Act II):}}{{ 89}}](#p91)
    - [{{ Reputation Earned:}}{{ 89}}](#p91)
    - [{{ Act III Setup:}}{{ 89}}](#p91)
  - #### [{{ DM Guidance}}{{ 89}}](#p91)
    - [{{ Running the Finale}}{{ 89}}](#p91)
    - [{{ The Five Outcomes}}{{ 89}}](#p91)
    - [{{ Player Agency}}{{ 89}}](#p91)
  - #### [{{ Transition to Act III}}{{ 89}}](#p91)
  - #### [{{ Quest 3.1: The Peacekeepers}}{{ 89}}](#p91)
  - #### [{{ Blood & Coin Campaign - Act III (Peace Path)}}{{ 89}}](#p91)
  - #### [{{ Act III Opening}}{{ 89}}](#p91)
  - #### [{{ The Three Crises}}{{ 90}}](#p92)
  - #### [{{ Crisis 1: The Border Incident}}{{ 90}}](#p92)
    - [{{ Arrival}}{{ 90}}](#p92)
    - [{{ Investigation}}{{ 90}}](#p92)
    - [{{ The TRUTH}}{{ 90}}](#p92)
    - [{{ The RESOLUTION}}{{ 90}}](#p92)
  - #### [{{ Crisis 2: The Trade Dispute}}{{ 91}}](#p93)
    - [{{ The SITUATION}}{{ 91}}](#p93)
    - [{{ Investigation}}{{ 91}}](#p93)
    - [{{ The TRUTH}}{{ 91}}](#p93)
    - [{{ The RESOLUTION}}{{ 91}}](#p93)
  - #### [{{ Crisis 3: The Assassination Attempt}}{{ 92}}](#p94)
    - [{{ The SCENE}}{{ 92}}](#p94)
    - [{{ Investigation}}{{ 92}}](#p94)
    - [{{ The TRUTH}}{{ 92}}](#p94)
    - [{{ The RESOLUTION}}{{ 92}}](#p94)
  - #### [{{ The Pattern}}{{ 93}}](#p95)
  - #### [{{ Aftermath}}{{ 93}}](#p95)
  - #### [{{ Rewards}}{{ 93}}](#p95)
  - #### [{{ Level Up}}{{ 93}}](#p95)
  - #### [{{ DM Guidance}}{{ 93}}](#p95)
    - [{{ Running Multiple Crises}}{{ 93}}](#p95)
    - [{{ The Investigation Layer}}{{ 93}}](#p95)
    - [{{ Peace is Hard}}{{ 93}}](#p95)
  - #### [{{ Transition to Quest 3.2}}{{ 94}}](#p96)
  - #### [{{ Quest 3.2: The Underground}}{{ 94}}](#p96)
  - #### [{{ Blood & Coin Campaign - Act III (Peace Path)}}{{ 94}}](#p96)
  - #### [{{ Quest Setup}}{{ 94}}](#p96)
  - #### [{{ The Hunt Structure}}{{ 94}}](#p96)
  - #### [{{ Phase 1: Cell Alpha (Urban Terrorists)}}{{ 94}}](#p96)
    - [{{ Intelligence Gathering}}{{ 94}}](#p96)
    - [{{ The SAFEHOUSE}}{{ 94}}](#p96)
    - [{{ Approach Options}}{{ 94}}](#p96)
    - [{{ The Intelligence}}{{ 95}}](#p97)
    - [{{ The CHOICE}}{{ 95}}](#p97)
  - #### [{{ Phase 2: Cell Beta (Border Guerrillas)}}{{ 95}}](#p97)
    - [{{ The Journey}}{{ 95}}](#p97)
    - [{{ Thornwood Ruins}}{{ 95}}](#p97)
    - [{{ Reconnaissance}}{{ 95}}](#p97)
    - [{{ Approach Options}}{{ 96}}](#p98)
    - [{{ The INTELLIGENCE}}{{ 97}}](#p99)
  - #### [{{ Phase 3: Cell Gamma (Leadership)}}{{ 97}}](#p99)
    - [{{ The DESCENT}}{{ 97}}](#p99)
    - [{{ Infiltration Options}}{{ 97}}](#p99)
    - [{{ The PROPHET}}{{ 98}}](#p100)
    - [{{ The CONFRONTATION}}{{ 98}}](#p100)
    - [{{ The Final Choice}}{{ 99}}](#p101)
  - #### [{{ Operation Collapse}}{{ 99}}](#p101)
  - #### [{{ Aftermath}}{{ 99}}](#p101)
  - #### [{{ Rewards}}{{ 99}}](#p101)
  - #### [{{ Level Up}}{{ 100}}](#p102)
  - #### [{{ Transition to QUEST 3.3}}{{ 100}}](#p102)
  - #### [{{ Quest 3.3: The Alliance}}{{ 100}}](#p102)
  - #### [{{ Blood & Coin Campaign - Act III (Peace Path)}}{{ 100}}](#p102)
  - #### [{{ Quest Setup}}{{ 100}}](#p102)
  - #### [{{ The External Threat}}{{ 100}}](#p102)
    - [{{ The DREADHOST}}{{ 100}}](#p102)
  - #### [{{ The Intelligence}}{{ 100}}](#p102)
  - #### [{{ Phase 1: Forge The Alliance}}{{ 100}}](#p102)
    - [{{ The Political Challenge}}{{ 100}}](#p102)
    - [{{ Challenge 1: Unified Command}}{{ 101}}](#p103)
    - [{{ Challenge 2: Troop Integration}}{{ 101}}](#p103)
    - [{{ Challenge 3: Resource Allocation}}{{ 101}}](#p103)
  - #### [{{ Phase 2: The First Battle}}{{ 102}}](#p104)
    - [{{ The BATTLEFIELD}}{{ 102}}](#p104)
    - [{{ The Battle Structure}}{{ 102}}](#p104)
  - #### [{{ Phase 3: The Counter-Strategy}}{{ 103}}](#p105)
    - [{{ The Strategic Situation}}{{ 103}}](#p105)
  - #### [{{ Chosen Strategy: Decapitation Strike}}{{ 103}}](#p105)
    - [{{ The Plan}}{{ 103}}](#p105)
    - [{{ The Infiltration}}{{ 104}}](#p106)
}}
{{skipCounting}}
\page
{{toc,wide
## Contents
  ...
  - #### [{{ Final Boss: The Dread King}}{{ 104}}](#p106)
    - [{{ Battle Phases}}{{ 105}}](#p107)
  - #### [{{ Aftermath}}{{ 105}}](#p107)
  - #### [{{ The Choice}}{{ 105}}](#p107)
  - #### [{{ Rewards}}{{ 105}}](#p107)  
  - #### [{{ Level Up}}{{ 105}}](#p107)
  - #### [{{ Transition to Quest 3.4}}{{ 106}}](#p108)
  - #### [{{ Quest 3.4: The Unification}}{{ 106}}](#p108)  
  - #### [{{ Blood & Coin Campaign - Act III (Peace Path)}}{{ 106}}](#p108)
  - #### [{{ Quest Setup}}{{ 106}}](#p108)
  - #### [{{ The Voyage North}}{{ 106}}](#p108)
    - [{{ Day 1-2: Normal Sailing}}{{ 106}}](#p108)
    - [{{ Day 3: The Ice Field}}{{ 106}}](#p108)
    - [{{ DAY 4-5: The MARCH}}{{ 106}}](#p108)
  - #### [{{ The Frozen Kingdom}}{{ 106}}](#p108)
    - [{{ Investigation Phase}}{{ 106}}](#p108)
  - #### [{{ The Throne Room}}{{ 107}}](#p109)
    - [{{ The Trap}}{{ 107}}](#p109)
  - #### [{{ Final Boss: The Dread King (Empowered)}}{{ 107}}](#p109)
    - [{{ The Real Challenge}}{{ 107}}](#p109)
    - [{{ Battle Strategy}}{{ 107}}](#p109)
    - [{{ Alternative Approaches}}{{ 107}}](#p109)
  - #### [{{ Crown Destruction Scene}}{{ 108}}](#p110)
  - #### [{{ The Return}}{{ 108}}](#p110)
  - #### [{{ The Proposal}}{{ 108}}](#p110)
    - [{{ Option 1: REQUEST GOLD}}{{ 108}}](#p110)
    - [{{ Option 2: Propose Full Unification}}{{ 108}}](#p110)
    - [{{ Option 3: REJECT BOTH}}{{ 108}}](#p110)
    - [{{ Option 4: Make Specific Requests}}{{ 109}}](#p111)
  - #### [{{ Rewards}}{{ 109}}](#p111)
  - #### [{{ Level Up}}{{ 109}}](#p111)
  ...
  - #### [{{ DM Guidance}}{{ 109}}](#p111)
    - [{{ Running the Final Dread King Fight}}{{ 109}}](#p111)
  ...
  - #### [{{ The Revelation}}{{ 110}}](#p112)
  - #### [{{ The Final Choice}}{{ 111}}](#p113)
    - [{{ Ending 1: Eternal Vigil}}{{ 111}}](#p113)
    - [{{ Ending 2: The Institution}}{{ 111}}](#p113)
    - [{{ Ending 3: Retirement}}{{ 111}}](#p113)
  - #### [{{ Personal Epilogues}}{{ 112}}](#p114)
    - [{{ Epilogue Scene For Each Pc}}{{ 112}}](#p114)
  - #### [{{ The Reunion (20 Years Later)}}{{ 112}}](#p114)
  - #### [{{ The Final Summary}}{{ 112}}](#p114)
  - #### [{{ Rewards (Final)}}{{ 112}}](#p114)
  - #### [{{ The True Ending}}{{ 112}}](#p114)
  - #### [{{ Campaign Complete}}{{ 113}}](#p115)
  - #### [{{ Post-Campaign Options}}{{ 113}}](#p115)
    - [{{ Option A: Epilogue Adventures}}{{ 113}}](#p115)
    - [{{ Option B: NEXT GENERATION}}{{ 113}}](#p115)
    - [{{ Option C: ALTERNATE TIMELINE}}{{ 113}}](#p115)
    - [{{ Option D: TRUE ENDING}}{{ 113}}](#p115)
  - #### [{{ DM Notes: Delivering The Ending}}{{ 113}}](#p115)
  - #### [{{ Final Advice For DMs}}{{ 113}}](#p115)
  - #### [{{ Thank You}}{{ 114}}](#p116)
- ### [{{ Appendix A: Campaign NPCs}}{{ 115}}](#p117)
  - #### [{{ Blood & Coin Campaign - Complete NPC Compendium}}{{ 115}}](#p117)
  - #### [{{ All Major NPCs by Act and Quest}}{{ 115}}](#p117)
  - #### [{{ ACT I NPCs}}{{ 115}}](#p117)
  - #### [{{ Quest 1.1: The Consortium Job}}{{ 115}}](#p117)
  - #### [{{ Quest 1.2: The Hunters}}{{ 116}}](#p118)
  - #### [{{ Quest 1.3: The Red Wolf}}{{ 117}}](#p119)
  - #### [{{ Quest 1.4: The Black Ledger}}{{ 118}}](#p120)
  - #### [{{ Quest 1.5: The Trial}}{{ 119}}](#p121)
- ### [{{ ACT II NPCs}}{{ 120}}](#p122)
  - #### [{{ Quest 2.1: The Recruiters}}{{ 120}}](#p122)
  - #### [{{ Quest 2.2: The First Mission}}{{ 122}}](#p124)
  - #### [{{ Quest 2.3: The Double Cross}}{{ 123}}](#p125)
  - #### [{{ Quest 2.4: The Heist}}{{ 124}}](#p126)
  - #### [{{ Quest 2.5: The Breaking Point}}{{ 126}}](#p128)
  - #### [{{ Act III NPCs}}{{ 126}}](#p128)
  - #### [{{ Quest 3.1: The Peacekeepers}}{{ 126}}](#p128)
    - [{{ Captain Marcus Stone}}{{ 126}}](#p128)
    - [{{ Lieutenant Sara Brightwind}}{{ 126}}](#p128)
    - [{{ Admiral Viktor Seaworth}}{{ 126}}](#p128)
    - [{{ Diplomat Chen Aldermist}}{{ 126}}](#p128)
...
## Contents
  ...
  - #### [{{ Quest 2.4: The Heist}}{{ 132}}](#p134)
    ...
    - [{{ Crown Jewels OF Thaldros}}{{ 132}}](#p134)
    - [{{ Defender Longsword}}{{ 132}}](#p134)
    - [{{ Staff OF Power}}{{ 132}}](#p134)
    - [{{ Ring OF Spell Storing}}{{ 133}}](#p135)
    - [{{ Cloak OF Invisibility}}{{ 133}}](#p135)
    - [{{ Amulet OF Health}}{{ 133}}](#p135)
    - [{{ Belt OF Giant Strength (Frost)}}{{ 133}}](#p135)
  - #### [{{ Quest 2.5: The Breaking Point}}{{ 133}}](#p135)
  ...
  - #### [{{ By Rarity}}{{ 135}}](#p137)
  - #### [{{ Cursed Items}}{{ 135}}](#p137)
  - #### [{{ DM Notes}}{{ 135}}](#p137)
    - [{{ Item Balance:}}{{ 135}}](#p137)
    - [{{ Artifact Warnings:}}{{ 135}}](#p137)
    - [{{ Treasure Philosophy:}}{{ 135}}](#p137)
  - #### [{{ Appendix C: Monsters}}{{ 136}}](#p138)
  - #### [{{ Standard Monsters Used}}{{ 136}}](#p138)
  - #### [{{ Custom/Modified Monsters}}{{ 136}}](#p138)
  - #### [{{ Act I Creatures}}{{ 136}}](#p138)
  - #### [{{ Act II Creatures}}{{ 137}}](#p139)
  - #### [{{ Act III Creatures}}{{ 138}}](#p140)
  - #### [{{ Undead Creatures (Act III)}}{{ 139}}](#p141)
    - [{{ Zombies (Quest 3.3, 3.4)}}{{ 139}}](#p141)
    - [{{ skeleton warriors (Quest 3.3, 3.4)}}{{ 139}}](#p141)
    - [{{ Wights (Quest 3.3, 3.4)}}{{ 139}}](#p141)
    - [{{ Wraiths (Quest 3.4)}}{{ 139}}](#p141)
  - #### [{{ Constructs}}{{ 140}}](#p142)
  - #### [{{ Special Encounters}}{{ 140}}](#p142)
    - [{{ dreadhost army (Quest 3.3)}}{{ 140}}](#p142)
  - #### [{{ Quick Reference BY CR}}{{ 140}}](#p142)
  - #### [{{ DM Notes}}{{ 140}}](#p142)
    - [{{ Monster Usage Guidelines:}}{{ 140}}](#p142)
    - [{{ Scaling Encounters:}}{{ 140}}](#p142)
    - [{{ Moral Complexity:}}{{ 140}}](#p142)
  - #### [{{ Appendix D: DM Quick Reference}}{{ 141}}](#p143)
  - #### [{{ Relationship to Shattered Oaths Campaign}}{{ 141}}](#p143)
  - #### [{{ BLOOD & COIN - DM QUICK REFERENCE}}{{ 141}}](#p143)
  - #### [{{ At-a-Glance Campaign Guide}}{{ 141}}](#p143)
    - [{{ CAMPAIGN STRUCTURE}}{{ 141}}](#p143)
  - #### [{{ QUICK SESSION BREAKDOWN}}{{ 141}}](#p143)
    - [{{ Quest 1.1: Welcome to Crossroads (Level 1, 1-2 sessions)}}{{ 141}}](#p143)
    - [{{ Quest 1.2: The Hunters (Level 2, 1-2 sessions)}}{{ 141}}](#p143)
    - [{{ Quest 1.3: The Red Wolf (Level 3, 2 sessions)}}{{ 141}}](#p143)
    - [{{ Quest 1.4: The Black Ledger (Level 4, 2-3 sessions)}}{{ 142}}](#p144)
    - [{{ Quest 1.5: The Trial (Level 5, 2-3 sessions)}}{{ 142}}](#p144)
    - [{{ Quest 2.1: The Recruiters (Level 6, 2-3 sessions)}}{{ 142}}](#p144)
    - [{{ Quest 2.2: First Mission (Level 7-8, 2-3 sessions)}}{{ 142}}](#p144)
    - [{{ Quest 2.3: Double Cross (Level 8-9, 2-3 sessions)}}{{ 142}}](#p144)
    - [{{ Quest 2.4: The Heist (Level 10-11, 3-4 sessions)}}{{ 142}}](#p144)
    - [{{ Quest 2.5: Breaking Point (Level 11, 2-3 sessions)}}{{ 142}}](#p144)
}}
{{skipCounting}}
\page
{{toc,wide
## Contents
   ...
   - [{{ Quest 3.1: The Peacekeepers (Level 11-12, 2 sessions)}}{{ 142}}](#p144)
  ...
  - #### [{{ KEY NPCs AT-A-GLANCE}}{{ 143}}](#p145)
    ...
    - [{{ Act III - Final Conflict}}{{ 143}}](#p145)
  - #### [{{ IMPORTANT DCs}}{{ 143}}](#p145)
    - [{{ Social Encounters}}{{ 143}}](#p145)
    - [{{ Investigation & Exploration}}{{ 143}}](#p145)
    - [{{ Stealth & Infiltration}}{{ 143}}](#p145)
  - #### [{{ COMBAT ENCOUNTERS BY CR}}{{ 143}}](#p145)
    - [{{ Act I (Levels 1-5)}}{{ 143}}](#p145)
    - [{{ Act II (Levels 6-11)}}{{ 143}}](#p145)
    - [{{ Act III (Levels 11-15)}}{{ 144}}](#p146)
  - #### [{{ FACTION RELATIONSHIPS}}{{ 144}}](#p146)
    - [{{ Thaldros (Kingdom)}}{{ 144}}](#p146)
    - [{{ Aethoria (Republic)}}{{ 144}}](#p146)
    - [{{ Thornwood Syndicate}}{{ 144}}](#p146)
    - [{{ Iron Guild}}{{ 144}}](#p146)
  - #### [{{ TREASURE & REWARDS SUMMARY}}{{ 144}}](#p146)
    - [{{ Act I (Levels 1-5)}}{{ 144}}](#p146)
    - [{{ Act II (Levels 6-11)}}{{ 144}}](#p146)
    - [{{ Act III (Levels 11-15)}}{{ 144}}](#p146)
    - [{{ Magic Items}}{{ 144}}](#p146)
  - #### [{{ KEY DECISION POINTS}}{{ 144}}](#p146)
    - [{{ Quest 1.5: The Trial}}{{ 144}}](#p146)
    - [{{ Quest 2.1: The Recruiters}}{{ 144}}](#p146)
    - [{{ Quest 2.5: Breaking Point}}{{ 144}}](#p146)
    - [{{ Quest 3.5: Final Choice}}{{ 144}}](#p146)
  - #### [{{ SESSION PREP CHECKLIST}}{{ 145}}](#p147)
    - [{{ Before Each Session}}{{ 145}}](#p147)
    - [{{ During Session}}{{ 145}}](#p147)
    - [{{ After Session}}{{ 145}}](#p147)
  - #### [{{ CAMPAIGN THEMES}}{{ 145}}](#p147)
  - #### [{{ IMPROVISATION TIPS}}{{ 145}}](#p147)
    - [{{ When Players Go Off-Script}}{{ 145}}](#p147)
    - [{{ Adjusting Difficulty}}{{ 145}}](#p147)
    - [{{ Pacing}}{{ 145}}](#p147)
  - #### [{{ RANDOM ENCOUNTER TABLES}}{{ 145}}](#p147)
    - [{{ Act I Random Encounters (d10)}}{{ 145}}](#p147)
    - [{{ Act II Random Encounters (d10)}}{{ 145}}](#p147)
    - [{{ Act III Random Encounters (d10)}}{{ 146}}](#p148)
  - #### [{{ DETAILED CROSSROADS ENCOUNTERS}}{{ 146}}](#p148)
    - [{{ 1. THE CONTRACT DISPUTE}}{{ 146}}](#p148)
    - [{{ 2. THE DESPERATE VETERAN}}{{ 146}}](#p148)
    - [{{ 3. THE POISONED DRINK}}{{ 147}}](#p149)
    - [{{ 4. THE ARENA INVITATION}}{{ 147}}](#p149)
    - [{{ 5. THE GUILD SHAKEDOWN}}{{ 148}}](#p150)
    - [{{ 6. THE MIDNIGHT MESSAGE}}{{ 148}}](#p150)
  - #### [{{ COMBAT TACTICS BY ENEMY TYPE}}{{ 149}}](#p151)
    - [{{ Thugs & Bandits (CR 1/2)}}{{ 149}}](#p151)
    - [{{ City Watch (CR 1)}}{{ 149}}](#p151)
    - [{{ Assassins (CR 2-5)}}{{ 149}}](#p151)
    - [{{ Elite Guards (CR 5-8)}}{{ 149}}](#p151)
    - [{{ Undead (CR varies)}}{{ 149}}](#p151)
    - [{{ Necromancers (CR 8-15)}}{{ 149}}](#p151)
  - #### [{{ KEY ITEM QUICK REFERENCE}}{{ 149}}](#p151)
    - [{{ Common Quest Rewards}}{{ 149}}](#p151)
    - [{{ Uncommon Magic Items (Quests 1.3-2.1)}}{{ 149}}](#p151)
    - [{{ Rare Magic Items (Quests 2.2-3.1)}}{{ 149}}](#p151)
    - [{{ Very Rare Magic Items (Quests 3.2-3.4)}}{{ 150}}](#p152)
    - [{{ Legendary Items (Quest 3.5)}}{{ 150}}](#p152)
  ...
  - #### [{{ STATUS EFFECT QUICK REFERENCE}}{{ 152}}](#p154)
    - [{{ Common Conditions}}{{ 152}}](#p154)
    - [{{ Exhaustion Levels}}{{ 152}}](#p154)
  - #### [{{ QUICK RULES REMINDERS}}{{ 152}}](#p154)
    - [{{ Action Economy}}{{ 152}}](#p154)
    - [{{ Advantage/Disadvantage}}{{ 152}}](#p154)
    - [{{ Cover}}{{ 152}}](#p154)
    - [{{ Stealth & Perception}}{{ 152}}](#p154)
  - #### [{{ DOWNTIME ACTIVITIES}}{{ 152}}](#p154)
    - [{{ Between Quests (1-7 days)}}{{ 152}}](#p154)
    - [{{ Between Acts (Weeks-Months)}}{{ 152}}](#p154)
  - #### [{{ NPC MOTIVATIONS & SECRETS}}{{ 153}}](#p155)
    - [{{ Act I NPCs}}{{ 153}}](#p155)
    - [{{ Act II Faction Leaders}}{{ 153}}](#p155)
  - #### [{{ MORAL DILEMMA EXAMPLES}}{{ 153}}](#p155)
    - [{{ Quest 1.2 Example}}{{ 153}}](#p155)
    - [{{ Quest 2.3 Example}}{{ 153}}](#p155)
    - [{{ Quest 3.2 Example}}{{ 153}}](#p155)   
  - #### [{{ SESSION ZERO GUIDANCE}}{{ 153}}](#p155)
    - [{{ Set Expectations}}{{ 153}}](#p155)
    - [{{ Establish Safety Tools}}{{ 154}}](#p156)
    - [{{ Character Creation Guidelines}}{{ 154}}](#p156)
    - [{{ Party Cohesion}}{{ 154}}](#p156)
}}
{{skipCounting}}
\page
{{toc,wide
## Contents
  ...
  - #### [{{ ALTERNATE ENDINGS OVERVIEW}}{{ 154}}](#p156)
    - [{{ Ending 1: The Peace}}{{ 154}}](#p156)
    - [{{ Ending 2: The Institution}}{{ 154}}](#p156)
    - [{{ Ending 3: The Ashes}}{{ 154}}](#p156)
    - [{{ Ending 4: The Betrayal}}{{ 154}}](#p156)
  - #### [{{ ADAPTING FOR YOUR TABLE}}{{ 154}}](#p156)
    - [{{ If Players Are More Heroic}}{{ 154}}](#p156)
    - [{{ If Players Are More Ruthless}}{{ 154}}](#p156)
    - [{{ If Players Are Stuck}}{{ 154}}](#p156)
    - [{{ If Campaign Going Off Rails}}{{ 154}}](#p156)
  - #### [{{ MEMORABLE MOMENTS TO CREATE}}{{ 154}}](#p156)
    - [{{ Act I Highlights}}{{ 154}}](#p156)
    - [{{ Act II Highlights}}{{ 155}}](#p157)
    - [{{ Act III Highlights}}{{ 155}}](#p157)
  - #### [{{ PLAYER HANDOUT: CROSSROADS RUMORS}}{{ 155}}](#p157)
...
- **Consequences:** Every choice has repercussions
- **Survival:** Money matters, reputation matters more
- **Professional Ethics:** The code of the sellsword
...
This distinction matters: it's a civil war with foreign backing, not a continental invasion.

### Relationship to Shattered Oaths Campaign

Blood & Coin and Shattered Oaths occur simultaneously in the same world:
...
Both campaigns feature Corvus Blackwood and the Unbound, but from different angles. Players who experience both will see how his conspiracy operates across the entire kingdom.
{{pageNumber,auto}}
\page
...
- Reputation opens doors (and closes them)
- You can't please everyone
- Sometimes the "right" choice gets you killed
...
**Government:** Iron Guild (mercenary guild)  
**Economy:** Mercenary work, black market, vice  
...
- Contract Board (public jobs)
- Varak's Office (private contracts)
- Meeting rooms, barracks for members
- Training yard

**2. The Copper Dragon Inn**
- Largest inn/tavern in town
- Run by Mira Copperstone (information broker)
- 20 rooms (5sp-5gp/night)
...
- Actually just gambling hall
- Loan sharks operate from back rooms
- Some healing available (expensive)
...
- Benefits: Protection, lodging, contracts, reputation

**The Black Chains** (Rival)
- Leader: Captain Kael Darkwater (human mercenary)
- Philosophy: Efficiency over honor, strength over tradition
- Members: ~200 mercenaries (growing)
...
- Neutral to guild politics (profit from both)

**Unaffiliated Mercenaries** (Independent)
- No guild membership
- Lower pay, less protection
...
Each PC arrives at Crossroads for their own reasons. Run individual cold opens for each PC (5-10 minutes each) showing why they're here:
...
**Mira Copperstone** (Halfling, Neutral, Commoner)
- **Role:** Innkeeper and information broker
- **Appearance:** 40s, practical clothes, sharp eyes, friendly smile that doesn't reach her eyes
- **Personality:** Friendly but mercenary, knows everything, sells information
- **Dialogue:** *"New faces! Welcome to the Dragon. Rooms are 5 silver, meals are 1 silver, information is negotiable. What can I get you?"*

**"Lucky" Finn** (Human, Neutral Good, Veteran)
- **Role:** Retired mercenary, mentor figure, Iron Guild recruiter
- **Appearance:** 50s, eye patch, scarred face, still strong despite age
- **Personality:** Gruff but kind, wants to help new blood survive
- **Dialogue:** *"You lot look fresh. Too clean. The Crossroads will fix that. Sit down. Let me tell you how not to die."*

### **Interaction: Lucky Finn's Advice**

If PCs engage with Finn, he offers free advice (he's genuinely trying to help):

**Finn's Wisdom:**

*"Listen up. You want to survive Crossroads? Three rules:*
...
- Values honor (in contracts, not morality)
...
- Taps desk with iron ring when thinking
- Makes eye contact, holds it uncomfortably long
- Quotes prices and terms immediately

### **Interaction: Varak's Offer**
...
*"But I need bodies. The guild is expanding, and most of these idiots die before they're useful. So here's my offer: Complete one contract. Any contract from the board. Bring proof of completion. If you survive and don't screw it up, I'll offer Iron Guild membership. First month's dues waived. After that, 10% of your earnings."*
...
- **Details:** "Simple escort duty. Leave at dawn, arrive by dusk. Standard bandit territory. Nothing special."
...
**Client Meeting:** Merchant Oleg Tharn
...
**Perception DC 13:** There's no damage to the warehouse consistent with rat infestation (no gnawed wood, no droppings near entrance).

**If PCs ask questions:**

**"What kind of cargo?":** *"Dry goods, cloth, nothing valuable! That's why I can't afford to lose it to rats!"*  
**"Why not hire an exterminator?":** *"Tried! Three exterminators quit after one look. Said the rats were too aggressive. That's why I need armed professionals!"*  
**"Can we see inside first?":** *"No, no! Too dangerous! The boy died, remember? Just go in, kill them, come out. I'll wait here. Very far away. Outside."*
...
**Encounter:** 8 **Giant Rats** (CR 1/8 each)
...
- Failure: Oleg refuses, threatens to tell guild you're shaking down clients
...
- Tell Oleg the rats destroyed the goods, collect 50gp
- **Consequence:** 125gp total, +1 Reputation with merchants (both), seen as discreet
- **Alignment:** Neutral Good, help victim without destroying thief
...
**Client Meeting:** Vareth Goldtooth
...
**Travel Time:** 6-8 hours (one long rest not possible during one day trip)
...
- If you lose: Arrested, fined, or forced to flee
...
- Guild confiscates wagon, arrests Cassia
- **Consequence:** Guild appreciates your integrity, pays you 40gp from seized assets, Cassia imprisoned, you're "boy scout"
- **Alignment:** Lawful Good, guild honor
...
After 1-2 days, Varak summons PCs to guild hall:
...
### **Quest 1.1 Design Philosophy**

This quest teaches players the core themes of Blood & Coin:

1. **Clients Lie** - Every single contract has hidden truth
2. **No Clear Morality** - Every choice has pros and cons
3. **Consequences Matter** - Choices establish reputation
4. **Pragmatism vs Idealism** - Both are valid, both have costs
5. **Money Matters** - Gold differences actually mean something
...
**Session 1:**
- Character introductions (30 min)
- Arrival at Crossroads (15 min)
- Meeting Finn and Mira (30 min)
- Meeting Varak, choosing contract (45 min)

**Session 2:**
- Complete chosen contract (2-3 hours)
- Return to Varak, get membership
- Brief downtime, meet more NPCs
- Hook for Quest 1.2
...
**If Party Dominates:**
- Add 2-3 more rats
- Have Vareth demand more aggressive collection
- Add 2 more officers to road stop

### **Branching Consequences**

Track these for later quests:

**Reputation Types:**
- Ruthless (brutal methods)
- Merciful (showed compassion)
- Pragmatic (chose middle path)
- Law-Abiding (sided with authorities)
- Outlaw (opposed law)
- Opportunistic (maximized profit)

**Ally/Enemy Status:**
- Oleg Tharn (ally/enemy)
- Cassia Valen (ally/enemy)
- Thomas Redhill (grateful/dead/unaware)
- Vareth Goldtooth (satisfied/suspicious)
- Thaldros Officers (neutral/hostile)
...
**Objective:** Choose between competing clients with opposite goals  
**Key NPCs:** Baron Darius Thornhill, Thomas Redwood, Elara Thornhill  
**Rewards:** 150-200gp (varies), permanent enemy made, lasting consequences  
**Theme:** "You can't serve two masters"
...
##### Read Aloud:
{{description,note
*You arrive at the guild hall to find it more crowded than usual. Two groups of mercenaries eye each other warily from opposite sides of the room. Hands rest on weapon hilts. The air crackles with potential violence.*

*Varak sits at his desk, jaw clenched, clearly irritated. Two men stand before him, both talking at once:*

*On the left: A nobleman in expensive clothing, mid-40s, imperious bearing, hand on his sword. His voice is commanding, entitled: "I offered first! The contract is MINE!"*
}}
:
{{description,note
*On the right: A younger man in merchant's clothing, nervous but determined, clutching a heavy coin purse: "I'm offering more gold! That's how this works!"*
...
Both clients present their case. Let them argue, interrupt each other, appeal to the PCs. This should feel chaotic, uncomfortable, real.

---

### **Client A: Baron Darius Thornhill**
...
**Personality:**
- Authoritarian father who "knows what's best"
- Genuinely loves his daughter (in his way)
- Views commoners as beneath his family
- Not evil, just classist and controlling
- Believes he's protecting his daughter

**Stats:** Use **Noble** with combat training (+2 longsword, 30 HP)
...
**Appearance:** Early 20s, merchant's son, clean-cut, earnest, scared but determined, wearing simple but quality clothing, obviously in love ::

**Personality:** ::
- Genuinely loves Elara
- Not fortune hunter (his family is modestly wealthy)
- Idealistic but practical
- Willing to fight for love but prefers peace
- Fears the Baron but won't abandon Elara

**Stats:** Use **Commoner** with +2 Persuasion, +3 Insight (22 HP from determination) ::
...
**"How do we know she really loves you?":** *"Talk to her yourself. She's at the cottage. She'll tell you. She chose this. She chose me."*
:
**"Why not just explain this to her father?":** *"We tried. He refused to listen. He called me a gold-digger, said I'd enchanted her. He had his guards beat me and throw me out. That's when we ran."*
;
...
*"So. Baron offers 200 gold and a noble's favor. Merchant offers 150 gold and gratitude. Baron wants girl brought back. Merchant wants her protected. Choose. Now."*
}}
{{pageNumber,auto}}
\page
...
**Option 1: Accept Baron's Contract** ::
- Work for the noble
- Higher pay (200gp + favor)
- Orders: Retrieve Elara, don't harm her, merchant is irrelevant
- Thomas hires rival mercenaries (3 level 2 fighters) to protect them

**Option 2: Accept Thomas's Contract** ::
- Work for the lovers
- Lower pay (150gp) but morally clearer
- Orders: Protect Elara and Thomas from Baron's mercenaries
- Baron hires rival mercenaries (4 level 2 fighters) to retrieve Elara

**Option 3: Refuse Both** ::
- Walk away, no payment
- Both clients hire other mercenaries
- PCs stay out of it
- **Consequence:** Varak respects neutrality but warns you'll make enemies either way by not choosing

**Option 4: Try to Mediate** (Persuasion DC 20, very hard) ::
- Attempt to broker peace between father and daughter
- If successful: Baron agrees to meet with Elara one time, no guards
- If failed: Both clients think you're wasting their time, both hire other mercenaries
- If mediation works (rare), both pay half (175gp combined), no one fights

### **Investigating The Truth**

Smart players might want to verify claims before choosing.

**Option: Visit the Cottage First**

Both clients agree (reluctantly) to let PCs investigate before deciding.
...
**Appearance:** 19 years old, dark hair, nobleman's features, simple clothing, sun-tanned (new for her), calloused hands from work, defiant eyes ::

**Personality:** ::
- Strong-willed, not naive
...
*If you're here to drag me back... you'll have to tie me up and carry me. I won't go willingly. And I'll hate every mercenary who helps my father cage me again."*

}}

**Insight DC 10:** She's telling the truth. She's not enchanted, not manipulated. This is genuine choice. ::
{{pageNumber,auto}}
\page
...
*"I miss her. Gods, I miss her. But she won't stand up to father. She never has. She told me once, 'Sometimes we sacrifice freedom for security.' I refuse to make that trade."*
...
After investigating, players should understand:

- Elara was NOT kidnapped  
- She chose to leave willingly  
...
### **Path A: Working For The Baron**

If PCs accept Baron's contract:

**Phase 1: The Approach** ::

Baron provides:
- Map to cottage
- Description of Elara
- 100gp upfront, 100gp on delivery
- Orders: "Bring her back alive. Unharmed. Use force only if necessary."

##### Read Aloud:
{{description,note
*You approach the cottage at dusk. As expected, Thomas Redwood is outside, chopping firewood. He sees you coming. His face falls. He knows why you're here.*
...
**Encounter:** 3 **Rival Mercenaries** (Thomas's hired guards) ::

- 1 **Fighter** (Female leader, CR 1) - Uses Longsword, shield
- 2 **Thugs** (Male guards, CR 1/2 each) - Use clubs, pack tactics

**Tactics:** ::
- Mercenaries defend the cottage, don't pursue
- Leader shouts: "We don't want to fight! Just leave them alone!"
- If PCs attack, they defend but try for non-lethal (don't want murder charges)
- If leader drops below 10 HP, she calls retreat
- Thomas and Elara barricade inside cottage during fight

**Non-Combat Options:** ::

**Option: Negotiation** (Persuasion DC 16) ::
- Offer rival mercenaries MORE money to walk away (requires 100gp bribe)
- Success: They leave, apologize to Thomas, "business is business"
- Failure: They refuse, see PCs as dishonorable

**Option: Intimidation** (DC 15) ::
- Threaten rivals with guild backing or superior numbers
- Success: They back down, leave angry
- Failure: They attack out of pride

**Option: Deception** (DC 17) ::
- Lie about Baron's intentions ("He just wants to talk!")
- Success: Rivals lower guard, can be surprised or convinced to mediate
- Failure: They attack, angry at deception

**Phase 2: Elara's Resistance** ::

Once rivals are dealt with (fought, bribed, or convinced), face Elara:
...
**Option 1: Call Her Bluff** (Insight DC 15 to see if she's serious) ::
- If she's bluffing: She lowers knife, breaks down crying, gives up
- If she's serious: She cuts herself (1d4 damage), demands you leave
- **DM Note:** She IS serious. This is her last stand.

**Option 2: Disarm Her** (Athletics or Acrobatics DC 14, opposed check) ::
- Success: Grab the knife, restrain her
- Failure: She cuts herself (1d6 damage), screams for Thomas

**Option 3: Convince Her** (Persuasion DC 18, very hard) ::
- Argue that Baron loves her, will listen, she can negotiate terms
- Success: She agrees to meet father with YOU as mediators
- Failure: She refuses, threatens self-harm

**Option 4: Knock Her Out** (Non-lethal attack) ::
- Hit her unconscious, tie her up
- Thomas attacks you (futilely, easily subdued)
- **Consequence:** Most brutal option, but "completes" contract

**Option 5: Walk Away** ::
- Refuse to force her
- Return to Baron, report she'd rather die
- Baron is furious, refuses payment, hires assassins to target Thomas
- **Consequence:** Contract broken, reputation hit, but conscience clear

**Phase 3: The Return** ::

If you successfully retrieve Elara (willing or not):
...
*"Enjoy your blood money. I hope it buys you something worth selling your soul for."*
}}

**Baron's Payment:** ::

Baron pays the 100gp remainder (total: 200gp).

He offers his "favor" (can be called in later, Act II):
- Access to noble connections
- Letters of introduction
- Legal protection for one crime
- Invitation to high society events

**Consequence Tracking:** ::

- Quest complete, contract honored
- 200gp earned
- +1 Reputation: Law-Abiding, Noble's Ally
- -2 Reputation: Lovers' Enemy, "Soul Sold"
- Elara is returned against her will
- Thomas is heartbroken, possibly suicidal
- Baron believes he "saved" his daughter
- Elara will escape again within weeks (DM option for later)

**What Happens Next:** ::

One week later, PCs might hear:
- Thomas attempted suicide (survived, barely)
- Elara is locked in her room, refusing food
- Baron hired guards to watch her 24/7
- Rumors of forced marriage to Duke Harmond proceeding

:
**IF PCs feel guilty:** That's the point. Welcome to mercenary life. 

### **Path B: Working For Thomas**

If PCs accept Thomas's contract:

**Phase 1: The Preparation** ::

Thomas pays 75gp upfront (half), keeps 75gp for supplies.
...
**PCs must:** ::
- Defend cottage from Baron's mercenaries
- Keep Elara and Thomas safe
- Prevent kidnapping

**Fortifying THE Cottage:** ::

PCs have 1 day to prepare before attack. Options:

**Option: Set Traps** (Survival DC 13) ::
- Pit traps, tripwires, caltrops around perimeter
- Success: Attackers have disadvantage on first round
- Failure: Traps ineffective or hurt you

**Option: Barricade Doors** (Athletics DC 12) ::
- Reinforce cottage, create chokepoints
- Success: +2 AC while inside, advantageous terrain
- Failure: Minimal improvement
{{pageNumber,auto}}
\page

**Option: Gather Allies** (Persuasion DC 15) ::
- Hire more mercenaries with Thomas's gold (50gp)
- Success: 2 level 1 fighters join as backup
- Failure: No one wants to fight against Baron

**Option: Create Escape Route** (Investigation DC 14) ::
- Dig tunnel/secret exit for emergency escape
- Success: Can evacuate Elara if overwhelmed
- Failure: No escape route

**Phase 2: The Assault** ::

The next evening, Baron's mercenaries attack:
...
*Behind you, in the cottage, Elara whispers: "Please don't let them take me. Please."*

}}

**Encounter:** 4 **Baron's Mercenaries** ::
- 1 **Veteran** (Female leader, CR 3) - Plate armor, longsword, shield
- 3 **Guards** (Male soldiers, CR 1/8 each) - Chainmail, spears

**Tactics:** ::
- Leader attempts peaceful surrender first
- If refused, guards advance while leader provides ranged support
- Focus on subduing, not killing (want Elara alive)
- If leader drops below 25 HP, calls retreat
- Guards surrender if leader falls

**Special Complication:** ::

Halfway through fight (round 3):
...
**Option 1: Negotiate** (Persuasion DC 14) ::
- Offer gold to rogue (100gp)
- Success: He releases her, takes gold, vanishes
- Failure: He demands more or tightens grip

\column

**Option 2: Ranged Attack** (Attack roll at disadvantage) ::
- Shoot rogue without hitting Elara
- Success (high roll): Rogue drops, Elara safe
- Failure (low roll): Might hit Elara (DM discretion)

**Option 3: Distraction** (Deception DC 13) ::
- Create diversion, Thomas tackles rogue
- Success: Thomas and rogue grapple, Elara escapes
- Failure: Rogue cuts Elara (1d4 damage), maintains control

**Option 4: Surrender** ::
- Drop weapons, let them take Elara
- Contract failed, no payment
- But everyone lives

**Resolution:** ::

If mercenaries are defeated or driven off:

##### Read Aloud:
{{description,note
*The Baron's mercenaries retreat, dragging wounded with them. Their leader shouts back:*

*"This isn't over! The Baron has resources! He'll send more! You can't protect her forever!"*

*Inside the cottage, Elara is shaking. Thomas holds her. She looks at you:*

*"Thank you. Thank you for choosing us. For choosing love over gold. I won't forget this."*
}}

**Thomas'S Payment:** ::
Pays the remaining 75gp (total: 150gp).

Also offers:
- Family heirloom: **Merchant's Signet Ring** (worth 100gp, or connections to merchant network)
- Gratitude: Will help PCs in future if possible
- Safe house: Can use cottage as hideout if needed

**Consequence Tracking:** ::

- Quest complete, contract honored
- 150gp earned (+ ring worth 100gp)
- +2 Reputation: Romantic, Freedom Fighter
- -1 Reputation: Noble's Enemy, "Troublemaker"
- Elara and Thomas are safe (for now)
- Baron is furious, considers you enemies
- Baron may send assassins later (Act II hook)
- Lovers owe you their happiness

**What Happens Next:** ::

Two weeks later, PCs might hear:
- Elara and Thomas successfully fled to Aethoria
- Baron is raging, demanded guild hand over PCs (Varak refused)
- Baron posted 500gp bounty for information on daughter's location
- PCs are personae non gratae in noble circles
{{pageNumber,auto}}
\page

**If PCs feel good:** Enjoy it. Moral victories are rare in this campaign.


### **Path C: MEDIATION** (Rare Success Path)

If PCs successfully mediate (DC 20 Persuasion, very difficult):

**The Meeting:** ::

Baron agrees to meet Elara, no guards, neutral ground (guild hall).

##### Read Aloud:
{{description,note
*Father and daughter face each other across Varak's desk. The tension could be cut with a knife. Elara's arms are crossed, defiant. The Baron looks older, tired, almost broken.*

*He speaks first: "Elara... I thought I'd lost you."*
...
*Silence. The Baron's hand trembles. When he speaks again, his voice cracks:*

*"I love you. You're my daughter. My only daughter. I just... I don't want you to make mistakes that will hurt you."*

*"Then trust me to make my own mistakes. Trust that you raised me well enough to choose for myself."*

}}

**The Negotiation:** ::
PCs can help mediate. Persuasion checks to find middle ground:

**Option A: Compromise** (DC 15) ::
- Elara agrees to wait 6 months before marrying Thomas
- Baron agrees to meet Thomas, evaluate him fairly
- If Thomas proves himself worthy (business success), Baron gives blessing
- Both agree to this trial period

**Option B: Conditional Blessing** (DC 16) ::
- Baron allows marriage IF Thomas proves financial stability
- Elara must visit family monthly
- No forced marriages to others
- Thomas must sign prenup protecting family assets

**Option C: Clean Break** (DC 18) ::
- Baron releases Elara from family obligations
- She gets modest dowry (500gp) to start new life
- She renounces claim to inheritance
- They part on neutral terms, no hard feelings

\column

**If Successful:** ::

Both clients pay half their offered amounts:
- Baron pays 100gp
- Thomas pays 75gp
- Total: 175gp

Plus both are grateful:
- Baron's favor (can be called later)
- Thomas's ring and friendship

**Consequence Tracking:** ::

- Quest complete, both contracts satisfied
- 175gp earned + ring
...
*No payment, but no blood on your hands either. Some mercenaries care about that. Most don't survive long, but some do."*

}}

**What Happens:** ::
One week later, PCs witness the outcome:

##### Outcome Table

| d6 | Result | Description |
|:--:|:-------|:------------|
| 1-2 | **Baron Wins** | His mercenaries retrieved Elara by force. Thomas was beaten, left for dead. Elara is locked up, miserable. PCs could have prevented this. |
| 3-4 | **Thomas Wins** | His mercenaries fought off Baron's forces. Elara and Thomas escaped to Aethoria. Baron is furious, two mercenaries dead. PCs could have earned gold. |
| 5 | **Both Sides Bloody** | Mercenaries fought to mutual destruction. Multiple deaths, Elara wounded in crossfire. Thomas killed, Elara returned to Baron. Everyone loses. |
| 6 | **Unexpected Truce** | Mercenaries refused to fight (too bloody). Baron and Thomas negotiated directly. Compromise reached without PC help. Everyone lives, but PCs missed credit. |
{{pageNumber,auto}}
\page
...
- No quest completion
- 0gp earned
- +1 Reputation: Neutral, Cautious
- -1 Reputation: Both clients see you as "unhelpful"
- Outcome happens without PC involvement
- PCs learn some conflicts resolve themselves 
- Or don't, and people die

## Aftermath & Epilogue

Regardless of path chosen, Quest 1.2 concludes with:
...
*"But here's the lesson: Every choice makes enemies. Work for the Baron? Thomas hates you. Work for Thomas? Baron hates you. Try to please everyone? They both distrust you. Walk away? They both think you're useless.*

*"There's no 'good' answer in this business. Only choices and consequences. Get used to it. This is what we do."*
}}


### **Reputation Impact**

Track these for future quests:

**If Worked for Baron:** ::
- +1 Noble Ally
- -1 Common Folk Enemy
- Known as "Noble's Dog" by some
- Future noble clients more likely

**If Worked for Thomas:** ::
- +1 Common Folk Ally
- -1 Noble Enemy
- Known as "Romantic" or "Rebel"
- Future noble clients less likely

**If Mediated:** ::
- +1 Mediator
- Both sides respect but don't fully trust
- Known as "Peacemaker"
- Future clients seek you for negotiations

**If Refused:** ::
- +1 Cautious
- -1 Both sides see as "unreliable"
- Known as "Picky" about contracts

### **Quest Rewards Summary**

**Path A (Baron):** 200gp + noble's favor  
**Path B (Thomas):** 150gp + ring (100gp value) + gratitude  
**Path C (Mediation):** 175gp + ring + noble's favor + both grateful  
**Path D (Refused):** 0gp + clean conscience  

### **Lingering Consequences**

This quest will echo through the campaign:

**Act II Possibilities:** ::
- Baron calls in favor (if worked for him)
- Thomas asks for help again (if worked for him)
- Elara contacts PCs (if she escaped)
- Assassins target PCs (if Baron is enemy)
- Rival mercenaries remember you (if fought them)

### **Level Up**

PCs should reach **Level 3** after completing Quest 1.2.



## DM Guidance: QUEST 1.2

### **Key Themes**

1. **No Clear Right Answer:** Both clients have valid perspectives
2. **Choose Your Enemies:** Every choice makes someone hate you
3. **Love vs Duty:** Explore the conflict between heart and obligation
4. **Consequences Matter:** This choice ripples through campaign

### **Running the Negotiation Scene**

- Let both clients argue passionately
- Make Baron sympathetic (he loves his daughter, just misguided)
- Make Thomas earnest (he's genuine, not a con artist)
- Make Elara strong-willed (not a damsel, an adult making choices)
- **Don't judge player choices** - present both as equally valid contracts

### **Combat Difficulty**

**If PCs Chose Baron:** ::
- 3 rival mercenaries (1 Fighter CR 1, 2 Thugs CR 1/2)
- CR 2 encounter for party of 4 = Medium

**If PCs Chose Thomas:** ::
- 4 Baron's mercenaries (1 Veteran CR 3, 3 Guards CR 1/8)
- CR 3.5 encounter for party of 4 = Hard/Deadly
- Add fortification advantages to balance
{{pageNumber,auto}}
\page
...
**If Party Struggles:** ::
- Reduce enemy numbers by 1
- Have reinforcements arrive late (PCs can escape)
- Rivals offer surrender earlier

**If Party Dominates:** ::
- Add 1-2 more enemies
- Enemies have better tactics
- Add environmental hazards (fire, collapsing building)

### **Moral Complexity Notes**

**This quest works because:** ::
- Baron isn't evil (controlling but loving)
- Thomas isn't perfect (idealistic but naive)
- Elara isn't naive (adult making informed choice)
- No one is lying (all three tell truth from their perspective)

**The conflict is VALUES, not good vs evil:** ::
- Family duty vs personal freedom
- Tradition vs love
- Security vs autonomy
- Father's protection vs daughter's agency

### **Player Agency**

**Respect all choices:** ::
- Working for Baron is valid (contract, money, order)
- Working for Thomas is valid (romance, freedom, right thing)
- Mediating is valid (peace, wisdom, creativity)
- Refusing is valid (no good option, stay neutral)

**Don't punish players for "wrong" choice because there isn't one.** ::

**NPCs to Add to Compendium:** ::
- Baron Darius Thornhill (Noble with combat training)
- Thomas Redwood (Commoner, enhanced stats)
- Elara Thornhill (Commoner)
- Rival Mercenaries (Fighter, Thugs)
- Baron's Mercenaries (Veteran, Guards)
- Rogue Infiltrator (Thug with stealth)

**Items to Add:**
- Merchant's Signet Ring (100gp value, merchant network access)
- Noble's Favor (political resource for Act II)

## Quest 1.3: BLOOD MONEY
...
*"The pay is high. 500 gold for one bandit? That's suspicious. Either she's incredibly dangerous, or there's more to this story. Find out which before you commit."*
}}
{{pageNumber,auto}}
\page
...
*I don't know the whole story, but something isn't right. These merchants are hiding something. If I were you, I'd investigate before taking this contract at face value."*
...
- **Payment:** 500gp (250 upfront, 250 on proof of death)
...
**NPC: Old Mira** (Use Commoner stats)

If PCs buy her ale and talk:

{{description,note
*"You're here about the bandits, aren't you? The merchants sent you. Of course they did. They always send people.*
...
**Survival DC 15:** Find recent bandit activity (3 days old)  
...
- Wants justice, not revenge (though line is blurry)
...
##### Read Aloud:
{{description,note
*Red Wolf steps forward, hand on sword but not drawing yet. Her voice is clear, authoritative:*
...
- Lose = you're captured or killed
...
- Magistrate's confession (if you got it)
...
- PCs must decide: warn her or let it happen
...
- Focuses on strongest PC (perceived leader)
...
- Survivors scattered into the forest
...
*"You've done the entire region a service! Trade will flow freely again! Profits will soar! This calls for celebration!"*
...
*But let me ask you something: How much is your soul worth? Because you just sold a piece of it for 600 gold. That's 600 gold per piece. You have many pieces left?*

*I'm not judging. I've made the same trade. Many times. Just... know what you're trading, and for how much. Because one day you'll look in the mirror and not recognize the person looking back.*
...
**Path A (Switch Sides):** 500gp, clear conscience, justice served  
**Path B (Walked Away):** 0gp, clean hands, others did dirty work  
**Path C (Exposed Corruption):** 500gp, hero status, made powerful enemies  
**Path D (Completed Contract):** 600gp, mercenary reputation, moral stain  
**Path E (Faked Death):** 500gp, everyone lives, risky deception  

### **Experience & Level Up**

PCs should reach **Level 4** after completing Quest 1.3.
...
- Let players decide what matters more
...
- "Are we mercenaries or moral arbiters?"
...
- Are they mercenaries or heroes?
...
- Elara has killed people (guards who fought back)
...
- Helping Elara? Valid (justice thinking)
...
- Characters should have different opinions
- Party might split on decision
- That's the point
...
- **Contract vs. Conscience** - What wins?
- **Profit vs. Principles** - Which matters more?
...
**Key NPCs:** Lord Pembroke, Master Thief "Whisper," Marcus Blackwood  
**Rewards:** 750gp (guild payment) + The Black Ledger (critical evidence)  
**Theme:** "In the shadows, truth is currency"

---

### Quest Setup

After Quest 1.3, the Iron Guild has noticed the Merchant Consortium's activities. Varak summons the party with an unusual proposition.
...
*He slides a leather folder across the desk.*

*"The Consortium's been busy. Land seizures, fraudulent contracts, people disappearing. We've looked the other way because they pay on time. But they've gotten greedy. Started targeting guild members. Three of our people lost property last month to their 'legal' maneuvers."*
...
- Disadvantage: Massive consequences, likely deaths
...
*"Ah. The mercenaries. I wondered when you'd show up."*
...
*"The Consortium wants him dead. They've bought the prosecutor. Maybe the judge. We need someone who can't be bought. That's you."*
}}
...
| Temple of Sera | Appeal to mercy | 14 | Healing testimony, public sympathy |
| Disgraced Noble | Offer mutual benefit | 16 | Insider court knowledge, procedural tricks |
...
- Consequence: Refugees lose hope, become desperate
...
- Marcus freed but situation explodes
...
*"Whatever happened in there... it's done. But this isn't over. The Consortium's wounded, not dead. They'll regroup. And when they do, they'll remember who hurt them."*

*He hands you a pouch of coin.*

*"Take some time. Six months, maybe longer. When the heat dies down, there'll be bigger players who want to meet you. People who shape nations, not just cities. When that happens... well. That's a choice for another day."*
...
**Time:** Six months after Quest 1.5 (Act I finale) ::
...
*This morning, three separate messages arrived for you. Three different factions. Three offers. All arriving the same day.*
...
**PCs receive three sealed letters:**

### **Message 1: Royal Seal**

*Ornate envelope, wax seal bearing crown of Thaldros*

{{description,note
**"To the Mercenaries of [their group name/reputation]:**


Your services are requested by Commander Helena Dawnblade of the Royal Army of Thaldros. A matter of national importance and significant compensation.
...
### **Message 2: Republican Paper**

*Simple paper, no seal, republican symbol stamped*
...
### **Message 3: Blank Envelope**

*No seal, no signature, just an address and time*

{{description,note
**"The old world is dying. A new one will be born.**


Those with vision are needed. Those with courage are welcome.
...
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|18 (+4)|12 (+1)|14 (+2)|14 (+2)|16 (+3)|17 (+3)|
___
**Saving Throws** :: Wis +7, Cha +7
**Skills** :: Athletics +8, Insight +7, Intimidation +7, Persuasion +7, Religion +6
**Senses** :: Passive Perception 13
**Languages** :: Common, Celestial, Dwarvish
**Challenge** :: 10 (5,900 XP)
___
***Divine Sense (3/Day).*** Can detect celestials, fiends, and undead within 60 feet.

***Lay on Hands (50 HP/Day).*** Can heal as an action.

***Aura of Protection.*** Allies within 10 feet gain +3 to saving throws.

***Improved Divine Smite.*** Melee attacks deal extra 1d8 radiant damage.
### Actions
***Multiattack.*** Three longsword attacks.

***Longsword +2.*** *Melee Weapon Attack:* +10 to hit, reach 5 ft., one target. *Hit:* 11 (1d8 + 7) slashing damage, or 12 (1d10 + 7) if used with two hands, plus 4 (1d8) radiant damage.

***Divine Smite (Spell Slot).*** When she hits with melee attack, can expend spell slot to deal extra 2d8 (1st level) to 5d8 (4th level) radiant damage.
### Spellcasting
**Spellcasting Ability:** Charisma (spell save DC 15, +7 to hit)

**Spells Prepared:**
- 1st level (4 slots): *bless, cure wounds, divine favor, shield of faith*
- 2nd level (3 slots): *aid, lesser restoration, zone of truth*
- 3rd level (3 slots): *crusader's mantle, dispel magic, revivify*
- 4th level (1 slot): *banishment, death ward*
}}

## Meeting 1: Commander Helena Dawnblade (Noon)
...
*"Sit," she says. Not a request. "We have much to discuss and little time for pleasantries."*
}}
...
- Earned paladin oath through devotion to order
- Has done questionable things for crown
- Believes strong government prevents anarchy
- Sees war as necessary to preserve civilization

**Motivation:**
- Genuinely believes Thaldros must win
- Fears Aethoria's democracy will spread chaos
- Willing to hire morally flexible mercenaries
...
*Thaldros is order. Civilization. Law. We've maintained peace for 500 years through strength and structure. We intend to continue.*
...
**The Offer:** ::
- **Upfront Payment:** 2,500 gold pieces (deposited today)
- **Per Mission:** 1,000-2,000gp depending on difficulty
- **Authority:** Deputized as crown agents (can act with royal authority)
- **Protection:** Legal immunity for actions taken under orders
- **Post-War Rewards:** Lands, titles, or additional gold (10,000gp minimum)

**The Expectations:** ::
- Intelligence gathering on Aethoria military
- Sabotage of enemy supply lines
- "Neutralization" of key targets (assassination)
- Publicly: "Defending the kingdom"
- Privately: "Whatever's necessary to win"
...
**Persuasion DC 18 (to get her to reveal doubts):** ::
{{description,note
*(Privately, checking no one listening)*
*"Off the record? I've served Thaldros 30 years. I've seen it do great things and terrible things. But I've also seen what happens when government collapses. Famine. Warlords. Suffering.*

*Order is worth defending, even when order is imperfect. That's my oath. If you can't accept that, walk away now. No judgment."*
}}


### **Dawnblade'S Secret Agenda**
...
- Genuinely cares about common people
...
**Skills** :: Deception +7, History +6, Insight +5, Persuasion +10
**Senses** :: Passive Perception 12
**Languages** :: Common, Elvish, Dwarvish, Sylvan
**Challenge** :: 6 (2,300 XP)
___
***Inspiring Leader.*** Can spend 10 minutes inspiring up to 6 creatures, granting them temporary HP equal to level + Charisma modifier.

***Silver Tongue.*** Advantage on Persuasion checks when arguing for democratic ideals.

***Political Network.*** Has contacts throughout Aethoria and can call in favors.
### Actions
***Dagger.*** *Melee or Ranged Weapon Attack:* +5 to hit, reach 5 ft. or range 20/60 ft. *Hit:* 4 (1d4 + 2) piercing damage.

***Inspiring Speech (Recharge 5-6).*** As an action, can grant allies within 30 feet advantage on their next attack roll or saving throw.
### Spellcasting
**Spellcasting Ability:** Charisma (spell save DC 15, +7 to hit)
...
**Spells Known:**
- 1st level (4 slots): *charm person, disguise self, mage armor, sleep*
- 2nd level (3 slots): *detect thoughts, suggestion, zone of truth*
- 3rd level (3 slots): *counterspell, sending, tongues*
- 4th level (2 slots): *compulsion, greater invisibility*
}}

**Motivation:**
- Save democracy from monarchy
- Prove people can govern themselves
- Prevent Thaldros expansion
- Win war for republic's survival
- Knows Aethoria will make mistakes but believes in the system
...
**The Offer:** ::
- **Upfront Payment:** 1,500 gold pieces (less than Thaldros)
- **Per Mission:** 800-1,500gp depending on success
- **Authority:** Republican commission (less legal weight than crown)
- **Protection:** Popular support (common folk shelter you)
- **Post-War Rewards:** Citizenship, gratitude, historical recognition (not gold or lands)

**The Expectations:** ::
- Intelligence gathering on Thaldros nobility
- Smuggling weapons to resistance cells
- Protecting democratic leaders from assassination
...
{{description,note
*"We're a republic, not a monarchy. We don't have royal vaults. But what we offer is worth more than gold: you'll be on the right side of history. Your children will sing songs of how you fought tyranny. Can Dawnblade offer you that?"*
}}
...
*"War is terrible. Revolution is messy. Will I ask you to kill Thaldros soldiers? Yes. Sabotage supply lines? Yes. These are necessary evils to defeat a greater evil. I won't lie and say our hands stay clean. But we fight for a just cause. That matters."*
}}

**Insight DC 14:**
- Valen is genuine but naive about some realities
- He believes in his cause deeply
- He knows Aethoria leadership has corruption too
...
**What he's NOT telling PCs:**

1. **Corruption:** Aethoria senate is more corrupt than he admits
2. **Post-War:** Some leaders plan to establish "temporary dictatorship" after victory
3. **Defector:** They're protecting a war criminal (General Thorne) for his intelligence
4. **The War:** Republic knows it's outmatched but hoping for guerrilla victory
...
*"My name is Corvus Blackwood. And I'm going to save the world."*
}}
...
- Use World-Splitter Components to create "perfect" world
- Destroy old systems (monarchies AND democracies)
...
**Speed** :: 30 ft. ![Corvus Blackwood](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/all_artwork/npcs/villain-corvus-blackwood.jpg){width:300px}
___
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
...
**Skills** :: Arcana +15, History +15, Insight +7, Investigation +10, Persuasion +8, Religion +10
**Damage Resistances** :: psychic
**Senses** :: Passive Perception 12
**Languages** :: Common, Draconic, Elvish, Abyssal, Celestial, Primordial
**Challenge** :: 9 (5,000 XP)
___
***Arcane Recovery (1/Day).*** Can recover spell slots during short rest (up to 9 levels total).

***Portent (3/Day).*** Roll 3d20 at dawn. Can replace any roll (his or others) with portent die.

***Spell Mastery.*** Can cast *detect magic* and *mage armor* at will without spell slots.

***Scholar of the Godsfall.*** Expert on World-Splitter Components and ancient magic.
### Actions
***Quarterstaff.*** *Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 3 (1d6) bludgeoning damage, or 4 (1d8) if used with two hands.

***Ancient Artifact.*** Carries World-Splitter Component #1 (see items). Can activate it as an action (devastating effects).
### Spellcasting
**Spellcasting Ability:** Intelligence (spell save DC 18, +10 to hit)

**Cantrips (at will):** *fire bolt, mage hand, message, prestidigitation, shocking grasp*

**Spells Prepared:**
- 1st level (4 slots): *detect magic*, *mage armor*, *shield*, *identify*
...
- 5th level (3 slots): *cone of cold*, *scrying*, *teleportation circle*
...
**The "contract" he offers is more like a manifesto:** ::

**The Offer:** ::
- **Upfront Payment:** 1,000 gold pieces (least of three)
- **Per Mission:** 500-1,000gp + share of recovered artifacts
- **Authority:** None (you're outside the law)
...
{{description,note
*(Pauses, considering)*
*"That's... a philosophical question. Is 'free will' to starve, wage war, and oppress each other truly freedom? Or is it a luxury we can't afford? I'm offering freedom FROM suffering. That's real freedom."*
}}
**"What if you're wrong?"**
{{description,note
*"Then millions continue suffering under failed systems. At least I'm TRYING to fix it. Dawnblade maintains oppression. Valen enables chaos. I offer actual change. Which is most moral?"*
}}

**Insight DC 16:** ::
- Corvus is absolutely sincere
- He's brilliant but potentially delusional
- He genuinely believes he's saving the world
- He's aware using Components might kill millions
- He considers it acceptable cost for "perfect" future
- He's charismatic cult leader who believes own rhetoric

**Persuasion DC 18 (to get him to reveal the cost):** ::
{{description,note
*"You want to know the truth? Using all five Components will... disrupt reality temporarily. The restructuring process might kill... 10-20% of population. Maybe 30%.*

*That's millions dead. I'm aware. I've done the calculations. I've spent three years agonizing over this decision.*

*But if we DON'T act? Wars kill millions over decades. Poverty kills millions over centuries. I'm offering to save billions at the cost of millions. That's... that's utilitarian calculus.*

*I don't LIKE it. But I'll do it. Because someone has to make hard choices."*
}}

### **Corvus'S Secret Agenda**
...
**After meeting all three:** ::

##### Read Aloud:
{{description,note
*Three offers. Three visions. Three futures.*
...
**PCs can investigate all three factions before committing.** ::

**Suggested Activities:** ::

1. **Talk to NPCs from Act I**
   - Varak or Kael (guild leader): What do they think?
   - Mira (info broker): What rumors has she heard?
   - NPCs from previous quests: Which side did they choose?

2. **Research the Factions**
   - History checks about Thaldros
...
3. **Observe Faction Actions**
   ...
   - Investigate Unbound hideout

### **Information Gathering Results**

**About Thaldros (History DC 15):** ::
- Kingdom has ruled 500+ years
- Stable but oppressive
- Efficient bureaucracy
- Common folk have little freedom but relative safety
- Recent decades: increasing corruption
- Marcus Blackwood case (if PCs know about it) is example of injustice

**About Aethoria (History DC 14):** ::
- Republic formed 80 years ago through revolution
...
- Led by Corvus Blackwood (last heir of destroyed House Blackwood, also known as "Lord Shadows")
- Obsessed with Godsfall artifacts
- Growing membership (2,000+ followers)
- Some members genuinely idealistic
- Others are apocalyptic extremists
- World-Splitter Components are REAL and DANGEROUS


### **Talking TO Act I Npcs**

**If PCs ask Varak (or Kael):** ::

**Varak (Iron Guild):**
{{description,note
*"Thaldros. Always Thaldros. Order beats chaos every time. Aethoria's democracy is mob rule. And The Unbound? Cult nonsense. Take Dawnblade's gold and help maintain civilization."*
}}
**Kael (Black Chains):**
{{description,note
*"Play all three if you can. Get paid by everyone. When the war ends, whoever wins will need mercenaries. Loyalty is for soldiers. We're businessmen."*
}}
**Mira (Info Broker):**
{{description,note
...
{{description,note
*(Letter from Marcus, now in exile)*
*"If you're reading this, war has begun. I urge you: side with Aethoria. Thaldros proved its injustice when it tried to silence me. Democracy is flawed, but it's our only hope against tyranny."*
}}
**If delivered Marcus to trial:**
{{description,note
...
**After investigation, PCs must choose (or try to delay):** ::

### **Option 1: JOIN THALDROS**

**What You Get:** ::
- 2,500gp upfront (deposited immediately)
- Royal authority (legal backing)
- Political connections
- Highest pay per mission
- Post-war lands/titles

**What It Means:** ::
- Fighting for oppressive monarchy
- Some missions are war crimes
- You're tools of tyranny
- Common folk will hate you
- But you're on strongest side
...
### **Option 2: JOIN AETHORIA**

**What You Get:** ::
- 1,500gp upfront (less than Thaldros)
- Popular support (common folk help)
- Moral high ground (fighting tyranny)
- Moderate pay per mission
- Post-war gratitude and recognition

**What It Means:** ::
- Fighting for unstable democracy
- Some missions require compromise
...
### **Option 3: Join The Unbound**

**What You Get:** ::
- 1,000gp upfront (least gold)
- Ancient artifacts access
- Underground network
- Low pay but artifact shares
- Post-"restructuring" positions as Wardens

**What It Means:** ::
- Fighting for apocalyptic cult
- Missions involve reality-warping artifacts
- You're terrorists to both kingdoms
- Everyone will hunt you
- But you're trying to "save" the world

**Immediate Effect:** ::
- Corvus thrilled
- Both Dawnblade AND Valen mark you as enemies
- Hunted by law
- Quest 2.2-U begins (Unbound mission)


### **Option 4: PLAY MULTIPLE SIDES (Double/Triple Agent)**

**Persuasion DC 16 with each faction to accept you while claiming loyalty** ::

**What You Get:** ::
- Multiple upfront payments (if successful)
- Access to all networks
- Maximum information
- Can switch sides as needed
- Highest potential profit

**What It Means:** ::
- Living a lie to everyone
- Constant Deception checks
- Will be discovered eventually (Quest 2.3)
- When exposed, ALL factions become enemies
- High risk, high reward

**Immediate Effect:** ::
- All factions think you're loyal
- You receive missions from multiple sources
...
**What You Get:** ::
- Independence
- Freedom to take contracts from anyone
- No faction commitments
- Can work for any as freelancer
- Maintain neutrality

**What It Means:** ::
- Lower pay (no upfront bonuses)
- No faction backing
- Fewer opportunities
- Must navigate war as independent
- Harder but freer path
...
**If THALDROS:** 2,500gp upfront   ::
**If AETHORIA:** 1,500gp upfront   ::
**If UNBOUND:** 1,000gp upfront   ::
**If MULTIPLE:** Variable (2,000-5,000gp if all deceived)   ::
**If REFUSE:** 0gp (but freedom) ::

**Plus:** ::
- Faction access
- First mission assignment
- Reputation with chosen side
- Enemies with other sides

## DM Guidance

### **Running the Three Meetings**

**Pacing:** ::
- Each meeting should take 30-45 minutes
- Let players ask questions
- Don't rush the decision
- This choice affects entire Act II

**Presenting Fairly:** ::
- Make all three appealing in different ways
- Don't telegraph "correct" choice
- All have valid arguments
- All have hidden flaws

**Player Agency:** ::
- Some players will choose quickly
- Some will agonize
- Both are valid
...
**All three recruiters give 3-day deadline:** ::

{{description,note
*"War waits for no one. Three days. Then we find other mercenaries."*
}}

**After 3 days:** ::
- Offers expire (can still work freelance but no bonuses)
- Other mercenary groups are hired
- War begins without them

### **If Players Can't Agree**

**Party may split:** ::
- Some join Thaldros
- Some join Aethoria
- Some go independent
- This is VALID and creates interesting dynamics
- Campaign continues with divided party (harder but doable)
...
## Transition to QUEST 2.2

**Based on choice, next quest is:** ::

- **Quest 2.2-T:** The Convoy (Thaldros mission)
- **Quest 2.2-A:** The Defector (Aethoria mission)
- **Quest 2.2-U:** The Component (Unbound mission)
- **Quest 2.2-M:** Mixed (if playing multiple sides)
- **Quest 2.2-F:** Freelance (if refused all)


## Quest 2.2: The First Mission

## Blood & Coin Campaign - Act II

**Level:** 7 ::
**Duration:** 2-3 sessions   ::
**Objective:** Complete first major mission for chosen faction   ::
**Rewards:** 1,500-2,500gp + faction trust   ::
**Theme:** "Prove your loyalty" ::

## Quest Structure

**This quest BRANCHES into three parallel missions based on Quest 2.1 choice:** ::

- **Quest 2.2-T:** The Convoy (if joined Thaldros)
- **Quest 2.2-A:** The Defector (if joined Aethoria)
- **Quest 2.2-U:** The Component (if joined Unbound)

**DM runs the mission matching PC faction choice.** ::

If PCs are playing multiple sides, see "Multiple Factions" section at end.


## Quest 2.2-T: The Convoy
## Thaldros Mission

**Level:** 7  ::
**Duration:** 2-3 sessions  ::
**Theme:** "How far for gold?" ::
...
**If PCs ask questions:** ::
:
**"What kind of supplies?":** *"Military supplies. Food for soldiers, medicine for their wounded, weapons for their militia. Standard wartime logistics."*
:
**"How many guards?":** *"Intelligence suggests 15-20 militia. Farmers with spears, mostly. A few veterans. Nothing you can't handle."*
:
...
**Reward Breakdown:**
- Base Payment: 2,000gp (confirmed destruction)
- Bonus: 500gp (no surviving guards)
- Failure: 0gp and reputation damage

### Travel to Greymarch Valley

**Distance:** 40 miles | **Travel Time:** 2 days on foot, 1 day mounted
...
- **8 wagons** of supplies: food, medicine, blankets, seeds
- **4 wagons** of personal belongings
- **18 volunteer militia** (use Guard stats, CR 1/8)
- **2 veteran soldiers** (use Veteran stats, CR 3)
- **1 priestess** - Sara Whitehaven (see stat block)
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|10 (+0)|12 (+1)|12 (+1)|13 (+1)|16 (+3)|14 (+2)|
___
**Skills** :: Medicine +5, Persuasion +4, Religion +3
**Senses** :: Passive Perception 13
**Languages** :: Common, Celestial
**Challenge** :: 2 (450 XP)
___
***Spellcasting (4th-level Cleric).*** Spell save DC 13, +5 to hit.
...
***Protective Aura.*** Allies within 10 ft. have advantage on saves vs. fear.
### Actions
...
#### Option 1: COMPLETE THE MISSION (Destroy Supplies)

**Actions:** ::
- Burn wagons, destroy food and medicine
- Leave refugees with nothing
- Kill anyone who resists

**Mechanics:** ::
- Militia will try to protect wagons (18 Guards, 2 Veterans)
- Sara casts *sanctuary* on herself, uses healing on wounded
- Most refugees flee; some die in crossfire
- Takes 1-2 hours to fully destroy convoy

**Consequences:** ::
- Full payment: 2,000gp (+ 500gp if no survivors)
- Reputation: +3 with Thaldros military
- Reputation: -5 with common folk (word spreads)
- Aethoria marks you as war criminals
- Haunted by screams (Wisdom save DC 12 each long rest for 1 week or no benefit from rest)

**Dawnblade's Reaction:** ::
{{description,note
*She reads your report in silence. Her jaw tightens. She counts out your gold without meeting your eyes.*

*"Mission accomplished. The Crown thanks you for your service." Her voice is flat. Professional. But when she finally looks at you, something has changed. Respect? Disgust? Hard to tell.*

*"More missions will follow. Similar... complexity. I trust you'll be equally efficient."*
}}

#### Option 2: REFUSE THE MISSION

**Actions:** ::
- Tell Sara you won't attack
- Let convoy pass
- Return to Dawnblade empty-handed

**Consequences:** ::
- No payment (mission failed)
- Reputation: -3 with Thaldros military
- Dawnblade questions your loyalty
- May be reassigned to less important missions
- Refugees survive (Sara grateful, future ally?)
...
**Actions:** ::
- Destroy weapons and military-adjacent supplies
- Leave food, medicine, personal belongings
- Report convoy was "smaller than expected"

**Mechanics:** ::
- Deception DC 16 to convince Dawnblade
- Must actually identify and destroy some supplies
- Sara cooperates (points out items Thaldros would consider "military")

**What Gets Destroyed:** ::
- Blacksmith tools (could make weapons)
...
- Reputation: Neutral with Thaldros (didn't excel, didn't fail)
- Refugees survive with reduced supplies
- Sara suspicious but grateful
- Risk of discovery later (Quest 2.3 complication)

**Dawnblade's Reaction:** ::
{{description,note
*"Smaller convoy than reported? Intelligence failure, then." She frowns at your report. "Thirty percent destruction is... acceptable. Not impressive, but acceptable."*

*She pays you half rate. "Next time, I expect complete results. The Crown doesn't pay for partial victories."*
}}

#### Option 4: FAKE THE DESTRUCTION

**Actions:** ::
- Help convoy reach safety via alternate route
- Burn empty wagons as "evidence"
- Fabricate detailed report

**Mechanics:** ::
- Deception DC 18 to convince Dawnblade
- Survival DC 14 to find alternate route for convoy
- Must procure or create "evidence" of destruction

**Consequences:** ::
- Full payment: 2,000gp (based on lie)
- Reputation: Appears +3 with Thaldros (actually 0)
- Refugees survive completely
- Sara deeply grateful (major future ally)
- HIGH risk of discovery (Quest 2.3)
- If caught: Execution for treason

**Dawnblade's Reaction (if believed):** ::
{{description,note
*"Excellent work. Clean. Professional. This is what I expect from Crown operatives." She smiles for the first time. "You're exactly what Thaldros needs in this war."*

*She hands you full payment plus a medal of commendation. "Wear it proudly. You've earned the Crown's trust."*

*(The medal feels heavier than it should.)*
}}

#### Option 5: DEFECT TO AETHORIA

**Actions:** ::
- Escort convoy to Fort Castellan
- Request asylum from Aethoria
...
**Consequences:** ::
- Payment: 1,500gp from Aethoria (hero's welcome)
- Reputation: +5 with Aethoria
- Reputation: -10 with Thaldros (HUNTED)
- Bounty placed on your heads (500gp each)
- Sara vouches for you (powerful ally)
- Quest 2.2 effectively becomes Aethoria path
...
- Sara Whitehaven becomes recurring NPC (antagonist or reluctant contact)

**If Convoy Saved (any method):** ::
...
*"Tell the mercenaries," Sara wrote in a letter that somehow found you, "that Sera sees what they did. And so do I. If they ever need sanctuary, they have it."*
}}


**Mechanical Effect:** ::
- Sara Whitehaven becomes major ally
...
**"Why is he defecting?":** *"He says he's disillusioned. The Crown ordered something he couldn't stomach. He wants out." Valen shrugs. "His motives don't matter. His intelligence does."*
:
...
{{description,note
*Valen sighs. "You'll hear about it eventually. Riverside was a village. Emphasis on 'was.' During the early border skirmishes, General Thorne... made a tactical decision. Thaldros claims it was military necessity. Our intelligence suggests it was a massacre."*

*"Two hundred civilians. Women and children. Thorne commanded the operation personally."*

*"He's a war criminal. And we need his intelligence anyway. Welcome to the morally gray world of espionage."*
}}
...
**Reward Breakdown:**
- Base Payment: 1,500gp (successful extraction)
- Bonus: 500gp (if no alarms raised)
- Failure: 0gp and blown intelligence operation

### Travel to Thornfield Manor
...
**Perception DC 14:** Two guards at main gate, two patrolling grounds, at least four more inside ::
...
**Layout:** ::
- **Main Gate:** 2 guards (Veterans, CR 3)
- **Grounds Patrol:** 2 guards (Guards, CR 1/8)
- **Servant Entrance:** 1 guard (Guard, CR 1/8)
- **Interior:** 4 guards (2 Guards, 2 Veterans)
- **Thorne's Study:** 2nd floor, east wing

**Entry Options:** ::

**A. Main Gate (Deception)** ::
- Bluff as visitors, officials, or family
- Deception DC 16
- Gets you inside but watched closely

**B. Servant Entrance (Stealth)** ::
- Sneak in during delivery (dawn)
- Stealth DC 14
- Undetected but limited time

**C. Over the Wall (Athletics)** ::
- Climb wall, cross grounds at night
- Athletics DC 13, Stealth DC 15
- Highest risk, most control

**D. Forge Orders (Forgery)** ::
- Create transfer orders for Thorne
- Forgery kit + INT check DC 17
- Walk him out openly if successful

### Meeting General Thorne
...
*When you confirm, he almost sags with relief. "Thank the gods. I thought... I thought they'd abandoned me. Left me to rot here until the Crown decides I'm more useful dead."*

*He moves to gather documents from his desk. "I have everything. Troop positions. Supply routes. Crown battle plans for the spring offensive. This will save thousands of lives. Republican lives. Lives I..."*
...
*See NPC Compendium for full stat block (CR 8)*

**Role:** Defector with critical intelligence   ::
**Complication:** War criminal (Riverside massacre) ::

### The Escape

**Regardless of entry method, exfiltration is complicated:** ::
...
*Someone talked. Or someone suspected. Either way, your quiet extraction just became a fighting retreat.*
}}

**Escape Encounter:** ::

**Wave 1 (Immediate):** ::
- 4 Guards (CR 1/8 each)
- 2 Veterans (CR 3 each)

**Wave 2 (3 rounds later):** ::
- 6 Guards (CR 1/8 each)
- 1 Knight (CR 3) - Lieutenant Cade, loyal to Thorne (hesitates)

**Environmental Factors:** ::
- Horses in stable (can be used for faster escape)
...
*The young man's sword shakes in his hand. Rage. Betrayal. Grief.*
}}

**Resolution Options:** ::
- Fight Cade (Knight, CR 3) - He fights to the death
...
**After escaping the manor, you have 2 days of travel to reach Millbrook.** ::

##### Read Aloud:
{{description,note
*The second night, you camp in an abandoned barn. Thorne is restless, barely sleeping. He keeps muttering about "making it right" and "the Republic will understand."*
...
**The Mob:** ::
- 40 commoners (CR 0) - Not a combat threat individually
- Calira Ashford (Mob Leader) - Survivor of Riverside
- Armed with farm tools, overwhelming numbers
- Will not negotiate, will not retreat
- Want Thorne dead

**Calira's Declaration:** ::
{{description,note
...
*"Sorry doesn't bring my children back," Calira snarls.*
}}
...
#### Option 1: PROTECT THORNE (Complete Mission)

**Actions:** ::
- Fight off or disperse the mob
- Continue extraction to Millbrook
- Deliver Thorne to Republic intelligence

**Mechanics:** ::
- Mob is not a combat threat but numbers are overwhelming
- Intimidation DC 16 to scatter them
...
- Reputation: -3 with common folk (protected a war criminal)
- Survivors remember you as Thorne's accomplices
- Thorne provides intelligence (thousands of lives saved)
- Justice denied to Riverside victims
...
**Consequences:** ::
- No payment (mission failed)
- Reputation: -5 with Republic intelligence (you're unreliable)
...
*Was it justice? Revenge? Does the distinction matter?*
}}

#### Option 3: DEMAND A FAIR TRIAL
...
- Must genuinely promise trial (Valen won't like this)
- Survivors join convoy (complications)
- Thorne provides intelligence BUT also confesses
...
**Calira's Response:** ::
{{description,note
*She stares at you for a long moment. The torches flicker. The mob mutters.*
...
**Actions:** ::
- Present Thorne with options
- Let him decide his own fate
- Execute his choice

**Mechanics:** ::
- Thorne gets to make the decision
- Insight DC 14 to gauge his true wishes
- May choose surrender (guilt-ridden)
- May choose to fight (survival instinct)
- May choose trial (seeking redemption)

**Thorne's Choice (roll d6 or DM decides):** ::
|d6|Choice|
|:-:|:----:|
|1-2| Fights (refuses to die like this) |
|3-4}| Surrenders (accepts punishment) |
|5-6| Requests trial (wants to confess publicly) |

**Consequences:** ::
- Varies based on Thorne's choice
- PCs can't be blamed for the outcome
- Neither credit nor responsibility
- Philosophically interesting, practically complicated

#### Option 5: KILL THORNE YOURSELF

**Actions:** ::
- Execute Thorne personally
- Deny him to both mob and Republic
- Take his intelligence documents

**Mechanics:** ::
- Single attack (Thorne won't fight back)
- Mob satisfied (justice delivered cleanly)
- Intelligence preserved (documents, not interrogation)

**Consequences:** ::
- Partial payment: 750gp (delivered intelligence, not prisoner)
- Reputation: Mixed (just? Merciful? Pragmatic?)
- Survivors grateful (clean death, not torture)
- Valen disappointed but understanding
- Documents valuable but incomplete
- Thorne dies... relieved?
...
##### Read Aloud:
{{description,note
*General Thorne's intelligence proves valuable. Troop movements. Supply lines. Crown strategies. The Republic uses it to win three engagements, saving an estimated 2,000 soldiers.*

*Thorne lives in comfortable custody, debriefed endlessly, protected from justice. The Riverside survivors protest outside his holding facility every day. The Republic ignores them.*
...
*Did you make the right choice? The survivors say yes. The widows of Republic soldiers might disagree. There's no calculus for this. No formula that makes the math work out.*
...
**Level:** 7 ::
**Duration:** 2-3 sessions ::
**Theme:** "Should some knowledge be forbidden?" ::

### Mission Briefing

One week after joining the Unbound, you receive a coded message directing you to a candlelit chamber beneath an abandoned temple. Corvus Blackwood awaits, his eyes gleaming with feverish intensity.
...
**Insight DC 18:** When he mentioned "reshaping reality," his hands trembled slightly. Part of him is afraid of what he's seeking. He's doing it anyway. ::
...
*"Oh, and one more thing." His smile is unsettling. "Don't touch the Component directly. Not without these." He hands you a pair of warded gloves. "Unshielded contact tends to... change people. Usually for the worse."*
}}

**Reward Breakdown:** ::
- Base Payment: 1,000gp
- Bonus: Pre-Worldrend artifact (magical item, rare)
- Failure: 0gp and Corvus's "disappointment" (which is dangerous)

### Travel to the Vault of Whispers

**Distance:** 80 miles through Contested Lands ::
**Travel Time:** 4 days ::
...
- Compasses spin randomly (Survival DC 15 to navigate by landmarks)
- Strange sounds at night (whispers, music, voices in unknown languages)

**Random Encounters (roll d6 once per day):** ::
|  d6 | Encounter |
|:---:|:---------:|
|1-2|Reality Fragment (roll on Wild Magic table,affects random PC)|
...
*The air hums. Your teeth ache. Something inside the Vault is... waiting.*
}}
...
##### Read Aloud:
{{description,note
*A circle of symbols surrounds the entrance, glowing faintly silver. As you approach, the glow intensifies. A voice echoes from nowhere:*

*"State your purpose, seekers. Speak truth or speak not at all."*
}}

**The Ward Tests:** ::

**Test 1 - Purpose:** ::
- Must state genuine intention
- Deception fails automatically (ward detects lies)
- Acceptable purposes: "To retrieve the Component," "To claim what was hidden," "To complete our mission"
- Unacceptable: Pure greed, destruction, "just looking"

**Test 2 - Sacrifice:** ::
- Ward demands something of value
- Options: Blood (1d6 damage per PC), magical item, genuine secret shared aloud
- Each PC must sacrifice something

**Test 3 - Unity:** ::
- Party must enter together, holding hands
- No hostility between members during entry
- If any PC secretly plans to betray the others, Ward detects it
...
### Vault Interior - The Halls of Whispers
...
**The Whispers Effect:** ::
- Every PC makes Wisdom save DC 13 upon entry
- Failure: Whispers reveal a secret about the PC (player chooses which)
- Secrets spoken aloud; other PCs hear
- Creates tension without mechanical penalty

**Chamber 1 - The Gallery of Seekers:** ::
...
- No Dexterity checks required if walking honestly
- If PC is currently deceiving party (hidden agenda), DC 15 Dexterity save each 10 feet
- Failure: Fall, caught by magical force, deposited at entrance (take 2d6 psychic damage)
- Three failures: Petrified (join the Gallery)

**Alternative - Confess:** ::
- PC can confess their deception to the party
- Whispers verify truth
- Bridge becomes stable for them
- But now party knows their secret

**Chamber 3 - The Guardian:** ::
...
*See NPC Compendium for full stat block (CR 10)*

**Combat Notes:** ::
- Guardian fights to test, not to kill
- Reduces to 0 HP but doesn't destroy
...
{{description,note
*The Guardian kneels, damaged but not destroyed. Its eyes flicker as it assesses you.*

*"You have proven... adequate. The Component recognizes strength. But strength alone is not wisdom."*

*It gestures to the floating crystal. "Take what you came for. But know this: the World-Splitter was unmade for a reason. Those who seek to reunite it seek the end of all things. Is that truly what you desire?"*
...
*You have the Component. Now you have to decide what to do with it.*
}}

**Component Effects (if touched without gloves):** ::
- Wisdom save DC 18
- Failure: Petrified (join the Gallery)
- Success: 4d10 psychic damage, one indefinite madness from DMG table

**Component Effects (with gloves):** ::
- Safe to carry
- Faint whispers at edge of hearing
- Dreams become strange (visions of the Worldrend)
- Wisdom save DC 14 each long rest or become obsessed with keeping it

**The Guardian's Warning:** ::
{{description,note
*"You are not the first to claim a Component. You will not be the last. But consider: every seeker before you believed they could control this power. Their statues line my gallery. Think carefully before you join them."*
}}
...
#### **Option 1: DELIVER TO CORVUS (Complete Mission)**

**Actions:** ::
- Take Component back to Corvus
...
- Component now in Corvus's hands (2 of 5 collected)
- Apocalypse one step closer
- You've enabled potential mass death
...
- Use magic, smashing, etc.

**Reality:** ::
- Component is nearly indestructible
- Requires *disintegrate* spell or similar high-level magic
- DC 18 Intelligence (Arcana) to figure out how

**If destroyed:** ::
- No payment (mission failed)
- Reputation: -10 with Unbound (hunted)
- Component eliminated (apocalypse harder to achieve)
- World slightly safer
- Corvus becomes enemy

**Corvus's reaction:** ::
{{description,note
*"You DESTROYED it? Centuries of research! The hope of humanity! You've doomed millions to continued suffering. I'll never forgive this."*
}}

#### **Option 3: KEEP COMPONENT**

**Actions:** ::
- Take artifact for yourself
- Don't return to Corvus
- Power in your hands (corrupting?)

**Consequences:** ::
- No payment (stole from employer)
- Reputation: -10 with Unbound (hunted)
- Component's influence on you (corruption)
- Both kingdoms hunt you (want Component)
- Future plot: What do YOU do with it?

**Every long rest: Wisdom save DC 14 or Component influences your decisions** ::

#### **Option 4: GIVE TO OPPOSING FACTION**

**Actions:** ::
- Deliver Component to Thaldros or Aethoria
- Betray Corvus
- Let kingdom study/use it

**Consequences:** ::
- Payment: 3,000gp from kingdom (major prize)
- Reputation: -10 with Unbound (hunted)
- Reputation: +10 with kingdom
- Kingdom now has Component (also dangerous)
- They'll study it for military advantage
- Different apocalypse risk

**Kingdom reaction:** ::
{{description,note
*"Extraordinary! Our scholars will study this. Its power could win the war. You've served [kingdom name] well. You're a hero."*
}}
**Later (Quest 2.4): Learn kingdom is weaponizing it** ::

#### **Option 5: HIDE COMPONENT**

**Deception DC 17:** ::

**Plan:** ::
- Claim Component was destroyed in trap
- Hide it somewhere secret
- Keep its location known only to you

**If successful:** ::
- Half payment: 500gp (failed mission)
- Component hidden (future plot point)
- Neither Corvus nor kingdoms have it
- World safer for now
- You know where ultimate power is buried
...
**They receive multiple missions:** ::

**Thaldros wants:** Convoy destroyed   ::
**Aethoria wants:** Thorne extracted   ::
**Unbound wants:** Component retrieved ::
...
- Then split party: half does convoy, half does extraction
- High risk, high reward

**Consequences:** ::
- If succeed all: Maximum gold (5,000gp+)
- If fail any: That faction becomes suspicious
- Eventually discovered (Quest 2.3)
- All factions turn on you when revealed
...
**Quest 2.2-T (Convoy):** ::
- If completed: 2,000gp + Thaldros trust
- If refused: 0-500gp + Thaldros suspicion
- If exposed: Possible arrest

**Quest 2.2-A (Defector):** ::
- If delivered: 1,500gp + Aethoria trust
- If turned over: 0gp + moral clarity
- If public trial: 750gp + forced transparency

**Quest 2.2-U (Component):** ::
- If delivered: 1,000gp + artifact + Unbound trust
- If destroyed: 0gp + world safer
- If sold: 3,000gp + kingdom trust

**Level Up:** ::
- All PCs should reach **Level 8** after Quest 2.2
- New class features
- Increased spell power
- Ready for Act II escalation

## DM Guidance

### **Running Parallel Missions**

**Each mission tests different moral boundaries:** ::

**Thaldros (Convoy):** ::
- Tests: Willingness to harm innocents
- Theme: Collateral damage
- Question: "How far for gold?"

**Aethoria (Defector):** ::
- Tests: Justice vs pragmatism
- Theme: Moral compromise
- Question: "Does the end justify the means?"

**Unbound (Component):** ::
- Tests: Power vs safety
- Theme: Playing with fire
- Question: "Should some knowledge be forbidden?"
...
**These choices echo through Act II:** ::

**If killed refugees (Convoy):** ::
- Civilian NPCs distrust you
- Aethoria sees you as monsters
- Thaldros gives more "difficult" missions

**If protected war criminal (Defector):** ::
- Justice subverted
- Survivors remember
- But Aethoria wins intelligence advantage

**If delivered Component:** ::
- Apocalypse closer
- Corvus more powerful
- World more dangerous

**Track all consequences for later quests** ::

## Transition to QUEST 2.3

**Regardless of mission outcome:** ::

After 1-2 weeks, **Quest 2.3: The Double Cross** begins.

**Setup:** ::
- Your faction has been lying to you
...
### **World-Splitter Component #2**
*Artifact (divine fragment), legendary*

*A crystalline shard glowing with impossible colors. Fragment of power that ended the Godsfall. Dangerous to touch. Catastrophic if misused.*

**Properties:** ::
- **Reality Sense:** Holder can sense distortions in reality within 1 mile
- **Divine Fragment:** Counts as holy symbol for all deities (living or dead)
- **Corrupting Influence:** Wisdom save DC 14 each long rest or become obsessed with its power
- **Indestructible:** Can only be destroyed by *disintegrate* or *wish*

**If Used (Do Not Do This):** ::
- Can cast *reality break* once (custom 9th level spell)
- Tears hole in reality, devastating 1-mile radius
- 10d10 force damage to all creatures (no save)
- Reality distorted permanently in area
- User must succeed DC 18 Con save or die

**Campaign Role:** ::
- Central to Unbound plot
- Corvus needs 5 to "reshape" reality
- Both kingdoms want them
- Incredibly dangerous

**Acquisition:** ::
- Quest 2.2-U (if retrieve from Old Kaer vault)

### **Ancient Vault Artifacts**

**Found in Old Kaer vault (if searched):** ::

1. **Ring of Mind Shielding** (Uncommon)
2. **Cloak of Protection** (Uncommon)
3. **Wand of Web** (Uncommon, 7 charges)
4. **Dusty spellbooks** (3d4 wizard spells, random)

**PCs can take 1-2 items depending on time and carrying capacity** ::
...
**Time:** Two weeks after Quest 2.2 ::

**What's Happened:** ::
- You completed 2-3 missions for your chosen faction
- Built reputation and trust
- Earned significant gold
...
**Session begins normally. Then:** ::

##### Read Aloud:
{{description,note
*You're returning to your lodgings after another successful mission. Gold in hand, reputation solid. You're becoming important players in this war.*
...
**The document varies by faction...** ::


## If Working For Thaldros

## The Document

**Royal Military Memo (appears authentic):** ::
{{description,note
**FROM:** Royal Command   ::
...
**Speed** :: 30 ft.![Captain Sarah Vale](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/all_artwork/npcs/kt-captain-sarah-vale.jpg) {width:325px,mix-blend-mode:multiply}
___
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|15 (+2)|14 (+2)|14 (+2)|12 (+1)|13 (+1)|14 (+2)|
___
**Saving Throws** :: Str +5, Con +5
**Skills** :: Athletics +5, Insight +4, Perception +4, Persuasion +5
**Senses** :: Passive Perception 14
**Languages** :: Common
**Challenge** :: 3 (700 XP)
___
***Combat Veteran.*** Advantage on saves vs fear.

***Second Wind (Recharge 5-6).*** Heal 1d10 + 9 as bonus action.
### Actions
...
**The folder contains:** ::
- 12 more documents (authentic)
- Execution orders pre-signed
- Lists of "mercenary crimes" to publicize
- Timeline: arrest you 3 days after war ends
- Commander Dawnblade's signature on several

**Appearance:** 30s, royal military uniform under cloak, blonde hair, haunted eyes, guilty expression ::
...
**Motivation:** ::
- Can't stomach executing honorable mercenaries
...
- Dawnblade is conflicted but will follow orders
- Crown has done this before (you're not first)
- War's end is 2-3 months away (timeline urgent)
...
**If PCs confront her with evidence:** ::

##### Read Aloud:
{{description,note
*You storm into Dawnblade's office, documents in hand. She looks up, sees what you're holding, and her face falls.*

*"Ah." She stands slowly. "Sarah. I should have watched her more closely."*

*She doesn't deny it. Doesn't even try.*

*"Yes. It's real. Scapegoat Protocol. Orders from high command. When the war ends, you'll be arrested. Tried for war crimes. Executed. The crown needs someone to blame, and mercenaries are perfect."*

}}

**Insight DC 12:** She's deeply uncomfortable but resigned to following orders ::

**If PCs get angry:** ::

{{description,note
*"You think I LIKE this? I'm a soldier. I follow orders. Even orders I hate. That's the oath I took. That's the burden I bear."*

*(Her voice cracks slightly)*

*"For what it's worth... you're good people. You did the dirty work no one else would do. And yes, you'll die for it. That's the price of serving power. I'm sorry."*
}}
**If PCs threaten her:** ::
{{description,note
*"Kill me if you want. Won't change anything. Scapegoat Protocol is official. My replacement will execute it. You can't fight the entire kingdom."*
}}

### **The CHOICE (Thaldros Path)**
...
- Become fugitives
- Find new employer or go independent

**Consequences:** ::
- Wanted by entire Thaldros military
- Bounty: 5,000gp (dead or alive)
- Lose all Thaldros connections
- Can't return to kingdom-controlled areas
- Sarah defects with you (if you let her)
- Survive but hunted
...
**Consequences:** ::
- Aethoria pays 2,000gp for defection + intelligence
- Reputation: +10 with Aethoria
- Reputation: -20 with Thaldros (traitors)
- Now working for opposite side
- War continues, you've switched teams

#### **Option 3: BLACKMAIL THALDROS**

**Intimidation DC 18 to make Dawnblade back down:** ::

**If successful:**
{{description,note
*"You want to negotiate? Fine. I'll report Scapegoat Protocol 'failed' due to security leak. You'll be marked as liabilities instead of assets. They won't actively hunt you, but they won't protect you either. You'll be on your own. Deal?"*
}}

**Consequences:** ::
- Thaldros backs off (you're too risky to arrest)
- No payment, no support, no protection
- Technically independent
- Can work for anyone now
- Thaldros watches you but doesn't attack
- Uneasy truce

#### **Option 4: ACCEPT FATE**

**Decide to stay loyal despite betrayal:** ::

**Why PCs might choose this:** ::
- Believe in Thaldros cause despite corruption
- Pragmatic acceptance of mercenary risks
...
- Try to gather evidence to exonerate selves
...
**If you kill her:** ::
- Immediate alarm
- 20 **Thaldros Guards** respond (CR 1/8 each)
- Must fight way out or die

**If you expose protocol:** ::
- Publish documents to press/public
- Major scandal for crown
- Some nobles support you, others hunt you
- Public opinion divided
- Crown furious but can't openly retaliate

**Consequences:** ::
- Massive political fallout
- Thaldros government embarrassed
- You're heroes to some, traitors to others
- Can't work in Thaldros territory
- Crown sends assassins privately
...
*Translation: Suspend elections "temporarily." Establish emergency council of senators (us). Grant ourselves extraordinary powers "until stability restored."*

*We fought for democracy. We'll rule through democracy. Just... guided democracy. The people aren't ready for full self-governance. They need strong leaders.*

*Valen: Your mercenaries have served well. After victory, they know too much. Offer them command positions in remote territories. Keep them busy. If they refuse, frame as Thaldros collaborators. Trial. Exile.*

*The revolution must be protected. Even from those who fought for it.*

}}

**Investigation DC 15:** Document appears genuine (senate seals, authentic signatures) ::

## The Meeting

**Old Mill, Midnight** ::

**The Informant:** **Marcus Thorne** (the defector from Quest 2.2, if he survived) ::

**If Thorne died in Quest 2.2, use different informant:** ::

**Alternative: JULIA REDWIND** (Aethoria intelligence officer, similar stats to Sarah Vale) ::

**Thorne'S Revelation:** ::

##### Read Aloud:
{{description,note
*General Marcus Thorne stands in the shadows. He looks even more haunted than before.*

*"I defected from Thaldros because I saw what tyranny does. Now I'm watching Aethoria become the same thing. Different name. Same poison.*
...
*"Gods. I sound like them. I'm making excuses for tyranny."*
...
{{description,note
*"You want the truth? I KNEW. I knew some senators had this plan. I told myself it wouldn't happen. That we'd stop it after victory. That democracy would prevail.*

*But I also knew that if I opposed them openly, I'd be removed. Replaced with someone worse. So I... cooperated. Kept my head down. Told myself I was being pragmatic.*

*(Ashamed)*

*I'm a hypocrite. I fought for democracy while enabling its betrayal. You deserved better."*
}}

### **The CHOICE (Aethoria Path)**

**PCs must decide:** ::

#### **Option 1: FLEE AETHORIA**
...
#### **Option 2: SWITCH TO THALDROS**

**Actions:** ::
- Contact Commander Dawnblade
- Offer intelligence on Aethoria
- Join monarchy

**Dawnblade's Response:** ::
{{description,note
*"Aethoria betrayed you? Democracy always fails. Welcome to the side of order. We'll pay well for your intelligence. 3,000 gold. Plus, when we win, you'll be rewarded properly."*
}}

**Consequences:** ::
- Thaldros pays 3,000gp for defection
- Reputation: +10 with Thaldros
- Reputation: -20 with Aethoria (traitors)
- Irony: fought for freedom, joined tyranny
- But at least tyranny is honest about being tyranny

#### **Option 3: SAVE DEMOCRACY**

**Work with Valen to expose corrupt senators:** ::

**Persuasion DC 16 to convince Valen to help:** ::
...
**The Campaign:** ::
- Gather more evidence (3 skill challenges)
- Build coalition of honest senators (social encounters)
- Public reveal at senate session (dramatic scene)
- Face political assassination attempts (2 combat encounters)

**If successful:** ::
- Corrupt senators removed
- Democracy preserved
- You're heroes of the TRUE revolution
- Aethoria remains flawed but honest
- Rare good ending for this path

**Consequences:** ::
- Partial payment: 1,000gp (from grateful honest senators)
- Reputation: +15 with common people
- Reputation: +5 with honest senators
- Reputation: -20 with corrupt politicians (now enemies)
- Democracy survives but wounded

#### **Option 4: ACCEPT OLIGARCHY**

**Decide corrupt senate is better than Thaldros:** ::

**Rationalization:** ::
- "Guided democracy" is still better than monarchy
- Pragmatic acceptance
- Lesser evil
- At least they'll rule competently

**Consequences:** ::
- Continue working for Aethoria
- Know democracy is dying
- Help establish oligarchy
- Payment continues but conscience damaged
- Become tools of hypocrisy
...
- Reveal Thaldros Scapegoat Protocol too
- Undermine both governments
- Create power vacuum

**Consequences:** ::
- Both kingdoms destabilized
- Chaos spreads
- You're wanted by EVERYONE
- Common folk divided (some support, some blame you)
- Unbound (Corvus) sees opportunity
- You've started regional collapse

## If Working For The Unbound
...
*Is this evil? No. It's necessity. I'm saving humanity by making them something better. Something controlled.*
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|8 (-1)|14 (+2)|10 (+0)|16 (+3)|14 (+2)|13 (+1)|
___
**Skills** :: Arcana +6, History +6, Investigation +6, Perception +5
**Senses** :: Passive Perception 15
**Languages** :: Common, Draconic, Elvish
**Challenge** :: 4 (1,100 XP)
___
### Spellcasting
**Spellcasting Ability:** Intelligence (spell save DC 14, +6 to hit)

**Cantrips:** *fire bolt, mage hand, minor illusion, prestidigitation*

**Spells Prepared:**
- 1st level (4 slots): *detect magic, mage armor, shield, thunderwave*
...
- He'll kill 30-40% of world population
- Final restructuring removes free will
- He has two Components (needs three more)
- Plans to use mercenaries until last moment, then eliminate them

**What She Wants:** ::
- Destroy the Components
- Stop Corvus (even if it means killing him)
- Save humanity from "salvation"
...
*(He's not apologetic. He's EXPLAINING.)*

*"You're mercenaries. You understand hard choices. Sometimes you must kill to save. This is that, scaled up. Kill millions to save billions.*

*The old world is BROKEN. War. Poverty. Oppression. I can FIX it. Make humanity perfect. Isn't that worth the cost?"*

}}

**Insight DC 15:** He's completely serious and genuinely believes this is right ::

**If PCs call him insane:** ::

{{description,note
*"Insane? I'm the ONLY sane one. Look at the world! Thaldros murders refugees. Aethoria betrays its own ideals. Endless cycles of suffering. I'm offering to END that.*

*Yes, the price is high. Yes, you'll lose free will. But you'll also lose suffering. Pain. War. Isn't that worth it?"*

**If PCs threaten to stop him:** ::

*(Sadly)*
*"I hoped you'd understand. But if you oppose me, you're choosing suffering over salvation. I can't allow that.*

*(He raises hand, Components glowing)*
...
#### **Option 1: Fight Corvus Now**

**Actions:** ::
- Kill Corvus before he completes plan
- Destroy/secure Components
- End Unbound threat
...
**If defeated:** ::
- Corvus dies
- Components can be secured/destroyed
...
*Medium humanoid (human), chaotic neutral*
___
**Armor Class** :: 18 (enhanced by Components)
**Hit Points** :: 150 (20d8 + 60)
**Speed** :: 30 ft., fly 30 ft. (Components grant flight)
___
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|10 (+0)|16 (+3)|16 (+3)|20 (+5)|15 (+2)|17 (+3)|
___
**Saving Throws** :: Int +10, Wis +7, Con +8
**Skills** :: Arcana +15, History +15, Insight +7, Investigation +10, Persuasion +8
...
***Component Bond.*** While attuned to 2 Components, gains resistance to nonmagical damage and truesight 60 ft.

***Scholar of the Godsfall.*** Expert on World-Splitter Components and ancient magic. Advantage on Intelligence checks related to the Worldrend.
### Actions
***Multiattack.*** Two *eldritch blast* attacks or one spell and one *quarterstaff* attack.

***Quarterstaff.*** *Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 3 (1d6) bludgeoning damage, or 4 (1d8) if used with two hands.

***Eldritch Blast (Enhanced).*** *Ranged Spell Attack:* +10 to hit, range 120 ft., one target. *Hit:* 14 (4d6) force damage.

***Reality Distortion (Recharge 5-6).*** Corvus releases Component energy in a 30-ft. radius. All creatures in the area must make a DC 18 Wisdom saving throw, taking 28 (8d6) psychic damage and becoming stunned until the end of Corvus's next turn on a failed save, or half damage and no stun on a success.

***Summon Unbound Fanatics (1/Day).*** Corvus summons 6 **Cult Fanatics** that appear in unoccupied spaces within 30 feet. They act on his initiative and fight until destroyed.
### Bonus Actions
***Phase Shift (3/Day).*** Corvus becomes incorporeal until the start of his next turn. While incorporeal, he can move through creatures and objects as difficult terrain, has resistance to all damage, and cannot be grappled or restrained.

***Misty Step.*** Corvus teleports up to 30 feet to an unoccupied space he can see.
### Spellcasting
**Spellcasting Ability:** Intelligence (spell save DC 18, +10 to hit)

**At Will:** *detect magic*, *mage armor*, *mage hand*, *message*

**Spells Prepared:**
- 1st level (4 slots): *shield*, *magic missile*, *identify*
- 2nd level (3 slots): *detect thoughts*, *misty step*, *see invisibility*
- 3rd level (3 slots): *counterspell*, *dispel magic*, *fly*
...
- 7th level (1 slot): *forcecage*, *teleport*
### Reactions
***Shield.*** When hit by an attack, Corvus casts *shield*, gaining +5 AC until the start of his next turn.

***Counterspell.*** When a creature within 60 feet casts a spell, Corvus can attempt to counter it.
}}

**If you lose:** ::
- Corvus captures you
- Imprisoned until restructuring
- Bad ending (experience new world firsthand)

**Consequences of victory:** ::
- No payment (killed employer)
- Reputation: -20 with remaining Unbound
- Reputation: +10 with both kingdoms (removed mutual threat)
- Components in your possession (very dangerous)
- What do you do with them?

#### **Option 2: JOIN CORVUS**

**Accept his vision:** ::

**Rationalization:** ::
- Maybe he's right about world being broken
- 30% dead vs centuries of war casualties
- Perfect world worth the price
...
- Act III: You rule the new world (dystopian)

#### **Option 3: Flee The Unbound**

**Actions:** ::
- Abandon Corvus
- Don't fight him but don't help
- Go independent

**Consequences:** ::
- Unbound hunts you
- Both kingdoms hunt you (you're known Unbound members)
- Wanted by everyone
...
- Might ally against Unbound threat
- Quest 2.5 becomes alliance mission


#### **Option 4: STEAL COMPONENTS**

**Actions:** ::
- Betray Corvus
- Steal both Components from him
- Prevent apocalypse but keep power

**Stealth/Deception DC 18 to steal them:** ::

**If successful:** ::
- You have 2 of 5 Components
- Corvus hunts you obsessively
- Both kingdoms want them
- Ultimate power in your hands
- What will YOU do with god-tier artifacts?

**Consequences:** ::
- Corruption (Wisdom saves every long rest)
- Everyone hunts you
- Temptation to use them yourself
- Can you resist Components' influence?

#### **Option 5: Sabotage From Within**

**Pretend to stay loyal, sabotage secretly:** ::

**Deception DC 17 to maintain cover:** ::
...
- Secretly undermine operations
- Lead to final confrontation in Quest 2.5
- Dramatic betrayal at crucial moment

## Universal Elements (All Paths)

### **Regardless of faction, this quest includes:**

**The Betrayal:** ::
- Every faction was lying
- Trust broken
- Must reassess allegiances

**The Informant:** ::
- Someone inside helps you
- Risk their life to warn you
- Represents conscience in corrupt system

**The Confrontation:** ::
- Face your faction leader with evidence
- They don't deny it (refreshingly honest)
- Gives their justification

**The Choice:** ::
- Stay loyal despite betrayal
- Switch sides
- Go independent
- Expose corruption
- Take violent action
...
**The Consequences:** ::
- This decision determines your path through remaining Act II
- No "right" answer
- All choices have costs

## Aftermath

**Two weeks later (regardless of choice):** ::
...
*For now, you have one more job. One last mission before the endgame.*

*The Royal Vault of Kaer Thandros. Everyone wants in. Everyone's planning heists.*
...
**New capabilities:** ::
- 5th level spells (casters)
- More powerful class features
- Higher stakes combat
- Ready for Act II finale buildup

## New Npcs For Compendium

**Add these:** ::

1. **Captain Sarah Vale** (Thaldros Informant, CR 3)
2. **General Marcus Thorne** (if survived Quest 2.2, now informant)
...
**Let faction leaders defend themselves:** ::
- They have reasons
- They're not apologizing
- They believe they're right
- Might even respect PCs for discovering truth

**Don't make them cartoonishly evil:** ::
- Dawnblade follows orders (lawful evil)
- Valen compromised principles (conflicted good)
- Corvus believes own rhetoric (chaotic neutral)
...
**This choice matters ENORMOUSLY:** ::
- Determines Quest 2.4-2.5 structure
- Affects Act III options
- Creates permanent allegiances/enemies
- Shapes campaign endgame
...
## Transition to QUEST 2.4

**Regardless of current allegiance:** ::

Everyone wants into the Royal Vault.
...
*Multiple teams are planning heists. Yours is just one.*

*This is Ocean's Eleven. This is the big score. This is where everything changes.*
...
**Level:** 9   ::
**Duration:** 3-4 sessions   ::
**Objective:** Infiltrate Royal Vault, steal critical intelligence/artifact/gold   ::
**Key NPCs:** Rival heist teams, Vault Guardian, faction contacts   ::
...
**Time:** Two weeks after Quest 2.3

##### Read Aloud:
{{description,note
*The war is reaching critical mass. Both kingdoms marshaling forces. The Unbound growing bolder. Everyone positioning for the final push.*

*Then word spreads through the underworld: someone's planning to hit the Royal Vault of Kaer Thandros. The most secure location in the kingdom. Impossible to crack. Legendary security.*

*And suddenly, everyone wants in.*

*Your employer (whoever that is now) contacts you with an offer you can't refuse: "The vault contains what we need to win the war. Get it for us. Payment: enough gold to retire. Plus, you keep whatever else you find."*

*This is it. The big score. The heist of the century.*
...
3. **Historical Documents**
   - Proof of Marcus Blackwood's innocence (from Quest 1.5)
   - Evidence of various royal crimes
   - Conspiracy records

4. **Critical: The War Conspiracy**
   - Letters between Thaldros and Aethoria high command
   - Proof war is partially manufactured
   - Both sides coordinated conflict for political gain
   - Real casualties, fake justification

5. **Gold and Treasures**
   - 100,000+ gold pieces
   - Crown jewels
   - Magical artifacts
   - Priceless art
...
**Your employer (varies) gives orders:**

### **If Working For Thaldros:**

**Commander Dawnblade (if still employed):**
{{description,note
*"Aethoria intelligence suggests they're targeting the vault. We need you to get there first. Recover our military plans before they do. Also, there's a... component we need. Magical artifact. Retrieve it. Payment: 5,000 gold."*
}}
...
**Multiple buyers:**
- Thaldros: 5,000gp for Component + intelligence
- Aethoria: 3,000gp for documents + intelligence
- Unbound: 2,000gp for Component only
- Black Market: 10,000gp for everything (no questions)
...
1. **"Fingers" McGee** (Master Thief)
   - Cost: 500gp
   - Skills: Thieves' tools +12, Stealth +10
   - Specialty: Locks and traps

2. **Archmage Elise Ravencroft** (Dispel Expert)
   - Cost: 1,000gp
   - Skills: Arcana +10, can cast *dispel magic* at 7th level
   - Specialty: Magical wards

3. **Professor Aldrich Stone** (Puzzle Scholar)
   - Cost: 300gp
   - Skills: History +12, Intelligence +5
   - Specialty: Dwarven puzzles

4. **"Tank" Ironhide** (Muscle)
   - Cost: 400gp
...
##### Read Aloud:
{{description,note
*From the east entrance: The Shadows emerge from invisibility. Four professional thieves, eyes on the gold.*

*From the west stairs: The Fanatics storm in. Six Unbound cultists, chanting Corvus's name, eyes on the Component.*

*From the south passage: [Team 3, your former faction's revenge squad], weapons drawn, eyes on YOU.*

*And standing between everyone and the treasure: something moves in the shadows. The GUARDIAN.*
...
3. **The Fanatics** (Brother Ash + 6 cultists)
...
***Antimagic Vulnerability.*** *Dispel magic* (DC 19) shuts it down for 1 minute.
### Actions
***Multiattack.*** Two slam attacks OR one slam + force beam.

***Slam.*** *Melee Weapon Attack:* +11 to hit, reach 10 ft., one target. *Hit:* 25 (4d8 + 7) bludgeoning damage.

***Force Beam.*** *Ranged Weapon Attack:* +11 to hit, range 120 ft., one target. *Hit:* 27 (6d8) force damage, and the target must succeed on a DC 17 Strength save or be pushed 20 feet.

***Alarm (Recharge 5-6).*** Sounds vault-wide alarm. 20 more guards arrive in 5 rounds.

***Vault Lockdown (1/Day).*** Seals all exits for 10 minutes. No teleportation in or out.
}}

#### Tactics

- **Priority:** Defend vault contents
- **First action:** Sound alarm (guards incoming)
- **Second action:** Lockdown vault (trap everyone)
...
4. **Cloak of Invisibility** (Legendary)
...
##### Read Aloud:
{{description,note
*Among the military intelligence, you find something... unexpected. Letters. Correspondence between Thaldros high command and Aethoria military leadership.*
...
##### Read Aloud:
{{description,note
*The heist changed everything. What you did with what you stole set forces in motion.*
...
##### Read Aloud:
{{description,note
*Two months since the heist. Two months of escalation.*

*Every choice you made across Act II led here: The Border of Judgment, where Crown loyalists and Aethoria-backed rebels face each other across one mile of no-man's-land.*
...
*And you: mercenaries who've seen behind the curtain. You know the truth. You know the lies. You know what hangs in the balance.*

*War begins at dawn. Unless you stop it. Or unless you decide one side must win.*

*This is the breaking point. The choice that defines Act III.*
...
3. **unbound apocalypse** - Corvus succeeds, reality reshaped
...
*Behind you: 10,000 Thaldros soldiers.*  
*Across the field: 8,000 Republican defenders.*  
...
##### Read Aloud:
{{description,note
*They're running. Aethoria soldiers fleeing in disarray. Dawnblade orders: "Pursue! No quarter! End this!"*
...
##### Read Aloud:
{{description,note
*Aethoria falls. Republic collapses. Democracy dies on this field.*

*Thaldros banners fly over captured territory. Valen executed (if captured). Survivors flee to distant lands.*
...
*Behind you: 8,000 Republicans.*  
*Across the field: 10,000 Thaldros soldiers.*  
*You're outnumbered. But not outmaneuvered.*
}}
...
2. **Assassinate Commander**
   - Infiltrate command tent
   - Kill/capture Dawnblade
   - Decapitate leadership

3. **Free Prisoners**
   - Liberate captured Republicans
   - Boost morale
   - Gain reinforcements
...
##### Read Aloud:
{{description,note
*Thaldros breaks. Royal army retreats. Kingdom loses the war.*

*Republican flags fly. Democracy survives. Freedom preserved.*
...
*You helped create this. You helped chaos win.*
...
*Tomorrow, we remake the world. No more war. No more suffering. Perfection.*

*(His eyes are wild, intense)*
...
**Deliver Components to Corvus:**

##### Read Aloud:
{{description,note
*You return to Corvus with both Components. He now has all five. His hands shake with anticipation.*
...
##### Read Aloud:
{{description,note
*Corvus chants. Components pulse with power. Reality TEARS.*
...
- You're Wardens (governors of regions)
- Perfect order, zero freedom
- **ACT III Path C: UNBOUND APOCALYPSE**

**Rewards:**
- 2,000gp (symbolic, money is meaningless now)
- Position as Warden
- Power over thousands
- Haunted by what you've done

---

**Option B: STOP THE RITUAL**
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|10 (+0)|18 (+4)|16 (+3)|22 (+6)|16 (+3)|18 (+4)|
___
**Saving Throws** :: Int +11, Wis +8, Cha +9
**Skills** :: Arcana +16, History +16
...
___
***Component-Enhanced.*** Can cast any spell 7th level or lower without spell slots.

***Reality Anchor.*** Cannot be moved, banished, or teleported against will.

***Legendary Resistance (3/Day).*** Can choose to succeed on failed save.
### Actions
***Multiattack.*** Three *reality beam* attacks.

***Reality Beam.*** *Ranged Spell Attack:* +11 to hit, range 120 ft., one target. *Hit:* 28 (8d6) force damage, and the target must succeed on a DC 19 Wis save or be stunned until end of Corvus's next turn.

***Reshape Reality (Recharge 5-6).*** 60-ft. radius. All creatures make DC 19 Charisma save or take 10d10 psychic damage and be transported to harmless demiplane for 1 minute.

***Component Blast (1/Day).*** Releases stored energy. 120-ft. cone. DC 19 Dex save, 20d6 force damage (half on success).
### Legendary Actions
Corvus takes 3 legendary actions:

***Teleport.*** Teleports up to 60 feet.

***Cast Spell (Costs 2).*** Casts spell 5th level or lower.

***Reality Warp (Costs 3).*** Changes battlefield terrain dramatically.
}}

#### Tactics

- **First Round:** *Time stop*, position Components
- **Second Round:** Begin ritual (takes 3 rounds total)
- **While Casting:** Uses legendary actions to defend
...
##### Read Aloud:
{{description,note
*Corvus falls. Components shatter. Reality snaps back like a released bowstring.*

*The ritual fails. The world remains unchanged. Free will intact. Suffering continues.*

*(Corvus, dying)*

*"You... you doomed them. Humanity could have been perfect. Now... now they'll suffer forever. You... chose..."*
...
- Unbound collapses
- War continues (returns to Path 1, 2, or 4)
...
##### Read Aloud:
{{description,note
*Two months later. Treaty of Judgment Border signed. War ends. Ceasefire holds.*

*It's fragile. Hardliners on both sides grumble. Tensions remain. But no one's dying today.*

*You brokered peace. Ended a war. Saved thousands of lives.*

*Statues erected in your honor. Songs sung. "The Peacemakers," they call you.*
...
- Reputation: -20 with hardliners (both sides)
- Title: "Peacemaker"
...
##### Read Aloud:
{{description,note
*War begins at dawn. You watch from hillside as armies clash.*

*Thaldros cavalry charges. Aethoria pikes hold. Siege weapons fire. Magic flares. Thousands die.*

*By sunset: Stalemate. Neither side wins. Both sides bloodied.*

*This repeats. Day after day. Week after week. Month after month.*
...
##### Read Aloud:
{{description,note
*Six months later. War continues. Casualty count: 15,000+ dead. No end in sight.*

*Both kingdoms bleeding resources. Neither willing to surrender. Pride and sunk costs keep it going.*

*Mercenary work is plentiful. Tragic but profitable. You're wealthy but exhausted. And the war? It'll outlive you.*
...
### **What PCs Accomplished:**

**Quest 2.1:** Chose faction  
**Quest 2.2:** Proved loyalty  
**Quest 2.3:** Discovered betrayal  
**Quest 2.4:** Heisted Royal Vault  
**Quest 2.5:** Determined war outcome  

### **Total Possible Gold (Act II):**

**Conservative:** 8,000-15,000gp  
**Optimal:** 20,000-40,000gp  
**Maximum (if exploited all sides):** 50,000+ gp

### **Reputation Earned:**

Varies wildly by choices:
- Hero to some, villain to others
- Respected or hunted
- Legend or cautionary tale

### **Act III Setup:**

**Five possible campaign states:**
1. Thaldros Victory (tyranny)
2. Aethoria Victory (democracy)
3. Unbound Apocalypse (new world)
...
- Their story, not generals' story
...
- What was revealed
- What remains hidden
- This determines all of Act III
...
*But today is worse than usual. Three separate incidents. Same day. All threatening to reignite the war.*
...
*Aethoria Lieutenant: "You murdered an unarmed civilian! This is an act of war!"*
...
*Aethoria Diplomat: "Freedom of speech! We don't censor! Release the ship or we close ALL trade!"*
...
- Call for "new order" (Corvus-style rhetoric)
...
*And someone's actively trying to break it.*

*(A messenger arrives with three more urgent dispatches)*

*"More incidents. Northern border. Western trade route. Southern diplomatic mission. All need Peacekeeper intervention."*
...
##### Read Aloud:
{{description,note
*You've bought peace another day. Maybe another week. But the incidents continue. And now you know: The Unbound are behind them.*

*Corvus may be dead (or imprisoned, or in hiding). But his followers remain. Cells throughout both kingdoms. True believers who think war serves their goals.*
...
**Stealth DC 16 (group check):**

**What PCs see:**
- 25 Unbound members
- Fortified position (earthworks, stakes)
- Armory (stolen weapons)
...
**Skills** :: Acrobatics +9, Insight +6, Perception +10, Stealth +13, Survival +6
**Senses** :: Passive Perception 20
**Languages** :: Common, Thieves' Cant
**Challenge** :: 9 (5,000 XP)
___
***Assassinate.*** Advantage on attacks vs creatures that haven't acted yet. Hits are auto-crits.

***Evasion.*** No damage on successful Dex save, half on failure.

***Sneak Attack (5d6).*** Once per turn when has advantage.

***Action Surge (Recharges after Short Rest).*** Extra action on turn.
### Actions
***Multiattack.*** Three attacks with scimitar or longbow.

***Scimitar +2.*** *Melee Weapon Attack:* +11 to hit, reach 5 ft., one target. *Hit:* 10 (1d6 + 7) slashing damage + 17 (5d6) sneak attack if conditions met.

***Longbow +1.*** *Ranged Weapon Attack:* +10 to hit, range 150/600 ft., one target. *Hit:* 10 (1d8 + 6) piercing damage + 17 (5d6) sneak attack if conditions met.
...
- Joined Unbound after losing everything
- Radicalized by grief and rage
- Now leads Cell Beta
...
**In the vault sanctum:**

##### Read Aloud:
{{description,note
*The vault has been transformed. Eldritch symbols painted everywhere. Altar erected where Component pedestal stood. Dozens of cultists chanting.*

*At the center: A figure in black robes. They turn as you enter. The hood falls back.*

*(Reveal depends on who survived Act II)*
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|10 (+0)|16 (+3)|16 (+3)|20 (+5)|16 (+3)|18 (+4)|
___
**Saving Throws** :: Int +10, Wis +8, Cha +9
**Skills** :: Arcana +15, History +15, Insight +8, Persuasion +9
**Damage Resistances** :: psychic
...
***Reality Beam.*** *Ranged Spell Attack:* +10 to hit, range 120 ft., one target. *Hit:* 22 (5d8) force damage. Target makes DC 18 Wis save or stunned until end of Elara's next turn.

***Reshape Minor Reality (Recharge 5-6).*** 30-ft. cube. Terrain transforms as she wishes. Can create walls, pits, difficult terrain. Lasts 1 minute.

***Component Pulse (1/Day).*** 60-ft. radius. All creatures make DC 18 Con save or take 8d8 psychic damage and be paralyzed for 1 minute. Save ends paralysis at end of each turn.
### Spellcasting
**Spellcasting Ability:** Intelligence (spell save DC 18, +10 to hit)

**At will:** *detect magic, mage hand, prestidigitation, shocking grasp*

**3/day each:** *counterspell, dispel magic, fireball, fly, greater invisibility*

**1/day each:** *chain lightning, disintegrate, forcecage, plane shift*
### Legendary Actions
Elara takes 2 legendary actions:

***Teleport.*** Teleports up to 60 feet.

***Cast Cantrip.*** Casts cantrip.
...
*(She raises hand, Component glowing)*
...
*(But you're exhausted. How much longer can you keep this up?)*
}}
...
*Valen continues: "Three villages destroyed. Completely. No survivors. No demands. No explanation. Just... annihilation."*

*(They slide reconnaissance reports across table)*

*"Whatever this is, it's coming south. Toward both our kingdoms. We estimate... two weeks until it reaches our borders.*
...
##### Read Aloud:
{{description,note
*The war camp is divided. Thaldros soldiers on west side. Aethoria militia on east. They avoid each other. Refuse to share supplies. Three fights broke out yesterday over who gets better tents.*
...
##### Read Aloud:
{{description,note
*Dawn. The Judgment Border. Your combined army: 14,000 living soldiers. Arrayed in defensive formation. Trenches. Stakes. Prepared positions.*

*Then you see them. Cresting the northern hills. The Dreadhost.*

*Row after row of undead. Thousands. Silent except for bone-rattle and armor-clank. No battle cries. No fear. No hesitation.*

*At the rear: Six figures in black robes radiating necrotic energy. The Necromancer Lords.*

*And beyond them: A palanquin carried by zombie ogres. On it sits: The Dread King. Ancient. Skeletal. Crown of bone. Lich.*
...
- Black Chains fighters (Kael if alive)
- Marcus Blackwood (if alive from Quest 1.5)
...
##### Read Aloud:
{{description,note
*The Dread King sits on throne of skulls. Ancient lich. Crown of bone. Staff of dark crystal. Eyes that have seen centuries.*

*He doesn't rise. Doesn't seem surprised.*

*"Ah. Heroes. Come to slay the monster. How... predictable."*

*(His voice is dry, ancient, amused)*
...
**Skills** :: Arcana +19, History +13, Insight +11, Perception +11
...
***Rejuvenation.*** If destroyed, reforms in phylactery after 1d10 days unless phylactery destroyed.

***Turn Resistance.*** Advantage on saves against Turn Undead.

***Phylactery.*** Hidden somewhere in his original kingdom (north). If not destroyed, he returns.
### Spellcasting
**Spellcasting Ability:** Intelligence (spell save DC 21, +13 to hit)

- **Cantrips (at will):** *mage hand, prestidigitation, ray of frost, chill touch*
...
### Actions
***Paralyzing Touch.*** *Melee Spell Attack:* +13 to hit, reach 5 ft., one creature. *Hit:* 14 (3d6 + 4) cold damage, and the target must succeed on a DC 19 Con save or be paralyzed for 1 minute (save ends at end of each turn).

***Necrotic Bolt.*** *Ranged Spell Attack:* +13 to hit, range 120 ft., one target. *Hit:* 36 (8d8) necrotic damage.
### Legendary Actions
The Dread King takes 3 legendary actions:

***Cantrip.*** Casts cantrip.

***Paralyzing Touch (Costs 2).*** Makes one Paralyzing Touch attack.

***Animate Dead (Costs 2).*** Raises 2d4 skeletons from nearby remains.
...
- Casts *mirror image* and defensive buffs
...
- *Finger of death* targeting weakest PC
...
##### Read Aloud:
{{description,note
*The Dread King crumbles. Bones clatter to floor. Crown rolls away. Staff cracks. Ancient robes collapse into dust.*

*(But you hear his voice, fading)*

*"Well played... heroes. But I am deathless. My phylactery endures. In ten days... I return. This... is not... over..."*

*(Silence. He's gone. For now.)*
...
##### Read Aloud:
{{description,note
*You return to camp as dawn breaks. Carry news: The Dread King is defeated. His horde collapsed.*

*Both armies erupt in celebration. Thaldros and Aethoria soldiers embrace. Enemies becoming brothers through shared survival.*

*Dawnblade approaches, salutes: "You saved us. Both kingdoms owe you everything."*

*Valen kneels: "Heroes of the realm. Both realms. True Peacekeepers."*
...
##### Read Aloud:
{{description,note
*Ten days until the Dread King returns. His phylactery lies somewhere in his frozen kingdom to the north. Uncharted territory. Legends say no one returns from there alive.*

*Both kingdoms offer resources: Ships, supplies, soldiers. But this journey? It's yours. Only the most powerful heroes can survive what awaits.*
...
*Dawnblade: "Eight days left before he returns. Find the phylactery. Destroy it. Or we face him again. Forever."*

*Valen: "You've done the impossible before. Do it one more time. Come back heroes. Or don't come back at all."*
...
##### Read Aloud:
{{description,note
*The Frozen Kingdom. 400 years abandoned. Black stone towers coated in ice. Streets empty. No movement. No sound. Just wind and cold.*

*This was once capital of prosperous realm. 50,000 citizens. Now: Nothing. Just frozen monuments to dead ambition.*
...
##### Read Aloud:
{{description,note
*As you reach for the crown, the air FREEZES. The throne room doors slam shut. Ice spreads across floor. And from the crown itself: A voice.*

*"Did you truly think I'd leave it unguarded?"*

*(The Dread King materializes. Early. He reformed FASTER this time.)*
...
##### Read Aloud:
{{description,note
*The crown SHATTERS. Bone splinters. Black metal fragments.*
...
*The ice begins melting. The frozen courtiers crumble. The Frozen Kingdom... is finally dead. And free.*

*Outside, across the realm: Every undead he ever created collapses. Thousands of corpses finally rest.*
...
*"You've saved us three times now," Valen says. "Prevented the war. United us against the undead. And ended the greatest threat we've ever faced."*

*Dawnblade nods. "Both kingdoms owe you everything. Name your reward. Anything."*

*(They're serious. Anything.)*
}}
...
##### Read Aloud:
{{description,note
*Three months of negotiations. Compromises. Debates. Constitutional conventions. But finally:*

*The Treaty of Unity. Thaldros and Aethoria become: The United Realm of Tirvandor.*

*[Chosen system] established. Borders dissolved. One flag flies. One nation stands.*

*Citizens celebrate. Merchants rejoice (unified markets). Generals approve (stronger military). Historians marvel.*

*You've done it. Not just peace. Not just alliance. But true unification. Two ancient rivals become one.*
...
##### Read Aloud:
{{description,note
*One year since unification (or alliance). Peace reigns. Trade flows. Prosperity grows.*

*But you receive message. From both/all leaders. Urgent. One final matter requires your attention.*
...
##### Read Aloud:
{{description,note
*You've saved the world. Ended the war. United kingdoms. Defeated the lich. You're legends.*

*But one final question remains: What's your legacy? How do you want to be remembered? And what comes after?*
...
- Red Wolf (if alive/freed)
- Elara Corvus (if redeemed)
...
##### Read Aloud:
{{description,note
*"We've gathered everyone because we must decide: What happens to the Peacekeepers?*
...
##### Read Aloud:
{{description,note
*You accept. The peace needs guardians. You'll be those guardians. For as long as you live.*

*Years pass. Decades. You mediate disputes. Prevent wars. Train new generations. You become myths. Living legends who never stop.*

*Some of you marry. Have families. Grow old. But the duty never ends. Every generation has new conflicts. New threats. And you're there. Always.*

*Eventually, one by one, you fall. Age. Battle. Sacrifice. But each time, the survivors carry on. Until the last Peacekeeper dies, ancient and tired, having served for 50+ years.*
...
##### Read Aloud:
{{description,note
*You accept the compromise. You'll create the Peacekeeper Academy. Train the next generation. Build an institution that outlives you.*
...
##### Read Aloud:
{{description,note
*You decline. "The peace should stand on its own. If it requires us forever, it's not real peace. It's dependency."*
...
*You walk away. The role of Peacekeeper ends with you. The kingdoms must learn to maintain peace themselves.*
}}
...
**Regardless of ending chosen, each PC gets personalized conclusion:**

### **Epilogue Scene For Each Pc**

**DM asks each player:**

1. "How does [PC name] spend their final years?"
2. "What's their greatest personal achievement post-campaign?"
3. "How are they remembered?"
4. "When/how do they die?" (if desired)

**Narrate based on their choices throughout campaign:**
...
##### Read Aloud:
{{description,note
*Twenty years later. You gather at memorial site (statue of yourselves, or Academy, or battleground). Most of you are alive. Some aren't. Some came as ghosts to see friends one more time.*
...
*You drink. You remember. You laugh about old fights. Cry about fallen friends. Wonder at what you built.*
...
##### Read Aloud (Final Words):
{{description,note
*Years from now, long after you're gone, people will ask: "Were the Peacekeepers real? Or legend?"*

*The answer is: Both. You were real people who became legends. Flawed individuals who achieved the impossible.*

*You stopped a war. You prevented an apocalypse. You defeated a lich. You united kingdoms. You brought peace to a world that had forgotten how.*

*Not because you were chosen. Not because you were pure. Not because you were perfect.*
...
**New campaign, 20 years later:**
- Play as your PCs' children/students
- Inherit legacy
- Face new threats
...
- What if you joined Thaldros from start?
- What if you helped Corvus?
...
*Medium humanoid (human), neutral evil*
___
**Armor Class** :: 15 (glamoured leather)
**Hit Points** :: 58 (13d8)
**Speed** :: 30 ft.
___
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|10 (+0)|16 (+3)|11 (+0)|14 (+2)|13 (+1)|18 (+4)|
___
...
***Charm Person.*** DC 14 Wis save.

***Suggestion (1/Day).*** DC 14 Wis save.
}}
...
***Warhammer.*** *Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 8 (1d8 + 4) bludgeoning damage, or 9 (1d10 + 4) if used with two hands.
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|14 (+2)|18 (+4)|14 (+2)|13 (+1)|12 (+1)|16 (+3)|
___
**Saving Throws** :: Dex +7, Cha +6
**Skills** :: Acrobatics +7, Deception +6, Stealth +10
**Senses** :: Passive Perception 11
**Languages** :: Common, Thieves' Cant
**Challenge** :: 6 (2,300 XP)
___
...
***Shortsword.*** *Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 7 (1d6 + 4) piercing damage plus 14 (4d6) sneak attack if conditions met.
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|9 (-1)|12 (+1)|10 (+0)|16 (+3)|14 (+2)|17 (+3)|
___
**Saving Throws** :: Wis +4, Cha +5
**Skills** :: History +5, Insight +6, Persuasion +7
**Senses** :: Passive Perception 12
**Languages** :: Common, Elvish, Dwarvish
**Challenge** :: 2 (450 XP)
___
***Noble Influence.*** Can call upon guards, servants, and social connections.
### Actions
***Dagger.*** *Melee or Ranged Weapon Attack:* +3 to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* 3 (1d4 + 1) piercing damage.

***Command (3/Day).*** DC 13 Wis save.
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|14 (+2)|19 (+4)|16 (+3)|13 (+1)|15 (+2)|16 (+3)|
___
**Saving Throws** :: Dex +7, Wis +5
**Skills** :: Athletics +5, Perception +8, Stealth +10, Survival +8
**Senses** :: Passive Perception 18
**Languages** :: Common, Sylvan
**Challenge** :: 7 (2,900 XP)
___
***Legendary Guerrilla.*** Advantage on initiative, can't be surprised.

***Sneak Attack.*** +5d6 when has advantage.

***Action Surge.*** Extra action 1/short rest.
### Actions
***Multiattack.*** Three attacks (longbow or shortsword).

***Longbow +2.*** *Ranged Weapon Attack:* +9 to hit, range 150/600 ft., one target. *Hit:* 10 (1d8 + 6) piercing damage plus 17 (5d6) sneak attack if conditions met.

***Shortsword +1.*** *Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 8 (1d6 + 5) piercing damage.

***Smoke Bomb (3/Day).*** 20-ft radius becomes heavily obscured for 1 minute.
### Legendary Actions
Red Wolf can take 3 legendary actions:
...
___
### Actions
***Multiattack.*** Two longsword attacks or one longsword + shield bash.
...
***Shield Bash.*** *Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 5 (1d4 + 3) bludgeoning damage, and the target must succeed on a DC 14 Strength save or be knocked prone.
...
*Medium humanoid (human), lawful evil*
___
**Armor Class** :: 15 (glamoured chain shirt)
**Hit Points** :: 66 (12d8 + 12)
**Speed** :: 30 ft.
___
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|12 (+1)|14 (+2)|13 (+1)|16 (+3)|12 (+1)|17 (+3)|
___
...
**Challenge** :: 4 (1,100 XP)
___
***Political Connections.*** Can call upon guards and allies.

***Blackmail.*** Knows secrets, can use as leverage.
### Actions
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|10 (+0)|19 (+4)|13 (+1)|14 (+2)|12 (+1)|11 (+0)|
___
**Saving Throws** :: Dex +7, Int +5
**Skills** :: Acrobatics +7, Perception +4, Sleight of Hand +10, Stealth +10
**Senses** :: Passive Perception 14
...
***Halfling Luck.*** Reroll 1s on attack rolls, ability checks, and saving throws.
### Actions
***Multiattack.*** Two shortsword attacks.

***Shortsword.*** *Melee Weapon Attack:* +7 to hit, reach 5 ft., one target. *Hit:* 7 (1d6 + 4) piercing damage plus 14 (4d6) sneak attack if conditions met.

***Hand Crossbow.*** *Ranged Weapon Attack:* +7 to hit, range 30/120 ft., one target. *Hit:* 7 (1d6 + 4) piercing damage, with poison option.
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|10 (+0)|12 (+1)|13 (+1)|18 (+4)|17 (+3)|15 (+2)|
___
**Saving Throws** :: Int +7, Wis +6
**Skills** :: History +10, Insight +9, Investigation +10, Persuasion +5
**Senses** :: Passive Perception 13
**Languages** :: Common, Dwarvish, Elvish, Draconic
**Challenge** :: 5 (1,800 XP)
___
***Legal Authority.*** Can imprison, fine, or execute within jurisdiction.
### Spellcasting (7th-level Wizard)
- **Cantrips:** *mage hand, message, prestidigitation*
- **1st (4 slots):** *detect magic, identify, shield*
- **2nd (3 slots):** *detect thoughts, zone of truth*
- **3rd (3 slots):** *counterspell, dispel magic, tongues*
...
***Rhetorical Master.*** Can impose disadvantage on opponent's Persuasion checks.
### Actions
***Dagger.*** *Melee or Ranged Weapon Attack:* +3 to hit, reach 5 ft. or range 20/60 ft., one target. *Hit:* 3 (1d4 + 1) piercing damage.

***Suggestion (3/Day).*** DC 14 Wis save.
...
{{monster,frame,wide
## Commander Helena Dawnblade (Appendix)
*Medium humanoid (human), lawful neutral*
___
...
**Challenge** :: 10 (5,900 XP)
___
***Aura of Protection.*** Allies within 10 ft. gain +3 to saves.

***Divine Smite.*** Extra 5d8 radiant on hit (spell slots).

***Lay on Hands.*** 80 HP pool for healing.

***Indomitable.*** Reroll failed save (2/day).
### Spellcasting (13th-level Paladin)
- **1st (4 slots):** *command, cure wounds, heroism, shield of faith*
- **2nd (3 slots):** *aid, lesser restoration, zone of truth*
- **3rd (3 slots):** *aura of vitality, crusader's mantle, dispel magic*
- **4th (1 slot):** *death ward*
### Actions
***Multiattack.*** Three longsword attacks.

***Longsword +3.*** *Melee Weapon Attack:* +11 to hit, reach 5 ft., one target. *Hit:* 11 (1d8 + 7) slashing damage, or 12 (1d10 + 7) if used with two hands, plus 22 (5d8) radiant damage on smite.

***Sacred Weapon (1/Short Rest).*** Weapon glows, +3 to hit for 1 minute.
### Legendary Actions
Dawnblade can take 3 legendary actions:

***Move.*** Move without provoking.
...
___
**Saving Throws** :: Int +6, Wis +5, Cha +7
**Skills** :: History +6, Insight +8, Persuasion +10
**Senses** :: Passive Perception 12
**Languages** :: Common, Elvish, Dwarvish
**Challenge** :: 6 (2,300 XP)
___
***Inspiring Leader.*** Can grant 15 temp HP to 6 creatures (1/short rest).

***Political Influence.*** Can call upon Republican resources.
### Spellcasting (9th-level Bard)
- **Cantrips:** *mage hand, message, vicious mockery*
- **1st (4 slots):** *charm person, cure wounds, heroism, thunderwave*
- **2nd (3 slots):** *calm emotions, hold person, suggestion*
- **3rd (3 slots):** *hypnotic pattern, mass healing word, tongues*
- **4th (3 slots):** *compulsion, freedom of movement*
- **5th (1 slot):** *mass cure wounds*
### Actions
***Rapier.*** *Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 6 (1d8 + 2) piercing damage.

***Bardic Inspiration (4/Short Rest).*** Grant d10 bonus to rolls.
}}
...
**Challenge** :: 9 (5,000 XP)
___
***Arcane Recovery (1/Day).*** Recovers spell slots during short rest (up to 9 levels).

***Portent (3/Day).*** Replaces any roll with pre-rolled d20.

***Spell Mastery.*** Casts *detect magic* and *mage armor* at will.

***Ancient Artifact.*** Carries World-Splitter Component #1.
### Actions
***Quarterstaff.*** +5 to hit, 1d6 bludgeoning.
### Spellcasting
DC 18, +10 to hit. Has access to 9th-level spells including *wish*.
}}

**Role:** Unbound leader, major antagonist  
**Location:** Hidden sanctum

**Component Variants:**
- **CR 9:** Base form (1 Component)
...
**Skills** :: Athletics +7, History +4, Insight +5, Intimidation +5, Perception +5
**Senses** :: Passive Perception 15
**Languages** :: Common, Dwarvish
**Challenge** :: 7 (2,900 XP)
___
***Battle Veteran.*** Advantage on saves vs fear.

***Action Surge.*** Extra action (1/short rest).

***Second Wind.*** Heal 1d10+14 (1/short rest).
### Actions
***Multiattack.*** Three longsword attacks or two attacks + tactical command.

***Longsword +1.*** *Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 9 (1d8 + 5) slashing damage, or 10 (1d10 + 5) if used with two hands.

***Heavy Crossbow.*** *Ranged Weapon Attack:* +4 to hit, range 100/400 ft., one target. *Hit:* 6 (1d10 + 1) piercing damage.

***Commander's Strike.*** Ally makes weapon attack as reaction.
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|12 (+1)|16 (+3)|14 (+2)|14 (+2)|13 (+1)|15 (+2)|
___
**Saving Throws** :: Dex +5, Int +4
**Skills** :: Deception +6, Insight +5, Investigation +4, Perception +5, Stealth +7
**Senses** :: Passive Perception 15
**Languages** :: Common, Dwarvish, Elvish
**Challenge** :: 3 (700 XP)
___
...
**Challenge** :: 4 (1,100 XP)
___
### Spellcasting (5th-level Wizard)
- **Cantrips:** *fire bolt, mage hand, minor illusion, prestidigitation*
- **1st (4 slots):** *detect magic, mage armor, shield, thunderwave*
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|11 (+0)|18 (+4)|14 (+2)|13 (+1)|12 (+1)|10 (+0)|
___
**Saving Throws** :: Dex +7, Int +4
**Skills** :: Acrobatics +10, Perception +4, Sleight of Hand +10, Stealth +10
**Senses** :: Passive Perception 14
**Languages** :: Common, Thieves' Cant
...
***Assassinate.*** Advantage on attacks vs creatures that haven't acted, surprise attacks are crits.

***Evasion.*** No damage on successful Dex save, half on failure.
### Actions
***Multiattack.*** Two shortsword attacks.

***Shortsword.*** *Melee Weapon Attack:* +8 to hit, reach 5 ft., one target. *Hit:* 8 (1d6 + 5) piercing damage plus 14 (4d6) sneak attack if conditions met.
...
**Challenge** :: 7 (2,900 XP)
___
***Divine Eminence.*** +3 damage to cleric spells.
### Spellcasting (9th-level Cleric)
- **Cantrips:** *sacred flame, thaumaturgy, toll the dead*
- **1st (4 slots):** *cure wounds, guiding bolt, shield of faith*
- **2nd (3 slots):** *hold person, spiritual weapon*
- **3rd (3 slots):** *dispel magic, spirit guardians*
- **4th (3 slots):** *banishment, guardian of faith*
- **5th (1 slot):** *flame strike*
### Actions
...
***Antimagic Vulnerability.*** *Dispel magic* (DC 19) shuts it down for 1 minute.
### Actions
***Multiattack.*** Two slams OR one slam + force beam.

***Slam.*** *Melee Weapon Attack:* +11 to hit, reach 10 ft., one target. *Hit:* 25 (4d8 + 7) bludgeoning damage.

***Force Beam.*** *Ranged Spell Attack:* +11 to hit, range 120 ft., one target. *Hit:* 27 (6d8) force damage, and the target must succeed on a DC 17 Strength save or be pushed 20 feet.

***Alarm (Recharge 5-6).*** Sounds vault-wide alarm, 20 guards arrive in 5 rounds.

***Vault Lockdown (1/Day).*** Seals all exits for 10 minutes, no teleportation within vault.
}}
...
**Hit Points** :: 135 (18d8 + 54)
**Speed** :: 40 ft.
![Elise Thornwood](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/all_artwork/npcs/bc-elise-thornwood-reaper.jpg){width:270px}
___
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|14 (+2)|20 (+5)|16 (+3)|14 (+2)|15 (+2)|12 (+1)|
...
***Sneak Attack.*** +5d6 damage when has advantage.

***Action Surge.*** Extra action (Recharge after short rest).
### Actions
***Multiattack.*** Three scimitar or longbow attacks.

***Scimitar +2.*** *Melee Weapon Attack:* +11 to hit, reach 5 ft., one target. *Hit:* 10 (1d6 + 7) slashing damage plus 17 (5d6) sneak attack if conditions met.

***Longbow +1.*** *Ranged Weapon Attack:* +10 to hit, range 150/600 ft., one target. *Hit:* 10 (1d8 + 6) piercing damage plus 17 (5d6) sneak attack if conditions met.

***Shadow Step (Recharge 5-6).*** Bonus action, teleport 60 ft. to dim light/darkness.
}}
{{pageNumber,auto}}
\page

**Role:** Red Wolf's sister, Cell Beta leader  
**Location:** Thornwood Ruins

**Personality:**
- Seeks revenge if PCs killed Red Wolf
- Nihilistic if PCs helped Red Wolf (sister still lost)
...
**Armor Class** :: 17 (20 with *mage armor*)
**Hit Points** :: 157 (21d8 + 63)
**Speed** :: 30 ft., fly 30 ft. (Component fragment)
___
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|10 (+0)|16 (+3)|16 (+3)|20 (+5)|16 (+3)|18 (+4)|
...
***Legendary Resistance (2/Day).*** Choose to succeed on failed save.
### Spellcasting (17th-level Wizard)
- **At will:** *detect magic, mage hand, prestidigitation, shocking grasp*
- **3/day each:** *counterspell, dispel magic, fireball, fly, greater invisibility*
- **1/day each:** *chain lightning, disintegrate, forcecage, plane shift*
### Actions
...
***Reality Beam.*** *Ranged Spell Attack:* +10 to hit, range 120 ft., one target. *Hit:* 22 (5d8) force damage, and target must make DC 18 Wis save or be stunned until end of her next turn.

***Reshape Minor Reality (Recharge 5-6).*** 30-ft. cube, terrain transforms as desired, lasts 1 minute.

***Component Pulse (1/Day).*** 60-ft. radius, DC 18 Con save, 8d8 psychic damage + paralyzed 1 minute (save ends at end of each turn).
### Legendary Actions
The Prophet can take 2 legendary actions:

***Teleport.*** Teleport up to 60 feet.

***Cast Cantrip.*** Cast cantrip.

***Reality Warp (Costs 2).*** Use Reshape Minor Reality if available.
}}
...
***Rejuvenation.*** Reforms in phylactery after 1d10 days unless phylactery destroyed.

***Turn Resistance.*** Advantage on saves vs Turn Undead.

***Phylactery.*** Crown (in Frozen Kingdom throne room).
### Spellcasting (20th-level Wizard)
- **Cantrips (at will):** *mage hand, prestidigitation, ray of frost, chill touch*
- **1st (at will):** *detect magic, magic missile, shield*
- **2nd (at will):** *detect thoughts, mirror image, misty step*
...
- **6th (3 slots):** *circle of death, disintegrate, globe of invulnerability*
- **7th (3 slots):** *finger of death, plane shift, teleport*
- **8th (2 slots):** *dominate monster, power word stun*
- **9th (2 slots):** *power word kill, time stop*
### Actions
***Paralyzing Touch.*** *Melee Spell Attack:* +13 to hit, reach 5 ft., one target. *Hit:* 14 (3d6 + 4) cold damage, and the target must succeed on a DC 19 Con save or be paralyzed for 1 minute (save ends at end of each turn).

***Necrotic Bolt.*** *Ranged Spell Attack:* +13 to hit, range 120 ft., one target. *Hit:* 36 (8d8) necrotic damage.
### Legendary Actions
The Dread King can take 3 legendary actions:

***Cast Cantrip.*** Cast a cantrip.

***Paralyzing Touch (Costs 2).*** Make a Paralyzing Touch attack.

***Animate Dead (Costs 2).*** Raise 2d4 skeletons from nearby corpses.
...
**Hit Points** :: 150 (20d8 + 60) each
**Speed** :: 30 ft.
___
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|10 (+0)|14 (+2)|16 (+3)|20 (+5)|15 (+2)|14 (+2)|
___
**Saving Throws** :: Int +10, Wis +7
**Skills** :: Arcana +15, History +10
...
**Challenge** :: 12 (8,400 XP)
___
### Spellcasting (15th-level Wizard, Necromancy)
- **At will:** *ray of frost, chill touch*
- **3/day:** *animate dead, blight, dimension door*
- **2/day:** *circle of death, cloudkill*
- **1/day:** *finger of death, power word pain*
### Actions
***Necrotic Touch.*** *Melee Spell Attack:* +10 to hit, reach 5 ft., one target. *Hit:* 18 (4d8) necrotic damage.

***Ray of Frost.*** *Ranged Spell Attack:* +10 to hit, range 60 ft., one target. *Hit:* 18 (4d8) cold damage, and the target's speed is reduced by 10 feet until the start of the lord's next turn.
### Legendary Actions
Each Necromancer Lord can take 2 legendary actions:

***Cast Cantrip.*** Cast a cantrip.

***Animate Dead.*** Raise 1d4 zombies from nearby corpses.

***Necrotic Burst (Costs 2).*** 20-ft. radius, 3d8 necrotic damage, DC 17 Con save for half.
}}
...
**Properties:** ::
- Constitution becomes 19 (if lower)
- Advantage on Constitution saves vs poison

**Lore:** Simple but powerful. Royal Vault. ::
...
**Properties:** ::
- Strength becomes 23
- Can lift/carry as if Huge creature

**Lore:** Makes wearer incredibly strong. Royal Vault. ::
...
### **World-Splitter Component #5**
*Artifact (fragment), artifact*

**Properties:** Same as Component #1 but: ::
- Grants +2 to Charisma
...
**DM Note:** Along with Component #4 (carried by King Aldric IV), this represents the final pieces Corvus needs. Players can obtain both during the battle chaos in Quest 2.5, or prevent Corvus from ever completing the set.

## Act III Items

## Quest 3.2: The Underground

### **Elise'S Scimitars OF Vengeance**
*Weapon (scimitar), rare (requires attunement), pair*

**Damage:** 1d6 + 2 slashing each   ::
**Properties:** Finesse, light, +2 ::

**Paired Fighting:** When dual-wielding these scimitars, gain +1 AC. ::

**Vengeance Strike:** Once per turn, if you hit same creature with both scimitars, deal additional 2d6 psychic damage  ::(represents rage).

**Lore:** Elise Thornwood's weapons. Forged after Red Wolf's capture/death. Each strike channels her fury. ::

**Location:** Wielded by Elise "The Reaper" Thornwood ::

**Value:** 4,000gp (pair) ::

### **component fragment** (from Prophet's defeat)
...
**Lore:** Broken piece of Component. Less powerful than full Component but still dangerous. ::

**Location:** Recovered after defeating The Prophet ::

**Value:** 15,000gp (dangerous to possess) ::
{{pageNumber,auto}}
\page
...
- +3 to spell attack rolls and save DC
- **Necrotic Mastery:** Necromancy spells deal extra 2d8 necrotic damage
- **Animate Legion (1/Day):** Cast *animate dead* at 9th level (creates 16 undead)
- **Death's Touch:** Melee attack +10 to hit, 4d6 + 4 necrotic damage

**Curse:** Each use of Animate Legion requires DC 17 Wisdom save or gain 1 level of exhaustion (necrotic corruption). ::

**Lore:** The Dread King's personal staff. Carved from darkwood, capped with obsidian skull. Radiates necromantic power. ::

**Location:** Wielded by The Dread King, obtained after his first defeat ::

**Value:** 65,000gp (if anyone would buy cursed lich artifact) ::

### **Necromancer Lord'S Robes**
*Wondrous item, rare (requires attunement by spellcaster)*

**AC:** 13 + Dex modifier   ::
**Properties:** ::
- +1 to spell attack rolls and save DC for necromancy spells
- Resistance to necrotic damage
- Can cast *speak with dead* (1/day)

**Lore:** Worn by Dread King's lieutenants. Each robe is stitched from burial shrouds. ::

**Location:** Looted from defeated Necromancer Lords ::
...
*Artifact, artifact (cursed)*

**Do Not Wear** ::

**Properties:** ::
- +4 to Intelligence, Wisdom, and Charisma
- Can cast *detect thoughts* at will
- Can cast *dominate person* (DC 19, 3/day)
- **Immortality:** Wearer does not age

**Curse:** Wearing crown begins transformation into lich. Takes 1 year. Process is irreversible after 1 month. Wearer's alignment shifts to evil. ::

**Special:** This IS The Dread King's phylactery. While intact, he reforms after death. Must be destroyed to kill him permanently. ::

**Destruction:** Can only be destroyed by: ::
1. Dealing 100 damage (resist all but radiant/force)
2. Casting *disintegrate* successfully
3. Throwing into volcano or similar

**Lore:** The Dread King's crown IS his phylactery. He wears his own soul-prison, ensuring it's always with him. ::

**Location:** On The Dread King's head, even when "dead" ::

**Value:** Priceless but too dangerous to use ::

**DM Note:** If PCs wear this, it's a campaign-ending mistake. Warn them clearly. ::
...
- Resistance to cold damage
- Immunity to exhaustion from cold environments
- **Frost Blast (1/day):** Cast *cone of cold* (save DC 16)

**Lore:** Crystalline heart from Ice Golem. Radiates constant cold. ::

**Location:** Harvested from defeated Ice Golems ::

**Value:** 3,500gp ::

### **Frozen Kingdom Treasures** (various)

**Ancient Gold Coins** ::
- Value: 5,000gp total
- Historical artifacts, worth more to collectors

**Frost-Touched Longsword** ::
- Weapon (longsword), uncommon
- +1 weapon
- Deals additional 1d4 cold damage
- Value: 750gp

**Ring of Warmth** ::
- Ring, uncommon
- Immunity to cold weather
- Resistance to cold damage
- Value: 1,000gp

**Cloak of the Frozen Wastes** ::
- Wondrous item, rare
- Advantage on saves vs cold effects
- Can cast *ice storm* (1/day, DC 15)
- Value: 2,800gp
{{pageNumber,auto}}
\page
...
### **Peacekeepers' Badges**
*Wondrous item, rare (non-transferable)*

**Properties:** ::
- Symbol of office
- Grants authority in both kingdoms
- +2 to Charisma (Persuasion) with officials
- Can request aid from either kingdom's forces

**Lore:** Given to PCs as official Peacekeepers. Recognized throughout United Realm. ::

**Location:** Awarded at end of campaign ::

**Value:** Priceless (cannot be sold, personal honor) ::

### **Monument Coins**
*Wondrous item, uncommon*

**Properties:** ::
- Commemorative coins with PCs' faces
- Collectors' items
- Each worth 100gp

**Lore:** Minted to honor the Peacekeepers. Sold throughout kingdom. PCs are literally on currency. ::

**Location:** Given as gifts at campaign end ::

**Value:** 100gp each (but sentimental value higher) ::
...
**Common:** ::
- None (campaign features above-common items)

**Uncommon (750-1,500Gp):** ::
- Elise's Glamoured Leather (350gp)
- Marcus's Family Shield (400gp)
- Ring of Shadows (750gp)
- Lord Pembroke's Signet Ring (1,200gp)
- The Black Ledger (500gp object)
- Frost-Touched Longsword (750gp)
- Ring of Warmth (1,000gp)
- Monument Coins (100gp)

**Rare (1,500-6,000Gp):** ::
- Kael's Poisoned Blades (2,500gp)
- Cloak of the Thornwood (3,500gp)
- Magistrate's Robes of Office (4,000gp)
- Valen's Pendant (3,000gp)
- General Thorne's Plate +1 (2,500gp)
- Infiltrator's Cloak (3,200gp)
- Ring of Spell Storing (6,000gp)
- Amulet of Health (8,000gp)
- Elise's Scimitars (4,000gp pair)
- Necromancer Lord's Robes (4,000gp)
- Ice Golem Heart (3,500gp)
- Cloak of Frozen Wastes (2,800gp)
- Peacekeepers' Badges (priceless)

**Very Rare (6,000-40,000Gp):** ::
- Red Wolf's Longbow (8,000gp)
- Defender Longsword (24,000gp)
- Staff of Power (40,000gp)
- Belt of Giant Strength (10,000gp)

**Legendary (40,000+Gp):** ::
- Dawnblade's Longsword (45,000gp)
- Crown Jewels Set (50,000gp)
- Cloak of Invisibility (75,000gp)
- The Dread King's Staff (65,000gp)

**Artifacts:** ::
- World-Splitter Components (incalculable)
- The Dread Crown (priceless, cursed)
- Scales of Justice (unobtainable)
- Component Fragment (15,000gp)

## Cursed Items

**Minor Curses:** ::
- Lord Pembroke's Signet Ring (arrogance)

**Major Curses:** ::
- The Dread Crown (lich transformation - LETHAL)
- World-Splitter Components (madness/corruption)
- Component Fragment (paranoia)
- Dread King's Staff (exhaustion)

## DM Notes

### **Item Balance:**

All items are within standard D&D 5e power levels for their rarity. Nothing game-breaking except intentionally dangerous artifacts.

### **Artifact Warnings:**

- **World-Splitter Components:** Campaign plot items, extremely dangerous
- **The Dread Crown:** Will turn PC into lich, warn players clearly
- **Dread King's Staff:** Cursed, but usable with caution

### **Treasure Philosophy:**

Items support campaign themes:
- Act I: Survival tools
- Act II: Power symbols
- Act III: Legend-tier rewards
{{pageNumber,auto}}
\page
...
**These are from Monster Manual, used throughout campaign:**

**CR 0:** Commoner (refugees, civilians)  
**CR 1/8:** Guard, Cultist, Bandit, Zombie, Thaldros Soldiers  
**CR 1/4:** Acolyte, Scout, Skeleton  
**CR 1/2:** Thug, Scout (experienced), Wight (lesser)  
**CR 1:** Spy, Specter  
**CR 2:** Cult Fanatic, Priest (lesser)  
**CR 3:** Knight, Veteran, Wight  
**CR 5:** Wraith  

**Used as-is from SRD, no modifications needed**
...
___
***Pack Tactics.*** Advantage on attacks vs creature if ally within 5 ft.
### Actions
...
**Role:** Elise Consortium's muscle  
**Encountered:** 6-10 at a time (Quest 1.1)

{{monster,frame
## Black Chains Assassins
*Medium humanoid (human), lawful evil*
___
...
**Challenge** :: 3 (700 XP)
___
***Sneak Attack (1/Turn).*** +2d6 damage when has advantage.

***Cunning Action.*** Bonus action Dash, Disengage, or Hide.
### Actions
***Multiattack.*** Two shortsword attacks.

***Shortsword.*** *Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 6 (1d6 + 3) piercing damage plus 7 (2d6) sneak attack if conditions met.

***Hand Crossbow.*** *Ranged Weapon Attack:* +5 to hit, range 30/120 ft., one target. *Hit:* 6 (1d6 + 3) piercing damage, and the target must succeed on a DC 12 Con save or take 7 (2d6) poison damage.
}}

**Role:** Kael's elite killers  
**Encountered:** 2-4 at a time (Quest 1.2)
...
**Challenge** :: 2 (450 XP)
___
***Forest Camouflage.*** Advantage on Stealth in forest terrain.

***Guerrilla Tactics.*** Can take Hide action as bonus action in natural terrain.
### Actions
...
**Role:** Red Wolf's guerrilla fighters  
**Encountered:** 8-12 with Red Wolf (Quest 1.3)
{{pageNumber,auto}}
\page
...
**Challenge** :: 3 (700 XP)
___
***Formation Fighting.*** +2 AC when adjacent to ally with shield.
### Actions
***Longsword.*** *Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 7 (1d8 + 3) slashing damage.

***Heavy Crossbow.*** *Ranged Weapon Attack:* +2 to hit, range 100/400 ft., one target. *Hit:* 5 (1d10) piercing damage.

***Shield Bash.*** *Melee Weapon Attack:* +5 to hit, reach 5 ft., one target. *Hit:* 5 (1d4 + 3) bludgeoning damage, and the target must succeed on a DC 13 Strength save or be knocked prone.
}}

**Role:** Kingdom's best soldiers  
**Encountered:** 6-12 at a time (Quest 1.3, 1.5)

{{monster,frame
## Pembroke's Guard Dogs
...
**Challenge** :: 1/4 (50 XP)
___
***Keen Hearing and Smell.*** Advantage on Perception using hearing/smell.

***Pack Tactics.*** Advantage on attacks if ally within 5 ft.
### Actions
***Bite.*** *Melee Weapon Attack:* +3 to hit, reach 5 ft., one target. *Hit:* 4 (1d6 + 1) piercing damage, and the target must succeed on a DC 11 Strength save or be knocked prone.
}}

**Role:** Estate security  
**Encountered:** 4-6 dogs (Quest 1.4)
...
{{monster,frame
## Unbound Cultists
*Medium humanoid (various), chaotic neutral/evil*
___
...
***Sacrificial Strike.*** If reduced to 0 HP, can make one final attack as reaction.
}}

**Role:** Corvus's followers  
**Encountered:** Groups of 10-30 (Quests 2.1-2.5, Act III)
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|14 (+2)|14 (+2)|12 (+1)|10 (+0)|14 (+2)|13 (+1)|
___
**Skills** :: Insight +4, Persuasion +3, Religion +2
**Senses** :: Passive Perception 12
**Languages** :: Common
**Challenge** :: 2 (450 XP)
___
***Dark Devotion.*** Advantage on saves vs charm and fear.

***Fanatic Fervor.*** Critical hits on 19-20.
### Spellcasting (4th-level Cleric)
- **Cantrips:** *sacred flame, thaumaturgy*
- **1st (4 slots):** *command, inflict wounds*
- **2nd (3 slots):** *hold person, spiritual weapon*
### Actions
...
***Sacred Flame.*** DC 12 Dex save, 1d8 radiant damage on failed save.
}}

**Role:** Elite Unbound fighters  
**Encountered:** 2-6 with cultist groups (Quest 2.2, 2.4, Act III)
{{pageNumber,auto}}
\page

{{monster,frame
## Thaldros Heavy Infantry
*Medium humanoid (human), lawful neutral*
___
...
**Challenge** :: 1/2 (100 XP)
___
***Formation Fighting.*** +1 AC when in formation (3+ adjacent allies).
### Actions
...
**Role:** Kingdom's soldiers  
**Encountered:** Large groups (20-100) (Quest 2.5, Act III)
...
**Challenge** :: 1/8 (25 XP)
___
***Citizen Soldiers.*** Poorly trained, -2 to hit if isolated from allies.
### Actions
***Spear.*** *Melee Weapon Attack:* +3 to hit, reach 5 ft., one target. *Hit:* 4 (1d6 + 1) piercing damage, or 5 (1d8 + 1) if used with two hands.
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|11 (+0)|15 (+2)|12 (+1)|12 (+1)|14 (+2)|10 (+0)|
___
**Skills** :: Nature +3, Perception +4, Stealth +4, Survival +4
**Senses** :: Passive Perception 14
**Languages** :: Common
**Challenge** :: 1/2 (100 XP)
___
***Keen Sight.*** Advantage on Perception using sight.
### Actions
***Shortsword.*** *Melee Weapon Attack:* +4 to hit, reach 5 ft., one target. *Hit:* 5 (1d6 + 2) piercing damage.
...
**Role:** Cell Beta reconnaissance  
**Encountered:** Patrols of 4-6 (Quest 3.2)

---

{{monster,frame
## Unbound Assassins
*Medium humanoid (various), neutral evil*
___
**Armor Class** :: 15 (studded leather)
**Hit Points** :: 78 (12d8 + 24)
**Speed** :: 30 ft.
...
**Challenge** :: 5 (1,800 XP)
___
***Assassinate.*** Advantage on attacks vs creatures that haven't acted, surprise attacks auto-crit.

***Sneak Attack.*** +3d6 when has advantage.

***Evasion.*** No damage on successful Dex save.
### Actions
***Multiattack.*** Two shortsword attacks.

***Shortsword.*** *Melee Weapon Attack:* +6 to hit, reach 5 ft., one target. *Hit:* 6 (1d6 + 3) piercing damage plus 10 (3d6) sneak attack if conditions met.

***Light Crossbow.*** *Ranged Weapon Attack:* +6 to hit, range 80/320 ft., one target. *Hit:* 7 (1d8 + 3) piercing damage, and the target must succeed on a DC 14 Con save or take 10 (3d6) poison damage.
}}

**Role:** Elite killers  
**Encountered:** Teams of 2-4 (Quest 3.2, 3.3)
{{pageNumber,auto}}
\page

{{monster,frame
## Unbound High Priests
*Medium humanoid (human), chaotic evil*
___
**Armor Class** :: 14 (robes of protection)
...
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|12 (+1)|12 (+1)|14 (+2)|13 (+1)|18 (+4)|14 (+2)|
___
**Saving Throws** :: Wis +7, Cha +5
**Skills** :: Insight +7, Religion +4
**Senses** :: Passive Perception 14
**Languages** :: Common
**Challenge** :: 5 (1,800 XP)
___
***Divine Eminence.*** +4 to cleric spell damage.
### Spellcasting (9th-level Cleric)
- **Cantrips:** *sacred flame, spare the dying, thaumaturgy*
- **1st (4 slots):** *cure wounds, inflict wounds, shield of faith*
- **2nd (3 slots):** *hold person, spiritual weapon*
- **3rd (3 slots):** *bestow curse, spirit guardians*
- **4th (3 slots):** *banishment, guardian of faith*
- **5th (1 slot):** *flame strike*
### Actions
...
**Role:** Cell Gamma leadership  
**Encountered:** 6 protecting The Prophet (Quest 3.2)

## Undead Creatures (Act III)

### **Zombies** (Quest 3.3, 3.4)
*Medium undead, unaligned*

**Role:** Dreadhost basic troops  ::
**Challenge:** 1/4 (50 XP)   ::
**Encountered:** Hundreds ::

**Stats:** Use Zombie  ::

**Special:** Part of The Dread King's horde, all collapse when he's permanently destroyed ::


### **skeleton warriors** (Quest 3.3, 3.4)
*Medium undead, lawful evil*

**Role:** Dreadhost warriors   ::
**Challenge:** 1/4 (50 XP)   ::
**Encountered:** Hundreds ::

**Stats:** Use Skeleton ::

**Special:** More organized than zombies, fight in formation ::

### **Wights** (Quest 3.3, 3.4)
*Medium undead, neutral evil*

**Role:** Dreadhost officers   ::
**Challenge:** 3 (700 XP)   ::
**Encountered:** Squads of 2-8 commanding zombies ::

**Stats:** Use Wight ::

**Special:** Command zombie units ::

### **Wraiths** (Quest 3.4)
*Medium undead, neutral evil*

**Role:** Frozen Kingdom guardians   ::
**Challenge:** 5 (1,800 XP)   ::
**Encountered:** Pack of 6 ::

**Stats:** Use Wraith ::

**Special:** Former soldiers from ancient battle, might be negotiated with (hate Dread King) ::

{{monster,frame
## Skeleton Champions
*Medium undead, lawful evil*
___
**Armor Class** :: 16 (ancient plate armor)
**Hit Points** :: 58 (9d8 + 18)
**Speed** :: 30 ft.
___
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
...
**Challenge** :: 3 (700 XP)
___
***Undead Fortitude.*** If damage reduces to 0 HP, make DC 5+damage Con save, succeed = 1 HP instead.
### Actions
***Multiattack.*** Two longsword attacks.
...
**Role:** Dread King's personal guard  
**Encountered:** 6 guarding throne room (Quest 3.4)
{{pageNumber,auto}}
\page
...
___
**Damage Immunities** :: cold, poison, psychic; bludgeoning, piercing, slashing from nonmagical attacks not made with adamantine
**Condition Immunities** :: charmed, exhaustion, frightened, paralyzed, petrified, poisoned
...
***Cold Aura.*** Creatures starting turn within 10 ft. take 2d6 cold damage.
### Actions
***Multiattack.*** Two slam attacks.

***Ice Slam.*** *Melee Weapon Attack:* +10 to hit, reach 5 ft., one target. *Hit:* 19 (3d8 + 6) bludgeoning damage plus 7 (2d6) cold damage.

***Cold Breath (Recharge 5-6).*** 30-ft. cone. DC 17 Con save, 45 (10d8) cold damage (half on success).
}}

**Role:** Frozen Kingdom guardians  
**Encountered:** 4 summoned by Dread King (Quest 3.3, 3.4)

## Special Encounters

### **dreadhost army** (Quest 3.3)
*Mass combat abstraction*

**Initial Composition:** ::
- 10,000+ Zombies (CR 1/4)
- 600 Skeleton Warriors (CR 1/4)
- 50 Wights (CR 3)
- 6 Necromancer Lords (CR 12)
- The Dread King (CR 18)

**After each battle:** Grows by raising fallen enemies ::

**Tactics:** Mindless waves, necromancers raise dead, Dread King commands from rear ::

\column

## Quick Reference BY CR
:
**CR 0:** War Refugees (Commoner)  
**CR 1/8:** Unbound Cultists, Guard, Aethoria Militia  
**CR 1/4:** Zombie, Skeleton, Pembroke's Guard Dogs  
**CR 1/2:** Consortium Enforcers, Thaldros Infantry, Unbound Scouts  
**CR 1:** Spy, Specter  
**CR 2:** Thornwood Rangers, Unbound Fanatics  
**CR 3:** Black Chains Assassins, Royal Guard Elite, Knight, Veteran, Wight, Skeleton Champions  
**CR 5:** Unbound Assassins, Unbound High Priests, Wraith  
**CR 10:** Vault Guardian, Ice Golems  
**CR 12:** Necromancer Lords  
**CR 18:** The Dread King  
**CR 19:** The Dread King (Empowered)  

## DM Notes

### **Monster Usage Guidelines:**

**Acts I-II:** Mix of humanoid enemies (guards, cultists, mercenaries)  
**Act II Finale:** Large-scale armies abstracted  
**Act III:** Mix of continued humanoids + undead threat  

### **Scaling Encounters:**

- **Low levels (1-5):** Use guards, cultists, bandits in groups of 4-8
- **Mid levels (6-11):** Knights, veterans, fanatics in groups of 2-6
- **High levels (11-15):** Elite enemies, undead hordes, boss monsters

### **Moral Complexity:**

Many "enemies" aren't evil:
- War refugees are innocents
- Aethoria militia are fighting for freedom
- Thornwood rangers are freedom fighters
- Some cultists are desperate/misled

**Don't make all combats simple good vs evil** ::
{{pageNumber,auto}}
\page
...
| Element | Blood & Coin | Shattered Oaths |
|---------|--------------|-----------------|
| Corvus Blackwood | Scholar recruiter persona | "Lord Shadows" assassin persona |
| Stat Block | CR 9 (soft power) | CR 14 (full capabilities) |
| The Unbound | Western recruitment operations | Eastern conspiracy operations |
| Marcus Blackwood | Refugee leader in Crossroads | Referenced as "Lost Heir" |
...
- Quest 1.1: Welcome to Crossroads - Introduction, Iron Guild membership
- Quest 1.2: The Hunters - Faction conflict, moral choices
- Quest 1.3: The Red Wolf - Crime syndicate, player agency
- Quest 1.4: The Black Ledger - Investigation, corruption
- Quest 1.5: The Trial - Courtroom drama, major choice point

**Act II: Power Plays** (Levels 6-11) ::
- Quest 2.1: The Recruiters - Faction recruitment, allegiance choice
- Quest 2.2: First Mission - First job for chosen faction
- Quest 2.3: Double Cross - Betrayal, switching sides possible
- Quest 2.4: The Heist - Multi-party heist, complex planning
- Quest 2.5: Breaking Point - Faction conflict climax

**Act III: Empire of Ashes** (Levels 11-15) ::
- Quest 3.1: The Peacekeepers - War has begun
- Quest 3.2: The Underground - Corvus revealed as antagonist
- Quest 3.3: The Alliance - Building coalition
- Quest 3.4: The Unification - Final preparations
- Quest 3.5: The Mediator's Rest - Final battle, campaign resolution

## QUICK SESSION BREAKDOWN

### Quest 1.1: Welcome to Crossroads (Level 1, 1-2 sessions)
**Goal:** Join Iron Guild, complete starter contracts ::
**Key NPCs:** Varak Ironfist (CR 5), Lucky Finn ::
**Encounters:** Giant rats (CR 1/4), bandits (CR 1/8), debt collectors ::
**Rewards:** 50-150 gp, Iron Guild membership ::
**Key Decision:** Accept or decline guild membership ::
...
### Quest 1.4: The Black Ledger (Level 4, 2-3 sessions)
**Goal:** Recover ledger, expose corruption ::
**Key NPCs:** Lord Pembroke (CR 6), Whisper (CR 8) ::
**Encounters:** Mansion infiltration, city watch (CR 4-5) ::
**Rewards:** 800-1,500 gp, political leverage ::
...
### Quest 2.2: First Mission (Level 7-8, 2-3 sessions)
**Goal:** Complete faction's first assignment ::
**Thaldros Mission:** Destroy enemy supply convoy (moral test) ::
**Aethoria Mission:** Extract defector from enemy territory ::
**Unbound Mission:** Retrieve ancient Component from Vault of Whispers ::
**Key NPCs:** General Thorne (CR 12), Captain Vale (CR 10), Julia Redwind (CR 9) ::
**Encounters:** Ambush (CR 8-9), infiltration, assassination ::
**Rewards:** 2,500-4,000 gp, faction rank increase ::
**Key Decision:** How ruthlessly to complete mission ::
...
### Quest 2.5: Breaking Point (Level 11, 2-3 sessions)
**Goal:** Prevent or enable war between kingdoms ::
**Key NPCs:** All faction leaders, returning NPCs ::
**Encounters:** Mass battle (CR 11-13), political confrontation ::
**Rewards:** 8,000-15,000 gp, major story impact ::
**Key Decision:** Peace, war, or third option (dramatically changes Act III) ::

### Quest 3.1: The Peacekeepers (Level 11-12, 2 sessions)
**Goal:** Respond to war, investigate necromantic activity ::
**Key NPCs:** War generals, undead commanders ::
**Encounters:** Undead armies (CR 11-12), necromancers ::
**Rewards:** 10,000-15,000 gp ::
**Key Decision:** Which side to support in war ::

### Quest 3.2: The Underground (Level 12-13, 3 sessions)
**Goal:** Discover Corvus Blackwood is the true antagonist ::
**Key NPCs:** Corvus Blackwood (CR 18), Arcanus (CR 17) ::
**Encounters:** Necromantic cult (CR 12-13), undead hordes ::
**Rewards:** 15,000-20,000 gp, truth revealed ::
**Key Decision:** How to respond to Corvus revelation ::

### Quest 3.3: The Alliance (Level 13-14, 2-3 sessions)
**Goal:** Build coalition against Corvus, unite kingdoms ::
**Key NPCs:** All surviving faction leaders ::
**Encounters:** Diplomacy challenges, assassination attempts (CR 13-14) ::
**Rewards:** 18,000-25,000 gp, unified army ::
**Key Decision:** How to structure post-war government ::
{{pageNumber,auto}}
\page

### Quest 3.4: The Unification (Level 14, 2 sessions)
**Goal:** Final preparations, assault on Corvus's fortress ::
**Key NPCs:** Allied commanders, Corvus forces ::
**Encounters:** Fortress siege (CR 14-15), elite undead ::
**Rewards:** 20,000-30,000 gp, legendary items ::
**Key Decision:** Strategy for final assault ::

### Quest 3.5: The Mediator's Rest (Level 15, 2-3 sessions)
**Goal:** Final battle with Corvus, resolve campaign ::
**Key NPCs:** Corvus Blackwood - Empowered (CR 19) ::
**Encounters:** Epic three-phase boss battle ::
**Rewards:** 30,000+ gp, legendary rewards, kingdom reshaping ::
**Key Decision:** What happens to Tirvandor after Corvus falls ::
...
- **Arcanus** (Lich, CR 17) - Corvus's master, ancient evil
- **Allied Faction Leaders** - Surviving NPCs from Act I-II
...
### Social Encounters
- Persuasion DC 12-15: Standard negotiations
- Persuasion DC 16-18: Difficult negotiations, faction leaders
- Persuasion DC 20+: Nearly impossible, changing minds

- Deception DC 13-15: Routine lies
- Deception DC 16-18: Complex deceptions, fooling experts
- Deception DC 20+: Deceiving major NPCs with high stakes

- Intimidation DC 14-16: Standard threats
- Intimidation DC 17-19: Intimidating dangerous NPCs
- Intimidation DC 20+: Intimidating faction leaders

### Investigation & Exploration
- Investigation DC 12-14: Finding obvious clues
- Investigation DC 15-17: Discovering hidden evidence
- Investigation DC 18-20: Uncovering deeply buried secrets

- Perception DC 10-12: Noticing obvious threats
- Perception DC 13-15: Spotting hidden enemies/traps
- Perception DC 16-18: Detecting expert concealment

### Stealth & Infiltration
- Stealth DC 12-14: Sneaking past guards
- Stealth DC 15-17: Infiltrating secure locations
- Stealth DC 18-20: Avoiding elite security
...
### Act II (Levels 6-11)
- CR 7-8: Military patrols, convoy ambush (Quest 2.2)
- CR 9-10: Assassination squads, faction elites (Quest 2.3)
- CR 11-12: Vault guardians, rival heist teams (Quest 2.4)
- CR 12-13: Mass battle encounters, war scenarios (Quest 2.5)
{{pageNumber,auto}}
\page

### Act III (Levels 11-15)
- CR 11-13: Undead armies, necromancers (Quest 3.1-3.2)
- CR 14-15: Elite undead, fortress defenders (Quest 3.3-3.4)
- CR 16-19: Corvus Blackwood phases, Arcanus (Quest 3.5)
...
- **Values:** Contracts, reputation, neutrality
- **Conflicts with:** Anyone who breaks contracts
- **Allies:** Mercenaries, independent contractors

## TREASURE & REWARDS SUMMARY

### Act I (Levels 1-5)
- Quest 1.1: 50-150 gp + guild membership
- Quest 1.2: 200-400 gp
- Quest 1.3: 400-800 gp
- Quest 1.4: 800-1,500 gp
- Quest 1.5: 1,500-2,500 gp
- **Total Act I:** ~3,000-5,000 gp

### Act II (Levels 6-11)
- Quest 2.1: 1,000-2,500 gp + faction access
- Quest 2.2: 2,500-4,000 gp
- Quest 2.3: 3,000-5,000 gp
- Quest 2.4: 5,000-10,000 gp + artifact
- Quest 2.5: 8,000-15,000 gp
- **Total Act II:** ~20,000-35,000 gp

### Act III (Levels 11-15)
- Quest 3.1: 10,000-15,000 gp
- Quest 3.2: 15,000-20,000 gp
- Quest 3.3: 18,000-25,000 gp
- Quest 3.4: 20,000-30,000 gp
- Quest 3.5: 30,000+ gp + legendary items
- **Total Act III:** ~90,000-120,000 gp

### Magic Items
- Uncommon: Quests 1.3, 1.4, 2.1
- Rare: Quests 2.3, 2.4, 3.1
- Very Rare: Quests 3.2, 3.3, 3.4
- Legendary: Quest 3.5

## KEY DECISION POINTS

### Quest 1.5: The Trial
**Impact:** Determines Act II faction options
- Side with Thaldros → Military path available
- Side with Aethoria → Political path available
- Side with Thornwood → Criminal path available
- Independent → All paths available but harder
...
- Peace achieved → Easier Act III, best ending possible
- War declared → Harder Act III, kingdoms weakened
- Third option → Moderate difficulty, unique outcomes

### Quest 3.5: Final Choice
**Impact:** Campaign epilogue
- Constitutional monarchy → Balanced power
- Federal republic → Democratic future
- Complete merger → United empire
- Maintain separation → Status quo
{{pageNumber,auto}}
\page
...
**Core Theme:** Moral ambiguity in conflict ::
- No faction is purely good or evil
- Player choices have lasting consequences
- War affects everyone differently
- Power corrupts, even good intentions

**Secondary Themes:** ::
- Loyalty vs. personal ethics
- Cost of peace vs. cost of war
- Individual agency in grand conflicts
- Redemption and betrayal

## IMPROVISATION TIPS

### When Players Go Off-Script
1. Have 2-3 random NPCs ready (names, personalities)
2. Keep generic combat encounters prepared (bandits, guards, monsters)
3. Use faction reactions to guide consequences
4. Remember: player choices should matter, but campaign can adapt

\column

### Adjusting Difficulty
- **Too Easy:** Add reinforcements, environmental hazards, time pressure
- **Too Hard:** Give tactical advantage, allow clever solutions, add NPC aid
- **Just Right:** Players win but use resources, feel accomplished

### Pacing
- **Session feels slow:** Skip to action, introduce complication
...
| d10 | Encounter |
|:---:|:---------:|
|1| City Watch patrol (3-5 guards, CR 1/2 each) |
|2| Pickpocket attempt (Sleight of Hand vs Passive Perception) |
|3| Bar brawl (1d4 thugs, CR 1/2 each) |
|4| Merchant offering job (investigation hook) |
|5| Rival mercenary group (potential conflict) |
|6| Street preacher warning of doom (Elara foreshadowing) |
|7| Escaped prisoner causing chaos (CR 2) |
|8| Faction recruiter making pitch |
|9| Thieves' Guild marking territory |
|10| Nothing - peaceful travel |

### Act II Random Encounters (d10)
| d10 | Encounter |
|:---:|:---------:|
|1| Military checkpoint (social encounter, possible combat) |
|2| Assassination attempt (2-3 assassins, CR 4-5 each) |
|3| Refugee caravan needing help |
|4| Enemy faction patrol (combat or stealth) |
|5| War profiteer offering black market goods |
|6| Deserters asking for aid |
|7| Necromantic cultists performing ritual (CR 6-7) |
|8| Spy following party (Perception DC 18 to notice) |
|9| Battlefield aftermath (investigation opportunity) |
|10| Allied NPC with urgent message |
{{pageNumber,auto}}
\page
...
| d10 | Encounter |
|:---:|:---------:|
|1 Undead patrol (2d4 zombies, 1 wight, CR 8-9 total) |
|2| Desperate civilians fleeing war |
|3| Elite enemy squad (CR 11-12) |
|4| Ancient guardian awakened by war |
|5| Magical phenomenon from artifact use |
|6| Allied forces requesting aid |
|7| Enemy necromancer with undead (CR 12-13) |
...
- **Veteran** with following modifications:
...
### Thugs & Bandits (CR 1/2)
- Fight in groups, flee if outnumbered
- Target spellcasters first
- Use pack tactics when possible
- Morale breaks at 50% casualties

### City Watch (CR 1)
- Fight defensively, call for backup
- Attempt non-lethal takedowns
- Use formations and teamwork
- Never flee unless all allies down

\column

### Assassins (CR 2-5)
- Strike from stealth, disengage frequently
- Focus single target until dead
- Use poison and status effects
- Flee if discovered before killing target

### Elite Guards (CR 5-8)
- Coordinated tactics, protect VIPs
- Shield allies, control battlefield
- Fight to the death for their charge
- Use magic items and superior equipment

### Undead (CR varies)
- No morale, fight until destroyed
- Zombies: Slow but relentless
- Wights: Tactical, use life drain
- Wraiths: Incorporeal hit-and-run
- All commanded by necromancer if present

### Necromancers (CR 8-15)
- Stay at range, summon undead
- Use battlefield control spells
- Animate fallen enemies mid-combat
- Flee via teleportation if threatened
...
- **Climber's Kit** (25 gp) - Advantage on climbing checks
- **Thieves' Tools** (25 gp) - Required for lock picking

### Uncommon Magic Items (Quests 1.3-2.1)
- **+1 Weapon** - Most common reward
- **Cloak of Protection** - +1 AC and saves
- **Boots of Elvenkind** - Advantage on Stealth
- **Bag of Holding** - 500 lb capacity, 64 cubic feet

### Rare Magic Items (Quests 2.2-3.1)
- **+2 Weapon** - Major combat boost
- **Ring of Spell Storing** - Store 5 levels of spells
- **Periapt of Wound Closure** - Stabilize automatically, double healing
- **Figurine of Wondrous Power** - Summon creature ally
{{pageNumber,auto}}
\page

### Very Rare Magic Items (Quests 3.2-3.4)
- **+3 Weapon** - Legendary weapon tier
- **Amulet of the Planes** - Plane shift once per day
- **Belt of Giant Strength** (Frost) - Strength 23
- **Cloak of Invisibility** - True invisibility, no concentration

### Legendary Items (Quest 3.5)
- **Scales of Justice** - Truth detection, divine judgment
- **Artifact Fragments** - World-altering power (campaign finale)
...
**HP:** 58 | **AC:** 16 | **Speed:** 30 ft ::
**Attacks:** Shortsword +6 (1d6+4), Dagger +6 (1d4+4) ::
...
### Corvus Blackwood (CR 9/11/13)
**HP:** 99/150/180 | **AC:** 15/18/20 | **Speed:** 30 ft, fly 30/60 ft (with Components) ::
**Attacks:** Quarterstaff +5 (1d6), Eldritch Blast +10 (4d6 force), Reality Beam +11 (8d6 force) ::
**Special:** Portent (3/day), 9th-level spellcasting, Component powers (Phase Shift, Reality Distortion) ::
**Tactics:** Controls battlefield with walls and banishment, uses Portent on key saves, flees if outmatched ::
...
**Speed** :: 30 ft.
![](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/all_artwork/npcs/villain-arcanus-elder-lich.jpg) {width:200px,mix-blend-mode:multiply}
___
|  STR  |  DEX  |  CON  |  INT  |  WIS  |  CHA  |
|:-----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|11 (+0)|16 (+3)|20 (+5)|22 (+6)|18 (+4)|18 (+4)|
...
- **Paralyzed:** Incapacitated, auto-fail Str/Dex saves, attacks against have advantage, hits within 5ft are crits
...
- **Unconscious:** Incapacitated, drop everything, auto-fail Str/Dex saves, attacks within 5ft are crits
...
- **Bonus Action:** Specific abilities only (Cunning Action, bonus action spells, etc.)
- **Reaction:** Opportunity Attack, Ready action trigger, specific abilities
- **Movement:** Can split before/after action
- **Free:** Drop item, brief communication, interact with one object
...
- Hidden = Advantage on attack, attacks against have disadvantage

## DOWNTIME ACTIVITIES

### Between Quests (1-7 days)
- **Training:** Learn tool, language (250 days total, 1 gp/day)
- **Crafting:** Create items (5 gp progress per day)
- **Carousing:** Make contacts (25 gp per week, roll on table)
- **Research:** Learn lore (100 gp per week, Intelligence check)
- **Crime:** Risky income (25 gp per week, risk of jail)
- **Work:** Safe income (1-5 gp per day)
...
**Varak Ironfist** ::
- Motivation: Maintain Iron Guild neutrality and reputation
- Secret: Knows more about Crossroads politics than he lets on
- Will Help: If party proves trustworthy and competent
- Won't Help: If party breaks contracts or threatens guild

**Lucky Finn** ::
- Motivation: Survive, gather information to sell
- Secret: Works as informant for multiple factions
...
**Commander Helena Dawnblade** ::
- Motivation: Protect Thaldros, uphold military honor
- Secret: Doubts the righteousness of the coming war
...
- Won't Betray: Core ideals of liberty and justice

**Corvus Blackwood** ::
- Motivation: Achieve immortality, gain ultimate power
- Secret: Already partially transformed into lich, manipulating all factions
- Will Betray: Everyone, always was planning to
- Won't Betray: His master Arcanus (until Act III)

## MORAL DILEMMA EXAMPLES

### Quest 1.2 Example
**Situation:** Marcus Blackwood (refugee) vs Kael Shadowbane (guild enforcer) ::
**Choice 1:** Help Marcus escape - Refugees live, guild reputation damaged ::
**Choice 2:** Complete contract - Marcus captured, party rewarded, refugees suffer ::
**Choice 3:** Negotiate - Moderate outcome, both sides partially satisfied ::
**DM Tip:** No "right" answer. Emphasize consequences of all choices. ::

### Quest 2.3 Example
**Situation:** Faction orders assassination of civilian leaders ::
**Choice 1:** Obey orders - War escalates, party advances in faction ::
**Choice 2:** Refuse orders - Faction turns hostile, party must flee or fight ::
**Choice 3:** False flag - Frame another faction, creates complex consequences ::
**DM Tip:** Test player moral limits. Make consequences real and lasting. ::

### Quest 3.2 Example
**Situation:** Discover Corvus was manipulating everything ::
**Choice 1:** Expose immediately - Corvus escapes, gains time to prepare ::
**Choice 2:** Play along - Learn more, but risk being discovered ::
**Choice 3:** Turn tables - Try to manipulate Corvus (very difficult) ::
**DM Tip:** Players should feel betrayed. Make revelation dramatic. ::

## SESSION ZERO GUIDANCE

### Set Expectations
- This is a MORALLY GREY campaign
- Player characters may commit morally questionable acts
- No guaranteed "happy ending"
- Player choices have permanent consequences
- War and its horrors will be depicted
{{pageNumber,auto}}
\page

### Establish Safety Tools
- Lines: Topics to completely avoid
- Veils: Topics to acknowledge but not detail
- X-Card: Any player can stop scene, no questions
- Check-ins: Pause if anyone uncomfortable

### Character Creation Guidelines
- Mercenaries or those willing to work as mercenaries
...
- Define why characters trust each other (even if cautiously)
- Agree on red lines the party won't cross
- Accept that party may disagree on major decisions

## ALTERNATE ENDINGS OVERVIEW

### Ending 1: The Peace
**Requirements:** Quest 2.5 negotiated peace, Quest 3.5 all challenges succeeded ::
**Outcome:** Kingdoms unite peacefully, Corvus defeated, democracy emerges ::
**Epilogue:** Golden age begins, characters become legendary peacemakers ::
**Player Reward:** Best possible ending, maximum rewards ::

### Ending 2: The Institution  
**Requirements:** Quest 2.5 resulted in war, Quest 3.5 military victory ::
**Outcome:** One kingdom conquers other, Corvus defeated but at great cost ::
**Epilogue:** Authoritarian empire emerges, peace through strength ::
**Player Reward:** Rewarded by winning faction, but world darkened ::

### Ending 3: The Ashes
**Requirements:** Both kingdoms severely weakened or destroyed ::
**Outcome:** Pyrrhic victory over Corvus, civilization in ruins ::
**Epilogue:** Dark age begins, characters must rebuild from nothing ::
**Player Reward:** Survival itself is the reward, legendary items but broken world ::

\column

### Ending 4: The Betrayal
**Requirements:** Party joins Corvus or switches to Unbound ::
**Outcome:** Corvus achieves lichdom, undead empire ::
**Epilogue:** World falls to darkness, party becomes dark lords or servants ::
**Player Reward:** Power but at cost of souls, unique dark ending ::

## ADAPTING FOR YOUR TABLE

### If Players Are More Heroic
- Emphasize civilian suffering to motivate heroic choices
- Provide more chances for redemption arcs
- Make NPCs more sympathetic and redeemable
- Tone down faction atrocities slightly
- Still maintain consequences but lighter touch

### If Players Are More Ruthless
- Embrace the mercenary lifestyle fully
- Show world becoming darker due to choices
- Introduce even darker enemies to contrast
- Make pragmatic choices more obviously beneficial
- Consider darker ending more likely

### If Players Are Stuck
- Have Lucky Finn or other informant provide intel
- Elara can have vision pointing direction
- Faction handler can give strong hint
- Environmental clues can guide (wanted posters, rumors, etc.)
- Avoid direct railroad, but provide clear options

### If Campaign Going Off Rails
- Remember: Corvus is manipulating everything
- Any major deviation can be Corvus plan
- Faction leaders can adjust strategies
- New NPCs can emerge to redirect
- Worst case: Time skip to next major plot point

## MEMORABLE MOMENTS TO CREATE

### Act I Highlights
- First seeing Crossroads (desperate but alive)
- Lucky Finn's cynical wisdom
- Elara's prophecy (chilling and mysterious)
- The Trial (dramatic courtroom battle)
- Faction recruitment (major choice point)
{{pageNumber,auto}}
\page

### Act II Highlights
- Faction leader meetings (three very different offers)
- First faction mission (proving yourself)
- Betrayal revelation (shocking discovery)
- The Heist (Ocean's Eleven moment)
- War declaration or peace treaty (campaign-changing)

### Act III Highlights
- Undead armies marching (horror and scale)
- Corvus revelation (villain unmasked)
- Alliance building (bringing enemies together)
- Fortress assault (epic siege)
- Final battle (three-phase boss fight)

## PLAYER HANDOUT: CROSSROADS RUMORS

*Give this to players during Quest 1.1-1.2*

1. "The Iron Guild is neutral, but Varak has favorites..."
2. "That prophet girl in the square? She predicted the grain fire. Exactly."
3. "Thornwood Syndicate runs half this town. Guards look the other way."
4. "Strange ships at the docks. Flying foreign colors I don't recognize."
5. "The Black Chains are recruiting. Assassins' guild, very selective."
6. "Tensions between kingdoms getting worse. War's coming."
7. "Someone's buying up all the silver. Weird, right?"
8. "The old temple district? Avoid it. Things happen there at night."
9. "Lucky Finn knows everything. For a price."
10. "That Kael fellow? Guild enforcer. Don't cross him."

:
*For additional NPC stat blocks, see the full Blood & Coin Campaign book.* 
:
*For complete quest details, see individual quest chapters.* 
:
*This is YOUR campaign. Modify freely to fit your table's playstyle.* 
...
- **Property Owned:** _________________________________
- **Business Interests:** _________________________________
- **Debts Owed:** _________ GP (To: ___________________)
- **Debts Owed to Party:** _________ GP (By: ___________________)
{{pageNumber,auto}}
\page
...
║  elite protectors of the wilderness and   ║
║  guardians of the frontier.               ║
║                                           ║
║  BEARER: ___________________              ║
║                                           ║
║  RANK: ___________________                ║
║                                           ║
║  OATH:                                    ║
║  "I am the shadow in the trees,           ║
║   the arrow in the dark,                  ║
║   the howl before the strike.             ║
║   I protect those who cannot protect      ║
║   themselves. I am a Red Wolf."           ║
║                                           ║
║  Authority granted by the Crown           ║
║  to patrol, arrest, and execute justice   ║
║  in the name of the kingdom.              ║
║                                           ║
║  _____________________________            ║
║  Ranger-Captain's Seal                    ║
║                                           ║
╚═══════════════════════════════════════════╝
```
}}
