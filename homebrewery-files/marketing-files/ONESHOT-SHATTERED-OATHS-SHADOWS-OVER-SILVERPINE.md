...
# Shadows Over Silverpine
## A One-Shot Adventure for Level 1 Characters

**Setting:** Tirvandor Campaign Setting
**Location:** Silverpine, Thaldros
**Duration:** 4-5 hours
...
Each character has a reason to be in Silverpine:
- Investigating a missing family member
- Hired as caravan guard, now between jobs
...
- *"Welcome, travelers! Sit yourselves down. We've got hot stew, cold ale, and warm beds."*
- If asked about town: *"Silverpine? It's a good town, usually. But... things haven't been right lately."* (trails off nervously)
...
- Trying to appear calm but clearly frightened
...
- 1-2 days old, heading northwest
- Someone was dragged (scuff marks)

**Survival DC 16:**
- Tracks lead toward old Thornwood shrine (1 mile)
- Return tracks show fewer people coming back than went in

**Perception DC 14:**
- Find melted black candles arranged in a circle
...
- Cellar entrance on east side (stairs down)
- Candlelight visible through main door
- Faint chanting in unknown language

**Perception DC 16:**
- 4-5 cultists visible inside
...
- 3 Cultists + 1 Cult Fanatic
- Direct confrontation

**B. Cellar Entrance (Rescue First)**
- 1 Cultist guard below
- Can free prisoners first
- Athletics DC 12 to break chains quietly

**C. Second Floor Window (Stealth)**
- Athletics DC 13 to climb
- Provides high ground
- Surprise attack opportunity

**D. Deception**
- Need black robes (from scouts)
...
- Dagger +4 (1d4+2)
- Spellcasting: *command, inflict wounds, hold person, spiritual weapon*

**3 Cultists** — CR 1/8 each
...
- If Fanatic alone, tries to flee
...
**From the shrine:**
- 45 gold pieces total
- 2 more Potions of Healing (hidden compartment)
...
- Who is **Lord Shadows**?
- What are the **World-Splitter components**?
- Why was **House Blackwood** destroyed?
- What is **Raven's Keep**?
...
| Name | Role | Stats |
|------|------|-------|
| Elder Thom | Quest giver | Commoner |
| Marta Goodbarrel | Innkeeper | Commoner |
| Brother Malthus | Cult leader | Cult Fanatic (CR 2) |
...
1. **The Unbound** exists and is recruiting
2. Someone called **Lord Shadows** leads them
3. **House Blackwood** is connected (destroyed family)
4. **"First Component"** at Raven's Keep
5. A multi-phase plan to "destroy kingdoms"
6. Cultists believe they're the good guys
...
- Give Fanatic 45 HP
- Add 2 Scouts to ambush

**For Level 3:**
- Add 1 more Cult Fanatic
...
- Investigation of Raven's Keep
- Discovery of the World-Splitter artifact
- The truth about House Blackwood's destruction
- Confronting Lord Shadows himself
- Choosing between justice and catastrophe
...
- Track cultists through dark forests
- Storm an ancient shrine turned evil temple
