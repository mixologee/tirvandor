...
![DMG-cover](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/tirvandor-cover-dungeon-masters-guide.png){position:absolute,top:0px,left:0px,width:820px}
...
## Complete Timeline of Tirvandor
...
The First Creation:
- Primordials and First Gods walked the world
- Magic flowed without restraint
- Dragons born from the blood of the earth
...
- Giant-Dragon Pact ended Dragon Wars
...
- Last attempts to save civilization
...
- Ley lines glow visible to naked eye
- Animals flee the region
- Ground begins shaking

Day 1 - Midday:
- Ritual reaches critical point
- Ocean starts receding
- Gods manifest physically, try to stop ritual
...
- Eastern third separates and drifts
- Massive tsunami destroys coastal cities
- 20 million more die in floods

Day 3-7 - Chaos:
- Earthquakes continue for week
- Volcanic eruptions across continent
- Ash clouds block sun
...
- Crops fail globally
- Starvation begins
- Survivors flee underground

Final Toll:
- 35 million dead from direct impact (70% of population)
- 10 million more in first year (starvation, disease)
- Population stabilized at 5 million (10% of original)
- Civilization nearly destroyed
...
- Oral tradition preserves some history

200-400 CR - Rebuilding:
...
### 3. The Weaver (Under Silverpeak Mountains)
- Domain: Fate, Threads, Control
- Prison Status: Severe (15-20 years)
- Corruption: Loss of free will, become puppets

### 4. The Tyrant (Under Highcrown Ruins)
- Domain: Domination, Hierarchy, Subjugation
- Prison Status: Severe (15-20 years)
- Corruption: Megalomania, enslave others

### 5. The Corruptor (Under Border Wastes)
- Domain: Disease, Decay, Transformation
- Prison Status: Advanced (5-10 years)
- Corruption: Mutation into monstrosities

### 6. The Hunter (Deep Wilderness, Unknown)
- Domain: Pursuit, Prey, Terror
- Prison Status: Unknown (hidden)
- Corruption: Become bestial, hunt former friends

### 7. The Oracle (Lost Temple, Unknown)
- Domain: Time, Knowledge, Future
- Prison Status: Unknown
- Corruption: See all futures simultaneously, madness
...
Call for ability checks when:
- The outcome is uncertain
- Both success and failure have interesting consequences
- The action takes significant effort or skill

Don't call for checks when:
- The outcome is certain (routine tasks for skilled characters)
- Failure would just stop the story with no interesting outcome
- Success is impossible regardless of roll

### Setting Difficulty Classes

| Difficulty | DC | Example |
|------------|-----|---------|
| Very Easy | 5 | Notice something obvious, climb a knotted rope |
| Easy | 10 | Hear an approaching guard, climb a surface with ledges |
| Medium | 15 | Eavesdrop through a door, scale a brick wall |
| Hard | 20 | Hear a whisper through a door, climb a slippery sheer surface |
| Very Hard | 25 | Hear breathing through a door, climb an oiled wall |
| Nearly Impossible | 30 | Read lips from across a plaza, climb a perfectly smooth surface |

Most checks should be DC 15 (Medium). Reserve DC 25+ for legendary feats.

### Multiple Ability Options

When a task could use multiple abilities, let players describe their approach:

Example: Getting Past a Guard
- Strength (Athletics): Overpower and restrain
- Dexterity (Stealth): Sneak past without being seen
- Charisma (Deception): Convince guard you belong there
- Charisma (Intimidation): Threaten guard into letting you pass
- Intelligence (Investigation): Find alternate route by studying patrol patterns
- Wisdom (Insight): Determine when guard is distracted
...
Everyone rolls. If more than half succeed, the group succeeds.

Method 2: Leader + Help
One character leads (rolls), others who succeed on DC 10 checks give advantage through the Help action.

Method 3: Best Applies
When one character's success helps everyone (ranger navigating, rogue scouting ahead), use the best result.

### Contests

When two creatures oppose each other (arm wrestling, chase, hiding vs seeking):
- Both roll appropriate ability checks
- Highest total wins
- Ties go to the creature with higher ability modifier
...
- Target is restrained, prone, or unconscious
- Ally provides Help action
- Environmental factor aids the task (bright light for Perception, etc.)
- Creative player solution that makes sense
...
- Attacker is blinded or can't see target
- Target has cover (for attacks)
- Environmental hindrance (darkness for Perception, noise for Stealth)
- Exhaustion levels 1-2
- Task is being rushed

Don't Stack: Multiple sources don't stack.
...
| Roll | Result |
|-----|--------|
| 1 | Situation becomes combat (violence is inevitable, trap springs, ambush happens) |
| 2 | Everyone rolls d20 + Dexterity modifier |
| 3 | DM ranks all combatants from highest to lowest |
| 4 | Ties: PCs win ties with monsters. Tied PCs/monsters choose their order. |


Tracking Initiative:
Write on paper or use tracker. Call out current turn and who's next: "Thea, you're up. Marcus, you're on deck."

Changing Initiative: Some DMs reroll each round. Others keep same order entire combat. Choose consistency.

### Actions in Combat

On Your Turn (in any order):
- Move: Up to your speed
- Action: One of the options below
- Bonus Action: If you have ability that grants one
- Object Interaction: One free (draw weapon, open door, etc.)
- Communication: Brief phrases, a few words

Standard Actions:
- Attack: Make one melee or ranged attack (more if Extra Attack)
- Cast a Spell: Cast one spell with casting time of 1 action
- Dash: Move again (up to your speed)
- Disengage: Move without provoking opportunity attacks
- Dodge: Attacks against you have disadvantage, you have advantage on Dex saves
- Help: Give ally advantage on ability check or next attack against creature you can see
- Hide: Make Dexterity (Stealth) check
- Ready: Prepare action to trigger on condition ("I attack if it comes through door")
- Search: Make Wisdom (Perception) or Intelligence (Investigation) check
- Use an Object: Interact with second object (first is free)

Reactions (Triggered, Not on Your Turn):
- Opportunity Attack: Enemy leaves your reach without Disengaging
- Spells: Some spells cast as reactions (Shield, Counterspell, etc.)
- Readied Action: Triggering condition occurs

### Movement

Speed: Move up to your speed in feet. Can split movement (move 10 ft, attack, move 20 ft more).

Difficult Terrain: Every foot costs 2 feet of movement (rubble, shallow water, undergrowth, steep stairs).

Prone: Standing from prone costs half your speed.

Climbing/Swimming: Usually costs 2 feet per foot moved (unless creature has climb/swim speed).
...
| Roll | Result |
|-----|--------|
| 1 | Declare target within reach |
| 2 | Roll d20 + Strength modifier + proficiency bonus (if proficient) |
| 3 | Compare to target's AC |
| 4 | If equal or higher: Hit! Roll damage. |
| 5 | If lower: Miss. |


Ranged Attack:
Same as melee but uses Dexterity and has range limitations.

Range: Weapon has normal range and long range (e.g., 80/320 for longbow)
- Normal range: Attack normally
- Long range: Attack at disadvantage
- Beyond long range: Can't attack

Cover: Target behind cover gets AC bonus
- Half cover (+2 AC): Behind furniture, narrow tree, another creature
- Three-quarters cover (+5 AC): Arrow slit, thick tree trunk
- Total cover (can't target): Completely concealed
...
{{footnote Part II: Running the Game}}
\page
Critical Fails: Some DMs use special effects for natural 1s. Official rules: just automatic miss. If using critical fails, keep them minor (drop weapon, fall prone) not campaign-ending.

### Damage and Healing

Taking Damage:
Subtract from current hit points. Track carefully.

Dropping to 0 HP:
Fall unconscious. Start making death saving throws.

Death Saving Throws:
- At start of your turn if at 0 HP, roll d20 (no modifiers)
- 10 or higher: Success (mark one)
...
Damage at 0 HP:
- Any damage while at 0 HP: One death save failure
- Critical hit while at 0 HP: Two death save failures
- Damage equals or exceeds max HP: Instant death

Healing:
Regain HP (from spells, potions, etc.). If at 0 HP, regain consciousness.

Stabilizing:
- Action: DC 10 Wisdom (Medicine) check stabilizes dying creature
- Spare the Dying cantrip: Stabilizes automatically
- Healing magic: Restores HP and stabilizes
...
Charmed:
- Can't attack charmer or target them with harmful effects
- Charmer has advantage on social checks against you

Deafened:
- Can't hear, automatically fails checks requiring hearing
...
- Attacks against you have advantage
- Attacks within 5 feet are automatic crits if they hit

Petrified:
- Transformed to stone along with nonmagical objects worn/carried
- Weight increases by factor of 10, stops aging
- Incapacitated, can't move or speak
...
Prone:
- Can only crawl (every foot costs 1 extra foot) or stand up (costs half speed)
- Disadvantage on attack rolls
- Attacks within 5 feet have advantage
- Attacks from more than 5 feet have disadvantage
...
Combat: Rounds (6 seconds) and turns
Exploration: Minutes, hours, days
Downtime: Days, weeks, months
Campaign Time: Months, years

Use calendar to track dates. Note seasonal changes, festivals, and important events.
...
- Success: Find 1d6 pounds food + 1d6 gallons water per point over DC
...
Short Rest:
- At least 1 hour
- Can spend Hit Dice: Roll + Con modifier, regain that many HP
- Some abilities recharge
- Can do light activity (eat, read, tend wounds)

Long Rest:
- At least 8 hours
- At most 2 hours light activity (watch, cook), rest must be sleep
- Regain all HP
- Regain spent Hit Dice (up to half maximum)
- Regain all expended spell slots and abilities
- Can only benefit from one long rest per 24 hours

Interrupting Rest:
- Short rest interrupted: No benefit, must start over
...
| Attitude | Description | Effect |
|----------|-------------|---------|
| Hostile | Will actively oppose party | Attacks, sabotages, spreads rumors |
| Unfriendly | Dislikes party | Won't help, might hinder, needs convincing |
| Indifferent | Doesn't care either way | Professional, transactional, fair price |
| Friendly | Likes party | Helps if convenient, gives honest advice, fair deals |
| Helpful | Strongly likes party | Goes out of their way, takes risks, offers discounts |
...
- Oppose NPC's interests: Disadvantage
- NPC has reason to distrust you: +5 DC
- You've helped them before: -5 DC

### Persuasion, Deception, Intimidation

Persuasion: Convince through logic, emotion, or appeal to interests
- "The Resistance can offer you protection from Thaldros retaliation"
- Must present actual argument or benefit
- Won't make NPC do things completely against their nature

Deception: Convince through lies or misdirection
- "We're Thaldros agents sent to inspect your papers"
...
| 10 | Generally known (local noble's name, recent news) |
| 15 | Hidden but findable (crime boss identity, secret meeting place) |
| 20 | Well-kept secret (spy network contact, hidden treasure) |
| 25+ | Closely guarded (conspiracy details, hidden vault location) |
...
Stay Calm: Players going unexpected directions is normal and good. It means they're engaged.
...
- Bad: "No, that's not in the rules."
- Good: "Yes! Make an Athletics check. If you fail, it breaks and you fall."

### Quick NPC Creation

When you need an NPC right now:

Name: Use name list or combine syllables
Distinctive Feature: One physical trait (scar, accent, nervous tic)
Goal: What do they want?
Secret: What are they hiding?

Example:
- Name: Kerra
- Feature: Missing left ear
- Goal: Get enough money to leave town
- Secret: Secretly works for Iron Guild

### Quick Room Description

When party enters unexpected room:

Size and Shape: Small/medium/large, square/rectangular/circular
Purpose: What was this room for? (Bedroom, storage, shrine, guard post)
Condition: Pristine/dusty/damaged/destroyed
Notable Feature: One interesting thing (murals, weapons rack, altar, fireplace)
Exists: Obvious doors/windows
...
Better: "That won't work because [reason], but what if you [alternative]?"
...
{{pag### Speeding Things Up

In Combat:
- Set turn timer (30-60 seconds)
- Roll multiple attacks together
- Describe outcomes cinematically
- Skip to interesting parts ("You fight through minions...")

In Exploration:
- Montage: "You spend three days traveling through forest. Anything specific you want to do?"
- Jump to next interesting scene
- Resolve routine tasks quickly

In Social Interaction:
- Get to the point: "What do you want from them?"
...
Don't play out every moment. Jump to interesting parts.
...
When situation isn't covered by rules:

1. Listen to player's intent
2. Determine appropriate ability + skill
3. Set DC based on difficulty
4. Consider advantage/disadvantage
...
Look it up:
- First time using complex rule
- Player challenges ruling
- Affects major outcome (death, TPK)

Don't look it up:
- Middle of intense moment
- Would break pacing
- You're reasonably sure of rule

Make ruling, note it, look it up after session.

### Admitting Mistakes

If you realize you ruled wrong:
- Acknowledge it: "I got that rule wrong."
- Correct it going forward: "From now on we'll do it this way."
- Don't retcon unless truly game-breaking
...
Reference these mechanics during play. Most important points:


| Roll | Result |
|-----|--------|
| 1 | Most checks are DC 15 |
| 2 | Grant advantage/disadvantage liberally |
| 3 | Say "yes, and..." to player ideas |
| 4 | Keep combat moving |
| 5 | Cut boring parts, zoom into interesting parts |
| 6 | Make rulings, look up rules later |


The goal is fun and flow, not perfect rules mastery.
...
A good D&D adventure has:


| Roll | Result |
|-----|--------|
| 1 | Clear Initial Hook: Players know why they're doing this |
| 2 | Meaningful Choices: Players decisions matter |
| 3 | Multiple Approaches: Combat isn't the only solution |
| 4 | Rising Tension: Stakes increase as adventure progresses |
| 5 | Satisfying Resolution: Clear ending with consequences |
| 6 | Player Agency: Players drive the story through their choices |


Bad adventure: Linear railroad with one solution
...
What is this adventure about in one sentence?
...
- Have clear stakes
- Can be completed in 3-6 sessions

### Step 2: Identify the Villain or Threat

Who or what opposes the players?

Villain Checklist:
- Goal: What do they want?
- Method: How are they trying to achieve it?
- Weakness: How can they be stopped?
- Backup Plan: What if first plan fails?

Example: Captain Vex (Thaldros Officer)
- Goal: Capture Resistance leaders
- Method: Infiltrate with spies, set trap
- Weakness: Too confident, underestimates party
- Backup: Has reinforcements 1 hour away

Threat Checklist (Non-Villain):
- Source: Where does threat come from?
...
Identify 3-5 important locations for this adventure.

For Each Location:
- Purpose: What happens here?
- Description: What does it look/sound/smell like?
- Inhabitants: Who or what is here?
- Secrets: What's hidden here?
- Connections: How does this tie to other locations?

Example Locations:

| Roll | Result |
|-----|--------|
| 1 | Resistance Safehouse - Party's base, information source |
...
Design 3-5 important NPCs players will interact with.

For Each NPC:
- Name and Appearance: Distinctive feature
- Role: Ally? Enemy? Neutral?
- Goal: What do they want?
- Secret: What are they hiding?
- Offer: What can they give players?
- Ask: What do they want from players?

Example: Kerra the Smuggler
- Appearance: Missing left ear, nervous energy
- Role: Uneasy ally
- Goal: Make enough money to flee to Aethoria
- Secret: Secretly reports to Iron Guild
...
Design 4-8 encounters mixing combat, social, and exploration.

Encounter Types:

Combat Encounters:
- Planned fights (guards, monsters)
...
Types of Rewards:
- Gold and Treasure: Standard, use CR-based tables
- Magic Items: 1-2 per adventure (based on level)
- Information: Maps, letters, intelligence
- Contacts: New NPCs who owe them favors
- Reputation: Faction influence points
- Story Progress: Answers to mysteries, plot advancement

Balance: Don't over-reward or under-reward. Match party level.

### Step 7: Prepare for Player Choices

Anticipate 3-4 likely player approaches:

Example: Stealing Supplies

Approach 1: Stealth
- Sneak in at night
- Disable guards quietly
- Load supplies and escape

Approach 2: Social
- Forge documents
- Bribe or convince guards
- Walk out with "authorized" supplies

Approach 3: Combat
- Attack during escort
- Fight through guards
- Take supplies by force

Approach 4: Alternative
- Discover supplies going elsewhere
- Hijack alternate route
- Avoid main depot entirely
...
Adventure centers on exploring a place (dungeon, city, wilderness).

Structure:

| Roll | Result |
|-----|--------|
| 1 | Entrance: How players get in |
| 2 | Zones: Different areas with different threats/themes |
| 3 | Factions: Groups within location (may ally, fight, or ignore players) |
| 4 | Goal: What players seek (rescue, artifact, information) |
| 5 | Exit: How players get out (may be different from entrance) |
...
Adventure follows sequence of events. Location changes as events unfold.

Structure:

| Roll | Result |
|-----|--------|
| 1 | Inciting Incident: Event that kicks everything off |
| 2 | Rising Action: Series of encounters/scenes building tension |
| 3 | Complication: Unexpected twist raises stakes |
| 4 | Climax: Final confrontation or decision |
| 5 | Resolution: Immediate consequences of player actions |


Good For: Heists, chases, time-sensitive missions

Example: Supply Convoy Heist
- Inciting Incident: Learn convoy leaving tomorrow
- Rising Action: Gather information, plan attack, prepare ambush
- Complication: Convoy has unexpected magical defense
...
| Roll | Result |
|-----|--------|
| 1 | Crime/Mystery: Something happened, players investigate |
| 2 | Clues: Information pointing to suspects/locations |
| 3 | Red Herrings: False leads that seem promising |
| 4 | Revelation: Key discovery that clarifies situation |
| 5 | Confrontation: Confront culprit or reveal truth |
...
Act 1: Introduction (Session 1)
- Present hook
- Introduce key NPCs
- Establish stakes
- Give players clear short-term goal

Act 2: Rising Action (Session 1-2)
- Players pursue goal
- Encounters increase in difficulty
- New information complicates situation
- Players make meaningful choices

Act 3: Midpoint Twist (Session 2-3)
- Major revelation changes everything
- Stakes increase dramatically
- New threat or ally emerges
- Players must adapt plan

Act 4: Approaching Climax (Session 3-4)
- Final preparations
- Point of no return
- All pieces come together
- Building to showdown

Act 5: Climax and Resolution (Session 4)
- Major encounter/decision
- All previous choices matter
- Clear victory or defeat conditions
- Immediate consequences
- Seeds for next adventure

### Building Tension

Early Adventure (Sessions 1-2):
- Easier encounters
- Success comes easier
- Players feel capable
- Information flows

Middle Adventure (Sessions 2-3):
- Harder encounters
- Complications arise
- Resources depleting
- Time pressure introduced

Late Adventure (Sessions 3-4):
- Hardest encounters
- Multiple threats at once
- Resources scarce
- High stakes, real danger

### Using Time Pressure

Introduce countdown or deadline:
- "Ritual completes in 3 days"
- "Convoy leaves at dawn"
- "Corruption spreading, infects 1d6 more citizens daily"

Each session: Advance the countdown. Make consequences clear.

If players delay: Bad things happen. Don't pull punches, but don't make it impossible either.

---

## Encounters by Party Level

### Levels 1-4: Local Threats

Appropriate Challenges:
- Local bandits, wild animals
- Minor undead, goblins
...
Appropriate Challenges:
- Organized crime, mercenary companies
- Young dragons, ettins, trolls
...
Rewards:
- 5,000-50,000 gp
- Rare to very rare magic items
- Command positions
- Political power

### Levels 17-20: World-Ending Threats
...
Problem: Players have no real choices. One path only.

Fix: Always provide 2-3 ways to approach situations. Accept unexpected solutions.

### Killer DM

Problem: Adventure designed to kill players or "beat" them.

Fix: Challenge players, but give them tools to succeed. Death should result from bad choices, not unfair design.

### No Stakes

Problem: Nothing bad happens if players fail or delay.

Fix: Establish clear consequences. If players ignore quest, things get worse.

### Too Many NPCs

Problem: Players can't remember who's who.

Fix: Limit to 5-6 major NPCs per adventure. Give each distinctive feature.

### Info Dump

Problem: Pages of backstory dumped on players.

Fix: Reveal information through play. Show, don't tell. Let players discover it.

### Ignoring Player Choices

Problem: Players' decisions don't matter, everything leads to same outcome.
...
Hook: Steal valuable item from well-guarded location
Investigation Phase: Scout location, gather information
Planning Phase: Players devise approach
Execution Phase: Pull off the heist
Escape Phase: Get away with loot
Resolution: Deal with consequences

Key NPCs:
- Quest giver (patron)
- Inside contact (information)
- Rival thief (complication)
- Guard captain (opposition)

### Template 2: The Rescue

Hook: Someone important captured
Investigation Phase: Learn where they're held
Infiltration Phase: Sneak into enemy territory
Rescue Phase: Free the captive
Escape Phase: Get out alive
Resolution: Return safely, learn why they were taken

Key NPCs:
- Captive (rescue target)
- Captor (villain)
- Betrayer (sold them out)
- Insider (helps escape)

### Template 3: The Mystery

Hook: Crime or strange occurrence
Investigation Phase: Gather clues
Suspect Phase: Identify potential culprits
Revelation Phase: Discover truth
...
Tracking Phase: Follow trail
Encounter Phase: First confrontation (escapes)
Ambush Phase: Set trap or be ambushed
Final Battle: Climactic showdown
Resolution: Safety restored, but at what cost?

Key NPCs:
- Hunter (rival or ally)
- Victim (survived attack, has information)
...
| Roll | Result |
|-----|--------|
| 1 | Write one-sentence premise |
| 2 | Design 3-5 locations |
| 3 | Create 3-5 major NPCs |
...
- Adjust difficulty based on how players are doing
- Cut boring parts, zoom into interesting parts
- Let player choices have consequences

After Adventure:
- Note what worked and what didn't
- Plant seeds for next adventure in resolution
- Award appropriate rewards
- Give players sense of accomplishment
...
## Long-Term Play and Story Arcs
 ::
## Campaign vs Adventure

Adventure: Self-contained story (3-6 sessions)
Campaign: Series of interconnected adventures (months or years of play)

A campaign has:
- Overarching plot or threat
...
- 5-10: Regional faction conflicts
...
Campaign Hooks:
- Spies in faction hierarchy
- Noble houses vying for power
- Iron Guild playing both sides
- Church hiding dangerous secrets
- Assassinations and betrayals

Escalation: Local politics → Regional scheming → Continental conspiracy → World-changing revelation

Levels 1-20 Arc:
- 1-4: Caught in local power struggle
- 5-10: Faction agents, missions
- 11-16: High-level politics, Continental intrigue
- 17-20: Reshape political landscape

### Personal Quests

Central Conflict: Character backstories drive campaign

Campaign Hooks:
- Revenge against those who wronged them
- Seeking lost family member
- Reclaiming stolen heritage
- Breaking family curse
- Proving themselves worthy

Escalation: Personal discovery → Local consequences → Regional impact → World-changing destiny

Levels 1-20 Arc:
- 1-4: Learn about past
- 5-10: Confront personal villains
- 11-16: Past has bigger implications
- 17-20: Personal arc affects world
...
Structure: Self-contained adventures with recurring cast and setting

Pros:
- Easy for players to miss sessions
- Low commitment
- Clear endings
- Easy to run
...
Structure: Interconnected adventures building toward major conclusion
...
Cons:
- Harder if players miss sessions
...
Structure: Episodic adventures with serialized backbone

How It Works:
- Main story progresses in background
- Most sessions are self-contained adventures
- Every 3-4 adventures, major plot advancement
- Players can miss sessions without losing thread

Example: Resistance Campaign
Session 1-3: Rescue prisoners (self-contained)
Session 4: Discover Thaldros attack plans (plot advancement)
Sessions 5-7: Steal supplies (self-contained)
Session 8: Betrayed by ally working for enemy (plot advancement)
Sessions 9-11: Infiltrate enemy fortress (self-contained)
Session 12: Thaldros invasion begins (major plot event)
...
Scope: Single settlement or small region
Threats: Local problems (bandits, monsters, corrupt officials)
Stakes: Save village, stop local cult, expose corruption
Power Level: Ordinary people with extraordinary potential
...
### Levels 5-10: Regional Agents

Scope: Multiple settlements, entire region
Threats: Organized factions, significant monsters, political intrigue
Stakes: Regional stability, faction conflicts, prevent disasters
Power Level: Recognized heroes, faction agents

Session Structure:
- Adventures with regional consequences
- Faction missions
- Discover bigger threats
- Political entanglements

Rewards: 500-5,000 gp per adventure, uncommon/rare items, faction rank

Focus: Faction relationships, moral complexity, meaningful choices
...
Session Structure:
- High-stakes missions affecting thousands
- Command armies or cells
- Face ancient evils
- Make decisions affecting nations

Rewards: 5,000-50,000 gp per adventure, rare/very rare items, titles and lands
...
Focus: Legacy, final choices, satisfying conclusion
...
- Medium: 20-40 sessions (Levels 1-15)
- Long: 40+ sessions (Levels 1-20)

3. Outline Major Arcs:
Break campaign into 3-5 major story arcs

Example - War Campaign (30 sessions):
- Arc 1 (Levels 1-5, 8 sessions): Join Resistance, local operations
- Arc 2 (Levels 6-10, 10 sessions): Faction intrigue, spy network
- Arc 3 (Levels 11-15, 10 sessions): Major battles, political upheaval
- Conclusion (Level 15-16, 2 sessions): Peace treaty or final victory

4. Identify Key NPCs:
Create 5-10 major NPCs who will recur throughout campaign:
- Allies (quest givers, mentors)
- Rivals (competing heroes or factions)
- Villains (antagonists, growing threat)
- Neutrals (Iron Guild, merchants, informants)

5. Establish Factions:
Identify which factions matter and their agendas
...
Tone: Serious but with moments of levity. Gritty realism mixed with heroic fantasy."

2. Safety Tools (10 minutes):
Establish X-card, lines and veils, consent checklist.
- What content should we avoid?
- What should we fade to black?
- How do we communicate discomfort?

3. Character Creation Together (60-90 minutes):
Create characters as group, not in isolation.

Connections: Each character must have:
- Connection to one other PC (established together)
- Reason to care about campaign theme
- Personal goal that can drive adventures

4. Establish Party Dynamic (15 minutes):
- How did you meet?
- Why do you trust each other?
- What's your group's dynamic?
- Do you have a name?

5. Set Logistics (10 minutes):
...
Identify 2-3 elements from each character's backstory that can become adventures or plot threads.

Example - Character: Marcus, Ex-Thaldros Soldier
Backstory: Deserted when ordered to kill civilians. Mentor (Commander Vale) helped him escape.

Incorporated:
- Session 8: Commander Vale sends coded message asking for help
- Session 15: Vale captured, faces execution for treason
- Session 22: Vale reveals why he helped Marcus - bigger conspiracy

Distribution:
Each character should have:
- 2-3 backstory adventures (focused on them)
- Regular moments to shine using their skills
- Character development opportunities

### When to Focus on Each Character

Don't:
- Do every character's backstory at once
- Ignore certain characters
- Make backstory adventures feel disconnected from main plot
...
Three-Act Structure for Each Arc:

Act 1 - Setup (2-3 sessions):
- Introduce arc's threat
- Establish stakes
- Give players goal

Act 2 - Development (3-5 sessions):
- Players pursue goal
- Complications arise
- Midpoint twist
- Stakes increase

Act 3 - Resolution (1-2 sessions):
- Final confrontation
- Consequences
...
### The Final Arc (Last 5-8 Sessions)

Structure:

Sessions 1-2: Gathering Allies
Call in favors, unite factions, prepare for final battle

Sessions 3-4: Final Preparations
Gather intelligence, craft weapons, final character moments

Session 5: Point of No Return
Launch final offensive, no going back
...
Good endings have:
- Direct result of player choices throughout campaign
- Every character gets moment to shine
- Clear victory or defeat conditions
- Consequences shown
- Emotional payoff
- Hints at characters' futures

Don't:
- Pull victory out of nowhere
- Ignore player choices in final moments
- Kill everyone for shock value
- Leave major threads unresolved
- Rush the ending

### Epilogue Session

After main campaign ends, dedicate one session to:

1. Immediate Aftermath (1 hour):
What happens right after final battle? Celebration? Mourning? Political shifts?

2. Character Fates (1-2 hours):
Go around table. Each player describes what their character does next:
- Do they retire? Continue adventuring?
- What relationships did they form?
- What's their legacy?

3. World State (30 minutes):
Describe how world changed because of party's actions:
- Political landscape
- Faction status
- Major NPCs
- Lasting impacts
...
### Problem: Players Not Engaged with Plot

Symptoms:
- Players ignore hooks
- Focus on side activities
- Don't care about NPCs or factions

Solutions:
- Tie plot to player backstories
- Make stakes personal
- Let players drive story
- Ask them what they want

### Problem: Pacing Issues
...
Solutions:
- Cut or combine adventures
- Resolve minor threads
- Fast-forward through downtime
- Escalate stakes

### Problem: Power Imbalance

Symptoms:
- One player dominates
- Some characters feel useless
- Unequal spotlight time

Solutions:
- Design encounters targeting different skills
...
Symptoms:
- Players fighting in or out of character
- Disruptive behavior
- Some players not having fun

Solutions:
- Session zero revisit
...
Symptoms:
- Players don't remember what's happening
...
|-----|--------|
| 1 | Choose theme |
| 2 | Outline 3-5 major arcs |
| 3 | Create 5-10 recurring NPCs |
...
- Flexible plans are better than rigid ones
- Not every campaign reaches level 20
- Better to end satisfyingly early than drag on too long
...
# Chapter 4: Secret Locations

## Hidden Places of Power

Locations players won't find in the World Guide.
...
Hook: PCs find 1 faculty key, must acquire others or break in.
...
- Ritual chamber with time distortion effects
- Portal to a demiplane (locked)

Plot: Monks aren't evil—they genuinely seek knowledge. But their patron may be corrupted.

Treasure: *Staff of Forgotten Moments* (legendary), historical texts worth 5,000 gp.

---

## Nexus of Seven Sorrows
Location: Sundering Sea floor, exact coordinates lost
Secret Level: Tier 4 (Mythical)

Description: Where the first seal was broken. Now a corrupted ley nexus radiating void energy.
...
- Haunted by drowned empire ghosts (10d10 specters)
...
## The Wandering Tower
Location: Appears randomly near ley nexuses
Secret Level: Tier 3 (Known only to Circle survivors)
...
Encounter: Valdren attacks intruders initially, but can be convinced to share knowledge (DC 20 Persuasion, or prove you're trying to fix his mistakes).

Information: Complete history, ritual to reinforce seals (requires legendary quest), locations of all nexuses.
...
- Ancient Sewers: Abandoned 200 years ago, now monster lair
- Imperial Ruins: Original city, partially flooded
- The Deep Vault: Where city's portion of imperial treasury was stored

Inhabitants:
- Smugglers (levels 1-2)
- Otyughs, ropers (levels 3-5)
- Undead imperial guards (levels 6-8)
- The Vault Guardian: Modified iron golem (CR 16)

Treasure: 50,000 gp in old imperial currency (collectors pay 3× face value), magic items, historical artifacts.

Hook: City council will pay 5,000 gp to clear undercity and recover treasury.

---

## The Singing Stones
Location: Northern Thaldros, remote valley
Secret Level: Tier 2 (Druid secret)

Description: Circle of standing stones that hum with ley line energy. Druids use for rituals.

Powers:
- Scrying across ley line network (requires attunement)
- Speak with ancient spirits (once per week)
...
- Portal to Feywild (new moon only)
- Ritual site (+5 to spellcasting checks here)
...
- The Devourer in center (size: gargantuan, appears as living void)
- Seal mechanisms in cardinal directions
- Each mechanism requires legendary artifact to operate

Encounter: The Devourer will bargain—offers incredible power in exchange for weakening just one seal mechanism. Lying. Will consume whoever accepts.

Outcome:
- Reinforce seal: Prevents catastrophe for 1,000 years
- Weaken seal: Devourer escapes in 1d10 years
- Drain power: Gain artifact but weaken seal by 50 years

---

## Goldreach Vault 13
Location: Beneath Goldreach central bank
Secret Level: Tier 1 (Known to thieves)

Description: Goldreach Bank has 12 public vaults. Vault 13 is unacknowledged.

Contents:
- Embezzled funds: 100,000 gp
- Blackmail material on 20 nobles
- Stolen art worth 50,000 gp
- Ledger proving bank owner funds Thornwood Syndicate

Security:
- Bank guards (20, levels 1-3)
- Magical locks (DC 25 to pick)
- Glyph of warding (fireball)
- Alarm spell (silent, alerts owner)

Heist Challenge: Getting in isn't hard—getting out with proof before guards arrive is.

Consequence: Exposing vault brings down bank owner, destabilizes Goldreach economy, but weakens Thornwood Syndicate.

---

## Temple of the Void Saints
Location: Contested Lands, moving camp
Secret Level: Tier 2 (Active threat)

Description: Cult worshipping The Devourer. Believe void will bring transcendence.

Leader: High Voidcaller Malthus (CR 11 warlock)
...
Camp: 40 cultists (CR 1/2 each), 6 void-touched (CR 3), Malthus, portable altar (desecrated ground effect).

Plot: Malthus genuinely believes void will save people from suffering. Debate him (DC 22 Persuasion) or fight.

Loot: *Void Crystal* (arcane focus, +2 to spell attacks, deals 1d6 necrotic to wielder on critical fails), 8,000 gp stolen goods.
...
- Planar effects: Roll on Wild Magic table every round
- Elementals pour through (endless spawn)
- Reality unstable: Gravity may reverse, time may slow

Opportunity: Portal to Elemental Planes, access to primordial essence (material component for epic magic).

Survival: DC 25 Arcana check to stabilize personal reality bubble. Lasts 10 minutes.

Treasure: Primordial essence (worth 10,000 gp per vial, 1d4 vials available), planar gems (5d10 × 100 gp).

---

## Using Secret Locations

Tier 1 (Levels 1-4): Ashgate Undercity, Goldreach Vault 13
Tier 2 (Levels 5-10): Forgotten Monastery, Singing Stones, Void Saints Temple
Tier 3 (Levels 11-16): Black Archive, Wandering Tower
Tier 4 (Levels 17-20): Nexus of Seven Sorrows, Obsidian Spire, Riftmaw

Integration: Drop hints in early game. Map fragments, NPC rumors, historical texts. Build toward high-level locations.

{{pageNumber,auto}}
{{footnote Part II: Running the Game}}
\page

# Chapter 5: Magic Mechanics Deep Dive: How Magic Really Works in Tirvandor
...
- Arcana DC 15: Feel ley line within 1 mile
- Arcana DC 20: Determine direction and strength
- Druid/Ranger: Automatic awareness within 1 mile (part of natural world)

### Ley Line Map (DM Reference)
...
### Requirements
- Caster level ≥ spell level ×2
- Access to spell slot of desired level
- Arcana proficiency
- Downtime: 1 week per spell level
- Cost: 50 gp × spell level
- Workspace: Library or laboratory
...
Roll 1d6 if spell creation failed by <5:

| d20 | Result |
|-----|--------|
| 1 | Unstable: Roll d20 when cast. On 1-2, wild magic surge. |
| 2 | Exhausting: Caster gains 1 level exhaustion after casting. |
| 3 | Obvious: Spell creates loud noise or bright flash. |
| 4 | Slow: Requires 1 round longer to cast. |
| 5 | Painful: Deals 1d6 damage per spell level to caster. |
| 6 | Unreliable: 10% chance spell simply fails when cast. |


Flawed spells can be fixed with another week of work and DC 15 Arcana check.

### Example Spells PCs Might Create

Tirvandor's Temporal Refuge (4th level, transmutation)
- Casting Time: 1 action
- Range: Self
- Duration: Special
- Effect: You step into a pocket dimension for up to 1 hour (your time). To outside observers, you disappear and reappear instantly. You age normally during this time.

Ley Line Sight (2nd level, divination)
- Casting Time: 1 action
- Range: Self
...
Requirements:
- Caster level 5+ (uncommon), 9+ (rare)
- Appropriate spell or class feature
- Materials: 500 gp (uncommon), 5,000 gp (rare)
- Time: 1 week per 1,000 gp value
- Workspace: Forge, lab, or enchanting chamber
...
Requirements:
- Caster level 13+ (very rare), 17+ (legendary)
- Access to ley nexus
- Materials: 50,000 gp (very rare), 500,000 gp (legendary)
- Time: 30 days per item
- Sacrifice: −2 to one ability score (minimum 8), permanent

Process:
- 30-day ritual at nexus
- Arcana check DC 22 (very rare), DC 25 (legendary)
- Success: Item created, crafter suffers ability score loss
- Failure: Lose all materials, suffer ability score loss anyway, wild magic backlash (roll on table)

Limitation: Can only create 1 legendary item per lifetime. Very rare: 1 per 5 years.

## Ritual Casting

### Standard Rituals

Any ritual spell can be cast by anyone who:
...
Consecrated Ground:
- Temple of aligned deity: +2 to ritual spell checks
- Ancient shrine: +1, may have side effects
- Desecrated ground: −2, attracts hostile entities

Ley Nexus Rituals:
- Double ritual spell duration
- Increase spell save DC by +2
- Can affect area 2× normal size

### Custom Rituals (DM Tool)

For plot-important rituals not in spell list:

Requirements:
- Multiple casters (1d4+2 recommended)
- Ritual time: 1 hour per desired spell level equivalent
...
Roll d20 when:
- Casting at corrupted nexus (1-3 triggers)
- Casting with flawed spell (1-2 triggers)
...
| d10 | Result |
|-----|--------|
| 1 | Ley Feedback: All creatures within 30 ft take 2d10 force damage. DC 15 Dex save for half. |
| 2 | Temporal Hiccup: Time reverses 6 seconds. Everyone except caster remembers. Caster can act differently. |
| 3 | Primordial Whisper: Caster hears ancient language. DC 16 Wis save or gain short-term madness. |
| 4 | Reality Thin: Portal opens to random plane for 1 minute. 1d4 creatures emerge (DM choice). |
| 5 | Magic Amplified: Spell succeeds at 2× power. Caster gains 1 exhaustion. |
| 6 | Magic Null: 30 ft radius antimagic field, 1 minute. Centered on caster. |
| 7 | Ley Surge: Spell targets 1d4 additional random creatures within range. |
| 8 | Elemental Storm: Random element (fire/ice/lightning/acid) fills 20 ft radius. 3d10 damage, Dex DC 15. |
| 9 | Memory Loss: Caster forgets why they cast spell. Confused (as spell) for 1 round. |
| 10 | Power Drain: Caster loses spell slot 1 level higher than spell cast (if available). |
| 11 | Blessing: Spell succeeds, caster gains inspiration. |
| 12 | Stable Flux: No additional effect. Wild Magic suppressed for 1 hour. |
...
- Caster must spend 4 hours/day meditating with artifact
- Arcana DC 20 to successfully attune
- Failure: Take 4d10 psychic damage, can retry after long rest

### Sentient Artifacts

Tirvandor artifacts are often sentient. When attuning:
...
- Opposed: −2 penalty, artifact may betray wielder at dramatic moment
...
- Wearer immune to divination
- 3 charges: Erase 1 minute of memory from all who witness an event (DC 20 Wis negates)
- Sentience: Int 20, Wis 8, Cha 12, CN alignment
- Goal: Catalog all forgotten lore
- Flaw: Occasionally erases wielder's memories (DM choice)
...
Permanent Portal:
- Requires: 9th level spell slot, ritual at ley nexus, 100,000 gp materials
- Time: 10 days
- Check: Arcana DC 25
- Result: Two-way portal between nexuses

Temporary Portal:
- Use *gate* spell normally
- At ley nexus: Duration doubles, save DC +2

---

## Using Magic Mechanics

For Plot:
- PCs discover corrupted nexus, must cleanse it
- Villain creating artifact, PCs must interrupt ritual
- Ley lines failing, world's magic weakening

For Player Agency:
- Let wizards research spells
- Allow downtime crafting
- Reward creative ritual use

Balance:
- Spell creation is expensive and time-consuming
- Artifact creation is heroic sacrifice
- Wild Magic keeps ley nexuses risky

{{pageNumber,auto}}
{{footnote Part II: Running the Game}}
\page
# Part III: Treasure
# Chapter 6: Treasure & Magic Items
...
![1: BORDER CAPTAIN'S BADGE](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-border-captains-badge.jpg) {width:200px,mix-blend-mode:multiply}
...
![4: POTION OF FIRE RESISTANCE](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-potion-of-fire-resistance.jpg) {width:150px,mix-blend-mode:multiply}
...
![5: POTION OF GREATER HEALING](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-potion-of-greater-healing.jpg) {width:200px,mix-blend-mode:multiply}
...
![7: WAND OF MAGIC MISSILES](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-wand-of-magic-missiles.jpg) {width:200px,mix-blend-mode:multiply}
...
![9: AMULET OF HEALTH](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-amulet-of-health.jpg) {width:200px,mix-blend-mode:multiply}
...
![11: DRAGON SLAYING ARROWS (SET OF 3)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-dragon-slaying-arrows.jpg) {width:200px,mix-blend-mode:multiply}
...
![12: DRAGON WARDING AMULETS (SET OF 4)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-dragon-warding-amulets.jpg) {width:200px,mix-blend-mode:multiply}
...
![13: FLAMING LONGSWORD - PHOENIX VARIANT](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-flaming-longsword.jpg) {width:200px,mix-blend-mode:multiply}
...
![14: MORNINGSTAR - HOLY RADIANT](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-morningstar-_1.jpg) {width:200px,mix-blend-mode:multiply}
...
![19: RING OF SPELL STORING](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-ring-of-spell-storing.jpg) {width:200px,mix-blend-mode:multiply}
...
![21: BELT OF GIANT STRENGTH (FROST GIANT)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-belt-of-giant-strength-frost.jpg) {width:200px,mix-blend-mode:multiply}
...
![23: ETERNAL WINTER SHARD](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-eternal-winter-shard.jpg) {width:150px,mix-blend-mode:multiply}
...
![28: STAFF OF DYNASTIES](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-staff-of-dynasties.jpg) {width:150px,mix-blend-mode:multiply}
...
![29: STAFF OF POWER](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-staff-of-power.jpg) {width:150px,mix-blend-mode:multiply}
...
![30: VOIDBLADE LONGSWORD](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-voidblade-longsword.jpg) {width:200px,mix-blend-mode:multiply}
...
![32: ARMOR OF THE UNBREAKABLE](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-armor-of-the-unbreakable.jpg) {width:200px,mix-blend-mode:multiply}
...
![34: CLOAK OF INVISIBILITY](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-cloak-of-invisibility.jpg) {width:200px,mix-blend-mode:multiply}
...
![39: NECROMANCER LORD'S PHYLACTERY](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/items/tirvandor-item-necromancer-lords-phylactery.jpg) {width:200px,mix-blend-mode:multiply}
...
**Speed** :: 30 ft.
![King Aldric IV Thandris](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-king-aldric-iv-thandris.jpg){width:325px,mix-blend-mode:multiply}
___
...
- **Race:** Human
- **Age:** 52
- **Location:** Kaer Thandros, The Iron Palace
- **Role:** High King of Thaldros (Western Continent)
- **Alignment:** Lawful Neutral
- **Class:** Fighter 15 / Noble Background

### Physical Description
Tall and powerfully built (6'4", 220 lbs), with broad shoulders and a commanding presence. Steel-gray hair cut short, kept beard neat and trimmed. Deep-set brown eyes that miss nothing. Weathered face with a scar across his left cheek from a border skirmish in his youth. Always stands with perfect military posture.

### Equipment
- **Armor:** Plate Armor +2 (Mythril-forged, black iron finish, Thandris family crest)
- **Shield:** Tower Shield +2 (Iron-bound, bears the mountain sigil)
- **Primary Weapon:** Thrandil's Edge (Legendary longsword, see above)
- **Secondary:** Heavy crossbow (masterwork), 20 bolts
- **Crown:** Iron Crown of Thaldros (counts as +2 circlet of intellect for official duties)
- **Ring:** Ring of Protection +1
- **Cloak:** Cloak of Protection (heavy fur-lined, royal purple)
- **Other:** Royal seal, ceremonial regalia worth 5,000 gp

### Personality
**Traits:**
- Speaks in clipped, military tones; every word has purpose
- Stands when others enter the room out of respect and dominance
- Constantly assesses threats and tactical situations
- Values loyalty above all other virtues

**Ideals:**
- **Duty:** "The crown is a burden I bear for my people, not a treasure I enjoy."
- **Strength:** "Only through strength can we protect what matters."
- **Legacy:** "My ancestors built this kingdom; I will not be the one to lose it."
...
- Views compromise as weakness, especially with House Aethermere
...
### Plot Hooks
1. **The High King's Quest:** Hires party to find the legendary proof of succession—the High King's Sword or crown jewels from the Sundered Palace.
2. **Assassination Plot:** The Syndicate makes another attempt. Party must protect him or investigate who hired the killers.
3. **Northern Crisis:** Giants are pushing boundaries of the secret treaty. King needs deniable agents to resolve situation.
4. **The Lost Heir:** Evidence surfaces of a third bloodline. King wants party to investigate quietly.
5. **Dragon's Return:** A dragon attacks the border. King needs heroes to deal with it—but secretly, it might be tied to his family's past.
6. **Princess in Danger:** One of his children is kidnapped or threatened. King will pay anything for their safe return.
7. **The Unity Summit:** King arranges a summit with Queen Aelindra. Needs party to ensure security and perhaps influence negotiations.

### Roleplaying Notes
**Voice:** Deep, commanding, formal. Uses "we" when speaking officially. Short sentences.
**Mannerisms:** 
- Taps fingers on sword pommel when thinking
- Stands with weight on both feet, ready for combat
- Makes direct eye contact—holds it until others look away
- Adjusts armor straps when stressed

**In Combat:** Fights from the front. Protects weaker allies. Never retreats unless tactical. Uses Intimidating Presence to break enemy morale.

**Social Situations:** Formal, proper, expects respect. Will relax slightly with trusted advisors. Enjoys strategic discussions. Has dry sense of humor that catches people off-guard.

**Goals:**
- Short-term: Secure the northern border, maintain stability
- Medium-term: Prove his claim to High King title
- Long-term: Reunify the realms under Thandris rule (but only if truly best for everyone)

### Notes for DMs
- Use him as quest-giver for high-level parties
- Can be ally or obstacle depending on party's goals
- Not evil—genuinely believes he's doing right thing
- Complex character—military pragmatist with hidden depths
- His stubbornness can create problems even when he's right
...
**Speed** :: 30 ft.
![High Queen Aelindra Aethermere](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-high-queen-aelindra-aethermere.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 14 (+2) | 16 (+3) | 22 (+6) | 18 (+4) | 20 (+5) |
___
**Saving Throws** :: Intelligence +12, Wisdom +10
**Skills** :: Arcana +12, History +12, Insight +10, Perception +10, Persuasion +11
**Damage Resistances** :: Force (from protective spells)
**Senses** :: Darkvision 60 ft., Passive Perception 20
**Languages** :: Common, Elvish, Celestial, Draconic, Sylvan, Deep Speech, Primordial
**Challenge** :: 16 (15,000 XP)
___
***Spellcasting.*** :: 16th-level wizard. Spell save DC 20, +12 to hit with spell attacks.
...
***2nd level (3 slots).*** :: Detect Thoughts, Mirror Image, See Invisibility
***3rd level (3 slots).*** :: Clairvoyance, Counterspell, Dispel Magic
***4th level (3 slots).*** :: Arcane Eye, Banishment, Greater Invisibility
***5th level (2 slots).*** :: Scrying, Teleportation Circle, Wall of Force
***6th level (1 slot).*** :: True Seeing, Globe of Invulnerability
***7th level (1 slot).*** :: Teleport, Plane Shift
***8th level (1 slot).*** :: Maze, Mind Blank*
***9th level (1 slot).*** :: Foresight*, Time Stop
***Portent (2/Day).*** :: After a long rest, roll 2d20. Can replace any attack roll, save, or check with one of these rolls.
***Expert Divination.*** :: Regains a spell slot (up to 5th level) when casting divination spell of 2nd level or higher.
***The Third Eye (1/Rest).*** :: Can see invisible creatures, read any language, see into Ethereal Plane, or gain darkvision 60 ft. for 1 hour.
***Fey Ancestry.*** :: Advantage against being charmed, immune to magical sleep.
***Trance.*** :: Meditates for 4 hours instead of sleeping.
***Queen's Wisdom.*** :: Has advantage on Insight and Persuasion checks when in her realm.
***Starlight Blessing.*** :: Once per day, can cast Lesser Restoration or Remove Curse without expending a spell slot.
### Actions
***Multiattack.*** :: Casts a cantrip and uses her Star Staff, or casts two cantrips.
***Star Staff (Quarterstaff +3).*** :: Melee Weapon Attack: +8 to hit, reach 5 ft., one target. ***Hit.*** 1d6+2 bludgeoning damage (1d8+2 versatile), plus 2d8 force damage.::
***Special.*** :: Can cast a wizard spell through the staff as a bonus action once per turn.
***Spellcasting.*** :: Casts a spell from her prepared list.
### Reactions
***Shield.*** :: Casts Shield to increase AC by 5 until start of next turn.
***Counterspell.*** :: Automatically counters spells of 6th level or lower, or makes check for higher levels.
***Precognitive Defense.*** :: Using Portent, can change an enemy's attack roll to one of her portent rolls.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Casts a cantrip.
**Detect.** :: Makes a Wisdom (Perception) or Intelligence (Investigation) check.
**Spell (Costs 2).** :: Casts a spell of 3rd level or lower.
**Foresight (Costs 3).** :: Uses her divination to grant one ally within 60 feet advantage on their next attack roll, save, or check.
...
### Equipment
- **Armor:** Robes of the Archmagi (white with silver stars, AC 15 + Dex modifier)
- **Staff:** Star Staff (legendary quarterstaff, see above, acts as Rod of Absorption)
- **Crown:** Crown of Stars (silvery circlet, functions as Headband of Intellect +2 but already included in stats)
- **Ring:** Ring of Protection +1
- **Cloak:** Cloak of Displacement (appears as flowing starlight)
- **Amulet:** Amulet of Proof Against Detection and Location
- **Spellbook:** The Chronicle of Stars (contains all wizard spells up to 7th level, some 8th-9th)
- **Other:** Crystal focus, royal seal, several spell scrolls, potions of greater healing (3)

### Personality
**Traits:**
- Speaks slowly and deliberately, as if each word has been foreseen and chosen
- Makes eye contact that seems to see your past, present, and future
- Often pauses mid-conversation, as if listening to something others can't hear
- Smiles knowingly, which can be comforting or unnerving
...
**Bonds:**
- Aethermere and the elven people are her sacred trust
- The ancient traditions and wisdom of the pre-Worldrend elves must be preserved
- Her son, Prince Eldrin, whom she's carefully preparing to rule
- The stars themselves, which she believes hold the answers to all questions

**Flaws:**
- Sometimes so focused on long-term future that she misses immediate crises
- Can appear cold or detached because she's seen so many possible futures
- Trusts her divinations absolutely—sometimes to her detriment when magic fails
...
- **Magical Mentor:** Archmage Veridian Starweaver (University)
- **Spiritual Guide:** Archdruid Silvaris Oakenheart
- **Rival:** King Aldric IV Thandris (political opponent, but respects him)
- **Concern:** The growing power of the Syndicate in both continents
- **Secret:** Has regular visions of a potential Second Worldrend
{{pageNumber,auto}}
{{footnote Part IV: NPCs}}
\page
{{descriptive
#### Secrets (DM Only)
1. **The Vision:** Has foreseen multiple possible futures, several involving catastrophe. Working quietly to prevent them without revealing the full scope of danger (might cause panic).
2. **The Lost Sister:** Had a twin sister who died in the Worldrend. Consults her spirit through magic (others don't know). Sister's advice is sometimes... questionable.
3. **The True Heir:** Her divinations show that neither Thandris nor Aethermere is the "true" heir—but also show three different people who could be. Trying to identify them.
4. **The Stars' Warning:** The stars have gone "quiet" in recent years. Her divination magic still works, but there's a sense that something is blocking or changing fate itself. This terrifies her.
5. **Mother's Death:** Officially died of old age. Truth: sacrificed herself in a ritual to prevent something terrible. Aelindra continues the ritual monthly in secret.
}}

### Plot Hooks
1. **The Prophecy Quest:** Hires party to investigate a prophecy that promises revelation but requires dangerous journey.
2. **Stolen Future:** Her Portent ability stops working—someone or something is blocking divination magic. Party must find out why.
3. **The Lost Prince:** Prince Eldrin goes missing while researching ancient magic. Queen needs discreet heroes to find him.
4. **Diplomatic Mission:** Sends party as emissaries to Thaldros to discuss potential peace. They might represent her at crucial negotiations.
5. **The Third Heir:** Party finds evidence of the mysterious third bloodline. Queen wants them to investigate without alerting the other houses.
...
**Mannerisms:**
- Gazes into distance as if seeing beyond present moment
...
**Social Situations:** Gracious host, excellent listener, gives impression she knows more than she says. Diplomatic but firm. Uses divination to anticipate arguments and prepare responses.

**Goals:**
- Short-term: Maintain peace and prosperity in Aethoria
- Medium-term: Prevent the catastrophes she's foreseen
- Long-term: Guide the realms toward reunification when the time is right (but not forced)

### Notes for DMs
- Use her as patron for parties working for greater good
- Excellent quest-giver for mysteries and prophecies
- Her Portent ability means she might know party is coming
- Can serve as deus ex machina but use sparingly
- Interesting moral conflict: she knows terrible futures but can't prevent all of them—which does she choose?
- Good foil to King Aldric IV—wisdom vs. strength, patience vs. action
...
**Speed** :: 30 ft.
![Merchant Prince Davos Goldshore](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-merchant-prince-davos-goldshore.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 18 (+4) | 14 (+2) | 16 (+3) | 14 (+2) | 20 (+5) |
___
**Saving Throws** :: Dexterity +9, Intelligence +8, Wisdom +7, Charisma +10
**Skills** :: Deception +15, Insight +12, Intimidation +10, Investigation +8, Perception +7, Persuasion +15, Sleight of Hand +9, Stealth +9
**Damage Resistances** :: Psychic (from Words of Terror feature)
**Senses** :: Darkvision 60 ft., Passive Perception 17
**Languages** :: Common, Elvish, Dwarvish, Halfling, Thieves' Cant, Draconic
**Challenge** :: 13 (10,000 XP)
___
***Sneak Attack (6d6).*** :: Once per turn, deals extra damage when he has advantage or an ally is within 5 feet of target.
***Cunning Action.*** :: Can take bonus action to Dash, Disengage, or Hide.
***Expertise.*** :: Double proficiency in Deception, Insight, Persuasion, Investigation.
***Master of Intrigue.*** :: Can mimic speech patterns and accents. Can unerringly mimic another person's speech, writing, and behavior if studied for at least 1 hour.
***Master of Tactics.*** :: Can use Help action as bonus action. When using Help, ally also gains advantage on their next attack against the target.
***Insightful Manipulator.*** :: If he spends 1 minute observing or interacting with someone, can learn if target is his equal, superior, or inferior in:
***Misdirection.*** :: When targeted by attack while a creature within 5 feet is also within reach of attacker, he can use reaction to have attack target that creature instead.
***BARDIC INSPIRATION (d6).*** :: Can inspire allies 5 times per long rest. Lasts 10 minutes.
***SPELLCASTING (Bard).*** :: 4th-level bard. Spell save DC 15, +7 to hit with spell attacks.
***Cantrips.*** :: Message, Vicious Mockery, Minor Illusion
***1st level (4 slots).*** :: Charm Person, Disguise Self, Detect Thoughts
***2nd level (3 slots).*** :: Detect Thoughts, Suggestion, Zone of Truth
***WORDS OF TERROR.*** :: Can whisper to a creature during conversation (at least 1 minute). Target must succeed DC 15 Wisdom save or be frightened of him or another creature for 1 hour. Doesn't realize it was magically induced.
***PSYCHIC BLADES.*** :: Can expend Bardic Inspiration when dealing Sneak Attack damage to add psychic damage equal to inspiration die.
***Fey Ancestry.*** :: Advantage against being charmed, immune to magical sleep.
***Merchant's Fortune.*** :: Has advantage on Charisma checks when negotiating trade deals.
***Network of Informants.*** :: Can make Intelligence check (DC 15) to know information about any notable person or organization in Goldreach or major trade cities.
### Actions
***Multiattack.*** :: Makes two rapier attacks or one rapier attack and uses a bonus action.
***Goldvein (Rapier +2).*** :: Melee Weapon Attack: +11 to hit, reach 5 ft., one target. ***Hit.*** 1d8+6 piercing damage plus 6d6 sneak attack (if conditions met).::
***Special.*** :: On a critical hit, target must succeed DC 15 Constitution save or be poisoned for 1 minute (coated in subtle toxin).
***Hand Crossbow +1.*** :: Ranged Weapon Attack: +10 to hit, range 30/120 ft., one target. ***Hit.*** 1d6+5 piercing damage plus 6d6 sneak attack (if conditions met).::
***Spellcasting.*** :: Casts a bard spell.
### Reactions
***Uncanny Dodge.*** :: Halves damage from an attack he can see.
***Misdirection.*** :: Redirects attack to another creature (see above).
***Counteroffer.*** :: When someone makes a request or demand, can use Persuasion or Deception to completely change the terms of negotiation.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Move.** :: Moves up to his speed.
**Assess.** :: Makes an Insight check.
**Attack.** :: Makes one weapon attack.
**Whisper (Costs 2).** :: Uses Words of Terror on a creature within 5 feet.
**Manipulate (Costs 2).** :: Uses Bardic Inspiration or casts a 1st-level spell.
*"Gold opens doors that armies cannot breach, and silence is the most profitable investment."*
}}
{{pageNumber,auto}}
\page
#### Basic Information
...
### Plot Hooks
1. **The Salvage Job:** Hires party to recover something from the sunken palace. Pays extremely well but mission is dangerous and possibly illegal.
...
- Smiles that doesn't reach eyes
- Touches jewelry when calculating
- Leans back when he's won a negotiation

**In Combat:** Avoids if possible. If fighting, uses minions, traps, and poison. Fights dirty. Uses Cunning Action to escape. Only fights if escape is impossible.

**Social Situations:** Charming host, excellent conversationalist, remembers everything said. Appears to give ground in negotiations but ends up with what he wanted. Makes people feel clever for accepting his terms.

**Goals:**
- Short-term: Increase wealth and market share
- Medium-term: Control majority of cross-continental trade
- Long-term: House Goldshore becomes indispensable to both continents' economies

### Notes for DMs
- Excellent recurring patron for mercenary-type parties
- Can be ally or antagonist depending on party's actions
- Not obviously evil—just ruthlessly practical
- Good source of morally gray quests
- His resources mean he can bail out or screw over the party
- Use as example of "rich getting richer" and systemic corruption
...
**Speed** :: 40 ft.
![Sultan Rashid Al-Sahir](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-sultan-rashid-al-sahir.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 12 (+1) | 16 (+3) | 16 (+3) | 14 (+2) | 20 (+5) | 16 (+3) |
___
**Saving Throws** :: Wisdom +11, Charisma +9
**Skills** :: History +8, Insight +11, Medicine +11, Perception +11, Religion +8
**Damage Resistances** :: None
**Senses** :: Passive Perception 21
**Languages** :: Common, Celestial, Primordial, Draconic
**Challenge** :: 14 (11,500 XP)
___
***Spellcasting.*** :: 14th-level cleric. Spell save DC 19, +11 to hit with spell attacks.
***Cantrips (at will).*** :: Light, Mending, Resistance, Sacred Flame, Thaumaturgy
***1st level (4 slots).*** :: Bless, Cure Wounds, Detect Evil and Good, Sanctuary
***2nd level (3 slots).*** :: Aid, Lesser Restoration, Prayer of Healing, Spiritual Weapon
***3rd level (3 slots).*** :: Beacon of Hope, Dispel Magic, Mass Healing Word, Revivify
...
***6th.*** :: Heal
***7th.*** :: Resurrection
***- Preserve Life.*** :: Restore 70 hit points, divided among creatures within 30 feet
***DIVINE INTERVENTION.*** :: Can call upon his deity for aid. 14% chance of success. If successful, cannot use again for 7 days.
***Unarmored Defense.*** :: AC = 10 + Dex + Wis (already calculated)
***Martial Arts (1d4).*** :: Unarmed strikes deal 1d4 + Dex damage, can use as bonus action
***Ki Points (2/Rest).*** :: Can use for Flurry of Blows, Patient Defense, or Step of the Wind
***Blessed Healer.*** :: When he casts a spell that restores hit points to someone else, he regains 2 + spell level hit points.
***Supreme Healing.*** :: When restoring hit points with a 1st level or higher spell, target regains additional 5 hit points.
***Twice-Blessed.*** :: Has survived two lethal situations through divine intervention (actual game mechanic activated both times). Considered a living miracle.
***Desert Wisdom.*** :: Has advantage on Wisdom checks related to survival, weather, or desert phenomena.
### Actions
***Multiattack.*** :: Makes two unarmed strikes or one staff attack, or casts a spell.
***Sun Staff (Quarterstaff).*** :: Melee Weapon Attack: +7 to hit, reach 5 ft., one target. ***Hit.*** 1d6+1 bludgeoning damage (1d8+1 versatile), plus 2d6 radiant damage.::
***Special.*** :: Once per day, can cast Daylight as bonus action.
***Unarmed Strike.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target. ***Hit.*** 1d4+3 bludgeoning damage.::
***Sacred Flame.*** :: Target makes DC 19 Dexterity save or takes 3d8 radiant damage (no cover bonus).
***Spellcasting.*** :: Casts a cleric spell.
### Reactions
***Patient Defense.*** :: Can spend 1 ki point to take Dodge action as bonus action.
***Shield of Faith (Pre-cast).*** :: +2 AC to self or ally within 60 feet.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Move.** :: Moves up to his speed.
**Heal.** :: Touches a creature and restores 2d8 + 5 hit points.
**Bless (Costs 2).** :: Casts Bless without expending a spell slot (if not already active).
**Channel Divinity (Costs 3).** :: Uses Channel Divinity ability.
...
2. **The False Heir:** One of his spiritual successors is actually a Syndicate plant. Rashid suspects but can't prove it. Needs investigation.
3. **The Third Blessing:** Rashid receives vision that the moment for his final Divine Intervention is coming. Party must help him reach the place where it must be used.
4. **The Plague Returns:** Disease strikes Sundara again. Rashid heals everyone he can, but it's not enough. Party must find the source/cure.
...
**Mannerisms:**
- Closes eyes when praying (several times daily)
- Touches forehead, lips, heart when blessing people
- Offers water to everyone (symbolic and practical)
- Smiles even when discussing sad topics

**In Combat:** Avoids combat if possible. If fighting, focuses on healing allies and protecting innocents. Uses non-lethal methods when possible. Will use lethal force only to save lives.

**Social Situations:** Extremely approachable. Listens more than talks. Gives advice when asked, never forces it. Treats everyone with equal respect—beggar and king alike.

**Goals:**
- Short-term: Keep Sundara safe and prosperous
...
- Can be patron for holy quests
- His two Divine Interventions are legendary—third one is major campaign moment
- Use him to teach moral lessons without being preachy
...
**Speed** :: 30 ft.
![Council Mistress Elara Silverleaf](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-council-mistress-elara-silverleaf.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 14 (+2) | 18 (+4) | 20 (+5) | 16 (+3) | 14 (+2) |
___
**Saving Throws** :: Intelligence +11, Wisdom +9
**Skills** :: Arcana +17 (expertise), History +11, Investigation +11, Insight +9, Perception +9
**Damage Resistances** :: Damage from spells
**Senses** :: Darkvision 60 ft., Passive Perception 19
**Languages** :: Common, Elvish, Draconic, Dwarvish, Celestial, Abyssal, Infernal, Sylvan
**Challenge** :: 15 (13,000 XP)
___
***Spellcasting.*** :: 15th-level wizard. Spell save DC 19, +11 to hit with spell attacks.
***Cantrips (at will).*** :: Fire Bolt, Mage Hand, Message, Prestidigitation, Ray of Frost
...
***Arcane Ward.*** :: Has a magical ward with 45 hit points (2 × wizard level + Int modifier). When she takes damage, ward takes damage first. Regains 15 hit points when she casts an abjuration spell of 1st level or higher.
***Projected Ward.*** :: When a creature within 30 feet takes damage, can use reaction to have ward take damage instead.
***Improved Abjuration.*** :: When casting abjuration spell that requires check (like Dispel Magic), adds proficiency bonus (+6) to check.
***Spell Resistance.*** :: Has advantage on saving throws against spells and resistance to spell damage.
***Fey Ancestry.*** :: Advantage against being charmed, immune to magical sleep.
***Trance.*** :: Meditates for 4 hours instead of sleeping.
***Academic Authority.*** :: Has advantage on Charisma checks when dealing with scholars, students, or in academic settings.
***Master of Protection.*** :: Can cast Shield as a reaction without expending a spell slot 3 times per day.
### Actions
***Multiattack.*** :: Casts two cantrips or one spell and one cantrip.
***Staff of Power.*** :: Melee Weapon Attack: +8 to hit, reach 5 ft., one target. ***Hit.*** 1d6+2 bludgeoning damage, plus 1d8 force damage.::
***Special.*** :: Functions as Staff of Power (has multiple charges for spells and abilities).
***Spellcasting.*** :: Casts a wizard spell.
### Reactions
***Shield.*** :: +5 AC until start of next turn when targeted by attack or Magic Missile.
***Counterspell.*** :: Automatically counters spells of 5th level or lower, or makes check for higher.
***Projected Ward.*** :: Uses Arcane Ward to protect ally within 30 feet.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Casts a cantrip.
**Move.** :: Moves up to her speed.
**Spell (Costs 2).** :: Casts a spell of 3rd level or lower.
**Arcane Ward (Costs 2).** :: Restores 15 hit points to her Arcane Ward by casting an abjuration spell.
...
### Equipment
- **Robe:** Robe of the Archmagi (burgundy, AC 15 + Dex, advantage on saves vs. spells, resistance to spell damage)
- **Staff:** Staff of Power (can cast multiple spells, stores spell slots, can be used as weapon)
- **Ring:** Ring of Protection +1
- **Spellbook:** The Compendium of Wards (contains all wizard spells up to 6th level, specializing in abjuration)
- **Spectacles:** Glasses of Reading (magical, allow reading any language, worth 500 gp)
- **Other:** Component pouch, spell scrolls (Shield x3, Counterspell x2, Dispel Magic x2), potions of greater healing (2)
...
- **Protection:** "Magic should be used to protect, not destroy."
- **Excellence:** "Good enough is the enemy of great."

**Bonds:**
- The University and its students are her life's work
- The city of Silverpine must remain safe haven for learning
- Her most promising students—she tracks their careers with pride
- The great library—repository of centuries of knowledge
...
Also leads the Silverpine Council (city government). Silverpine is unique—governed by council of academics, merchants, and artisans. Elara chairs it. She's good administrator but sometimes frustrated by politics.
...
- **Concern:** The Syndicate (they've tried to infiltrate the University)
- **Student:** Has many former students in positions of power across Tirvandor
- **Rival:** Some faculty members think she's too controlling

{{descriptive
#### Secrets (DM Only)
1. **The Forbidden Vault:** University has vault of dangerous magical knowledge. Only she has access. Contains things that shouldn't exist—necromancy tomes, demon summoning, reality-breaking spells. She's studied them all (to know how to counter them, she tells herself).
2. **The Failed Student:** One of her most promising students turned to dark magic. She tried to stop him. He died in the confrontation. She's never fully forgiven herself.
3. **The True Power:** Her Staff of Power contains fragment of an ancient artifact. If reassembled with other fragments, it would create world-shattering weapon. She guards it carefully.
4. **The Secret Research:** Privately researching way to prevent another Worldrend. Has theory that requires massive magical energy. Hasn't told anyone—sounds too much like what caused first Worldrend.
...
3. **The Dark Student:** Elara's former student is using dark magic for terrible purposes. She wants party to stop them—but alive if possible, for her sake.
4. **The Research Mission:** Needs rare magical components for research. Hires party to retrieve them from dangerous location.
5. **The Infiltration:** Suspects Syndicate spy in University. Party must identify them without causing panic.
6. **The Artifact Fragments:** Party discovers fragment of the same artifact as in her staff. She wants to secure it. Others want to assemble complete artifact.
7. **The Final Exam:** Needs party to test new magical defense system. What could go wrong? (Everything.)

### Roleplaying Notes
**Voice:** Clear, precise, academic. Uses technical terms. Speaks in complete paragraphs.
**Mannerisms:**
- Adjusts spectacles when thinking
- Conjures small illusions to illustrate points
- Casts minor protective spells unconsciously (like someone cracking knuckles)
...
**Goals:**
- Short-term: Expand University, increase enrollment
- Medium-term: Establish satellite campuses in other cities
- Long-term: Make magical education accessible to all who show aptitude

### Notes for DMs
- Excellent quest-giver for magical research missions
- Can provide magical item identification, spell research, etc.
- University can be campaign location—intrigue among faculty, student problems
- Her protective magic makes her hard to kill—use as safe ally
- Good mentor figure for wizard PCs
- Her forbidden knowledge can seed dark magic plots
...
**Speed** :: 25 ft.
![Lord Commander Thrain Ironoak](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lord-commander-thrain-ironoak.jpg){width:315px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 10 (+0) | 22 (+6) | 12 (+1) | 14 (+2) | 13 (+1) |
___
**Saving Throws** :: Strength +10, Constitution +11
**Skills** :: Athletics +10, Intimidation +6, Perception +7
**Senses** :: darkvision 60 ft., passive Perception 12
**Languages** :: Common, Dwarvish
**Challenge** :: 13 (10,000 XP)
___
***Dwarven Resilience.*** :: Has advantage on saving throws against poison, and resistance to poison damage.
***Action Surge (2/rest).*** :: Extra action
***Second Wind.*** :: 1d10+13 HP as bonus action
***Improved Critical.*** :: Crits on 19-20
***Remarkable Athlete.*** :: Add half proficiency to Str/Dex/Con checks
### Actions
***Battleaxe +3.*** :: Melee Weapon Attack: +13 to hit, reach 5 ft., one target. ***Hit.*** 1d8+8 slashing (1d10+8 versatile) + 1d6 fire::
***Warhammer +2.*** :: Melee Weapon Attack: +12 to hit, reach 5 ft., one target. ***Hit.*** 1d8+7 bludgeoning (1d10+7 versatile)::
***Extra Attack (3).*** :: Attacks three times per turn
}}

### Equipment
Plate Armor +2 (mythril, dwarf-forged), Battleaxe +3 "Kingbreaker" (returns when thrown), Shield +1, Warhammer +2, Cloak of Protection, Ring of Feather Falling
...
### Plot Hooks
1. **The Northern Pact Renewal:** Giants demand renegotiation. Thrain needs discrete agents to carry tribute and negotiate—official envoys would expose the secret.
2. **The Traitor Hunt:** Evidence suggests a high-ranking officer is selling military secrets to the Shadow Syndicate. Thrain needs outsiders to investigate without alerting the mole.
3. **The Lost Standard:** His first company's battle standard was taken by orcs and now sits in a warlord's trophy hall. He'll pay handsomely for its recovery—and silence about what really happened.
4. **The Blackwood Papers:** He's obtained documents suggesting House Blackwood was framed. Needs someone to verify them without his involvement being known.
5. **Dragon Witness:** After decades of silence, he's ready to tell someone what he saw during the Dragon Crisis—but only adventurers who've proven themselves trustworthy.
...
**Speed** :: 25 ft.
![Master Smith Durgan Forgefire](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-master-smith-durgan-forgefire.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 12 (+1) | 16 (+3) | 20 (+5) | 14 (+2) | 10 (+0) |
___
**Saving Throws** :: Constitution +7, Intelligence +9
**Skills** :: Arcana +9, Investigation +9, Smith's Tools +13 (expertise)
**Senses** :: darkvision 60 ft., passive Perception 12
**Languages** :: Common, Dwarvish, Elvish
**Challenge** :: 11 (7,200 XP)
___
***Dwarven Resilience.*** :: Has advantage on saving throws against poison, and resistance to poison damage.
***Spellcasting.*** :: Artificer spells (DC 17), specializes in metal/fire magic
***Can create.*** :: +1 weapons (1 day), +2 weapons (1 week), rare magic items (1 month)
***Infusions.*** :: Has 6 infusions active (various enhanced items)
***Right Tool for the Job.*** :: Can create any artisan's tools
### Actions
...
- **Secret Contact:** A mysterious Aetheian elf who provides rare materials (identity unknown)

{{descriptive
#### Secrets (DM Only)
1. **Mythril Mastery:** One of only three living smiths who can forge true mythril. The others are Rurik Ironanvil (his rival) and someone in Aethoria he's never met. The technique is dying.
2. **The Dragon's Purpose:** Found slag in the Forge District that shouldn't exist—dragon fire alone couldn't create it. Something else burned here. Something magical.
3. **The Incomplete Blade:** His father died mid-forge on a commissioned blade. Durgan has kept the unfinished weapon for 90 years, unable to complete it or destroy it. It whispers to him sometimes.
4. **The Eastern Journey:** He did visit Aethoria—specifically House Crystalborn. They showed him crystal-infusion techniques. He's never used them, afraid of what he might create.
5. **The Royal Request:** King Aldric IV has asked him to forge something unprecedented—a weapon that could kill an ancient dragon. He's not sure it's possible. Or ethical.
}}

### Plot Hooks
1. **The Rare Materials:** Needs adamantine from a specific crashed meteor in orc territory. Hiring adventurers for extraction.
2. **The Stolen Techniques:** His former apprentice fled to the Shadow Syndicate with forging secrets. They're making inferior but mass-produced magic weapons. Needs the apprentice stopped.
3. **The Ancient Forge:** Explorers discovered a pre-Worldrend dwarven forge in the Sealed Levels. Durgan needs it secured and studied—the techniques there might be lost to time.
4. **The Dragon Scale Commission:** A wealthy patron wants dragon-scale armor. Durgan needs fresh scales from a living dragon—and someone to get them.
5. **The Incomplete Blade:** Finally ready to complete his father's last work. But the blade requires a specific component: the tear of a dying king. He hopes King Aldric IV will volunteer a tear before his natural death, decades hence.
6. **The Rival's Challenge:** Rurik Ironanvil has challenged him to a forge-off. The prize: recognition as Thaldros's greatest smith. Durgan needs rare materials to win.
7. **The Whispering Steel:** The incomplete blade has started speaking clearly. It wants to be finished. It's telling him how. He's not sure he should listen.
...
**Speed** :: 25 ft.
![Captain Borin Stoneshield](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-captain-borin-stoneshield.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 10 (+0) | 18 (+4) | 10 (+0) | 14 (+2) | 14 (+2) |
___
**Saving Throws** :: Strength +8, Constitution +8, Wisdom +6, Charisma +6
**Skills** :: None
**Senses** :: darkvision 60 ft., passive Perception 12
**Languages** :: Common, Dwarvish
...
___
***Dwarven Resilience.*** :: Has advantage on saving throws against poison, and resistance to poison damage.
***Divine Smite.*** :: Adds 2d8 radiant to hits (1st level slot)
***Lay on Hands.*** :: 15 HP pool for healing
***Divine Sense.*** :: Detect celestial/fiend/undead
***Sacred Weapon.*** :: Bonus action, weapon deals radiant damage
### Actions
***Longsword +2.*** :: Melee Weapon Attack: +10 to hit, reach 5 ft., one target. ***Hit.*** 1d8+6 slashing + 1d8 radiant (smite)::
...
**Speed** :: 30 ft.
![Sage Thelmar Runescribe](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-sage-thelmar-runescribe.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 12 (+1) | 14 (+2) | 20 (+5) | 16 (+3) | 12 (+1) |
___
**Saving Throws** :: Intelligence +9, Wisdom +7
**Skills** :: Arcana +13, History +13, Insight +7
**Senses** :: passive Perception 13
**Languages** :: Common, Elvish
**Challenge** :: 11 (7,200 XP)
___
***Spellcasting.*** :: 12th-level wizard, DC 17
***Portent (2/day).*** :: Roll 2d20, replace any roll with these
***Expert Divination.*** :: Regains spell slot when casting divination
***Specializes in.*** :: Scrying, Divination, Identify, Legend Lore, Contact Other Plane
### Actions
***Quarterstaff.*** :: Melee Weapon Attack: +3 to hit, reach 5 ft., one target. ***Hit.*** 2 (1d6 - 1) bludgeoning damage.::
***Spellcasting.*** :: Thelmar is a 12th-level spellcaster. His spellcasting ability is Intelligence (spell save DC 17, +9 to hit with spell attacks). He has the following wizard spells prepared:
***Cantrips (at will).*** :: *light, mage hand, message, prestidigitation*
***1st level (4 slots).*** :: *detect magic, identify, shield, sleep*
...
{{descriptive
#### Secrets (DM Only)
1. **The Third Bloodline:** His research suggests a third royal line exists—neither Thandris nor Aethermere, but descendants of a sibling history forgot. If true, the entire succession dispute is moot.
2. **The Dragon's Deal:** His divinations show King Aldric III's father made some kind of bargain with Infernalix. He can't see the terms, but the dragon's departure wasn't random.
3. **The Prophecy Suppression:** He's had a vision of Kaer Thandros burning that he's hidden from the king. Showing it might cause the very panic that makes it come true.
4. **The Aetheian Contact:** His anonymous correspondent claims to be from House Starweaver. They're sharing information that contradicts both continental histories.
...
5. **The Correspondent Meeting:** His Aetheian contact wants to meet in person. Needs protection for the dangerous journey to neutral Port Myrthen.
...
**Speed** :: 30 ft.
![Brother Tormund](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-brother-tormund.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 10 (+0) | 16 (+3) | 11 (+0) | 18 (+4) | 14 (+2) |
___
...
___
***Spells.*** :: Cleric spells (DC 16), War Domain spells
***War Priest (3/day).*** :: Bonus action attack
***Divine Strike.*** :: Extra 1d8 to weapon damage
### Actions
***Warhammer +2.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target. ***Hit.*** 1d8+5 bludgeoning + 1d8 radiant::
***Channel Divinity.*** :: Guided Strike (+10 to hit) or Turn Undead
}}
...
- **Allies:** Father Aldric Tidekeeper of Goldreach (fellow war-cleric)
- **Congregants:** Hundreds of soldiers, guards, and veterans who attend his services
- **Rival:** Brother Marcus of the Lightbringers (doctrinal disputes about the role of warfare)
...
### Plot Hooks
1. **The Battle Preparation:** Needs help preparing the temple for mass casualties. Supplies, cots, healers, escape routes—all without causing panic.
2. **The Haunted Soldier:** A veteran is possessed by something from the battlefield. Needs both combat skill and spiritual knowledge to help.
3. **The Deserter Crisis:** One of his sheltered deserters was actually a spy. Now Tormund needs help finding him before the spy sells what he's learned.
4. **The Sacred Weapon:** A legendary warrior's blade needs to be recovered from a battlefield. The soldier's ghost won't rest until it's returned to his family.
5. **The Confession Dilemma:** The traitor from confession is about to be promoted to a sensitive position. Tormund can't break the seal but needs someone to find evidence independently.
...
**Speed** :: 35 ft.
![Professor Elara Moonwhisper](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-professor-elara-moonwhisper.jpg){width:315px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 14 (+2) | 14 (+2) | 18 (+4) | 18 (+4) | 12 (+1) |
___
**Saving Throws** :: None
**Skills** :: None
...
***Portent (2/day).*** :: Replace any roll
***Expert Divination.*** :: Regain slots
***Blessings of Knowledge.*** :: Expertise in Arcana, History
***Channel Divinity.*** :: Read Thoughts or Knowledge of Ages
***Specializes in.*** :: All divination magic, prophecy interpretation
### Actions
***Quarterstaff.*** :: Melee Weapon Attack: +3 to hit, reach 5 ft., one target. ***Hit.*** 2 (1d6 - 1) bludgeoning damage.::
***Spellcasting.*** :: Elara is an 11th-level wizard and 3rd-level cleric. Her spellcasting ability is Intelligence for wizard spells (spell save DC 16, +8 to hit) and Wisdom for cleric spells (spell save DC 16, +8 to hit).
***Wizard spells prepared.*** :: 
***Cantrips.*** :: *guidance, light, mage hand, prestidigitation*
...
***5th level (2 slots).*** :: *contact other plane, legend lore, scrying*
***6th level (1 slot).*** :: *true seeing*
***Portent (2/Day).*** :: Rolls two d20s on long rest to replace any roll she can see.
...
{{descriptive
#### Secrets (DM Only)
1. **The Returning Stars:** The sky is slowly reverting to its pre-Worldrend configuration. At current rate, it will match ancient records in approximately 100 years. What happens then?
2. **The Hidden Observatory:** Maintains a secret observation post in the Ironspine Mountains, away from Silverpine's light pollution. Only her most trusted students know.
3. **The Prophecy Collection:** Has compiled every recorded prophecy about the Worldrend and its aftermath. Patterns suggest a second Worldrend—or something that prevents one.
4. **The Aetheian Connection:** Her correspondent is actually Archmage Eldrin Aethermere himself. They share astronomical data that contradicts both continents' historical records.
5. **The Student's Death:** A promising student died investigating something she asked him to observe. She carries guilt but has never told anyone what he was looking for.
}}

### Plot Hooks
1. **The Celestial Event:** A rare astronomical conjunction approaches. She needs observers at multiple locations simultaneously—including dangerous ones.
2. **The Ancient Observatory:** Pre-Worldrend records mention an observatory that survived the cataclysm. Needs adventurers to find it.
3. **The Stolen Research:** Someone broke into her office and copied her notes on the returning stars. Who has this information now?
4. **The Student's Quest:** Ready to continue her late student's work. Needs brave souls willing to observe what killed him.
5. **The Continental Meeting:** Her Aetheian correspondent wants to meet in person to share discoveries too sensitive for letters. Needs escort to Port Myrthen.
6. **The Prophecy Interpretation:** Has found a prophecy that specifically mentions adventurers who will "read the stars' return." She's looking for those adventurers.
7. **The Ley Line Disruption:** Celestial observations predict a massive ley line shift. Needs help preparing defenses for Silverpine's magical infrastructure.
...
**Speed** :: 30 ft.
![Master Artisan Silvanus Brightforge](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-master-artisan-silvanus-brightforge.jpg){width:300px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 16 (+3) | 14 (+2) | 20 (+5) | 12 (+1) | 16 (+3) |
___
**Saving Throws** :: None
**Skills** :: None
...
___
***Fey Ancestry.*** :: Has advantage on saving throws against being charmed, and magic can't put them to sleep.
***Spellcasting.*** :: Artificer spells, DC 17
***Infusions (6 active).*** :: Can create +2 items, rare magic items
***Eldritch Cannon.*** :: Can summon protective or offensive cannon
***Arcane Firearm.*** :: Adds 1d8 to spell damage
***Specializes in.*** :: Jewelry, decorative items, art pieces with magical properties
### Actions
***Light Hammer.*** :: Melee or Ranged Weapon Attack: +7 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 4 (1d4 + 2) bludgeoning damage.::
***Eldritch Cannon.*** :: As a bonus action, creates a Small magical cannon (AC 18, HP 39) within 5 feet. The cannon lasts 1 hour. It has one of the following effects:
***- *Flamethrower.*** :: * 15-foot cone, DC 17 Dex save, 2d8 fire damage.
***- *Force Ballista.*** :: * Ranged spell attack +9, 2d8 force damage, pushes 5 feet.
***- *Protector.*** :: * Grants 1d8 + 5 temporary HP to creatures within 10 feet.
***Spellcasting.*** :: Silvanus is a 13th-level artificer. His spellcasting ability is Intelligence (spell save DC 17, +9 to hit).
***Cantrips (at will).*** :: *mending, fire bolt, light*
***1st level (4 slots).*** :: *absorb elements, cure wounds, identify*
***2nd level (3 slots).*** :: *heat metal, magic weapon, web*
...
- **Patrons:** House Silverleaf, House Thandris, several Aetheian noble houses
...
2. **The Aetheian Connection:** Still corresponds with artists in Aethermere. Has secretly smuggled techniques across the Sundering Sea despite trade restrictions.
3. **The Guild Corruption:** Some guild members are selling inferior work under guild seals. He knows but hasn't acted—they're relatives of powerful patrons.
4. **The Pre-Worldrend Design:** Found ancient artifact designs in his research. One matches something that shouldn't exist—a weapon that could shatter continents.
5. **The Failing Eyes:** His vision is deteriorating. He has perhaps five more years of detailed work left. He's told no one.
}}

### Plot Hooks
1. **The Artifact Recovery:** Finally ready to retrieve his hidden crown. Needs trusted help to reach it—the location is dangerous.
2. **The Guild Investigation:** Ready to clean house but needs outside investigators the corrupt members won't recognize.
3. **The Commission of a Lifetime:** Will create a masterwork for free if someone retrieves specific rare materials from pre-Worldrend ruins.
...
**Speed** :: 35 ft.
![Captain Lyra Swiftwind](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-captain-lyra-swiftwind.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
### Personality
& Background
Fair, tough, intelligent. Commands City Watch with skill. Solved multiple high-profile cases. Incorruptible. Syndicate has tried to bribe her dozens of times—she arrests the messengers. Respected by criminals and citizens alike for her fairness and competence.

**Secret:** Her father was a Syndicate member. She turned him in. He died in prison. She's never forgiven herself but stands by the decision.

### Background & History
Born in Silverpine's lower district to a mixed-race family—human mother, elven father. Her father Marcus worked for the Shadow Syndicate as a fence, providing the family a comfortable but morally compromised living.
...
- **Reports To:** Council Mistress Elara Silverleaf (complicated relationship)
- **Ally:** Sage Thelmar Runescribe (provides magical support for investigations)
- **Enemy:** The Shadow Syndicate (multiple assassination attempts)
- **Informant:** Silas the Fence (ironic, given her history)

{{descriptive
#### Secrets (DM Only)
1. **The Father's Legacy:** Found her father's hidden records after his death. The Syndicate doesn't know she has them—details of operations, contacts, safehouses.
2. **The Mother's Blame:** Her mother still lives in Silverpine. They haven't spoken in 15 years. Lyra watches over her secretly.
3. **The Syndicate Offer:** They've offered to leave her alone if she returns the records. She's refused. They're getting desperate.
4. **The Corrupt Officer:** One of her lieutenants is on the Syndicate payroll. She knows who but is gathering evidence for a clean prosecution.
5. **The True Reason:** Her father wasn't just arrested for smuggling. He was about to turn crown's witness against Syndicate leadership. Someone silenced him in prison. She's still hunting his killer.
}}

### Plot Hooks
1. **The Records' Secret:** Found something in her father's records pointing to Syndicate leadership. Needs help investigating.
2. **The Corrupt Lieutenant:** Ready to spring her trap but needs witnesses who can't be bought.
3. **The Prison Murder:** Finally has a lead on who killed her father. Needs outsiders to investigate without alerting the killer.
...
**Speed** :: 30 ft.
![Madame Celeste](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-madame-celeste.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 18 (+4) | 14 (+2) | 18 (+4) | 16 (+3) | 20 (+5) |
___
**Saving Throws** :: None
**Skills** :: None
...
**Challenge** :: 13 (10,000 XP)
___
***Master of Intrigue.*** :: Perfect disguises, mimicry
***Insightful Manipulator.*** :: Learn creature's stats/class
***Words of Terror.*** :: Frighten through conversation
***Network.*** :: Knows everything happening in city
### Actions
***Multiattack.*** :: Celeste makes two attacks with her dagger.
***Dagger.*** :: Melee or Ranged Weapon Attack: +9 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 7 (1d4 + 5) piercing damage plus 21 (6d6) sneak attack damage if she has advantage or an ally is within 5 feet of the target.::
***Spellcasting.*** :: Celeste is a 4th-level bard. Her spellcasting ability is Charisma (spell save DC 17, +9 to hit).
***Cantrips (at will).*** :: *friends, minor illusion, vicious mockery*
***1st level (4 slots).*** :: *charm person, disguise self, dissonant whispers*
***2nd level (3 slots).*** :: *detect thoughts, suggestion, zone of truth*
***Psychic Blades (3/Day).*** :: When Celeste hits with a sneak attack, can deal an extra 2d6 psychic damage.
***Master of Tactics.*** :: Uses the Help action as a bonus action. Additionally, can help an ally within 30 feet rather than 5 feet.
...
{{descriptive
#### Secrets (DM Only)
1. **The True Nature:** An ancient demon of knowledge, not malice. Her binding stripped her of most powers, leaving only enhanced perception and perfect memory.
2. **The Loophole's Limit:** Can act freely but cannot directly harm mortals without cause. The binding's protection still restricts her.
3. **The Church Hunter:** An Inquisitor suspects her nature. She's been feeding him false leads for decades, but he's getting close.
4. **The Real Goal:** Doesn't care about Material Plane politics. Only wants to go home. Everything else is means to that end.
5. **The Worldrend Connection:** Believes the Worldrend weakened her planar prison. A second Worldrend might free her—or destroy her.
}}

### Plot Hooks
1. **The Information Trade:** Knows almost everything about Silverpine. Will share for services that advance her goals.
2. **The Inquisitor Problem:** The hunter is getting too close. Needs help misdirecting him—permanently.
3. **The Planar Research:** Needs someone to investigate a site related to the Worldrend. Paying extremely well.
...
**Speed** :: 30 ft.
![Harbor Master Tobias Saltwind](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-harbor-master-tobias-saltwind.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 16 (+3) | 16 (+3) | 14 (+2) | 14 (+2) | 12 (+1) |
___
**Saving Throws** :: None
**Skills** :: Athletics +7, Perception +6, Navigator's Tools +10, Water Vehicles +10
**Senses** :: passive Perception 12
**Languages** :: Common
**Challenge** :: 8 (3,900 XP)
___
### Actions
***Multiattack.*** :: Tobias makes two attacks with his cutlass.
***Cutlass +1.*** :: Melee Weapon Attack: +8 to hit, reach 5 ft., one target. ***Hit.*** 8 (1d6 + 5) slashing damage.::
***Light Crossbow.*** :: Ranged Weapon Attack: +7 to hit, range 80/320 ft., one target. ***Hit.*** 7 (1d8 + 3) piercing damage.::
***Action Surge (1/Rest).*** :: On his turn, Tobias can take one additional action.
***Second Wind (1/Rest).*** :: As a bonus action, regains 1d10 + 8 hit points.
...
3. **The Orphanage Threat:** Someone's discovered the money trail. The orphanage is in danger.
...
![Captain Mira Wavecrest](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-captain-mira-wavecrest.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 14 (+2) | 18 (+4) | 12 (+1) | 14 (+2) | 14 (+2) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: darkvision 60 ft., passive Perception 12
...
{{descriptive
#### Secrets (DM Only)
1. **The Personal Vendetta:** The pirate captain who killed her husband escaped. He's still out there. She's been hunting him for 20 years.
2. **The Letter:** Darian left a letter she's never opened. Carries it everywhere. Can't bring herself to read his last words.
3. **The Offer:** The pirate who escaped offered to surrender—if she let his crew go free. She refused. Sometimes she wonders if she was wrong.
4. **The New Threat:** Something is stirring in the deep lakes. Ships disappearing without wreckage. Not pirates—something worse.
5. **The Forbidden Zone:** Knows the location of a sunken pre-Worldrend city beneath the lake. Officially it doesn't exist. She's seen its lights.
}}

### Plot Hooks
1. **The Final Hunt:** Has a lead on her husband's killer. Needs help to pursue without abandoning her duties.
2. **The Lake Mystery:** Ships vanishing. Needs investigators who can travel where her fleet can't.
3. **The Sunken City:** Ready to explore the forbidden ruins. Needs divers and adventurers.
...
**Speed** :: 25 ft.
![Merchant Lord Cornelius Goldpurse](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-merchant-lord-cornelius-goldpurse.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 18 (+4) | 14 (+2) | 16 (+3) | 12 (+1) | 18 (+4) |
___
**Saving Throws** :: None
**Skills** :: None
...
### Actions
***Multiattack.*** :: Mira makes three attacks with her trident or two attacks with her crossbow.
***Trident +2.*** :: Melee or Ranged Weapon Attack: +9 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 9 (1d6 + 6) piercing damage, or 10 (1d8 + 6) piercing damage if used with two hands.::
***Heavy Crossbow.*** :: Ranged Weapon Attack: +6 to hit, range 100/400 ft., one target. ***Hit.*** 9 (1d10 + 4) piercing damage.::
***Unwavering Mark.*** :: When Mira hits a creature with a melee weapon attack, she can mark the target until the end of her next turn. A marked creature has disadvantage on any attack roll that doesn't target Mira.
***Action Surge (1/Rest).*** :: On her turn, Mira can take one additional action.
...
{{descriptive
#### Secrets (DM Only)
1. **The Original Cornelius:** Murdered his master. The body is buried under his first warehouse. He visits it annually.
2. **The Abolition Network:** Spends a fortune smuggling slaves to freedom. No one suspects the "evil" merchant lord.
3. **The Blackmail Files:** Has dirt on half the nobility. Uses it to protect his interests—and his causes.
4. **The Real Ledgers:** Maintains two sets of books. The public ones show ruthless capitalism. The private ones show massive charitable spending.
5. **The Wife's Price:** His wife demanded one thing for her silence: he must never stop helping slaves escape. He hasn't.
}}

### Plot Hooks
1. **The Rescue Mission:** A slave caravan needs intercepting. Willing to pay adventurers to "rob" it.
2. **The Blackmail Crisis:** Someone stole some of his compromising files. Needs them recovered before they're used.
3. **The Identity Threat:** Someone is investigating the original Cornelius's death. Needs the trail confused.
...
**Speed** :: 30 ft.
![Father Aldric Tidekeeper](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-father-aldric-tidekeeper.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 12 (+1) | 10 (+0) | 10 (+0) | 18 (+4) | 14 (+2) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 14
...
___
### Actions
***Multiattack.*** :: Cornelius makes two attacks with his dagger.
***Dagger +1.*** :: Melee or Ranged Weapon Attack: +10 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 7 (1d4 + 5) piercing damage plus 17 (5d6) sneak attack damage if he has advantage or an ally is within 5 feet.::
***Cunning Action.*** :: On each of his turns, Cornelius can use a bonus action to take the Dash, Disengage, or Hide action.
***Use Magic Device.*** :: Cornelius can use any magic item, ignoring all class, race, and level requirements.
***Fast Hands.*** :: Can use Cunning Action to make a Sleight of Hand check, use thieves' tools, or use an object.
...
**Speed** :: 30 ft.
![The Scarlet Knife (Verena Shadowblade)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-the-scarlet-knife.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 20 (+5) | 16 (+3) | 14 (+2) | 12 (+1) | 14 (+2) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: darkvision 60 ft., passive Perception 11
...
___
### Actions
***Multiattack.*** :: Aldric makes two attacks with his trident.
***Trident +2.*** :: Melee or Ranged Weapon Attack: +9 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 9 (1d6 + 6) piercing damage, or 10 (1d8 + 6) piercing damage if used with two hands.::
***Spellcasting.*** :: Aldric is a 12th-level cleric. His spellcasting ability is Wisdom (spell save DC 16, +8 to hit).
***Cantrips (at will).*** :: *guidance, light, sacred flame, thaumaturgy*
***1st level (4 slots).*** :: *bless, create or destroy water, fog cloud, healing word*
***2nd level (3 slots).*** :: *gust of wind, lesser restoration, shatter, spiritual weapon*
***3rd level (3 slots).*** :: *call lightning, mass healing word, water walk*
***4th level (3 slots).*** :: *control water, freedom of movement, ice storm*
***5th level (2 slots).*** :: *commune, destructive wave, mass cure wounds*
...
- **Mother:** Selena Shadowblade (alive, living in poverty in a distant village)
- **Rivals:** Other high-end assassins who resent her reputation
- **Informant:** A servant in the Goldshore household who feeds her information
...
{{descriptive
#### Secrets (DM Only)
1. **The Father Connection:** Knows exactly who her father is. Has killed for him a dozen times. Each contract is simultaneously revenge and audition.
2. **The Mother's Location:** Sends money anonymously. Her mother doesn't know she's an assassin—thinks she married well.
3. **The Goldshore Files:** Has compiled extensive information about her father's criminal activities. Could destroy him. Might save it for leverage instead.
4. **The One Who Got Away:** Failed to kill one target—a child who was supposed to be with the mark. Let the child go. The child is now adult and hunting her.
5. **The Retirement Plan:** Accumulating wealth to disappear completely. Or to reveal herself to her father and take everything. Still deciding.
}}

### Plot Hooks
1. **The Contract Offer:** Will take contracts that meet her code. Pays well for leads on deserving targets.
2. **The Goldshore Revelation:** Ready to confront her father—but needs witnesses who can protect her afterward.
3. **The Survivor's Revenge:** The child she spared is hunting her. Needs help determining if they're a threat or an opportunity.
...
**Speed** :: 30 ft.
![Burgher-Master Wilhelm Von Handel](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-burgher-master-wilhelm-von-handel.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 14 (+2) | 16 (+3) | 16 (+3) | 14 (+2) | 18 (+4) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 12
...
***Spellcasting.*** :: Wilhelm is a 5th-level bard. His spellcasting ability is Charisma (spell save DC 14, +6 to hit).
***Cantrips (at will).*** :: *friends, minor illusion, vicious mockery*
***1st level (4 slots).*** :: *charm person, comprehend languages, disguise self, healing word*
***2nd level (3 slots).*** :: *calm emotions, detect thoughts, suggestion, zone of truth*
***3rd level (2 slots).*** :: *hypnotic pattern, tongues*
***Bardic Inspiration (4/Rest).*** :: As a bonus action, grants 1d8 to add to one ability check, attack roll, or saving throw in the next 10 minutes.
...
3. **The League Negotiation:** Needs intermediaries to negotiate with the Merchant League without appearing weak.
...
**Speed** :: 25 ft.
![Quartermaster Thorna Ironprice](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-quartermaster-thorna-ironprice.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 14 (+2) | 14 (+2) | 18 (+4) | 18 (+4) | 14 (+2) | 12 (+1) |
___
**Saving Throws** :: Constitution +7, Intelligence +7
**Skills** :: Insight +5, Investigation +7, Perception +5, Persuasion +4
**Senses** :: darkvision 60 ft., passive Perception 15
**Languages** :: Common, Dwarvish, Elvish, Halfling
**Challenge** :: 7 (2,900 XP)
___
***Dwarven Resilience.*** :: Has advantage on saving throws against poison, and resistance to poison damage.
***Merchant's Eye.*** :: Can accurately appraise any item's value within 10% and identify magical properties with a DC 15 Intelligence check.
***Photographic Memory.*** :: Has perfect recall of any transaction, shipment, or face she has encountered.
***Infused Items.*** :: Maintains 4 infused items: Bag of Holding, +1 Breastplate, +1 Shield, and Sending Stones.
### Actions
...
***Arcane Jolt (3/Day).*** :: When hitting with an infused weapon, can deal an extra 2d6 force damage.
...
{{descriptive
#### Secrets (DM Only)
1. **The Photographic Memory:** Remembers every transaction, every shipment, every face. Has never written down the truly sensitive information.
2. **The Smuggling Blind Eye:** Knows exactly which crates contain contraband. Looks the other way for a 5% cut—used to fund her retirement.
3. **The Missing Shipment:** One cargo disappeared 30 years ago. She knows who took it. She's waiting for the right moment to collect.
4. **The League's Secrets:** Has figured out the League's long-term strategy from shipping patterns. They're positioning for something big.
...
3. **The Market Intelligence:** Will trade shipping pattern analysis for services rendered.
...
**Speed** :: 30 ft.
![Caravan Master Hassan](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-caravan-master-hassan.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 14 (+2) | 16 (+3) | 16 (+3) | 12 (+1) | 16 (+3) | 14 (+2) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 13
...
___
### Actions
***Multiattack.*** :: Hassan makes two attacks with his scimitar.
***Scimitar +1.*** :: Melee Weapon Attack: +8 to hit, reach 5 ft., one target. ***Hit.*** 8 (1d6 + 5) slashing damage.::
***Longbow.*** :: Ranged Weapon Attack: +7 to hit, range 150/600 ft., one target. ***Hit.*** 8 (1d8 + 4) piercing damage.::
***Colossus Slayer (1/Turn).*** :: When Hassan hits a creature that is below its hit point maximum, the attack deals an extra 1d8 damage.
***Escape the Horde.*** :: Opportunity attacks against Hassan are made with disadvantage.
***Spellcasting.*** :: Hassan is an 8th-level ranger. His spellcasting ability is Wisdom (spell save DC 14, +6 to hit).
***1st level (4 slots).*** :: *cure wounds, entangle, hunter's mark, longstrider*
...
{{descriptive
#### Secrets (DM Only)
1. **The Cursed Scarab:** The artifact drains his life force. He has perhaps two years left. Wears it against his heart—can't bring himself to throw it away.
2. **The Tomb Location:** Knows where the tomb is. Hasn't told anyone. Whatever else is down there might be worse than the scarab.
3. **The Hermit's Warning:** A desert sage warned him not to take anything. He didn't listen. The sage might know how to undo the curse.
4. **The Family Secret:** His grandfather was a Blackwood loyalist who fled south after the rebellion. The Al-Rashid identity is adopted.
5. **The Final Route:** Has planned one last grand expedition—across the Sundering Sea to Aethoria. Wants to see the eastern continent before he dies.
}}

### Plot Hooks
1. **The Curse Quest:** Hiring anyone who might know how to break ancient curses.
2. **The Desert Caravan:** Needs guards for a dangerous crossing. Pays extremely well because it might be his last.
3. **The Return Expedition:** Ready to go back to the tomb—needs help dealing with whatever he awakened.
...
**Speed** :: 30 ft.
![Watch Captain Gregor Ironhand](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-watch-captain-gregor-ironhand.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
___
### Actions
***Multiattack.*** :: Gregor makes two attacks with his longsword.
***Longsword +1.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target. ***Hit.*** 10 (1d8 + 6) slashing damage, or 11 (1d10 + 6) slashing damage if used with two hands.::
***Heavy Crossbow.*** :: Ranged Weapon Attack: +5 to hit, range 100/400 ft., one target. ***Hit.*** 8 (1d10 + 3) piercing damage.::
***Action Surge (1/Rest).*** :: On his turn, Gregor can take one additional action.
***Second Wind (1/Rest).*** :: As a bonus action, regains 1d10 + 10 hit points.
...
**Speed** :: 25 ft.
![Silas the Fence](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-silas-the-fence.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 20 (+5) | 14 (+2) | 16 (+3) | 14 (+2) | 16 (+3) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 12
...
***Brave.*** :: Has advantage on saving throws against being frightened.
### Actions
***Multiattack.*** :: Silas makes two attacks with his dagger.
***Dagger +2.*** :: Melee or Ranged Weapon Attack: +10 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 8 (1d4 + 6) piercing damage plus 21 (6d6) sneak attack damage if he has advantage or an ally is within 5 feet.::
***Cunning Action.*** :: As a bonus action, Silas can Dash, Disengage, or Hide.
***Evasion.*** :: When subjected to an effect that allows a Dexterity saving throw for half damage, Silas takes no damage on a success and half damage on a failure.
...
2. **The Double Agent Opportunity:** Might be turned if convinced his escape plan could actually work.
3. **The Old Crime:** Wants to make amends for the innocent death. Will help—for a price that includes discretion.
...
**Speed** :: 30 ft.
![Commander Kael Stormwatcher](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-commander-kael-stormwatcher.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 18 (+4) | 18 (+4) | 14 (+2) | 16 (+3) | 14 (+2) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 13
...
___
### Actions
***Multiattack.*** :: Kael makes three attacks with his battleaxe or two with his longbow.
***Battleaxe +1.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target. ***Hit.*** 10 (1d8 + 6) slashing damage, or 11 (1d10 + 6) slashing damage if used with two hands.::
***Longbow.*** :: Ranged Weapon Attack: +6 to hit, range 150/600 ft., one target. ***Hit.*** 7 (1d8 + 3) piercing damage.::
***Action Surge (1/Rest).*** :: On his turn, Kael can take one additional action.
...
- **Reports To:** Lord Commander Thrain Ironoak
- **Secret Ally:** Frost Giant King Hrothgar (the pact partner)
- **Subordinate:** Sergeant Brenna Iceheart (doesn't know about the pact)
- **Supply Contact:** A Merchant League factor who provides "gifts" for the giants
...
{{descriptive
#### Secrets (DM Only)
1. **The Giant Pact:** Maintains peace through an unauthorized agreement. If discovered, he faces execution for treason.
2. **The Supply Runs:** Regular "patrol missions" are actually supply deliveries to giant camps.
3. **The Overlapping Pact:** Doesn't know Lord Commander Thrain has his own pact with the giants. Both think they're alone.
4. **The Growing Threat:** Something is disturbing the giants' territory. They're getting nervous. Might break the pact.
5. **The Succession Question:** Giant King Hrothgar is aging. His heir is aggressive. The peace might not survive the transition.
}}

### Plot Hooks
1. **The Diplomatic Crisis:** Giants are getting restless. Needs intermediaries who can't be traced to him.
2. **The Territory Threat:** Something in giant lands that threatens both sides. Needs investigation.
3. **The Supply Problem:** Regular supplier was killed. Needs someone to make the delivery without asking questions.
...
**Hit Points** :: 115 (11d10 + 44)
**Speed** :: 30 ft.
![Sergeant Brenna Iceheart](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-sergeant-brenna-iceheart.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 14 (+2) | 18 (+4) | 12 (+1) | 14 (+2) | 10 (+0) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 12
...
___
### Actions
***Multiattack.*** :: Brenna makes three attacks with her longsword or two with her longbow.
***Longsword +2.*** :: Melee Weapon Attack: +11 to hit, reach 5 ft., one target. ***Hit.*** 11 (1d8 + 7) slashing damage, or 12 (1d10 + 7) slashing damage if used with two hands.::
***Longbow +1.*** :: Ranged Weapon Attack: +9 to hit, range 150/600 ft., one target. ***Hit.*** 9 (1d8 + 5) piercing damage.::
***Action Surge (1/Rest).*** :: On her turn, Brenna can take one additional action.
***Indomitable (2/Rest).*** :: Brenna can reroll a failed saving throw.
...
**Speed** :: 25 ft.
![Scout Captain Finn Quickfoot](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-scout-captain-finn-quickfoot.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
***Brave.*** :: Has advantage on saving throws against being frightened.
### Actions
***Multiattack.*** :: Finn makes two attacks with his shortsword or shortbow.
***Shortsword +2.*** :: Melee Weapon Attack: +11 to hit, reach 5 ft., one target. ***Hit.*** 9 (1d6 + 6) piercing damage plus 14 (4d6) sneak attack damage if he has advantage.::
***Shortbow +1.*** :: Ranged Weapon Attack: +10 to hit, range 80/320 ft., one target. ***Hit.*** 8 (1d6 + 5) piercing damage plus 14 (4d6) sneak attack damage if he has advantage.::
***Cunning Action.*** :: As a bonus action, can Dash, Disengage, or Hide.
***Evasion.*** :: Takes no damage on successful Dex saves for half damage, and half on failures.
...
2. **The Intervention:** His scouts want someone to talk sense into him. Or help him finish the hunt safely.
3. **The Evidence Analysis:** Needs the scales and tooth identified by someone who won't report him.
...
**Speed** :: 30 ft.
![Brother Marcus](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-brother-marcus.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 10 (+0) | 16 (+3) | 11 (+0) | 18 (+4) | 14 (+2) |
...
___
### Actions
***Warhammer +1.*** :: Melee Weapon Attack: +8 to hit, reach 5 ft., one target. ***Hit.*** 9 (1d8 + 5) bludgeoning damage.::
***Spellcasting.*** :: Brother Marcus is a 10th-level cleric. His spellcasting ability is Wisdom (spell save DC 16, +8 to hit).
...
***3rd level (3 slots).*** :: *beacon of hope, mass healing word, revivify*
***4th level (3 slots).*** :: *death ward, freedom of movement, guardian of faith*
***5th level (2 slots).*** :: *flame strike, mass cure wounds*
***War Priest (3/Day).*** :: When Marcus uses the Attack action, he can make one weapon attack as a bonus action.
...
{{descriptive
#### Secrets (DM Only)
1. **The Lost Faith:** Hasn't felt divine presence in years. Fakes it. The soldiers can't know their priest is empty.
2. **The Death Toll:** Knows exactly how many soldiers he's given last rites to. Dreams their faces.
3. **The Unanswered Prayer:** Prayed desperately to save a child during a giant raid. The child died. That was when his faith broke.
4. **The Comfort He Provides:** Still helps soldiers find peace. Wonders if he's lying to them.
5. **The Question:** Sometimes wishes for an answer—any answer—even if it meant his own death would prove gods exist.
}}

### Plot Hooks
1. **The Faith Quest:** Needs someone to help him find proof—or closure. Will travel anywhere.
2. **The Soldier's Souls:** A dying soldier asked him to deliver a message to a god. He needs to find a way to do it.
3. **The Temple Politics:** Silverpine wants to transfer him. The garrison wants to keep him. Needs allies for the political fight.
...
![The Frost Witch (Name Unknown)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-the-frost-witch.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 16 (+3) | 18 (+4) | 16 (+3) | 14 (+2) | 20 (+5) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 12
...
___
### Actions
***Ice Claw.*** :: Melee Spell Attack: +9 to hit, reach 5 ft., one target. ***Hit.*** 13 (2d8 + 4) cold damage.::
***Innate Spellcasting.*** :: The Frost Witch's innate spellcasting ability is Charisma (spell save DC 16, +8 to hit). She can innately cast the following spells:
***At will.*** :: *ray of frost, frostbite, shape water*
***3/day each.*** :: *ice storm, sleet storm, fog cloud, misty step*
***1/day each.*** :: *cone of cold, wall of ice, control weather*
***Ice Storm (Recharge 5-6).*** :: The Frost Witch creates a 20-foot-radius, 40-foot-high cylinder of freezing rain and hail centered on a point within 300 feet. Creatures must make DC 16 Dex save, taking 2d8 bludgeoning + 4d6 cold damage on a failed save, half on success.
...
- **Allies:** Some Ironhold soldiers genuinely care for her
...
{{descriptive
#### Secrets (DM Only)
1. **The Binding Truth:** Trapped by a pact she never agreed to. Commander Kael doesn't know—the ritual is passed down without explanation.
2. **The Renewal Date:** The pact must be renewed at winter solstice. If the ritual fails, she's free—but Ironhold loses her protection.
3. **The Loophole:** Believes a specific phrase or action could break the pact. Has been studying it for centuries.
4. **The Conflicted Heart:** Some Ironhold people have shown her kindness. She's not sure she wants to be free if it means abandoning them.
...
**Hit Points** :: 45 (10d8)
**Speed** :: 30 ft.
![Elder Rashid the Twice-Blessed](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-elder-rashid-the-twice-blessed.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 12 (+1) | 10 (+0) | 16 (+3) | 18 (+4) | 14 (+2) |
___
...
**Challenge** :: 5 (1,800 XP)
___
***Twice-Blessed.*** :: Has advantage on saving throws against being charmed or frightened. When reduced to 0 HP, can choose to drop to 1 HP instead (1/day).
***Divine Insight.*** :: Can cast Augury and Divination without material components (1/day each).
### Actions
***Blessed Staff.*** :: Melee Weapon Attack: +3 to hit, reach 5 ft., one target. ***Hit.*** 1d6 bludgeoning damage plus 2d6 radiant damage.::
...
**Speed** :: 30 ft.
![Master Glasswright Zara](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-master-glasswright-zara.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 16 (+3) | 16 (+3) | 20 (+5) | 14 (+2) | 14 (+2) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 12
...
___
### Actions
***Glass Dagger.*** :: Melee or Ranged Weapon Attack: +6 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 6 (1d4 + 4) piercing damage plus 2 (1d4) radiant damage (magical glass).::
***Spellcasting.*** :: Zara is a 10th-level artificer. Her spellcasting ability is Intelligence (spell save DC 16, +8 to hit).
***Cantrips (at will).*** :: *mending, light, fire bolt*
***1st level (4 slots).*** :: *absorb elements, cure wounds, detect magic, identify*
***2nd level (3 slots).*** :: *heat metal, magic weapon, web*
***3rd level (3 slots).*** :: *dispel magic, haste, protection from energy*
***Infused Items (4 active).*** :: Zara has infused the following items: goggles of night, bag of holding, +1 armor, +1 weapon.
...
**Speed** :: 30 ft.
![Desert Ranger Khalid](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-desert-ranger-khalid.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 14 (+2) | 18 (+4) | 16 (+3) | 12 (+1) | 16 (+3) | 10 (+0) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 13
...
___
### Actions
***Multiattack.*** :: Khalid makes three attacks with his scimitar or two with his longbow.
***Scimitar +2.*** :: Melee Weapon Attack: +11 to hit, reach 5 ft., one target. ***Hit.*** 10 (1d6 + 7) slashing damage.::
***Longbow +1.*** :: Ranged Weapon Attack: +9 to hit, range 150/600 ft., one target. ***Hit.*** 9 (1d8 + 5) piercing damage.::
***Colossus Slayer (1/Turn).*** :: When Khalid hits a creature below its hit point maximum, the attack deals an extra 1d8 damage.
***Spellcasting.*** :: Khalid is a 12th-level ranger. His spellcasting ability is Wisdom (spell save DC 15, +7 to hit).
***1st level (4 slots).*** :: *cure wounds, ensnaring strike, hunter's mark*
***2nd level (3 slots).*** :: *pass without trace, silence, spike growth*
...
Started taking prisoners for "extended questioning" five years ago. The information he extracts has prevented attacks, saved lives. But the screaming haunts him. He knows what he's becoming. Can't seem to stop. The boy hiding under his mother's corpse is still screaming for justice—and nothing satisfies him.
...
**Speed** :: 30 ft.
![Merchant Princess Yasmin](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-merchant-princess-yasmin.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 14 (+2) | 14 (+2) | 16 (+3) | 14 (+2) | 20 (+5) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 12
...
___
### Actions
***Dagger +1.*** :: Melee or Ranged Weapon Attack: +8 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 7 (1d4 + 5) piercing damage plus 17 (5d6) sneak attack damage if she has advantage.::
***Cunning Action.*** :: As a bonus action, Yasmin can Dash, Disengage, or Hide.
***Evasion.*** :: Takes no damage on successful Dex saves for half, half on failures.
***Uncanny Dodge.*** :: Can halve an attack's damage as a reaction.
***Fast Hands.*** :: Can use Cunning Action to make a Sleight of Hand check, use thieves' tools, or use an object.
...
2. **The Tomb Expedition:** Finally ready to open the sealed tomb. Needs skilled adventurers.
3. **The Rival Problem:** The Silverpine archaeologist is getting close to her best site. Needs interference.
...
**Hit Points** :: 91 (13d8 + 26)
**Speed** :: 30 ft.
![The Sand Prophet (Qadir al-Rum)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-the-sand-prophet.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 12 (+1) | 14 (+2) | 16 (+3) | 20 (+5) | 14 (+2) |
___
**Saving Throws** :: None
**Skills** :: None
...
***Spellcasting.*** :: Qadir is a 12th-level druid. His spellcasting ability is Wisdom (spell save DC 17, +9 to hit).
***Cantrips (at will).*** :: *druidcraft, guidance, mold earth, produce flame*
***1st level (4 slots).*** :: *create or destroy water, detect magic, goodberry, speak with animals*
***2nd level (3 slots).*** :: *augury, locate animals or plants, pass without trace*
***3rd level (3 slots).*** :: *call lightning, meld into stone, wind wall*
...
***Desert Sight.*** :: Qadir can accurately predict weather, locate water, and navigate desert terrain without error. He has advantage on all Wisdom (Survival) checks in desert environments.
...
- **The Desert:** His true companion and source of all knowledge
...
{{descriptive
#### Secrets (DM Only)
1. **No Divine Gift:** His "prophecies" are observation, not revelation. The desert tells him everything if he listens.
2. **The Fear:** What if he's wrong someday? One failed prediction destroys his credibility—and his ability to help.
3. **The Hermit's Death:** His teacher didn't die naturally. Someone killed him. Qadir has never found out who.
4. **The True Prophecy:** Once, just once, he had an actual vision—a dream of fire consuming the world. Doesn't know what it means.
5. **The Successor:** Training the blind girl because he's aging. Worried she relies too much on him instead of the desert.
}}

### Plot Hooks
1. **The Real Vision:** The fire dream haunts him. Needs help interpreting it.
2. **The Hermit's Murder:** Finally has a lead. Needs investigators.
3. **The Successor's Training:** Needs adventurers to take his student on a journey to teach her self-reliance.
...
**Speed** :: 30 ft.
![Warden Commander Ignis Ashborn](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-warden-commander-ignis-ashborn.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 12 (+1) | 20 (+5) | 16 (+3) | 14 (+2) | 12 (+1) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 12
...
___
### Actions
***Multiattack.*** :: Ignis makes three attacks with his warhammer or two with his fire lance.
***Warhammer of Flames +2.*** :: Melee Weapon Attack: +11 to hit, reach 5 ft., one target. ***Hit.*** 12 (1d8 + 8) bludgeoning damage plus 4 (1d8) fire damage.::
***Fire Lance.*** :: Ranged Weapon Attack: +7 to hit, range 60/120 ft., one target. ***Hit.*** 11 (2d6 + 4) fire damage.::
***Action Surge (2/Rest).*** :: On his turn, Ignis can take one additional action.
***Indomitable (2/Rest).*** :: Ignis can reroll a failed saving throw.
***Fire Resistance.*** :: Ignis has resistance to fire damage and advantage on saving throws against fire-based effects.
***Commander's Presence.*** :: Allies within 30 feet of Ignis have advantage on saving throws against being frightened and gain +2 to damage rolls with weapon attacks.
}}

### Background & History
Born in Ashgate to a family that has served as volcano wardens for eight generations. Learned to read the mountain's moods before he could walk. His grandmother used to say the volcano was their family's oldest child—temperamental but not malicious.

Rose through the Ashwarden ranks by being right when everyone else was wrong. Predicted the 1220 eruption six months early, allowing full evacuation. His warning saved 3,000 lives. Promoted to Warden Commander immediately after.
...
{{descriptive
#### Secrets (DM Only)
1. **The Big One Coming:** Has mathematical proof of eventual catastrophic eruption. Hasn't told anyone in authority.
2. **The Secret Plans:** Developing evacuation routes that could save most of the population—if there's enough warning.
3. **The Acceleration Risk:** Certain activities could trigger early eruption. He's been quietly blocking them.
4. **The Refused Report:** Tried to report his findings once. Was told it would "cause panic." Ordered to stay silent.
5. **The Family Decision:** Plans to move his family to safety within 10 years. Will stay himself to monitor.
}}

### Plot Hooks
1. **The Warning Distribution:** Needs help spreading evacuation plans without causing panic.
2. **The Acceleration Prevention:** Someone is planning activities that could trigger early eruption. Needs them stopped.
3. **The Evidence Gathering:** Wants more proof before going public. Needs help with deep survey.
...
**Speed** :: 30 ft.
![Lady Morgana Blackwater](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lady-morgana-blackwater.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 14 (+2) | 16 (+3) | 20 (+5) | 14 (+2) | 16 (+3) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 12
...
***Spellcasting.*** :: Morgana is a 14th-level wizard (necromancy). Her spellcasting ability is Intelligence (spell save DC 17, +9 to hit).
...
***Command Undead.*** :: As an action, Morgana can target one undead within 60 feet that can see or hear her. It must make DC 17 Wisdom save or become friendly to her for 24 hours.
...
**Speed** :: 30 ft.
![Master Alchemist Varek](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-master-alchemist-varek.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 16 (+3) | 16 (+3) | 20 (+5) | 12 (+1) | 10 (+0) |
___
**Saving Throws** :: None
**Skills** :: None
**Senses** :: passive Perception 11
...
___
### Actions
***Alchemist's Syringe.*** :: Melee Weapon Attack: +6 to hit, reach 5 ft., one target. ***Hit.*** 4 (1d4 + 2) piercing damage plus 10 (3d6) poison damage. Target must make DC 15 Con save or be poisoned for 1 minute.::
***Alchemical Bolt.*** :: Ranged Weapon Attack: +6 to hit, range 30/120 ft., one target. ***Hit.*** 9 (2d8) acid, cold, fire, or poison damage (Varek's choice).::
***Experimental Elixir (6/Day).*** :: Varek creates an elixir with one of the following effects: healing (2d4+4), swiftness (+10 speed), resilience (+1 AC), boldness (advantage on saves), flight (10 ft fly speed), or transformation (alter self).
***Spellcasting.*** :: Varek is a 12th-level artificer. His spellcasting ability is Intelligence (spell save DC 16, +8 to hit).
***Cantrips.*** :: *acid splash, mending, poison spray*
***1st level (4 slots).*** :: *cure wounds, detect poison, purify food and drink*
***2nd level (3 slots).*** :: *lesser restoration, protection from poison*
***3rd level (3 slots).*** :: *gaseous form, haste*
...
{{descriptive
#### Secrets (DM Only)
1. **The Universal Antidote:** 95% complete. Last ingredient is rare and dangerous to acquire.
2. **The Lady's Knowledge:** Knows some of Lady Morgana's plans. Stays quiet because she protects him.
3. **The Test Subject:** Has been testing the antidote on himself. Side effects are concerning.
4. **The Poison Records:** Has formulas for every poison he's ever made. Could save lives—or end them.
5. **The Self-Loathing:** Hates that he creates death to fund his research into preventing it.
}}

### Plot Hooks
1. **The Final Ingredient:** Needs help acquiring the last component. It's in a very dangerous place.
2. **The Test Results:** Needs someone to observe his next self-test in case something goes wrong.
3. **The Poison Identification:** Will identify any poison for free—information is more valuable than gold.
...
**Speed** :: 30 ft., swim 30 ft.
![Swamp Guide Grizelda](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-swamp-guide-grizelda.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 14 (+2) | 18 (+4) | 16 (+3) | 12 (+1) | 16 (+3) | 10 (+0) |
...
**Challenge** :: 11 (7,200 XP)
___
***Swarmkeeper abilities.*** :: Swarmkeeper abilities (insect swarm assists in combat)
***Swamp terrain expert.*** :: Swamp terrain expert
...
{{descriptive
#### Secrets (DM Only)
1. **The Hidden Village:** Knows the location of a village of escaped slaves deep in the swamp who've built a hidden community. Protects their secret absolutely.
2. **Morgana's Cargo:** Has transported "sleeping" people for Lady Morgana. Suspects they become her undead servants but doesn't ask questions.
3. **The Sunken Temple:** Discovered a pre-Worldrend temple beneath the black water. Took one artifact and never returned—something down there is still alive.
4. **Sweetness's Brood:** Her crocodile has a nest with eggs. When they hatch, she'll control a pack of giant crocodiles.
5. **The True Path:** Knows a route through the swamp that leads to a tear between worlds—fey creatures use it. She guards it from both sides.
}}

### Plot Hooks
1. **The Desperate Guide:** Offers to lead the party through the swamp for free if they help her rescue someone from Captain Vex's ship.
2. **The Missing Scholar:** An archaeologist she guided to the Sunken Temple never returned. His family is offering a fortune for recovery.
3. **The Crocodile Crisis:** Sweetness's eggs are about to hatch, but a monster has moved into her nesting ground. Grizelda needs help.
4. **The Hidden Village:** The escaped slaves' community has been discovered. They need evacuation before hunters arrive.
5. **The Fey Crossing:** Something is coming through the tear between worlds. Grizelda needs help sealing it—or negotiating with what's on the other side.
6. **The Smuggler's War:** Captain Vex and Grizelda's conflict is escalating. She's looking for allies.
...
![Captain Vex Darkwater](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-captain-vex-darkwater.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 14 (+2) | 20 (+5) | 16 (+3) | 12 (+1) | 12 (+1) | 16 (+3) |
___
**Saving Throws** :: —
**Skills** :: Perception +4
**Senses** :: darkvision 60 ft., passive Perception 11
...
**Challenge** :: 12 (8,400 XP)
___
***Rakish Audacity.*** :: Rakish Audacity (advantage on initiative)
***can't be surprised.*** :: can't be surprised
### Actions
***Multiattack.*** :: Vex makes two attacks with his rapier.
***Rapier +3.*** :: Melee Weapon Attack: +14 to hit, reach 5 ft., one target. ***Hit.*** 12 (1d8 + 8) piercing damage plus 24 (7d6) sneak attack damage if he has advantage or an ally is within 5 feet.::
***Dagger.*** :: Melee or Ranged Weapon Attack: +10 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 8 (1d4 + 6) piercing damage.::
***Cunning Action.*** :: As a bonus action, Vex can Dash, Disengage, or Hide.
***Fancy Footwork.*** :: When Vex makes a melee attack against a creature, that creature can't make opportunity attacks against him for the rest of his turn.
...
Unlike many pirates, Vex operates with a code: no slavery, no torture without cause, and always leave enough survivors to spread tales. Fear is better than corpses, and enemies who fear you make mistakes. He's never been caught because he's patient, well-informed, and knows when to fight and when to disappear into the swamp's countless waterways.

### Connections
- **Patron:** Lady Morgana Blackwater (protection arrangement, mutual benefit)
- **Rival:** Captain Mira Wavecrest (professional respect tinged with genuine hatred)
...
{{descriptive
#### Secrets (DM Only)
1. **The Sylas Truth:** Captain Sylas didn't die fighting the navy—Vex poisoned him after discovering Sylas was planning to sell the crew into slavery.
2. **The Goldreach Informant:** Has a highly placed informant in Goldreach's Harbor Authority who provides shipping schedules.
3. **Morgana's Deal:** His arrangement with Lady Morgana involves more than just protection money—he helps transport her "special cargo."
4. **The Treasure Map:** Possesses half of a map to Sylas's hidden treasure cache, rumored to contain a king's ransom.
5. **The Escape Plan:** Has a bolt-hole prepared in the Sundaran desert—identity papers, gold, and a contact who can make him disappear if things go wrong.
}}

### Plot Hooks
1. **The Enemy's Enemy:** Offers the party a job raiding a mutual enemy's ship, no questions asked about their reasons.
2. **The Map's Other Half:** Knows the party has the other half of the treasure map (or something he wants). Proposes a partnership.
3. **The Rescue Mission:** His informant in Goldreach has been arrested. Needs them broken out before they talk.
4. **The Navy's Trap:** The navy is setting an ambush using false shipping information. Vex knows—and offers to share the knowledge for a price.
5. **The Morgana Problem:** Lady Morgana's demands are becoming troubling. He's looking for leverage or allies against her.
6. **The Honest Deal:** Claims to have information about something the party desperately needs. For once, he's offering a straight trade.
...
**Hit Points** :: 91 (13d8 + 26)
**Speed** :: 30 ft.
![Witch Mother Helga](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-witch-mother-helga.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
### Connections
- **Patron:** The Lady of Thorns (Archfey of the Dark Court)
- **Client:** Lady Morgana Blackwater (bought forbidden knowledge; debt not fully paid)
...
{{descriptive
#### Secrets (DM Only)
1. **The Binding Cost:** Her original deal with the Lady of Thorns requires her to collect one soul per year. She chooses her victims carefully—murderers, slavers, the wicked.
2. **The Unfinished Bargain:** Lady Morgana owes her "a service to be named." Helga is waiting for the perfect moment to collect.
3. **The Lost Children:** Some children who wander into the swamp find their way to her hut. She raises them for seven years, then sends them to the Feywild. They return as changelings.
4. **The Prophecy Collection:** Has recorded hundreds of visions over fifty years. Together, they form a picture of a coming catastrophe.
5. **The Heart's Desire:** Deep down, she wants to die—but the Lady of Thorns won't release her. She's looking for someone strong enough to kill her and take her place.
}}

### Plot Hooks
1. **The Three Wishes:** Offers the party exactly what they need—but each wish has a price that seems minor but has devastating implications.
2. **The Prophecy Trade:** Has seen something important about one of the party members' futures. Will trade the knowledge for a service.
3. **The Lady's Errand:** Her patron demands a task completed in the mortal world. She needs mortal agents.
4. **The Soul Debt:** This year's soul is a member of the party's family or ally. She offers an alternative: complete an impossible task.
5. **The Final Rest:** Confesses her desire for death and asks if the party would take her place—or help her trick the Lady into releasing her.
6. **The Changeling Return:** One of her changeling children has returned from the Feywild, bringing something dangerous with them.
...
**Speed** :: 30 ft.
![Council Elder Thaelon Starlight](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-council-elder-thaelon-starlight.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 14 (+2) | 16 (+3) | 20 (+5) | 18 (+4) | 18 (+4) |
___
**Saving Throws** :: —
**Skills** :: Perception +7
**Senses** :: darkvision 60 ft., passive Perception 14
...
___
***Fey Ancestry.*** :: Has advantage on saving throws against being charmed, and magic can't put them to sleep.
***Instinctive Charm.*** :: Instinctive Charm (charm attackers)
***Split Enchantment.*** :: Split Enchantment (target two creatures)
***Channel Divinity: Knowledge of Ages.*** :: Channel Divinity: Knowledge of Ages
### Actions
***Weapon Attack.*** :: Melee Weapon Attack: +3 to hit, reach 5 ft., one target. ***Hit.*** Weapon damage + -1 modifier.::
}}

### Background & History
Born in Aethermere nearly eight centuries ago, Thaelon was a prodigy of enchantment magic who could charm birds from trees before he finished his first century. He served on the Circle of Speakers for three hundred years before stepping back to focus on magical research, then returned to politics when the Worldrend's aftereffects threatened Aetheian stability.
...
2. **The Thaldros Channel:** Maintains secret diplomatic communications with King Aldric IV, working toward eventual reunification of the continents.
3. **The Mind Wound:** Was mentally attacked decades ago by something from beyond; still carries scars that occasionally cause episodes of confusion.
...
2. **The Fragment's Awakening:** The Worldrend fragment is becoming active. He needs help containing or studying it.
3. **The Mind Healer:** Looking for a way to repair the damage to his mind before it worsens.
4. **The Redemption Mission:** Wants to save Lyrian Crystal from their dark path. Needs help reaching them.
5. **The Prophecy's Burden:** Shares his vision with the party—one of them may be the one who must sacrifice.
...
**Speed** :: 30 ft.
![Archdruid Silvaris Oakenheart](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-silvaris.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
___
***Fey Ancestry.*** :: Has advantage on saving throws against being charmed, and magic can't put them to sleep.
***Forest terrain bonuses.*** :: Forest terrain bonuses
...
The role requires bonding with the Great Oak at the heart of Aethoria's oldest forest—a tree whose roots touch the ley lines connecting all life on the continent. Through this bond, the Archdruid can sense disturbances anywhere in the natural world, communicate with animal and plant life, and call upon ancient nature magic.
...
### Connections
- **Bond:** The Great Oak (mystical connection)
- **Predecessor:** Memories of twelve previous Archdruids
- **Ally:** Speaker Arien Swiftbrook (supports her secretly)
- **Circle:** Twenty-three druids who serve under her guidance
- **Enemy:** The Blight—a spreading corruption in the eastern forests
...
{{descriptive
#### Secrets (DM Only)
1. **The Fading Self:** Losing herself faster than any previous Archdruid. Something is accelerating the merge.
2. **The Blight's Origin:** Knows the corruption comes from a sealed portal to the Shadowfell. The seal is weakening.
3. **The Predecessor's Sin:** One previous Archdruid made a deal with dark powers. That debt is coming due.
4. **The Heart's Desire:** Has fallen in love—something the role supposedly forbids. It's keeping her anchored to herself.
5. **The Succession Crisis:** No suitable candidate exists for the next Archdruid. If she dies, the line may end.
}}

### Plot Hooks
1. **The Blight Investigation:** Needs outsiders to investigate the corruption's source—druids who approach are absorbed.
2. **The Identity Quest:** Looking for magic that could preserve her individuality without breaking her bond.
3. **The Predecessor's Debt:** Something is coming to collect on an ancient bargain. She needs help facing it.
4. **The Secret Love:** Her beloved is in danger. She can't act openly without scandal, but needs help protecting them.
5. **The Successor Search:** Asks the party to find potential Archdruids across both continents.
...
![Spellweaver Lyrian Crystal](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-spellweaver-lyrian-crystal.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 16 (+3) | 18 (+4) | 14 (+2) | 12 (+1) | 20 (+5) |
___
**Saving Throws** :: —
**Skills** :: Perception +4
**Senses** :: darkvision 60 ft., passive Perception 11
...
___
***Fey Ancestry.*** :: Has advantage on saving throws against being charmed, and magic can't put them to sleep.
***Draconic Presence.*** :: Draconic Presence (frighten)
***Dragon Wings.*** :: Dragon Wings (fly)
***Damage Resistance.*** :: Damage Resistance (cold)
### Actions
***Weapon Attack.*** :: Melee Weapon Attack: +3 to hit, reach 5 ft., one target. ***Hit.*** Weapon damage + -1 modifier.::
}}
...
{{descriptive
#### Secrets (DM Only)
1. **The Patron's Nature:** Doesn't know what their patron truly is—possibly a forgotten god, possibly something worse.
2. **The Partial Success:** One experiment worked—they healed a minor Worldrend scar. It nearly killed them but proved the theory.
3. **The Death Toll:** The accident that killed their colleagues wasn't entirely accidental. Their patron demanded the energy.
4. **The Redemption Possibility:** Sometimes hears Thaelon's teachings in their mind. Part of them wants to stop.
5. **The Final Experiment:** Planning something that could heal the greatest Worldrend wound—or tear reality apart trying.
}}

### Plot Hooks
1. **The Plea for Help:** Reaches out secretly, asking for help escaping their patron's control.
2. **The Dangerous Discovery:** Offers to share their healing knowledge if the party helps with "one small task."
3. **The Follower Defects:** One of Lyrian's followers contacts the party, terrified of the final experiment.
4. **The Thaelon Request:** The Elder asks the party to reach Lyrian—capture, kill, or redeem, depending on what they find.
5. **The Final Choice:** The experiment is beginning. Stop it, help it, or try to guide it toward a safer outcome.
...
### Actions
***Multiattack.*** :: Lady Shadowleaf makes two attacks with her longbow or shortsword.
***Shortsword +2.*** :: Melee Weapon Attack: +10 to hit, reach 5 ft., one target. ***Hit.*** 9 (1d6 + 6) piercing damage plus 10 (3d6) sneak attack damage if she has advantage.::
***Longbow +1.*** :: Ranged Weapon Attack: +9 to hit, range 150/600 ft., one target. ***Hit.*** 8 (1d8 + 4) piercing damage plus 10 (3d6) sneak attack damage.::
***Cunning Action.*** :: As a bonus action, can Dash, Disengage, or Hide.
***Spellcasting.*** :: Lady Shadowleaf is a 3rd-level ranger. Her spellcasting ability is Wisdom (spell save DC 14, +6 to hit).
***1st level (3 slots).*** :: *hunter's mark, pass without trace, speak with animals*
...
2. **The Family Assassination:** Was once ordered to kill a member of her birth family. She faked the death instead; they live under a new identity.
3. **The Double Agent:** One of her agents is feeding information to someone. She's waiting to see where it leads.
...
2. **The Burned Agent:** One of her agents is compromised, trapped in enemy territory. She needs outside help for extraction.
3. **The Family Debt:** The family member she saved is in trouble. She needs help that can't be traced back to her.
4. **The Mole Hunt:** Knows there's a traitor but can't act openly. Hires the party to investigate.
5. **The Artifact Quest:** Shares her search for the daylight artifact if the party proves trustworthy.
...
**Speed** :: 30 ft.
![High Diviner Celestia Starborn](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-high-diviner-celestia-starborn.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 14 (+2) | 16 (+3) | 22 (+6) | 18 (+4) | 14 (+2) |
___
**Saving Throws** :: —
**Skills** :: Perception +7
**Senses** :: darkvision 60 ft., passive Perception 14
...
___
***Fey Ancestry.*** :: Has advantage on saving throws against being charmed, and magic can't put them to sleep.
***Portent.*** :: Portent (3/day)
***Expert Divination.*** :: Expert Divination
***The Third Eye.*** :: The Third Eye
***Greater Portent.*** :: Greater Portent (additional portent die)
### Actions
***Weapon Attack.*** :: Melee Weapon Attack: +3 to hit, reach 5 ft., one target. ***Hit.*** Weapon damage + -1 modifier.::
}}

### Background & History
Born during a rare celestial conjunction, Celestia's first cry coincided with a meteor striking the mountains a hundred miles away. Her parents took it as an omen; they were right. She developed prophetic gifts before she could walk, seeing futures in dreams and reflections.

Her visions brought her to the Academy's attention, and she rose quickly through the ranks of diviners. Unlike most seers who glimpse fragments, Celestia can sometimes see complete futures with terrible clarity. This gift became a curse when she foresaw the death of her first love—and was unable to prevent it despite knowing every detail.

Now she leads the Harmony's diviners, guiding policy with her visions while struggling with the knowledge that seeing the future doesn't always mean being able to change it. She has become cold, clinical—treating prophecy as information to be analyzed rather than fate to be feared. Critics say she's lost her humanity; she says she's simply practical.

### Connections
- **Superior:** The Circle of Speakers (advisory role)
- **Student:** Six apprentice diviners learning to control their gifts
- **Rival:** Council Elder Thaelon (philosophical opposition to his diplomacy)
...
2. **The Blocked Future:** Something is hiding certain futures from her. She's never encountered anything that could do this.
3. **The False Prophecy:** Once gave a false prophecy to prevent a war. The truth would have been worse, but the lie haunts her.
4. **The Resurrection Obsession:** Secretly researches ways to bring back the dead. For her lost love, or perhaps for those she's foreseen dying.
5. **The Pattern Recognition:** Has noticed all her visions connect to something—a single future event that casts shadows across time.
}}

### Plot Hooks
1. **The Commission:** Offers to read the party's futures, but the visions she sees are troubling—and incomplete.
2. **The Blocked Vision:** Something the party carries or knows is blocking her sight. She needs to understand why.
3. **The Prevention Quest:** Shares a terrible vision and asks if they can help change it.
4. **The Ghost's Message:** Her dead love's ghost has a message for someone in the party.
5. **The Central Event:** Realizes the party is connected to the event she keeps glimpsing. Allies with them to understand it.
...
**Speed** :: 30 ft., swim 40 ft.
![Council Speaker Aquila Clearwater](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-council-speaker-aquila-clearwater.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 14 (+2) | 14 (+2) | 16 (+3) | 16 (+3) | 20 (+5) |
___
**Saving Throws** :: —
**Skills** :: Perception +6
**Senses** :: passive Perception 13
...
**Challenge** :: 8 (3,900 XP)
___
***Can breathe underwater.*** :: Can breathe underwater
***acid resistance.*** :: acid resistance
***shape water at will.*** :: shape water at will
***create water.*** :: create water
***expertise in Persuasion/Insight.*** :: expertise in Persuasion/Insight
### Actions
...
2. **The Political Favor:** Offers significant resources in exchange for a delicate diplomatic mission.
3. **The Succession Test:** Secretly tests the party as potential heirs or at least useful agents.
4. **The Sunken Secret:** The hidden discovery is becoming unstable. Needs help containing it.
5. **The Harmony Gambit:** A move against the Compact is coming. She needs allies who aren't officially connected to her.
...
![Elder Council Mother Talia Vinehart](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-elder-council-mother-talia-vinehart.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 12 (+1) | 14 (+2) | 16 (+3) | 14 (+2) | 20 (+5) | 16 (+3) |
...
- **Supporter:** Speaker Arien Swiftbrook (reform-minded)
...
### Plot Hooks
1. **The Refugee Crisis:** A new wave of refugees needs help reaching safety. She needs discrete assistance.
...
**Hit Points** :: 165 (15d10 + 75)
**Speed** :: 30 ft.
![Lord Commander Gareth Lightbane (Iron Council)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-gareth-lightbane.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 10 (+0) | 20 (+5) | 12 (+1) | 14 (+2) | 18 (+4) |
___
**Saving Throws** :: —
**Skills** :: Perception +5
**Senses** :: passive Perception 12
...
**Challenge** :: 15 (13,000 XP)
___
***Aura of Protection.*** :: Aura of Protection (+4)
***Aura of Devotion.*** :: Aura of Devotion (immune to charm)
***Purity of Spirit.*** :: Purity of Spirit (immune to disease/magic aging)
### Actions
***Multiattack.*** :: Makes 2 attacks per turn.
...
{{descriptive
#### Secrets (DM Only)
1. **The Demon Fragment:** A piece of demonic essence lodged in his soul during the Demon Tide. It grants him power but slowly corrupts.
2. **The Mercy Killings:** Has executed prisoners who would have been shown mercy. Justified it as necessity.
3. **The Doubt:** No longer certain his god exists. Fights on anyway because the evil definitely exists.
...
2. **The Exorcism:** Seeks a way to remove the demon fragment without dying. Willing to try dangerous methods.
3. **The Necessary Evil:** Asks the party to do something morally questionable that he cannot be seen doing.
4. **The Successor Search:** Testing potential successors without their knowledge. The party might be candidates.
5. **The Final Battle:** The demon fragment is winning. He's planning his last stand and wants allies for the end.
...
**Speed** :: 30 ft.
![Trade Prince Lucian Goldfingers (Merchant League)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lucian-goldfingers.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 18 (+4) | 16 (+3) | 18 (+4) | 14 (+2) | 20 (+5) |
___
**Saving Throws** :: —
**Skills** :: Perception +5
**Senses** :: passive Perception 12
...
**Challenge** :: 11 (7,200 XP)
___
***Sneak Attack.*** :: Sneak Attack (6d6)
***Master of Intrigue.*** :: Master of Intrigue
***Insightful Manipulator.*** :: Insightful Manipulator
***Misdirection.*** :: Misdirection
***massive network of merchants.*** :: massive network of merchants
### Actions
***Dagger +2.*** :: Melee or Ranged Weapon Attack: +11 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 8 (1d4 + 6) piercing damage plus 21 (6d6) sneak attack damage if he has advantage.::
***Cunning Action.*** :: As a bonus action, Lucian can Dash, Disengage, or Hide.
***Evasion.*** :: Takes no damage on successful Dex saves for half, half on failures.
***Spellcasting.*** :: Lucian is a 4th-level bard. His spellcasting ability is Charisma (spell save DC 15, +7 to hit).
***Cantrips.*** :: *friends, minor illusion, vicious mockery*
***1st level (4 slots).*** :: *charm person, disguise self, silent image*
***2nd level (3 slots).*** :: *detect thoughts, suggestion, zone of truth*
***Master of Tactics.*** :: Uses the Help action as a bonus action. Can help an ally within 30 feet rather than 5 feet.
...
**Speed** :: 30 ft.
![Master Crimson (The Syndicate)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-master-crimson.jpg){width:310px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 12 (+1) | 18 (+4) | 14 (+2) | 17 (+3) | 15 (+2) | 18 (+4) |
___
**Saving Throws** :: Dexterity +8, Intelligence +7, Charisma +8
**Skills** :: Deception +12, Insight +6, Intimidation +8, Perception +6, Stealth +8
**Damage Resistances** :: Poison
**Senses** :: Passive Perception 16
**Languages** :: Common, Thieves' Cant, plus 3 others
**Challenge** :: 10 (5,900 XP)
___
***Syndicate Master.*** :: Advantage on Deception checks and Insight checks to detect lies.
***Sneak Attack (5d6).*** :: Once per turn, extra damage when attacking with advantage or ally nearby.
***Evasion.*** :: Takes no damage on successful Dex save, half on failure.
***Uncanny Dodge.*** :: Halves damage from one attack as reaction.
### Actions
***Multiattack.*** :: Makes three attacks with poisoned dagger.
***Poisoned Dagger +1.*** :: Melee or Ranged Weapon Attack: +9 to hit, reach 5 ft. or range 20/60 ft., one target. ***Hit.*** 1d4+5 piercing damage plus 3d6 poison damage. DC 15 Con save or poisoned for 1 minute.::
### Reactions
...
{{descriptive
#### Secrets (DM Only)
1. **Crimson's Identity:** The current Master Crimson is actually Elena Thornwood—Captain Vex Darkwater's sister, who he believes lives a quiet life in Silverpine.
2. **The Succession:** The title has been held by three people over forty years. Elena is the third, having inherited it from her mentor ten years ago.
3. **The Blood Mages:** The Crimson Order actually did name themselves after the Syndicate as a subtle tribute. Several blood mages are Syndicate members.
4. **Lucian's Secret:** Knows about the Trade Prince's assassination of his rival. The evidence is part of Crimson's insurance collection.
5. **The Moral Line:** Elena has rules her predecessors didn't—no children, no killing for revenge only, no slavery. Some lieutenants chafe at these restrictions.
}}

### Plot Hooks
1. **The Succession Crisis:** Someone is trying to take over the Syndicate by eliminating Crimson. She needs protection or investigators.
2. **The Brother Problem:** Vex is getting too high-profile. If he's captured and talks, connections to Elena might emerge.
3. **Lucian's Betrayal:** The Trade Prince is planning to expose the Syndicate's leadership. She needs the threat neutralized.
4. **The Moral Conflict:** A lucrative contract violates her rules. Her lieutenants are pressuring her to take it.
...
**Speed** :: 30 ft.
![Grand Warden Volcanus Rex (Ashwardens)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-grand-warden-volcanus-rex.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 10 (+0) | 20 (+5) | 14 (+2) | 18 (+4) | 14 (+2) |
___
**Saving Throws** :: —
**Skills** :: Perception +7
**Senses** :: passive Perception 14
...
***Soul of the Forge.*** :: Soul of the Forge (+1 AC in heavy armor
***fire resistance for others).*** :: fire resistance for others)
***Saint of Forge and Fire.*** :: Saint of Forge and Fire (fire immunity)
### Actions
***Multiattack.*** :: Makes 2 attacks per turn.
...
{{descriptive
#### Secrets (DM Only)
1. **The Identity:** Is actually three people sharing the role—a human, an elf, and a half-orc who rotate duties.
2. **The Retirement Plan:** Has been slowly preparing to dissolve the Syndicate and transform it into legitimate business.
3. **The Protection Racket:** Some of the people Syndicate "protects" are actually hostages. If Crimson falls, so do they.
4. **The Law Enforcement Deals:** Multiple governments secretly pay the Syndicate to maintain underworld order.
5. **The Personal Rule:** Never kills unless absolutely necessary. Every death ordered haunts them.
}}

### Plot Hooks
1. **The Job Offer:** Has work that requires deniable outsiders. Payment is generous, questions are not.
2. **The Arbitration:** A dispute requires neutral judgment. The party's reputation makes them acceptable arbiters.
3. **The Retirement Assistance:** Needs help with the transition plan. Some lieutenants won't accept going legitimate.
4. **The Information Trade:** Offers valuable intelligence in exchange for a specific service.
5. **The Common Enemy:** Something threatens both Syndicate and legitimate society. Proposes temporary alliance.
...
![Warden Commander Thalia Moonbow (Ironspine Rangers)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-warden-commander-thalia-moonbow.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 14 (+2) | 22 (+6) | 18 (+4) | 14 (+2) | 18 (+4) | 12 (+1) |
___
**Saving Throws** :: —
**Skills** :: Perception +7
**Senses** :: darkvision 60 ft., passive Perception 14
...
___
***Fey Ancestry.*** :: Has advantage on saving throws against being charmed, and magic can't put them to sleep.
***Mountain terrain expert.*** :: Mountain terrain expert
***Colossus Slayer.*** :: Colossus Slayer
***Multiattack Defense.*** :: Multiattack Defense
***Superior Hunter's Defense.*** :: Superior Hunter's Defense
### Actions
***Multiattack.*** :: Makes 2 attacks per turn.
...
**Speed** :: 25 ft.
![Forge-Master Rurik Ironanvil (Forgebound Guild)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-forge-master-rurik-ironanvil.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 12 (+1) | 20 (+5) | 22 (+6) | 14 (+2) | 12 (+1) |
___
**Saving Throws** :: —
**Skills** :: Perception +5
**Senses** :: darkvision 60 ft., passive Perception 12
...
___
***Dwarven Resilience.*** :: Has advantage on saving throws against poison, and resistance to poison damage.
***Can create any weapon/armor.*** :: Can create any weapon/armor
***infusions.*** :: infusions (6 active)
***creates constructs.*** :: creates constructs
...
**Speed** :: 30 ft.
![Prince Aldric Thandris](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-prince-aldric-thandris.jpg){width:315px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 14 (+2) | 18 (+4) | 13 (+1) | 14 (+2) | 16 (+3) |
___
**Saving Throws** :: Strength +9, Constitution +9, Wisdom +7, Charisma +8
**Skills** :: Athletics +9, History +6, Insight +7, Intimidation +8, Perception +7, Persuasion +8
**Damage Resistances** :: None
**Senses** :: Passive Perception 17
**Languages** :: Common, Dwarvish, Elvish
**Challenge** :: 12 (8,400 XP)
___
***Action Surge (1/Rest).*** :: Can take one additional action on his turn.
***Second Wind (1/Rest).*** :: Bonus action to regain 1d10+8 hit points.
***Indomitable (2/Rest).*** :: Can reroll a failed saving throw.
***Extra Attack (2).*** :: Can attack twice when taking the Attack action.
***Divine Sense (7/Day).*** :: Can detect celestials, fiends, and undead within 60 feet.
***Lay on Hands (20 HP Pool).*** :: Can heal or cure disease/poison.
***Divine Smite.*** :: Can expend spell slots to deal extra radiant damage (2d8 per slot level).
***Divine Health.*** :: Immune to disease.
***Sacred Weapon (Channel Divinity).*** :: Weapon becomes magical, gets +3 to attack rolls, sheds bright light.
***Champion Challenge (Channel Divinity).*** :: Creatures within 30 feet can't willingly move away from him.
***Spell Save DC.*** :: 16, Spell Attack Bonus: +8
***1st Level (4 slots).*** :: Bless, Command, Compelled Duel, Shield of Faith
***2nd Level (2 slots).*** :: Aid, Find Steed, Zone of Truth
### Actions
***Multiattack.*** :: Makes two melee attacks.
***Heir's Blade (Longsword +1).*** :: Melee Weapon Attack: +10 to hit, reach 5 ft., one target. ***Hit.*** 1d8+5 slashing damage (1d10+5 versatile), plus Divine Smite if used.::
***Shield Bash.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target. ***Hit.*** 1d4+4 bludgeoning damage, target must succeed DC 17 Strength save or be knocked prone.::
### Reactions
***Parry.*** :: Adds +4 to AC against one melee attack.
***Protection.*** :: When ally within 5 feet is attacked, impose disadvantage on the attack roll.
...
### Personality
**Traits:**
- Earnest and dedicated to living up to his father's legacy
- Insists on training with common soldiers, not just nobles
- Speaks directly and honestly, sometimes too bluntly for court politics
- Quick to defend the honor of Thaldros or his family

**Ideals:**
- **Service:** "A ruler exists to serve the people, not the other way around."
- **Merit:** "Respect must be earned through action, not demanded by title."
- **Unity:** "A divided kingdom falls. We must stand together."

**Bonds:**
- Devoted to his father King Aldric IV
- Fiercely protective of his younger siblings
- Loyal to the soldiers he's trained alongside
- Believes in the eventual reunification of Thaldros and Aethoria

**Flaws:**
- Can be impulsive when family honor is questioned
- Sometimes too trusting of those who seem earnest
- Struggles with political maneuvering (prefers direct action)
...
- **Concern:** Lady Morgana Blackwater (Marshaven) - senses she's hiding something
- **Secret Correspondent:** Princess Elanil Aethermere - discussing future reunification
...
- **Mannerisms:** Stands with military posture. Gestures with hand on sword pommel when thinking. Salutes senior officers even though he outranks them.
- **Catchphrase:** "By steel and honor, we serve."
- **When stressed:** Grips sword hilt tightly, jaw clenches
- **In combat:** Fights at the front, protects weaker allies, never retreats first

### Notes for DMs
- Aldric is designed as a heroic NPC who can become a patron, ally, or even rival
- He represents the "good prince" archetype but with real flaws and complexities
- His secrets provide multiple adventure hooks across levels 5-15
- Can serve as quest-giver, companion, or tragic figure depending on campaign needs
- His relationship with Aethoria (through Elanil) can drive reunification plotlines
...
**Speed** :: 30 ft.
![General Marthos Thandris](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-general-marthos-thandris.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 14 (+2) | 20 (+5) | 16 (+3) | 14 (+2) | 14 (+2) |
___
**Saving Throws** :: Strength +11, Constitution +11
**Skills** :: Athletics +11, History +9, Insight +8, Intimidation +8, Perception +8, Survival +8
**Damage Resistances** :: None
**Senses** :: Passive Perception 18
...
___
***Action Surge (2/Rest).*** :: Can take one additional action on his turn.
***Second Wind (1/Rest).*** :: Bonus action to regain 1d10+14 hit points.
***Indomitable (3/Rest).*** :: Can reroll a failed saving throw.
***Extra Attack (3).*** :: Can attack three times when taking the Attack action.
***Master Tactician.*** :: Allies within 30 feet gain +2 to attack rolls and can reroll 1s on damage dice.
***Veteran Commander.*** :: As bonus action, can allow one ally within 60 feet to make an attack or move up to their speed.
***Fearless Presence.*** :: Immune to being frightened, allies within 10 feet have advantage on saves vs. fear.
### Actions
***Multiattack.*** :: Makes three melee attacks or two ranged attacks.
***Greatsword of Command +2.*** :: Melee Weapon Attack: +13 to hit, reach 5 ft., one target. ***Hit.*** 2d6+7 slashing damage. Critical on 19-20.::
***Heavy Crossbow.*** :: Ranged Weapon Attack: +8 to hit, range 100/400 ft., one target. ***Hit.*** 1d10+2 piercing damage.::
***Commander's Order (Recharge 5-6).*** :: All allies within 60 feet gain advantage on their next attack roll and add +5 to damage.
### Reactions
***Parry.*** :: Adds +5 to AC against one melee attack.
***Battlefield Awareness.*** :: When ally within 30 feet is hit by an attack, can use reaction to have the attack target him instead if he's within range.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Move.** :: Moves up to his speed without provoking opportunity attacks.
**Attack.** :: Makes one weapon attack.
**Tactical Command (Costs 2).** :: One ally within 60 feet can immediately make a weapon attack or use an action.
...
- Demanding of subordinates, expects excellence at all times
- Rarely shows emotion, maintains professional distance
- Values results over sentiment

**Ideals:**
- **Order:** "Discipline and structure create victory."
- **Duty:** "Personal feelings are irrelevant. The kingdom's security is everything."
- **Strength:** "Only through military might can we ensure lasting peace."

**Bonds:**
- Loyalty to the Thandris bloodline and the kingdom
- Dedication to the Royal Army (his life's work)
- Pride in his military accomplishments
- Distant respect for King Aldric IV
...
### Background & History
Marthos is a distant cousin of King Aldric IV - his great-grandfather was the King's great-uncle. While not in direct line for succession, he's close enough that in a catastrophic scenario, he could have a claim.
...
{{descriptive
#### Secrets (DM Only)
1. **The Contingency Plan:** Marthos has a detailed plan for taking control of the government if the royal line fails or proves incompetent. It's not treason per se - he frames it as emergency succession protocol - but it could be seen as such. The plan is hidden in encoded military documents.
...
### Plot Hooks
1. **The Coup Conspiracy:** The party discovers evidence of Marthos's contingency plan. Is it legitimate emergency planning or treason? They must investigate without tipping him off, and decide whether to expose it or let it stand.

2. **The Mission:** General Marthos recruits the party for a dangerous mission behind enemy lines. His orders are clear but brutal - success requires sacrifices. Will they follow orders or question their morality?

3. **The Investigation:** The surviving soldier with evidence of Marthos's past failure surfaces. Someone is trying to blackmail the General. He hires the party to retrieve the journal - but will they give it to him or use it themselves?
...
### Roleplaying Notes
- **Voice:** Deep, authoritative, rarely raised but always commanding attention
- **Mannerisms:** Stands at parade rest, uses military terminology in casual conversation, gestures with precision
- **Catchphrase:** "Strategy before sentiment."
...
- Can serve as quest-giver, rival, antagonist, or even reluctant ally
- His relationship with Aldric creates natural tension and political drama
- Works well as a "necessary evil" NPC - you need him but don't trust him
...
**Speed** :: 30 ft.
![Princess Elanil Aethermere](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-princess-elanil-aethermere.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 16 (+3) | 14 (+2) | 20 (+5) | 16 (+3) | 18 (+4) |
___
**Saving Throws** :: Intelligence +10, Wisdom +8, Charisma +9
**Skills** :: Arcana +10, Deception +9, Diplomacy +14 (expertise), History +10, Insight +8, Perception +8, Persuasion +14 (expertise), Performance +9
**Damage Resistances** :: Charmed condition (advantage on saves)
**Senses** :: Darkvision 60 ft., Passive Perception 18
**Languages** :: Common, Elvish, Sylvan, Draconic, Dwarvish, Celestial
**Challenge** :: 11 (7,200 XP)
___
***Fey Ancestry.*** :: Advantage on saves against being charmed, magic can't put her to sleep.
***Trance.*** :: Meditates for 4 hours instead of sleeping.
***Hypnotic Gaze.*** :: Can charm one creature within 5 feet (Wisdom save DC 18 or charmed).
***Instinctive Charm (Recharge 4-6).*** :: When attacked, attacker must target different creature (Wisdom save DC 18).
***Split Enchantment.*** :: When casting enchantment spell targeting one creature, can target second creature.
***Bardic Inspiration (d6, 3/Day).*** :: Bonus action, ally adds d6 to one ability check, attack, or save within 10 minutes.
***Jack of All Trades.*** :: Add +2 to ability checks using skills without proficiency.
***Song of Rest.*** :: Allies regain extra 1d6 HP during short rest if she performs.
***Spell Save DC.*** :: 18, Spell Attack Bonus: +10
***Cantrips.*** :: Friends, Mage Hand, Message, Prestidigitation, Minor Illusion
***1st Level (4 slots).*** :: Charm Person, Disguise Self, Sleep, Detect Magic, Shield
***2nd Level (3 slots).*** :: Suggestion, Hold Person, Detect Thoughts, Misty Step
***3rd Level (3 slots).*** :: Hypnotic Pattern, Counterspell, Sending, Tongues
***4th Level (3 slots).*** :: Charm Monster, Confusion, Dimension Door
***5th Level (2 slots).*** :: Dominate Person, Modify Memory, Dream
***6th Level (1 slot).*** :: Mass Suggestion
***Cantrips.*** :: Vicious Mockery, Dancing Lights
***1st Level.*** :: Cure Wounds, Healing Word, Heroism
### Actions
***Multiattack.*** :: Makes two attacks or casts a spell.
***Quarterstaff.*** :: Melee Weapon Attack: +4 to hit, reach 5 ft., one target. ***Hit.*** 1d6-1 bludgeoning damage (rarely used - prefers magic and diplomacy).::
***Enchantment Spell.*** :: Casts one of her prepared enchantment spells.
### Reactions
***Shield.*** :: Cast shield spell as reaction (+5 AC until start of next turn).
***Counterspell.*** :: Attempt to counter enemy spell (automatic success up to 3rd level, check for higher).
***Instinctive Charm.*** :: When attacked, force attacker to target different creature.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Cast a cantrip.
**Inspire.** :: Use Bardic Inspiration on an ally.
**Charm (Costs 2).** :: Attempt to charm one creature with Hypnotic Gaze.
...
3. **The Artifact Mission:** Elanil knows the location of a piece of the artifact that caused the Worldrend - a fragment of the Celestial Compass. She's been quietly trying to gather all pieces to either destroy them or use them to reverse the damage. She hasn't told anyone, not even her mother.
...
3. **The Artifact Hunt:** Elanil reveals her quest to find Celestial Compass fragments and asks the party to recover one from a dangerous location. But others are also seeking them - for potentially darker purposes.

4. **The Exposed Letters:** Someone steals the correspondence between Elanil and Aldric. The party must recover them before they're made public, facing thieves, spies, and political operators. Time is critical.

5. **The Assassination Plot:** The party uncovers a serious attempt on Elanil's life during a major diplomatic summit. They must protect her, identify the conspirators, and prevent an international incident.

6. **The Choice:** War threatens between the kingdoms. Elanil offers the party a controversial mission that could prevent war but requires morally gray actions. Will they help her, or refuse and watch conflict escalate?

### Roleplaying Notes
- **Voice:** Melodious, soothing, speaks slowly and deliberately in multiple languages
- **Mannerisms:** Gentle hand gestures, makes eye contact to show genuine interest, touches people lightly on arm when making point
- **Catchphrase:** "Let us find the path forward together."
- **When stressed:** Speaks even more slowly, switches to Elvish, fingers trace patterns on staff
- **In conflict:** Uses magic to control situations, rarely direct violence, always offers diplomatic out

### Notes for DMs
- Elanil is designed as a powerful diplomatic NPC and quest-giver
- She represents the "peace through understanding" philosophy
- Her secrets provide multiple campaign hooks across levels 8-15
- Works well as patron for diplomacy-focused parties
- Her relationship with Aldric can drive reunification storylines
- The artifact quest ties into deeper world lore
- Can serve as voice of reason, quest-giver, or moral compass
...
**Speed** :: 30 ft.
![Archmage Eldrin Aethermere](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-archmage-eldrin-aethermere.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 16 (+3) | 16 (+3) | 22 (+6) | 18 (+4) | 14 (+2) |
___
**Saving Throws** :: Intelligence +13, Wisdom +11
**Skills** :: Arcana +20 (expertise), History +13, Insight +11, Investigation +13, Perception +11
**Damage Resistances** :: Damage from spells (from robes)
**Senses** :: Darkvision 60 ft., Passive Perception 21
**Languages** :: Common, Elvish, Draconic, Celestial, Infernal, Abyssal, Sylvan, Primordial
**Challenge** :: 17 (18,000 XP)
___
***Fey Ancestry.*** :: Advantage on saves against being charmed.
***Trance.*** :: Meditates 4 hours instead of sleeping.
***Portent (2/Day).*** :: After long rest, rolls 2d20 and records. Can replace any attack roll, save, or ability check (ally or enemy) with one of these rolls.
***Expert Divination.*** :: When casting divination spell of 2nd level or higher, regain one expended spell slot (up to 5th level).
***The Third Eye (1/Rest).*** :: Gains one of the following for 1 minute: Darkvision 60 ft., See Invisible, Read all languages, or See into Ethereal Plane.
***Spell Mastery.*** :: Can cast Shield and Detect Magic at will without spell slot.
***Signature Spells.*** :: Can cast Counterspell and Dispel Magic once per short rest without spell slot.
***Spell Save DC.*** :: 21, Spell Attack Bonus: +13
***Cantrips (at will).*** :: Fire Bolt, Mage Hand, Message, Prestidigitation, Ray of Frost
***1st Level (4 slots).*** :: Detect Magic*, Shield*, Identify, Comprehend Languages
***2nd Level (3 slots).*** :: Detect Thoughts, Locate Object, See Invisibility
***3rd Level (3 slots).*** :: Counterspell**, Dispel Magic**, Sending, Tongues
***4th Level (3 slots).*** :: Arcane Eye, Dimension Door, Divination
***5th Level (2 slots).*** :: Scrying, Cone of Cold, Wall of Force
***6th Level (1 slot).*** :: True Seeing, Globe of Invulnerability, Chain Lightning
***7th Level (1 slot).*** :: Teleport, Forcecage, Simulacrum
***8th Level (1 slot).*** :: Dominate Monster, Mind Blank, Maze
***9th Level (1 slot).*** :: Foresight, Wish, Time Stop
### Actions
***Multiattack.*** :: Makes two attacks or casts a spell.
***Arcane Staff +2.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target. ***Hit.*** 1d6+2 bludgeoning damage plus 2d8 force damage.::
***Spellcasting.*** :: Casts one of his prepared spells.
### Reactions
***Shield.*** :: +5 AC until start of next turn (at will).
***Counterspell.*** :: Automatically counter spells 3rd level or lower, check for higher (1/short rest without slot).
***Portent.*** :: Replace any d20 roll with a portent die.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Cast a cantrip.
**Spell (Costs 2).** :: Cast a spell of 3rd level or lower.
**Foresight (Costs 3).** :: Use Portent ability even if already used this turn.
...
2. **The Prophecy Investigation:** Eldrin predicts disaster at a specific place and time. The party must investigate and determine if it's real or another false alarm. If they prevent it, was it real or would it not have happened anyway?

3. **The Forbidden Knowledge:** Eldrin needs the party to retrieve a dangerous magical tome from a forbidden location. The knowledge inside could save thousands or doom everyone - depends on how it's used.

4. **The Simulacrum Exposed:** Someone discovers Eldrin's simulacrum and is blackmailing him. The party must handle the situation without exposing the truth to the court.

5. **The Celestial Compass:** Eldrin reveals his research and asks the party to help gather the Compass fragments. But his visions show this could either save or doom the world - he's not sure which.

6. **The Time Loop:** Reality is breaking - the party keeps reliving the same day. Eldrin reveals he created it to save someone but can't end it. They must help him fix reality before it collapses.

### Roleplaying Notes
- **Voice:** Precise, formal, often speaks in conditional statements and probabilities
- **Mannerisms:** Peers into distance as if seeing things others can't, writes notes constantly, gestures with staff when explaining
- **Catchphrase:** "I have foreseen this possibility."
- **When stressed:** Speaks faster, switches to Elvish, rubs temples while processing visions
- **In combat:** Stays back, controls battlefield with magic, uses divination to predict enemy actions

### Notes for DMs
- Eldrin is designed as a powerful magical patron and plot device
- His divination abilities let you foreshadow future events
- He's the "hyper-intelligent wizard" archetype with human (elf) flaws
- Can serve as quest-giver, advisor, or mysterious figure with hidden knowledge
- His visions allow you to guide players toward plot without railroading
- The time loop and prophecy hooks work for levels 10-20 campaigns
- Perfect for mystery, magical investigation, and reality-bending adventures
- His secrets provide multiple campaign arcs
...
**Speed** :: 30 ft.
![Lord Aldris Goldshore IV](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lord-aldris-goldshore-iv.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 12 (+1) | 18 (+4) | 14 (+2) | 18 (+4) | 16 (+3) | 20 (+5) |
___
**Saving Throws** :: Dexterity +9, Intelligence +9, Charisma +10
**Skills** :: Deception +15 (expertise), Insight +13 (expertise), Intimidation +10, Investigation +9, Perception +8, Persuasion +15 (expertise), Sleight of Hand +9
**Damage Resistances** :: Poison (builds immunity through small doses)
**Senses** :: Passive Perception 18
**Languages** :: Common, Elvish, Dwarvish, Halfling, Thieves' Cant, Draconic
**Challenge** :: 13 (10,000 XP)
___
...
***Reliable Talent.*** :: Treats any roll of 9 or lower as 10 on ability checks.
***Elusive.*** :: No attack rolls have advantage against him while not incapacitated.
***Sneak Attack.*** :: Once per turn, deals extra 5d6 damage when has advantage or ally within 5 feet.
***Master Negotiator.*** :: Advantage on all Charisma checks related to commerce, can reroll once per conversation.
***Network of Contacts.*** :: Can call in favors from merchants, sailors, dockworkers across both continents.
***Escape Artist.*** :: Advantage on checks to escape bonds, can slip handcuffs/ropes as bonus action.
### Actions
***Multiattack.*** :: Makes two attacks with rapier or hand crossbow.
***Rapier +2.*** :: Melee Weapon Attack: +11 to hit, reach 5 ft., one target. ***Hit.*** 1d8+6 piercing damage, plus 5d6 Sneak Attack if applicable.::
***Hand Crossbow +1.*** :: Ranged Weapon Attack: +10 to hit, range 30/120 ft., one target. ***Hit.*** 1d6+5 piercing damage, plus 5d6 Sneak Attack if applicable.::
***Bribe/Persuade.*** :: Makes Persuasion check to influence NPC with offer of money, favors, or opportunities.
### Reactions
***Uncanny Dodge.*** :: Halve damage from one attack.
***Parry.*** :: +4 AC against one melee attack.
...
5. **The Alliance Offer:** Aldris offers the party a lucrative job - transport "cargo" with no questions asked. The pay is incredible. But they'll learn the cargo is slaves. What now?

6. **The Rival Elimination:** House Crystalborn is cutting into Aldris's profits. He hires the party to sabotage their operations - but the methods he suggests are criminal. Do they refuse, negotiate, or proceed?
...
**Speed** :: 30 ft.
![Lady Serina Goldshore](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lady-serina-goldshore.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 16 (+3) | 12 (+1) | 16 (+3) | 14 (+2) | 20 (+5) |
___
...
***Expertise.*** :: Double proficiency in Insight, Performance, and Persuasion.
***Font of Inspiration.*** :: Regains Bardic Inspiration on short rest.
***Countercharm.*** :: Action, allies within 30 feet have advantage vs. frightened/charmed.
***Cutting Words.*** :: Reaction, subtract d8 from enemy's attack, ability check, or damage roll.
***Additional Magical Secrets.*** :: Knows 2 spells from any class.
***Cunning Action.*** :: Bonus action to Dash, Disengage, or Hide.
***Sneak Attack.*** :: Once per turn, 2d6 extra damage with advantage or ally nearby.
***Spell Save DC.*** :: 17, Spell Attack Bonus: +9
***Cantrips.*** :: Prestidigitation, Message, Vicious Mockery, Minor Illusion
***1st Level (4 slots).*** :: Cure Wounds, Detect Magic, Disguise Self, Charm Person, Identify
***2nd Level (3 slots).*** :: Detect Thoughts, Invisibility, Suggestion, Zone of Truth
***3rd Level (3 slots).*** :: Dispel Magic, Sending, Tongues, Counterspell
***4th Level (3 slots).*** :: Dimension Door, Charm Monster, Greater Invisibility
***5th Level (1 slot).*** :: Modify Memory, Scrying
### Actions
***Rapier +1.*** :: Melee Weapon Attack: +8 to hit, reach 5 ft., one target. ***Hit.*** 1d8+4 piercing damage, plus 2d6 Sneak Attack if applicable.::
***Shortbow.*** :: Ranged Weapon Attack: +7 to hit, range 80/320 ft., one target. ***Hit.*** 1d6+3 piercing damage.::
***Spellcasting.*** :: Casts one of her prepared spells.
***Bardic Inspiration.*** :: Inspires ally as bonus action.
### Reactions
***Cutting Words.*** :: Subtract 1d8 from enemy roll.
...
Recently, she's discovered disturbing evidence suggesting her father may have killed his own father. She's terrified it's true and desperately hopes it's not.
...
4. **The Evidence Cache:** She knows the location of her father's secret vault (discovered it accidentally) but hasn't told anyone. She's terrified of what she'll find if she looks inside.
...
2. **The Underground:** The party discovers Serina's escaped prisoner operation. Are they helping her continue it, exposing her to her father, or trying to stop her for her own safety?

3. **The Double Agent:** Serina hires the party for what seems like legitimate work. They discover she's using them to investigate her own father. Do they help, refuse, or tell Aldris?

4. **The Kidnapping:** Someone kidnaps Serina to blackmail Aldris. The party must rescue her. But they discover she went willingly - she's trying to gather evidence. Do they extract her or help her mission?

5. **The Impossible Choice:** Evidence emerges that Aldris murdered his father. Serina asks the party to help her find truth. When they confirm it, she must choose between family and justice.

6. **The Takeover:** Aldris is arrested (for something). Serina must run House Goldshore temporarily. She asks the party to help her clean house - literally eliminating the illegal operations - before he returns.

### Roleplaying Notes
- **Voice:** Warm, genuine, musical quality from bardic training
- **Mannerisms:** Fidgets with necklace when nervous, smiles when greeting people, takes notes constantly
- **Catchphrase:** "Everyone deserves dignity, not just the wealthy."
- **When stressed:** Plays music to think, speaks softly and deliberately
- **In conflict:** Tries diplomacy first, uses magic to escape rather than fight

### Notes for DMs
- Serina is designed as a moral compass character and potential ally
- She's the "good person in bad situation" archetype
- Can serve as quest-giver, informant, or character who needs saving
- Her investigation provides campaign hooks for levels 6-12
- Works as bridge between party and her father (can vouch for them)
- The father-daughter dynamic creates emotional complexity
- Perfect for moral dilemma campaigns about loyalty vs. justice
- Her secrets allow her to be helpful without being overpowered
...
**Speed** :: 25 ft.
![Thane Durin Ironforge](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-thane-durin-ironforge.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 12 (+1) | 20 (+5) | 14 (+2) | 18 (+4) | 12 (+1) |
___
**Saving Throws** :: Strength +10, Constitution +10, Wisdom +9
**Skills** :: Athletics +10, Insight +9, Perception +9, Religion +7, Smith's Tools +12 (expertise), Mason's Tools +7
**Damage Resistances** :: Poison
**Senses** :: Darkvision 60 ft., Passive Perception 19
...
***Action Surge (2/Rest).*** :: Can take additional action on turn.
***Second Wind (1/Rest).*** :: Bonus action, regain 1d10+12 hit points.
***Indomitable (3/Rest).*** :: Reroll failed saving throw.
***Extra Attack (2).*** :: Can attack twice per Attack action.
***Blessing of the Forge (1/Long Rest).*** :: Touch nonmagical weapon or armor, becomes +1 for 24 hours.
***Soul of the Forge.*** :: Resistance to fire damage, +1 AC while wearing heavy armor (calculated).
***Divine Strike.*** :: Once per turn, weapon deals extra 1d8 fire damage.
***Spell Save DC.*** :: 17, Spell Attack Bonus: +9
***Cantrips.*** :: Mending, Resistance, Sacred Flame
***1st Level (4 slots).*** :: Searing Smite*, Shield of Faith, Bless, Cure Wounds
***2nd Level (3 slots).*** :: Heat Metal*, Spiritual Weapon, Lesser Restoration
### Actions
***Multiattack.*** :: Makes two attacks with warhammer.
***Forgemaster's Hammer +2.*** :: Melee Weapon Attack: +12 to hit, reach 5 ft., one target. ***Hit.*** 1d8+7 bludgeoning damage plus 1d8 fire damage. Critical on 19-20.::
***Special.*** :: Against constructs or objects, deals maximum damage.
***Shield Bash.*** :: Melee Weapon Attack: +10 to hit, reach 5 ft., one target. ***Hit.*** 1d4+5 bludgeoning damage, target must succeed DC 18 Strength save or be knocked prone.::
***Channel Divinity - Artisan's Blessing.*** :: Create simple metal object (up to 100 gp value).
### Reactions
***Parry.*** :: +5 AC against one melee attack.
***Shield Block.*** :: Impose disadvantage on attack against ally within 5 feet.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Move.** :: Moves up to speed.
**Strike.** :: Makes one hammer attack.
**Command (Costs 2).** :: One dwarf ally within 60 feet can make weapon attack as reaction.
...
2. **The Succession Crisis:** Durin's three sons compete for inheritance through dangerous challenges. He asks the party to monitor the competitions for cheating - but discovers the brothers are being manipulated by outside forces.

3. **The Missing Miners:** A team disappears in the deep mines. Durin sends the party to investigate. They find evidence of the old murder - and discover the killer is still active.

4. **The Mythril Emergency:** The veins are depleting catastrophically fast. Durin needs the party to find new sources before his house collapses economically. The search leads to dangerous territories.

5. **The Dragon Negotiation:** The dragon wants renegotiation of the pact - more territory or she starts raiding. Durin sends the party as intermediaries. Can they satisfy an ancient red dragon?

6. **The Ancient Warning:** The sealed chambers start opening from the inside. Durin must admit the truth and get help before whatever is down there escapes.

### Roleplaying Notes
- **Voice:** Deep, gravelly, thick dwarvish accent, speaks slowly
- **Mannerisms:** Strokes beard when thinking, gestures with hammer, stands with arms crossed
- **Catchphrase:** "Aye, that'll need doin' properly."
- **When stressed:** Switches to pure Dwarvish, grips hammer tighter, jaw clenches
- **In combat:** Fights defensively, protects allies, uses environment to advantage
...
- Perfect for dungeon delving and horror campaigns
...
**Speed** :: 25 ft.
![Master Smith Gundren Ironforge](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-master-smith-gundren-ironforge.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 14 (+2) | 18 (+4) | 20 (+5) | 14 (+2) | 12 (+1) |
___
**Saving Throws** :: Constitution +9, Intelligence +10
**Skills** :: Arcana +10, Investigation +10, Perception +7, Smith's Tools +15 (expertise), Tinker's Tools +10
**Damage Resistances** :: Poison
**Senses** :: Darkvision 60 ft., Passive Perception 17
...
***Magical Tinkering.*** :: Can imbue tiny objects with minor magical effects.
***Infuse Item.*** :: Can infuse 6 magic items simultaneously from list.
***Armorer Spells.*** :: Additional spells always prepared.
***Arcane Armor.*** :: Can turn suit of armor into magical powered armor as action.
***Armor Model (Guardian).*** :: Defensive field, can mark enemies to have disadvantage vs. allies.
***Steel Defender.*** :: Has a mechanical construct companion (see below).
***- Armor (his arcane armor).*** :: +2, resistance to fire
***- Weapon (warhammer).*** :: +2, returning
***- Goggles.*** :: Replicate Magic Item (Goggles of Night)
***- Belt.*** :: Replicate Magic Item (Belt of Hill Giant Strength, STR 21 not used in stats above)
***- Ring.*** :: Ring of Protection
***- Tools.*** :: Enhanced smith tools (+2 to checks)
***Spell Save DC.*** :: 18, Spell Attack Bonus: +10
***Cantrips.*** :: Mending, Fire Bolt, Create Bonfire, Magic Stone
***1st Level (4 slots).*** :: Cure Wounds, Feather Fall, Identify, Detect Magic
***2nd Level (3 slots).*** :: Heat Metal, Enhance Ability, See Invisibility
***3rd Level (3 slots).*** :: Dispel Magic, Haste, Protection from Energy
***4th Level (2 slots).*** :: Fabricate, Stone Shape, Freedom of Movement
***5th Level (2 slots).*** :: Creation, Wall of Stone
### Actions
***Multiattack.*** :: Makes two attacks with warhammer or uses Steel Defender.
***Warhammer +2 (Infused).*** :: Melee Weapon Attack: +11 to hit, reach 5 ft., one target. ***Hit.*** 1d8+6 bludgeoning damage (1d10+6 versatile), returns to hand when thrown.::
***Thunder Gauntlets (Armor Model).*** :: Melee Weapon Attack: +11 to hit, reach 5 ft., one target. ***Hit.*** 1d8+6 thunder damage, target has disadvantage on attack rolls against targets other than Gundren until start of his next turn.::
***Steel Defender Command.*** :: Command construct to attack or defend.
***Cast Spell.*** :: Casts one of his prepared spells.
***STEEL DEFENDER (Construct Companion).*** :: 
***- AC.*** :: 17, HP: 67 (same as Gundren's class level × 5)
***- Speed.*** :: 40 ft.
- STR 14, DEX 12, CON 14, INT 4, WIS 10, CHA 6
- Immune to poison, exhaustion, charmed
***- Attacks.*** :: Force-Empowered Rend (+7 to hit, 1d8+4 force damage)
***- Special.*** :: Can impose disadvantage on attacks vs. Gundren as reaction
### Reactions
***Flash of Genius.*** :: Add +5 to any ability check or save (his or ally within 30 feet) 5/day.
***Deflect Attack.*** :: Arcane armor grants +2 AC vs. one attack as reaction.
...
{{descriptive
#### Secrets (DM Only)
1. **The Masterpiece Quest:** Gundren has a secret project - recreating a legendary artifact called the "Worldforge Hammer" that was lost centuries ago. He's gathered fragments of lore and is close to understanding its creation. If successful, it would be the greatest work in recorded history.
...
5. **The Romantic Regret:** He was once engaged to an elven artificer named Erethiel. They broke up when he chose craft over relationship. She died 50 years later. He still has the engagement ring he made - his finest jewelry work. He's never shown anyone.

6. **The Iron Heart Secret:** Ironheart, his Steel Defender, isn't purely mechanical. It contains a fragment of his own soul - part of why it's so sophisticated. This process was painful and permanent. If Ironheart is destroyed, part of Gundren dies with it.
}}

### Plot Hooks
1. **The Commission:** Gundren offers to craft the party weapons/armor - but his price isn't gold. He needs rare materials from dangerous places. The quest to gather them becomes an adventure.

2. **The Failed Sword:** Gundren learns his massacre sword is in the party's region. He asks them to help recover it. But the current owner (who inherited it innocently) doesn't want to give up a masterwork weapon.

3. **The Masterpiece:** Gundren reveals the Worldforge Hammer project and needs help. Gathering the knowledge requires delving into ancient ruins, negotiating with dragons, and possibly time travel.

4. **The Student's Trial:** Gundren's hobgoblin student is discovered and arrested. He asks the party to help prove the student deserves a chance. This becomes about prejudice and second chances.

5. **The Living Metal:** Gundren needs the party's help studying the sentient metal. They must journey to where he found it - a place where reality is thin and strange things happen.

6. **The Defender's Damage:** Ironheart is severely damaged in battle. Gundren reveals the soul connection and begs the party to help him save his companion before the soul fragment dies.

### Roleplaying Notes
- **Voice:** Gruff, thick dwarvish accent, speaks in technical terms
- **Mannerisms:** Constantly examining things, runs fingers along metalwork, taps with hammer
- **Catchphrase:** "Good work's never rushed, and rushed work's never good."
...
- Can provide party with custom equipment (for price of adventure)
- His secrets provide hooks for levels 8-15
- Works as quest-giver, crafter, or traveling companion
- Perfect for crafting-focused campaigns
- His companion adds unique combat dynamics
- The masterpiece quest can become campaign centerpiece
...
![Lady Seraphine Silverleaf](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lady-seraphine-silverleaf.jpg){width:305px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
### Personality
**Traits:**
- Patient and wise, speaks in measured tones
- Protective of nature but pragmatic about civilization's needs
- Excellent judge of character, sees through deception
- Values balance between preservation and progress

**Ideals:**
- **Harmony:** "All life is interconnected. Harm one, harm all."
- **Stewardship:** "We don't own the forest. We're custodians for future generations."
- **Wisdom:** "Age teaches patience. Patience reveals truth."

**Bonds:**
- The Silverwood Forest (her responsibility and love)
- House Silverleaf's legacy and future
- The balance between elven traditions and modern change
- Her son Arannis (protective, sees his potential)

**Flaws:**
- Can be inflexible about protecting nature
- Holds ancient grudges (typical elf)
...
2. **The Reunion Vision:** Seraphine had a druidic vision of the kingdoms reuniting - but the vision showed it happening through catastrophe, not diplomacy. She's desperately trying to prevent the disaster while enabling peaceful reunification.
...
2. **The Vision Quest:** She tasks the party with preventing the catastrophic reunification she foresaw. But they must do so without knowing all details (she won't tell them the full vision).

3. **The Fey Renegotiation:** The ancient fey demand renegotiation of the pact. Seraphine sends the party as intermediaries to the Feywild. The fey's demands might be impossible or immoral.

4. **The Succession Trial:** Seraphine creates challenges to test Arannis (and possibly other candidates) for succession. She asks the party to observe objectively and report their assessment.

5. **The Ancient Enemy:** Something emerges from the deep forest - a threat from before the Worldrend that she thought sealed forever. She must lead the defense, and the party becomes crucial allies.

6. **The Memory Quest:** Seraphine is one of few who remember the pre-Worldrend world. Scholars, politicians, or dark forces want those memories - extracted magically if necessary. The party must protect her and her knowledge.

### Roleplaying Notes
- **Voice:** Melodious, deliberate, often speaks in nature metaphors
- **Mannerisms:** Touches plants as she passes, pauses to listen to things others don't hear, eyes follow unseen movements
- **Catchphrase:** "The forest speaks to those who listen."
- **When stressed:** Closes eyes, communing with nature for guidance
- **In combat:** Uses environment, controls battlefield with plants, rarely directly attacks

### Notes for DMs
- Seraphine is designed as wise mentor and quest-giver
- She's the "ancient guardian" archetype with genuine wisdom
- Can provide quests related to nature, ancient threats, or politics
- Her secrets provide hooks for levels 10-18
- Works as patron, advisor, or authority figure
- Perfect for druid-focused campaigns
- The succession angle creates political drama
- Her memory of pre-Worldrend can drive lore-heavy campaigns
...
**Speed** :: 40 ft., climb 40 ft.
![Ranger-Lord Arannis Silverleaf](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-arannis-silverleaf.jpg){width:305px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 22 (+6) | 20 (+5) | 14 (+2) | 20 (+5) | 12 (+1) |
___
**Saving Throws** :: Strength +8, Dexterity +11, Wisdom +10
**Skills** :: Animal Handling +10, Athletics +8, Investigation +7, Nature +7, Perception +15 (expertise), Stealth +16 (expertise), Survival +15 (expertise)
**Damage Resistances** :: None
**Senses** :: Darkvision 60 ft., Passive Perception 25
**Languages** :: Common, Elvish, Sylvan, Druidic, Goblin, Orc
**Challenge** :: 16 (15,000 XP)
___
***Fey Ancestry.*** :: Advantage on saves vs. charmed, immune to magical sleep.
***Mask of the Wild.*** :: Can hide in lightly obscured natural terrain.
***Fleet of Foot.*** :: Speed 40 ft.
***Favored Enemy (Aberrations, Monstrosities, Undead).*** :: +4 damage, advantage on tracking/recalling.
***Natural Explorer (Forest, Mountains, Swamp).*** :: Ignore difficult terrain, double proficiency on related checks, can't become lost, alert even while traveling/foraging, move stealthily at normal pace, find 2× food/water.
***Land's Stride.*** :: Move through magical difficult terrain.
***Hide in Plain Sight.*** :: Can spend 1 minute to camouflage self, gain +10 to Stealth while motionless.
***Vanish.*** :: Can Hide as bonus action, can't be tracked by nonmagical means.
***Hunter's Prey - Colossus Slayer.*** :: Once per turn, deal extra 1d8 damage to wounded target.
***Defensive Tactics - Multiattack Defense.*** :: When hit by creature, gain +4 AC against all subsequent attacks from that creature this turn.
***Superior Hunter's Defense - Evasion.*** :: Take no damage on successful Dex save, half on failure.
***Spell Save DC.*** :: 18, Spell Attack Bonus: +10
***1st Level (4 slots).*** :: Hunter's Mark, Goodberry, Longstrider, Ensnaring Strike
***2nd Level (3 slots).*** :: Pass Without Trace, Spike Growth, Silence, Lesser Restoration
***3rd Level (3 slots).*** :: Conjure Animals, Plant Growth, Lightning Arrow
***4th Level (2 slots).*** :: Conjure Woodland Beings, Freedom of Movement, Guardian of Nature
### Actions
***Multiattack.*** :: Makes four attacks with longbow or two with shortswords.
***Longbow +3 "Thornstrike".*** :: Ranged Weapon Attack: +16 to hit, range 150/600 ft., one target. ***Hit.*** 1d8+9 piercing damage, plus 1d8 if target already wounded (Colossus Slayer), plus 1d6 poison damage (poisoned arrows).::
***Shortswords +2 (dual wield).*** :: Melee Weapon Attack: +14 to hit, reach 5 ft., one target. ***Hit.*** 1d6+8 piercing damage each.::
***Volley (1/Turn).*** :: Make ranged attack against any number of creatures within 10-foot radius, within range.
### Reactions
***Uncanny Dodge.*** :: Halve damage from one attack.
***Steel Will.*** :: When charmed or frightened, can end the effect on himself as reaction.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Move.** :: Moves up to speed without provoking opportunity attacks.
**Shoot.** :: Makes one longbow attack.
**Vanish (Costs 2).** :: Hides and becomes invisible until end of next turn or attacks.
...
2. **The Forbidden Alliance:** He's made a deal with a green dragon named Veridianscale who lives in the forest. They share intelligence and coordinate against common threats. If his mother knew, she'd be furious - dragons are dangerous allies.

3. **The Succession Rejection:** Arannis doesn't want to be Matriarch. He's considered refusing inheritance or faking his death to avoid politics. He hasn't told anyone, including his mother, who's grooming him for leadership.

4. **The Lost Love:** He fell in love with a human ranger named Elena. They worked together for years. She died fighting aberrations, saving his life. He never told her his feelings. Her death made him colder, more ruthless.

5. **The Darkness:** Arannis has begun using increasingly brutal tactics - torture for information, scorched earth against enemies, killing prisoners. He justifies it as necessary but fears he's losing his moral compass.

6. **The Deep Patrol:** He led a ranger team into the deepest Silverwood, beyond where his mother permits. They found something - ruins, artifacts, creatures - that terrified him. He reported finding nothing and swore his team to secrecy.
}}

### Plot Hooks
1. **The Ranger Mission:** Arannis recruits the party for a dangerous mission into contested territory. The mission is crucial but his methods are questionable. Will they follow orders or question them?

2. **The Dragon Alliance:** The party discovers Arannis's pact with Veridianscale. They must decide whether to expose him, negotiate new terms, or help hide the alliance from Seraphine.

3. **The Deep Expedition:** Something from the deep forest is emerging. Arannis must reveal what he found years ago and lead a team back. The party must confront something that terrified him.

4. **The Blood Feud:** Grimfang the hobgoblin captures one of Arannis's rangers. He offers exchange - a duel to the death between them. Arannis accepts. The party must prepare him or find alternative.
...
- **Catchphrase:** "Move fast, strike hard, leave nothing."
- **When stressed:** Becomes even quieter, colder, more focused
- **In combat:** Ruthlessly efficient, no wasted movements, kills quickly

### Notes for DMs
- Arannis is designed as action-oriented NPC and military contact
- He's the "warrior who's seen too much" archetype
- Can provide combat-focused quests and missions
- His secrets provide moral dilemma hooks for levels 10-16
- Works as quest-giver, ally in combat, or potential antagonist
- Perfect for military campaigns or moral gray areas
- The mother-son tension creates family drama
...
**Speed** :: 30 ft.
![The Lost Heir (Elowen Gray)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-the-lost-heir-elowen-gray.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
**Speed** :: 30 ft., swim 30 ft.
![Admiral Theron Stormcrest](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-admiral-theron-stormcrest.jpg){width:315px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 16 (+3) | 18 (+4) | 14 (+2) | 16 (+3) | 16 (+3) |
___
**Saving Throws** :: Strength +10, Dexterity +8, Constitution +9
**Skills** :: Athletics +10, Intimidation +8, Investigation +7, Perception +8, Survival +8, Water Vehicles +12 (expertise)
**Damage Resistances** :: None
**Senses** :: Passive Perception 18
**Languages** :: Common, Aquan, Elvish, Thieves' Cant, Naval Signal Codes
**Challenge** :: 14 (11,500 XP)
___
***Action Surge (2/Rest).*** :: Can take additional action on turn.
***Second Wind (1/Rest).*** :: Bonus action, regain 1d10+14 HP.
***Indomitable (3/Rest).*** :: Reroll failed saving throw.
***Extra Attack (2).*** :: Attack twice per Attack action.
***Combat Superiority (6d10, recharge on short rest).*** :: Knows 9 maneuvers, can use 6 per rest.
***- Precision Attack.*** :: Add d10 to attack roll
***- Riposte.*** :: When enemy misses, reaction to attack and add d10 damage
***- Commander's Strike.*** :: Ally can use reaction to attack
***- Disarming Attack.*** :: Target drops item
***- Feinting Attack.*** :: Gain advantage, add d10 damage
***- Maneuvering Attack.*** :: Ally can move without provoking
***- Rally.*** :: Ally regains d10 + CHA HP
***- Trip Attack.*** :: Target knocked prone
***- Goading Attack.*** :: Target has disadvantage vs. others
***Cunning Action.*** :: Bonus action to Dash, Disengage, or Hide.
***Sneak Attack.*** :: 1d6 extra damage once per turn.
***Know Your Enemy.*** :: Spend 1 minute observing, learn if enemy is superior/inferior in STR/DEX/CON/AC/current HP/total levels/fighter levels.
***Sea Legs.*** :: Advantage on checks to maintain balance, resist being moved, or swim. Can hold breath 3× normal.
### Actions
***Multiattack.*** :: Makes three attacks with cutlass or two with pistol.
***Cutlass +2 "Tidebreaker".*** :: Melee Weapon Attack: +12 to hit, reach 5 ft., one target. ***Hit.*** 1d6+7 slashing damage, can add maneuver.::
***Naval Pistol +1 (2).*** :: Ranged Weapon Attack: +9 to hit, range 30/90 ft., one target. ***Hit.*** 1d10+4 piercing damage (can fire both in one action).::
***Commander's Order.*** :: All allies within 60 feet gain advantage on next attack roll.
### Reactions
***Riposte.*** :: When enemy misses, attack with advantage and add d10 damage.
***Parry.*** :: Add +5 to AC vs. one melee attack.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Move.** :: Move up to speed.
**Attack.** :: Make one weapon attack.
**Command (Costs 2).** :: Use Commander's Strike maneuver or Commander's Order.
...
2. **The Mutiny Investigation:** New evidence surfaces about the old mutiny - suggesting it was orchestrated by outside forces to discredit Theron. The party must investigate 15-year-old case and clear his name (or confirm his guilt).

3. **The Sister's Storm:** Tempest loses control during storm, endangering multiple ships. Theron asks party to help him understand what's wrong and either fix it or find way to limit her power.

4. **The Foreign Offer:** Theron reveals the foreign offer to party and asks their counsel. Should he accept? Refuse? Use it as leverage? Their advice matters, and consequences affect Tirvandor's naval power balance.

5. **The Pirate Alliance:** Captain Blackheart requests parley - claims to have evidence about the smuggling operation and offers temporary alliance. Theron asks party to negotiate. Is this genuine or trap?

6. **The Daughter's Danger:** Theron's secret daughter is in danger - her ship is attacked, she's kidnapped, or discovers her heritage. He asks party to help without revealing his connection. They must decide whether to expose the secret.

### Roleplaying Notes
- **Voice:** Deep, commanding, accustomed to being obeyed
- **Mannerisms:** Stands with hands clasped behind back, scans surroundings constantly, nautical terminology in casual speech
- **Catchphrase:** "Steady as she goes."
- **When stressed:** Grips sword hilt, jaw clenches, speaks in clipped commands
- **In combat:** Fights from tactical position, directs allies, precise and efficient

### Notes for DMs
- Theron is designed as military authority figure and quest-giver
- He's the "grizzled naval commander" archetype
- Can provide naval combat quests and investigations
- His secrets provide hooks for levels 10-16
- Works as patron, ally, or authority figure
- Perfect for nautical campaigns or smuggling investigations
- The sister relationship creates family tension
- His moral dilemmas explore duty vs. flexibility
...
![Lady Tempest Stormcrest](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lady-tempest-stormcrest.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 16 (+3) | 16 (+3) | 14 (+2) | 12 (+1) | 22 (+6) |
___
**Saving Throws** :: Constitution +8, Charisma +11
**Skills** :: Arcana +7, Intimidation +11, Perception +6, Performance +11, Nature +7
**Damage Resistances** :: Lightning, Thunder
**Senses** :: Passive Perception 16
**Languages** :: Common, Auran, Primordial, Draconic
**Challenge** :: 15 (13,000 XP)
___
***Wind Speaker.*** :: Can speak with air elementals, fly 30 ft as bonus action when outdoors.
***Tempestuous Magic.*** :: Before or after casting spell, can fly 10 feet without provoking attacks.
***Heart of the Storm.*** :: Resistance to lightning/thunder, can deal lightning damage to creatures within 10 feet (1d6 per spell level cast).
***Storm Guide.*** :: Can subtly control weather within 1 mile - clear rain, change wind direction, alter temperature slightly.
***Storm's Fury.*** :: When hit by melee attack, can use reaction to deal lightning damage equal to sorcerer level.
***- Quickened Spell.*** :: Cast bonus action
***- Empowered Spell.*** :: Reroll damage dice
***- Twinned Spell.*** :: Target second creature
***Spell Save DC.*** :: 19, Spell Attack Bonus: +11
***Sorcery Points.*** :: 15
***Cantrips.*** :: Dancing Lights, Gust, Lightning Lure, Ray of Frost, Shocking Grasp
***1st Level (4 slots).*** :: Chromatic Orb, Fog Cloud, Mage Armor, Shield, Thunderwave
***2nd Level (3 slots).*** :: Gust of Wind, Levitate, Mirror Image, Shatter
***3rd Level (3 slots).*** :: Call Lightning, Lightning Bolt, Fly, Tidal Wave
***4th Level (3 slots).*** :: Ice Storm, Storm Sphere, Greater Invisibility
***5th Level (2 slots).*** :: Control Winds, Cone of Cold
***6th Level (1 slot).*** :: Chain Lightning, Sunbeam
***7th Level (1 slot).*** :: Whirlwind, Reverse Gravity
***8th Level (1 slot).*** :: Control Weather, Tsunami
### Actions
***Multiattack.*** :: Casts two spells if using Quickened Metamagic.
***Shocking Grasp (Cantrip).*** :: Melee Spell Attack: +11 to hit, reach 5 ft., one target. ***Hit.*** 4d8 lightning damage, target can't take reactions until start of its next turn.::
***Lightning Bolt.*** :: 100-foot line, DC 19 Dex save, 8d6 lightning damage (half on success).
***Call Lightning.*** :: Summons storm cloud, can call down lightning bolt as action (3d10 damage, DC 19 Dex save half) on subsequent turns.
***Control Weather.*** :: Takes 10 minutes, can drastically alter weather within 5-mile radius for up to 8 hours.
### Reactions
***Shield.*** :: +5 AC until start of next turn.
***Storm's Fury.*** :: Deal 15 lightning damage to creature that hit her in melee.
***Counterspell.*** :: Counter enemy spell.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Cast a sorcerer cantrip.
**Fly.** :: Use Tempestuous Magic to fly 10 feet.
**Storm Strike (Costs 2).** :: Deal 3d6 lightning damage to all creatures within 10 feet.
...
5. **The Bargain:** A storm elemental once offered her a pact - merge with it, become purely elemental, have perfect control and unlimited power. She'd stop being human but become a eternal storm. She refused but sometimes wishes she'd accepted.
...
- **Mannerisms:** Hair moves with static, eyes flash blue when using power, unconsciously affects nearby weather
- **Catchphrase:** "I am the storm. You're just in it."
- **When stressed:** Eyes turn completely blue, clouds gather, temperature drops
- **In combat:** Dramatically casts spells, enjoys the power, laughs during battle

### Notes for DMs
- Tempest is designed as powerful but unstable ally
- She's the "dangerous wild magic" archetype
- Can provide weather support or create weather problems
- Her secrets provide hooks for levels 12-18
- Works as unreliable ally, quest-giver, or potential catastrophe
- Perfect for weather-focused campaigns or elemental plots
- The brother relationship creates family drama
- Her struggle with power explores control vs. freedom
...
**Speed** :: 30 ft.
![Patriarch Zircon Crystalborn](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-patriarch-zircon-crystalborn.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
- **Staff:** Crystal Staff +1 (acts as focus, conducts transmutation magic better)
- **Ring:** Ring of Protection (+1 AC/saves)
- **Amulet:** Periapt of Proof Against Poison
- **Transmuter's Stone:** Currently grants resistance to acid
...
- **Ally:** Patriarch Zircon of House Ironforge (confused? Different person - Durin is Ironforge patriarch)
...
2. **The Worldrend Crystals:** He's found gem formations that predate the Worldrend. They contain trapped magical energy - enormous amounts. One crystal could power a city for years or level a battlefield. He's collecting them secretly.
...
2. **The Dao Problem:** The dao binding is failing. Zircon needs party to renegotiate terms, strengthen binding, or prepare for the dao's revenge. They must deal with a angry genie who has legitimate grievance against being enslaved.

3. **The Synthetic Scandal:** Someone discovers Zircon's synthetic gems and threatens to expose him, crashing markets and destroying House Crystalborn. Party must retrieve evidence or deal with blackmailer - or decide if truth should be revealed.

4. **The Failed Experiment:** Party discovers the half-crystallized person. They must decide what to do - expose Zircon, help him fix it, or mercy-kill the victim. Each choice has moral and political ramifications.

5. **The Worldrend Research:** Zircon reveals the ancient crystals and asks party to help research them safely. But others also want them - for power, for weapons, for knowledge. Race to secure crystals before they fall into wrong hands.

6. **The Succession Crisis:** Sapphira discovers adoption truth (possibly through party investigation of something else). Zircon asks party to mediate. Can they repair the relationship? Should they? What happens to House Crystalborn?

### Roleplaying Notes
- **Voice:** Measured, precise, occasionally uses mineralogical metaphors
- **Mannerisms:** Examines things with jeweler's precision, gestures are calculated, touches his crystals when thinking
- **Catchphrase:** "Perfection is achieved through patience and precision."
- **When stressed:** Crystalline skin formations become more prominent, eyes reflect light more
- **In confrontation:** Calm, calculated, uses logic rather than emotion

### Notes for DMs
- Zircon is designed as knowledgeable patron and quest-giver
- He's the "perfectionist artificer" archetype
...
- His relationship with Sapphira creates emotional depth
...
**Speed** :: 30 ft.
![Gem-Mage Sapphira Crystalborn](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-gem-mage-sapphira-crystalborn.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 16 (+3) | 14 (+2) | 20 (+5) | 14 (+2) | 18 (+4) |
___
**Saving Throws** :: Intelligence +9, Wisdom +6, Charisma +8
**Skills** :: Arcana +13 (expertise), History +9, Insight +6, Investigation +9, Jeweler's Tools +9, Perception +6
**Damage Resistances** :: Force (from Arcane Ward)
**Senses** :: Darkvision 60 ft., Passive Perception 16
**Languages** :: Common, Draconic, Primordial, Celestial, Terran
**Challenge** :: 11 (7,200 XP)
___
***Arcane Ward.*** :: Ward with 33 HP (2× wizard level + Int). Absorbs damage first, recharges when casting abjuration spells.
***Projected Ward.*** :: When creature within 30 feet is hit, can use reaction to have Arcane Ward protect them instead.
***Improved Abjuration.*** :: When casting abjuration spell requiring check, add proficiency bonus.
***Draconic Resilience.*** :: Max HP increased, AC = 13 + Dex when not wearing armor.
***Dragon Ancestor (Crystal Dragon).*** :: +1 HP per sorcerer level, affinity with crystal/force magic.
***- Subtle Spell.*** :: Cast without verbal/somatic
***- Quickened Spell.*** :: Cast as bonus action
***Spell Save DC.*** :: 17 (wizard), 16 (sorcerer), Spell Attack Bonus: +9
***Wizard Cantrips.*** :: Mage Hand, Prestidigitation, Ray of Frost, Sword Burst
***Sorcerer Cantrips.*** :: Dancing Lights, Light, Mending
***1st Level (4 slots).*** :: Absorb Elements, Detect Magic, Identify, Mage Armor, Shield
***2nd Level (3 slots).*** :: Arcane Lock, See Invisibility, Shatter
***3rd Level (3 slots).*** :: Counterspell, Dispel Magic, Protection from Energy, Glyph of Warding
***4th Level (3 slots).*** :: Banishment, Resilient Sphere, Stoneskin
***5th Level (2 slots).*** :: Passwall, Wall of Force
***6th Level (1 slot).*** :: Globe of Invulnerability
***1st Level (4 slots).*** :: Chromatic Orb, Chaos Bolt
***2nd Level (2 slots).*** :: Mirror Image, Misty Step
### Actions
***Multiattack.*** :: Casts two spells using Quickened Metamagic.
***Dagger +1.*** :: Melee or Ranged Weapon Attack: +7 to hit, reach 5 ft. or range 20/60 ft. ***Hit.*** 1d4+4 piercing damage (rarely used).::
***Crystal Burst (Custom Spell).*** :: 30-foot cone, DC 17 Dexterity save, 6d6 force damage (half on success), crystalline shards explode from her hand.
***Spellcasting.*** :: Casts one of her prepared/known spells.
### Reactions
***Shield.*** :: +5 AC until start of next turn.
***Counterspell.*** :: Counter enemy spell.
***Absorb Elements.*** :: Resistance to incoming energy damage, add damage to next melee attack.
***Projected Ward.*** :: Use Arcane Ward to protect ally.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Cast a cantrip.
**Ward Surge (Costs 2).** :: Restore 2d6 HP to Arcane Ward.
...
- Can serve as ally, quest-giver, or character needing protection
- Her secrets provide hooks for levels 8-15
- Works as innocent companion, research partner, or eventual leader
- Perfect for campaigns involving family secrets, identity, magical research
- The adoption revelation is major emotional beat
- Her dragon bloodline provides transformation arc option
...
**Speed** :: 30 ft., swim 30 ft.
![Captain Brenna Frostbeard](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-captain-brenna-frostbeard.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
- **Secondary:** Ice Knife (cold-forged steel)
- **Tools:** Net, 60 ft. rope, grappling hook
...
### Personality
Traits
- Speaks in short, efficient commands
- Zero tolerance for stupidity on the ice
- Protective of her crews
- Superstitious about northern lights
- Gruff but has soft spot for those in need
...
- The ice and northern waters
- Frostholm community
- Her great-grandfather's harpoon

**Flaws:**
- Obsessive about safety (sometimes paralyzed by caution)
- Superstitious to the point of irrationality
- Owes debt to Merchant-Prince Kael (resents this deeply)
- Hearing voices in the ice (might be going mad)
- Distrusts outsiders, especially southern merchants

### Background & History
Brenna was born in a snowstorm on the coldest night in a century—an omen, the village elders said. They were right; she was born with the cold in her blood, able to endure temperatures that would kill others and shrug off frostbite like a minor inconvenience.
...
- Lost her brother to ice collapse - obsessive about safety now
...
- Ice breaking patterns suggest something large moving beneath
- Northern lights form strange runes - needs translation
- Raiders attacking fishing vessels - needs protection

**Connections:**
- Supplies The Frost Seer with rare ice crystals
- Childhood friend of Commander Torvald Stoneshield
...
![The Frost Seer (Eirlys Snowsight)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-the-frost-seer.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 12 (+1) | 14 (+2) | 16 (+3) | 20 (+5) | 16 (+3) |
___
**Saving Throws** :: Intelligence +6, Wisdom +8
**Skills** :: Arcana +6, Insight +12 (expertise), Medicine +8, Nature +6, Perception +8, Religion +6
**Damage Resistances** :: Cold, psychic
**Senses** :: Passive Perception 18, Truesight 30 ft. (sees spirits)
**Languages** :: Common, Aquan, Auran, Primordial (limited)
**Challenge** :: 9 (5,000 XP)
___
***Spellcasting.*** :: 9th-level wizard (Divination). Spell save DC 16, +8 to hit.
***Cantrips (at will).*** :: Guidance, Light, Mage Hand, Message
***1st level (4 slots).*** :: Detect Magic, Identify, Mage Armor*, Shield
***2nd level (3 slots).*** :: Augury, Locate Object, See Invisibility
***3rd level (3 slots).*** :: Clairvoyance, Counterspell, Tongues
***4th level (3 slots).*** :: Arcane Eye, Divination
***5th level (1 slot).*** :: Commune, Scrying
***Portent (2/Day).*** :: Rolls 2d20 at dawn. Can replace any attack roll, save, or ability check (hers or others') with one of these rolls before rolling.
***Aurora Reader.*** :: Can read prophecies in northern lights. When viewing aurora, can cast Augury, Divination, or Commune without expending spell slots (1/day each).
***Divine Connection.*** :: Has direct communication with Frostmere (Goddess of Winter) through aurora. Goddess answers questions cryptically through light patterns.
***Spirit Sight.*** :: Can see and communicate with spirits, ghosts, and ethereal creatures within 60 ft.
...
***Prophetic Warning.*** :: When ally within 30 ft. is about to make a potentially fatal decision, can shout warning as reaction. Ally gains advantage on next save or can reroll one failed save (1/day).
...
- **Friend:** Captain Brenna Frostbeard (kindred spirits, literally)
- **Student:** Three apprentice seers learning to read the ice
- **Contact:** The Sand Prophet Qadir (shares prophetic correspondence)
- **Enemy:** Whatever sleeps beneath the ice

### Physical Description
Ancient and weathered (5'5", 110 lbs), appearing far older than her 68 years. Hair is pure white, almost silver, flowing loose. Eyes are pale blue, almost colorless, with an otherworldly quality. Skin is pale, almost translucent. Wears layered white furs and ice crystal jewelry. Moves slowly but with purpose. Voice sounds like wind over ice. Smells of cold air and ozone.

### Equipment
- **Staff:** Ice Staff (carved from frozen wood, never melts)
- **Robes:** White fur robes (cold resistance)
- **Amulet:** Ice Crystal Amulet (focus, glows during prophecies)
- **Charms:** Multiple ice crystal charms (divination focuses)
- **Other:** No material needs, lives simply

### Connections
- Spiritual advisor to Captain Brenna Frostbeard
- Commands respect of Commander Torvald Stoneshield
- Corresponds with Archmage Veridian (who takes visions seriously)
- Has prophetic connection to Queen Marina (Drowned Oracle)
- Knows of Arch-Druid Thornbark's existence
- Distant, otherworldly, but deeply cares for community
- Speaks directly to spirits (seems mad to outsiders)
- Patient with those who seek genuine guidance
- Cryptic warnings often misunderstood until too late
- Protective of her lighthouse and its secrets

**Spellcasting:**
- Divination specialist (Wizard 9)
- Signature spells: *augury, divination, scrying, legend lore, commune*
- Ice-themed variants: *wall of ice, ice storm, cone of cold*
- Always knows when party is approaching (divination)

**Roleplaying:**
- Speaks in patterns: "Three paths you see. One leads to frost, one to fire, one to forgiveness."
- Stares through people, seeing their possible futures
- Touches ice crystals when concentrating
- Hums old northern songs unconsciously
...
- Stares through people (seeing their futures)
- Patient but urgent
- Cryptic warnings often misunderstood
- Protective of community

**Ideals:**
- **Truth:** "The auroras show what will be. I cannot lie about what I see."
- **Warning:** "Better to speak and be ignored than stay silent and watch them die."
- **Balance:** "Winter comes for all. We can only prepare."

**Bonds:**
- Frostholm community
- Frostmere (Goddess of Winter)
- Her lighthouse sanctuary
- The northern lights
- Ancient pact (family bound to protect something)

**Flaws:**
- Cryptic to the point of uselessness
- Sees so many futures she forgets the present
- Obsessed with Second Worldrend prevention
- Isolated, lonely
- Slowly transforming into living ice

### Roleplaying Notes
- Speaks in patterns of three
- Touches ice crystals when concentrating
- Stares at northern lights constantly
- Hums wordless songs
...
**Plot Hooks:**
- Gives cryptic warning about party's quest
- Auroras show vision of catastrophe - party must interpret
- Lighthouse under siege by ice elementals
- Reveals location of frozen primordial artifact
...
{{descriptive
#### Secrets (DM Only)
1. **The Sleeping God:** Has seen what lies beneath the northern glacier—an ancient entity of pure cold. It's dreaming, and its dreams affect reality.
2. **The Death Visions:** Can see when someone will die. Never tells them, but the knowledge weighs heavily.
3. **The Correspondence:** She and the Sand Prophet have compared visions. They've seen the same catastrophe from different angles.
4. **The Limited Time:** Her gift is killing her slowly, freezing her from within. She has perhaps ten more years.
5. **The Prevention Theory:** Believes she's found a way to prevent the catastrophe, but it requires terrible sacrifice.
}}

### Plot Hooks
1. **The Vision Sharing:** Has seen something about the party. Offers to share it—for a price.
2. **The Dream Investigation:** The sleeping god's dreams are intensifying. Needs help investigating without waking it.
3. **The Prophet Meeting:** Wants to meet the Sand Prophet in person to compare full visions. Needs escort.
...
**Speed** :: 25 ft.
![Commander Torvald Stoneshield](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-commander-torvald-stoneshield.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 10 (+0) | 22 (+6) | 14 (+2) | 16 (+3) | 14 (+2) |
___
**Saving Throws** :: Strength +9, Constitution +10, Wisdom +7
**Skills** :: Athletics +9, Insight +7, Intimidation +6, Perception +7, Persuasion +6
**Damage Resistances** :: Poison
**Senses** :: Darkvision 60 ft., Passive Perception 17
...
___
***Dwarven Resilience.*** :: Advantage on saves vs. poison.
***Stonecunning.*** :: Proficiency bonus x2 on History checks related to stonework.
***Extra Attack (2).*** :: Attacks three times with Attack action.
***Indomitable (2/Day).*** :: Reroll failed save.
***Action Surge (1/Rest).*** :: Take additional action.
***Second Wind (1/Rest).*** :: Regain 1d10+14 HP as bonus action.
***Giant Diplomat.*** :: Advantage on Charisma checks with giants. Giants start as neutral rather than hostile.
***Runic Prosthetic.*** :: Left hand is magical prosthetic. Can cast Shield 3/day, grants +2 AC (included).
***Commander's Aura.*** :: Allies within 30 ft. gain +1 to saves and can't be frightened if he's conscious.
### Actions
***Multiattack.*** :: Makes three attacks with Mountain's Voice.
***Mountain's Voice (Warhammer +3).*** :: Melee Weapon Attack: +11 to hit, reach 5 ft. ***Hit.*** 2d8+8 bludgeoning plus 1d6 thunder damage.::
***Special.*** :: On critical hit, target stunned until end of next turn (DC 17 Con save).
***Shield Bash.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft. ***Hit.*** 1d4+5 bludgeoning, target prone (DC 17 Str save).::
***Giant's Challenge (Recharge 5-6).*** :: Each enemy within 30 ft. makes DC 15 Wisdom save or frightened for 1 minute. Giants have advantage.
### Reactions
***Parry.*** :: Add +4 AC against one melee attack.
***Runic Shield.*** :: Cast Shield for +5 AC until next turn (3/day).
...
**Speed** :: 30 ft.
![Merchant-Prince Kael Icewind](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-merchant-prince-kael-icewind.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
**Skills** :: Deception +9 (expertise), Insight +5, Intimidation +6, Persuasion +9 (expertise), Sleight of Hand +7
**Senses** :: Passive Perception 12
**Languages** :: Common, Dwarvish, Elvish, Thieves' Cant
**Challenge** :: 8 (3,900 XP)
___
***Master of Disguise.*** :: Has lived as Kael Icewind for 30 years. No one suspects.
***Sneak Attack.*** :: Once per turn, +4d6 damage with advantage.
***Cunning Action.*** :: Bonus action to Dash, Disengage, or Hide.
***Trade Empire.*** :: Controls ice crystal trade, has network of informants.
***Evasion.*** :: Dex save for half = no damage, half on failure.
### Actions
***Multiattack.*** :: Makes two attacks with rapier or one attack and uses Cunning Action.
***Rapier +1.*** :: Melee Weapon Attack: +8 to hit, reach 5 ft. ***Hit.*** 1d8+5 piercing plus poison (DC 14 Con save or 3d6 poison).::
***Hidden Dagger.*** :: Melee or Ranged Weapon Attack: +7 to hit. ***Hit.*** 1d4+4 piercing plus poison.::
### Reactions
***Uncanny Dodge.*** :: Halve damage from one attack.
...
- **Peer:** Trade Prince Lucian Goldfingers (respects, wary of)
- **Supplier:** The Frost Witch (magical preservation methods)
...
{{descriptive
#### Secrets (DM Only)
1. **The Witch's Deal:** The Frost Witch taught him preservation magic in exchange for future services. She hasn't called it in yet.
2. **The Political Funding:** Secretly funds reform movements across multiple kingdoms. Wants to reshape society.
3. **The Ice Memory:** Ice from the northern glaciers sometimes contains preserved memories. He's collecting them.
4. **The Worldrend Artifact:** One expedition found something from the Worldrend era. He's studying it secretly.
5. **The Loneliness:** Has everything except meaningful connections. His wealth isolates him.
}}

### Plot Hooks
1. **The Expedition Funding:** Offers to fund the party's expedition in exchange for first rights to anything found.
2. **The Ice Memories:** Has found a memory that seems relevant to current events. Needs help interpreting it.
3. **The Witch's Service:** The Frost Witch has called in her debt. He needs help fulfilling it—or escaping it.
...
**Speed** :: 25 ft.
![Master Miner Grimnir Deepdelve](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-master-miner-grimnir-deepdelve.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 12 (+1) | 16 (+3) | 12 (+1) | 15 (+2) | 10 (+0) |
___
**Saving Throws** :: Strength +7, Constitution +6
**Skills** :: Athletics +7, Investigation +4, Perception +5, Survival +5
**Damage Resistances** :: Poison
**Senses** :: Darkvision 60 ft., Tremorsense 30 ft. (underground), Passive Perception 15
**Languages** :: Common, Dwarvish, Undercommon
**Challenge** :: 6 (2,300 XP)
___
***Master Miner.*** :: Advantage on checks related to mining, geology, underground navigation.
***Tremorsense.*** :: Can detect vibrations in ground within 30 ft. underground.
***Stone Sense.*** :: Automatically detects unstable structures, hidden passages.
***Extra Attack.*** :: Attacks twice.
### Actions
***Multiattack.*** :: Makes two attacks with pick or hammer.
***Mining Pick +1.*** :: Melee Weapon Attack: +8 to hit. ***Hit.*** 1d8+5 piercing. Double damage vs. constructs and earth elementals.::
***Warhammer.*** :: Melee Weapon Attack: +7 to hit. ***Hit.*** 1d8+4 bludgeoning (1d10+4 versatile).::
***Rock Throw.*** :: Ranged Weapon Attack: +7 to hit, range 20/60 ft. ***Hit.*** 2d6+4 bludgeoning.::
...
2. **The Mithril Vein:** Found a vein of pure mithril. Concealing it until he can arrange proper extraction and security.
...
### Plot Hooks
1. **The Mithril Expedition:** Ready to exploit the mithril vein. Needs trusted outsiders who can keep secrets.
...
**Speed** :: 30 ft.
![The Ice Witch of Iceridge (Ylva Frostborn)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-the-ice-witch-ylva-frostborn.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 16 (+3) | 14 (+2) | 14 (+2) | 16 (+3) | 20 (+5) |
___
**Saving Throws** :: Constitution +6, Charisma +9
**Skills** :: Arcana +6, Insight +7, Nature +6, Perception +7, Survival +7
...
**Challenge** :: 11 (7,200 XP)
___
***Fey Step (Recharge 4-6).*** :: Bonus action to teleport 30 ft. Each creature within 5 ft. of starting position takes 3d10 cold damage (DC 17 Cha save for half).
***Fey Ancestry.*** :: Advantage vs. being charmed, immune to magic sleep.
***Spellcasting.*** :: 11th-level sorcerer. Spell save DC 17, +9 to hit.
***Sorcery Points.*** :: 11 points for Metamagic.
***- Twinned Spell.*** :: Target second creature with single-target spell
***- Empowered Spell.*** :: Reroll damage dice
...
***Cold Immunity.*** :: Immune to cold damage, never feels cold.
***Winter's Child.*** :: Can walk on ice and snow without leaving tracks or slipping.
***Animal Affinity.*** :: Advantage on Animal Handling with arctic animals. They're naturally friendly.
***Ancient Oath.*** :: Bound by ancient pact to protect Iceridge. Can't permanently leave region.
### Actions
***Multiattack.*** :: Makes two frost touch attacks or casts two cantrips.
***Frost Touch.*** :: Melee Spell Attack: +9 to hit, reach 5 ft. ***Hit.*** 4d10 cold damage, target's speed reduced by 10 ft. until end of next turn.::
***Cast a Spell.*** :: Casts a spell.
***Summon Winter Wolves (1/Day).*** :: Summons 2d4 winter wolves that serve for 1 hour.
### Reactions
***Shield.*** :: Cast Shield for +5 AC.
***Counterspell.*** :: Counter spell of 3rd level or lower.
***Frozen Defense.*** :: When hit by melee attack, attacker takes 2d10 cold damage.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Casts a cantrip.
**Teleport (Costs 2).** :: Uses Fey Step if available or Misty Step.
**Frozen Aura (Costs 3).** :: 20 ft. radius around her becomes difficult terrain (ice) for 1 minute. Creatures starting turn there take 2d10 cold damage.
...
**Speed** :: 25 ft.
![Forge-Master Thordak Lavaheart](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-forge-master-thordak-lavaheart.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 12 (+1) | 18 (+4) | 18 (+4) | 14 (+2) | 12 (+1) |
___
**Saving Throws** :: Strength +9, Constitution +8, Intelligence +8
**Skills** :: Athletics +9, History +8, Insight +6, Perception +6, Smith's Tools +12 (expertise)
**Damage Resistances** :: Fire
**Senses** :: Darkvision 60 ft., Passive Perception 16
**Languages** :: Common, Dwarvish, Ignan, Primordial
**Challenge** :: 10 (5,900 XP)
___
***Fire Resistance.*** :: Resistant to fire damage.
***Reach to the Blaze.*** :: Can cast Burning Hands (3rd level) 1/day.
***Darkvision.*** :: 60 ft.
***Master Smith.*** :: Advantage on all checks to craft, repair, or identify metal items. Can create items of up to very rare quality.
***Lava Heart.*** :: Survived falling in lava as child. Immune to extreme heat. Can touch molten metal safely.
***Legendary Craftsman.*** :: Can craft magical weapons and armor. Creates items in half normal time.
***Runic Forging.*** :: Can etch permanent runes onto metal items, granting minor magical properties.
### Actions
***Multiattack.*** :: Makes two attacks with warhammer.
***Volcanic Warhammer +2.*** :: Melee Weapon Attack: +11 to hit, reach 5 ft. ***Hit.*** 2d8+7 bludgeoning plus 2d6 fire damage.::
***Smith's Hammer.*** :: Melee Weapon Attack: +9 to hit. ***Hit.*** 1d8+5 bludgeoning. Against objects, deals double damage.::
***Heat Metal (3/Day).*** :: As spell, DC 16.
***Molten Splash (Recharge 5-6).*** :: Throws molten metal in 15 ft. cone. Creatures make DC 16 Dex save or take 6d6 fire damage (half on success).
### Reactions
***Smith's Defense.*** :: When hit by metal weapon, can superheat it. Attacker takes 3d6 fire damage and must drop weapon (DC 16 Con save negates drop).
...
2. **The Dragon Legacy:** His red dragon ancestor is still alive somewhere. He's received one message in his life.
3. **The Perfect Work:** Has spent decades on a masterwork for himself. Nearly complete.
4. **The Giant Debt:** His teacher's debt was paid, but Thordak owes the giant something now.
5. **The Volcanic Instability:** Knows the volcano is building toward an eruption. Hasn't told anyone.
}}

### Plot Hooks
1. **The Commission:** Offers to make something extraordinary if the party retrieves volcanic materials.
2. **The Giant Contact:** Needs a message delivered to his teacher in the deep volcanic reaches.
3. **The Volcanic Warning:** Shares his knowledge of the coming eruption if properly approached.
...
**Speed** :: 30 ft.
![Sage Elminster Runereader](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-sage-elminster-runereader.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 12 (+1) | 12 (+1) | 20 (+5) | 18 (+4) | 14 (+2) |
___
**Saving Throws** :: Intelligence +9, Wisdom +8
**Skills** :: Arcana +13 (expertise), History +13 (expertise), Investigation +9, Perception +8, Religion +9
**Senses** :: Passive Perception 18
**Languages** :: Common, Dwarvish, Draconic, Elvish, Giant, Ancient Common
**Challenge** :: 9 (5,000 XP)
___
***Spellcasting.*** :: 9th-level wizard. DC 17, +9 to hit.
***Cantrips.*** :: Light, Mage Hand, Message, Prestidigitation
***1st (4).*** :: Comprehend Languages, Detect Magic, Identify, Mage Armor*
***2nd (3).*** :: Arcane Lock, Knock, See Invisibility
***3rd (3).*** :: Dispel Magic, Glyph of Warding, Tongues
***4th (3).*** :: Arcane Eye, Stone Shape
***5th (1).*** :: Legend Lore, Passwall
***Rune Expert.*** :: Can read and understand any runic script. Advantage on checks to identify magical symbols.
***Ancient Knowledge.*** :: Has studied pre-Worldrend sites for 50 years. Knows their construction, purpose, dangers.
***Glyph Specialist.*** :: Can identify and safely disarm magical glyphs and wards.
### Actions
***Quarterstaff.*** :: Melee Weapon Attack: +2 to hit. ***Hit.*** 1d6-1 bludgeoning.::
***Cast a Spell.*** :: Casts prepared spell.
***Runic Analysis (Special).*** :: Spends 10 minutes studying runes to determine their function, age, and activation conditions.
### Reactions
***Counterspell.*** :: Counter spell of 3rd level or lower.
***Runic Warning.*** :: When ally about to trigger magical trap, can shout warning (ally gains advantage on save, reaction).
...
**Speed** :: 25 ft.
![Engineer Mira Steamvent](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-engineer-mira-steamvent.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 8 (-1) | 16 (+3) | 14 (+2) | 20 (+5) | 14 (+2) | 10 (+0) |
___
**Saving Throws** :: Intelligence +8, Wisdom +5, Constitution +5
**Skills** :: Arcana +8, History +8, Investigation +11, Perception +5,
**Damage Resistances** :: Fire (heat-resistant gear)
**Senses** :: Darkvision 60 ft., Passive Perception 15
**Languages** :: Common, Gnomish, Dwarvish, Primordial (fire)
**Challenge** :: 7 (2,900 XP)
___
***Gnome Cunning.*** :: Advantage on Int, Wis, and Cha saves against magic.
***Artificer's Lore.*** :: Add double proficiency to History checks on magic items
***Engineering Genius.*** :: Can analyze any mechanical system in 1 minute.
***Heat Adapted.*** :: Immune to extreme heat environmental effects.
***Improvised Solutions.*** :: Can jury-rig temporary repairs. As an action,
### Actions
***Multiattack.*** :: Makes two wrench attacks or two crossbow attacks.
***Heavy Wrench.*** :: Melee Weapon Attack: +6 to hit, reach 5 ft., one target. ***Hit.*** 1d8+3 bludgeoning damage. On a critical hit, target's armor or::
shield AC is reduced by 1 until repaired.
***Light Crossbow.*** :: Ranged Weapon Attack: +6 to hit, range 80/320 ft. ***Hit.*** 1d8+3 piercing damage.::
***Steam Vent (Recharge 5-6).*** :: Releases superheated steam in 15-foot cone.
DC 16 Dex save. 6d6 fire damage, half on success. Creatures that fail
are blinded until end of their next turn.
***Emergency Shutoff (1/Day).*** :: Can immediately stop any mechanical system
within 60 feet that she can see, including constructs. Constructs make
DC 16 Con save or are stunned for 1 round.
### Reactions
***Danger Sense.*** :: When Mira or a creature within 30 feet triggers a trap
or mechanical hazard, she can shout a warning. Target gains +5 to
their saving throw.
...
{{descriptive
#### Secrets (DM Only)
1. **The Impossible Project:** Designing a system to redirect a super-eruption. Theoretically possible; practically untested.
2. **The Survivor's Guilt:** Blames herself for not warning her hometown in time, even though she was twelve.
3. **The Magical Component:** Her "intuition" might actually be a magical gift. She's refused to investigate.
4. **The Ashgate Weakness:** Knows Ashgate's containment system has a critical flaw she can't fix with current resources.
5. **The Alternative Plan:** Has designed evacuation systems for when containment fails. Hopes never to use them.
}}

### Plot Hooks
1. **The Field Installation:** Needs protection while installing containment systems in dangerous territory.
2. **The Resource Crisis:** The Ashgate flaw requires materials she can't obtain through normal channels.
3. **The Super-Eruption Test:** Wants to test her redirection system on a minor volcanic event. Needs observers.
4. **The Magic Question:** Finally ready to investigate whether her gift is magical. Needs discrete help.
5. **The Emergency Protocol:** A major eruption is imminent. Needs all hands helping with evacuation.


**Key Details:**
- Manages complex system of channels, vents, and cooling chambers
- Keeps town from being consumed by volcanic activity
- Brilliant but exhausted - works 18-hour days
- Covered in soot, goggles, carries blueprint tubes everywhere
- Invented three new cooling techniques
- Missing two fingers from early career accident
- Drinks coffee like water, rarely sleeps

**Personality:**
- Direct, no-nonsense, impatient with incompetence
- Brilliant under pressure
- Deeply responsible for town's safety
- Sarcastic dark humor about death by lava
- Softens around genuine technical curiosity
- Secretly terrified system will fail

**Secrets:**
1. **System Failing:** Recent tremors damaged core systems - holding together with patches
2. **Ancient Infrastructure:** Current systems built on pre-Worldrend dwarven engineering
...
- Her assistant murdered - saboteur still active
- Ancient mechanisms activating, she can't understand them
- Needs party to reach deep valve chamber through hostile tunnels
- The Deep Crack connects to something that shouldn't be disturbed
- She's kidnapped - no one else can prevent disaster
...
- Expert in geology, physics, structural engineering
- Can calculate pressure, flow rates, structural integrity instantly
- Designs contingency systems and fail-safes
- Improvises solutions with available materials
- Understands ancient dwarven technical documentation

**Equipment:**
- Masterwork tools (advantage on all checks)
- *Goggles of darkvision* and heat vision
- *Ring of fire resistance*
- Emergency cooling grenades (homebrew items)
- Portable pressure gauge (magical sensor)
...
**Hit Points** :: 112 (15d8 + 45)
**Speed** :: 25 ft.
![Quarry-Master Borin Stonecutter](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-quarry-master-borin-stonecutter.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
___
**Saving Throws** :: Strength +7, Constitution +6
**Skills** :: Athletics +10, History +4, Intimidation +3, Perception +5,
**Damage Resistances** :: Poison
**Senses** :: Darkvision 60 ft., Passive Perception 15
**Languages** :: Common, Dwarvish, Terran (basic)
**Challenge** :: 8 (3,900 XP)
___
***Dwarven Resilience.*** :: Advantage on saves against poison.
***Stonecunning.*** :: Double proficiency on History checks related to stonework.
***Quarry Veteran.*** :: 60 years of experience. Advantage on checks to identify
***Indomitable (2/Day).*** :: Can reroll a failed saving throw.
### Actions
***Multiattack.*** :: Makes three attacks with his warhammer or two thrown hammers.
***Stonecutter's Hammer (Family Heirloom).*** :: Melee Weapon Attack: +8 to hit,::
***reach 5 ft., one target. Hit.*** :: 2d8+5 bludgeoning damage. Against constructs
and objects, deals an extra 1d8 damage. This ancient dwarven hammer
glows faintly near active golem runes.
***Throwing Hammer.*** :: Ranged Weapon Attack: +7 to hit, range 20/60 ft. ***Hit.*** 1d6+4 bludgeoning damage.::
***Leadership (Recharges after Short Rest).*** :: For 1 minute, Borin can issue
a special command as a bonus action. Any ally within 30 feet who can
hear him adds 1d4 to their attack rolls and saving throws.
***Stone Sense (1/Day).*** :: Borin places his hand on stone and concentrates
for 1 minute. He learns the location of all creatures and hollow spaces
within 120 feet that are touching the same stone surface.
### Reactions
***Parry.*** :: Adds +3 to AC against one melee attack that would hit him.
Must be wielding his hammer.
***Protect the Workers.*** :: When an ally within 5 feet is hit by an attack,
...
{{descriptive
#### Secrets (DM Only)
1. **The Ancient Quarry:** The deepest quarry cuts into pre-Worldrend ruins. He's been quietly excavating.
2. **The Living Stone:** Has discovered stone that seems to respond to commands. Hasn't told anyone.
3. **The Worker Treatment:** His workers are well-paid because they've seen things they could reveal.
4. **The Noble Leverage:** Has dirt on multiple noble houses from construction projects. Emergency insurance.
5. **The Succession Problem:** No children, no clear heir. Worries about his legacy.
}}

### Plot Hooks
1. **The Deep Discovery:** Found something in the pre-Worldrend ruins. Needs experts to assess it.
2. **The Living Stone:** Wants to understand the responsive stone. Needs magical investigation.
3. **The Heir Search:** Looking for someone worthy to inherit. Tests likely candidates.
4. **The Competition Problem:** Someone is trying to break his market control. Needs the source identified.
5. **The Simple Job:** Just needs reliable protection for a valuable shipment. Honest work.
...
- Former military engineer, knows fortifications

**Personality:**
- Pragmatic, straightforward, salt-of-earth
- Proud of his work and his quarry
- Protective of his workers (23 under his command)
...
**Plot Hooks:**
- Golems attacking workers - needs immediate help
- Party hired to investigate golem origins
- Central control rune could shut them down or awaken them all
- Workers trapped in quarry by golem patrol
- Golem army could march on town if fully activated
- Ancient defense protocols recognizing modern people as intruders
...
**Combat Notes:**
- Veteran fighter (CR 8)
- Warhammer: +10 to hit, 2d8+6 bludgeoning
- Stone Sense: Advantage on checks related to stone and earth
- Quarry Master: Can judge structural stability instantly
- Defensive stance: +4 AC against constructs
...
**Speed** :: 30 ft.
![Elder Thalindra Oakheart](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-elder-thalindra-oakheart.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 14 (+2) | 16 (+3) | 18 (+4) | 22 (+6) | 16 (+3) |
___
**Saving Throws** :: Intelligence +9, Wisdom +11, Charisma +8
**Skills** :: Arcana +9, History +14 (expertise), Insight +11, Medicine +11, Nature +14 (expertise), Perception +11, Religion +9, Survival +11
**Damage Resistances** :: Poison; Bludgeoning, Piercing from nonmagical attacks
**Condition Immunities** :: Charmed, Frightened (while within 100 ft. of Heart Oak)
**Senses** :: Darkvision 60 ft., Passive Perception 21, Tremorsense 30 ft. (through tree roots)
**Languages** :: Common, Elvish, Sylvan, Druidic, Ancient Elvish, Primordial, Celestial
**Challenge** :: 13 (10,000 XP)
___
***Fey Ancestry.*** :: Advantage against being charmed, immune to magic sleep.
***Trance.*** :: Meditates 4 hours instead of sleeping.
***Ancient Memory.*** :: Can perfectly recall any event she's witnessed in her long life.
***Spellcasting.*** :: 15th-level druid (Circle of the Land - Forest). Spell save DC 19, +11 to hit with spell attacks.
***Cantrips (at will).*** :: Druidcraft, Guidance, Mending, Shillelagh, Thorn Whip
***1st level (4 slots).*** :: Cure Wounds, Detect Magic, Entangle, Goodberry, Speak with Animals
***2nd level (3 slots).*** :: Barkskin*, Lesser Restoration, Pass without Trace, Spike Growth
***3rd level (3 slots).*** :: Call Lightning, Dispel Magic, Plant Growth, Speak with Plants
***4th level (3 slots).*** :: Blight, Dominate Beast, Freedom of Movement, Grasping Vine
***5th level (2 slots).*** :: Commune with Nature, Greater Restoration, Tree Stride
***6th level (1 slot).*** :: Heal, Transport via Plants, Wall of Thorns
***7th level (1 slot).*** :: Regenerate
***8th level (1 slot).*** :: Animal Shapes
***Heart Oak Bond.*** :: While within 1 mile of the Heart Oak, Thalindra:
***Ancient Wisdom.*** :: Has lived through the Worldrend and Age of Strife. Can provide historical context for any event in the last 800 years. Advantage on all Intelligence checks related to history or lore.
***Tree Stride (At Will).*** :: Can use *tree stride* without expending a spell slot when within forest terrain, traveling between trees within 500 ft. (ritual takes 1 minute).
***Nature's Sanctuary.*** :: Animals and plant creatures must succeed on DC 19 Wisdom save to attack her. On success, immune for 24 hours.
***Timeless Body.*** :: Does not age magically. Appears middle-aged despite her centuries.
***Blessing of the Heart Oak (1/Day).*** :: Can channel the Heart Oak's power to cast any healing spell she knows without expending a spell slot, at 9th level.
### Actions
***Multiattack.*** :: Makes two attacks with Oakheart Staff, or casts a cantrip and uses staff once.
***Oakheart Staff (Shillelagh Enhanced).*** :: Melee Weapon Attack: +11 to hit, reach 5 ft., one target. ***Hit.*** 1d8+6 magical bludgeoning damage plus 2d6 radiant damage (tree's blessing).::
***Special.*** :: This ancient staff was carved from a branch of the Heart Oak 600 years ago. On critical hit, target must succeed DC 19 Wisdom save or be stunned until end of Thalindra's next turn.
***Thorn Whip.*** :: Ranged Spell Attack: +11 to hit, range 30 ft., one creature. ***Hit.*** 3d6 piercing damage, and target is pulled 10 ft. toward Thalindra if Large or smaller.::
***Entangling Roots (Recharge 5-6).*** :: Thalindra causes roots to burst from the ground in a 20-foot radius centered on her. Each creature in the area must succeed on a DC 19 Strength save or be restrained by roots (escape DC 19). The roots last 1 minute and have AC 15, 50 HP.
***Call the Ancient Forest (1/Day).*** :: Thalindra summons the forest's aid. For 1 minute:
- All plant growth in a 100-foot radius becomes difficult terrain for enemies
- She can cast *speak with plants* at will
- Allied druids and rangers within range gain advantage on attack rolls
- She gains +2 to spell save DC (becomes DC 21)
### Reactions
***Nature's Ward.*** :: When a creature within 30 ft. is hit by an attack, Thalindra causes vines to deflect the blow, granting +5 AC against that attack (potentially causing it to miss).
***Treespeech Warning.*** :: When danger approaches the Heart Oak, she is instantly aware and can use *tree stride* as a reaction to teleport to its location.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Casts a druid cantrip.
**Move.** :: Uses tree stride to teleport to any tree within 60 ft.
**Healing Touch (Costs 2).** :: Touches a creature and restores 3d8+6 hit points.
...
- **Advisors:** Circle of village elders (five others)
- **Druid Contact:** Archdruid Silvaris Oakenheart (old friend)
- **Trade Partner:** Various merchant caravans
- **Concern:** The young, restless elves leaving for cities

{{descriptive
#### Secrets (DM Only)
1. **The Village Anchor:** She is mystically bound to Oakheart Grove. If she leaves, she dies within days.
2. **The Old War:** In her youth, she killed a human noble who was enslaving elves. Never told anyone.
3. **The Exodus Fear:** Young elves are leaving faster than they're replaced. The village may die within a century.
...
- Touches the bark of the Heart Oak for comfort
- Makes tea from leaves and herbs during conversations
- Calls younger elves (under 300) "saplings"
- Refers to humans affectionately as "quick-bright flames"
- When stressed, leaves grow from her hair
- Her staff glows brighter when the Heart Oak is threatened

**Speech Pattern Examples:**
- "I have seen six hundred springs. Each taught me patience. This, too, shall pass."
- "When the Worldrend came, the trees wept. I hear their echoes still."
- "You ask what we should do? Child, I have watched mountains erode. I know what we *must* do."
- "The Heart Oak remembers the first words spoken in this land. It shares memories with me."
...
**Speed** :: 30 ft.
![Master Carpenter Aldric Woodwise](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-master-carpenter-aldric-woodwise.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
- **Shield:** Wooden Shield (masterwork, AC +2, can block one critical hit per day)
...
- **Backpack Contents:** Rope (100 ft.), block and tackle, wood samples, blueprints
- **Other:** Level, square, chalk line, plumb bob

### Personality
Traits
- Speaks in measured, thoughtful sentences
- Constantly fidgets with small wood pieces, carving as he talks
- Taps wooden structures to assess quality
- Quotes old carpentry sayings
- Protective of apprentices and trees
- Patient teacher but demanding master
- Takes pride in every piece he creates

**Ideals:**
- **Craftsmanship:** "If it's worth building, it's worth building right. No shortcuts."
- **Sustainability:** "Take only what the forest can spare. It'll provide forever."
- **Legacy:** "A good carpenter plants trees knowing he'll never see them grown."
- **Honor:** "My word is my contract. My work is my signature."

**Bonds:**
- His apprentices (currently training 6 young carpenters)
- The forest and sustainable practices
- His grandfather's axe (family heirloom for 150 years)
- The Oakenheart community
- His workshop (contains lifetime of tools and templates)
- His daughter Mira (learning the trade)

**Flaws:**
- Perfectionist to a fault (projects take longer than necessary)
- Stubborn about "the right way" to build things
- Holds grudge against merchant who wanted to clear-cut forest
- Sometimes values craftsmanship over people's urgent needs
...
### Connections
- **Workshop:** Master's Atelier in Silverpine
- **Apprentice:** Current apprentice nearing completion
- **Former Students:** Seventeen master craftspeople across the continent
- **Client:** Nobility and wealthy merchants
- **Supplier:** Various lumber operations, one special source


{{descriptive
#### Secrets (DM Only)
1. **The Special Source:** Gets exceptional wood from a dryad grove. They trade for his silence about their location.
2. **The Magical Technique:** His work involves minor nature magic he's never revealed. Not quite cheating, but not purely mundane.
...
### Plot Hooks
1. **The Dryad Problem:** The dryad grove is threatened. Needs help without revealing their location.
2. **The Commission Conflict:** The rejected client is causing trouble. Needs diplomatic intervention.
3. **The Sight Quest:** Looking for magical solutions to his failing eyes. Discrete inquiries.
4. **The Apprentice Test:** His current apprentice needs a final test. Involves the party somehow.
5. **The Masterwork Viewing:** Might show his hidden masterwork to those who prove worthy.

### Roleplaying Notes
- Runs hand along wood grain while thinking
- Quotes "Grandfather Woodwise always said..."
- Makes small carved gifts during conversations
- Taps roof beams and posts to test them
- Carries chunk of wood to whittle
- Always smells sawdust on the air
- Gives structural advice even when not asked

**Key Details:**
- Trained by grandfather, legendary carpenter
- Leads guild of 30 carpenters in Oakenheart
- Developed sustainable forestry pact with druids
- Built half the town's current structures
- Teaches forestry and carpentry to anyone willing to learn
...
**Speed** :: 30 ft.
![Miller Tobias Waterwheel](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-miller-tobias-waterwheel.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 14 (+2) | 12 (+1) | 16 (+3) | 16 (+3) | 14 (+2) | 13 (+1) |
___
**Saving Throws** :: Constitution +5, Intelligence +5
**Skills** :: Investigation +5, Nature +4, Perception +4, Tinker's Tools +7 (expertise), Engineer's Tools +7 (expertise), Insight +4
**Senses** :: Passive Perception 14
**Languages** :: Common, Dwarvish (engineering terms)
**Challenge** :: 4 (1,100 XP)
___
***Master Engineer.*** :: Has advantage on all checks related to mechanical devices, water systems, mills, or engineering problems. Can identify mechanical issues by sound or vibration.
***Hydraulic Expertise.*** :: Understands water flow, pressure, and mechanical advantage. Can calculate optimal wheel designs, water speeds, and power outputs.
***Jury Rigger.*** :: Given basic tools and materials, can temporarily repair almost any mechanical device. Repairs last 24 hours before needing proper maintenance.
***Powder Knowledge.*** :: Has extensive experience with grain dust explosions and fire prevention. Knows how to prevent or cause explosive conditions.
***Precise Calculations.*** :: Can mentally calculate weights, volumes, ratios, and mechanical advantages with perfect accuracy. Never makes math errors.
***Tinkerer's Eye.*** :: Can assess the quality and value of any mechanical device at a glance. Knows if something is well-made, defective, or sabotaged.
### Actions
***Multiattack.*** :: Makes two attacks with his Heavy Wrench or Grain Sack.
***Heavy Wrench.*** :: Melee Weapon Attack: +4 to hit, reach 5 ft., one target. ***Hit.*** 1d8+2 bludgeoning damage.::
***Special.*** :: On hit, can attempt to disarm target if they're wielding a mechanical or metal weapon (contested Athletics check).
***Grain Sack.*** :: Improvised Weapon: +4 to hit, reach 5 ft., one target. ***Hit.*** 1d6+2 bludgeoning damage.
***Special.*** :: On hit, target must succeed DC 13 Strength save or be knocked prone (40 lbs of grain is heavy).
***Mechanical Trap (Preparation Required).*** :: Given 10 minutes, can rig a mechanical trap using mill equipment. Examples:
- Swinging beam (DC 13 Dex save, 2d10 bludgeoning)
- Grain avalanche (20-ft cone, DC 13 Str save, 3d6 bludgeoning + buried)
- Millstone drop (30-ft area, DC 14 Dex save, 4d10 bludgeoning + prone)
***Sabotage Detection (1/Day).*** :: Examines mechanical device and instantly knows if it's been tampered with, how, and approximately when.
### Reactions
***Deflect Machinery.*** :: When a mechanical device attacks him or an ally within 5 ft., can use reaction to jam it with a tool. Device malfunctions and misses its attack.
***Practical Knowledge.*** :: When an ally within 30 ft. makes an Intelligence check related to mechanics or engineering, can provide guidance granting advantage on the check.
...
{{descriptive
#### Secrets (DM Only)
1. **The Upstream Source:** Has traced the river pollution to an abandoned mine. Something is leaking from it.
2. **The Listening Ear:** Knows secrets about half the valley from mill conversations. Never tells.
3. **The Hidden Fortune:** Has more saved than anyone suspects. Waiting to see if his daughter needs it.
4. **The Old Tunnels:** The mill basement connects to tunnels that lead... somewhere. Never explored far.
5. **The War Past:** Served as a soldier in his youth. Killed people. Became a miller partly to atone.
}}

### Plot Hooks
1. **The River Investigation:** Needs help investigating the abandoned mine safely.
2. **The Tunnel Mystery:** Strange sounds from the basement tunnels. Needs someone to explore.
...
- Checks pocket watch obsessively
- Taps rhythm of mill wheel on tables
- Explains everything with water flow analogies
- Offers fresh bread to visitors
- Mutters calculations under breath
- Always coated in fine white flour dust

**Key Details:**
- Owns and operates Willowbrook's primary grain mill
- Processes grain for 20 miles around
- Designed revolutionary waterwheel that's 30% more efficient
- Dwarven engineers study his wheel design
- Supplies flour to both kingdoms
...
**Speed** :: 30 ft.
![Lady Seraphina Riverbrook](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lady-seraphina-riverbrook.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 12 (+1) | 16 (+3) | 14 (+2) | 16 (+3) | 14 (+2) | 18 (+4) |
___
**Saving Throws** :: Dexterity +6, Wisdom +5, Charisma +7
**Skills** :: Deception +7, History +6, Insight +8 (expertise), Intimidation +7, Perception +5, Persuasion +10 (expertise), Rapier +6
**Senses** :: Passive Perception 15
**Languages** :: Common, Elvish, Dwarvish, Infernal (business contracts), Sylvan
**Challenge** :: 6 (2,300 XP)
___
***Noble Authority.*** :: Has advantage on Charisma checks when dealing with commoners, merchants, or lower nobility. Can invoke noble privilege to access restricted areas or demand audience with officials.
***Diplomatic Immunity.*** :: In civilized areas, attacking her openly brings serious legal consequences. She can parley even with hostile forces (though this doesn't guarantee safety).
***Resource Management.*** :: Has extensive knowledge of land management, water rights, taxation, agriculture, and resource allocation. Can assess land value, crop yields, and economic viability at a glance.
***Legal Expert.*** :: Knows noble law, land rights, contract law, and water rights extensively. Can craft ironclad contracts or find loopholes in existing ones.
***Dueling Training.*** :: Trained in noble fencing arts. Has advantage on Initiative and attack rolls when fighting one-on-one honorable duels.
***Political Network.*** :: Maintains relationships with nobility across both kingdoms. Can send messages and gather information through her network (takes 1-3 days depending on distance).
### Actions
***Multiattack.*** :: Makes two attacks with her Rapier or one rapier attack and uses Commanding Presence.
***Riverbrook Rapier +1.*** :: Melee Weapon Attack: +7 to hit, reach 5 ft., one target. ***Hit.*** 1d8+4 piercing damage.::
***Special.*** :: Family heirloom blade. On critical hit, target must succeed DC 15 Constitution save or be poisoned for 1 minute (blade is enchanted with subtle venom coating that replenishes daily).
***Elegant Riposte (Recharge 5-6).*** :: When a creature misses her with a melee attack, she immediately counterattacks. +7 to hit, 2d8+4 piercing damage.
***Main Gauche.*** :: Melee Weapon Attack: +6 to hit, reach 5 ft., one target. ***Hit.*** 1d4+3 piercing damage.::
***Special.*** :: Used for parrying. See reactions.
***Commanding Presence.*** :: Target one creature within 30 ft. that can hear and understand her. Target must succeed DC 15 Wisdom save or be charmed or frightened (her choice) for 1 minute. On successful save, immune for 24 hours.
***Demand Negotiation (1/Day).*** :: Forces a pause in combat if at least one enemy can be reasoned with. All combatants must succeed DC 15 Wisdom save or be compelled to hear her out for 1 minute. Attacking her during this time breaks the effect.
### Reactions
***Parry.*** :: When attacked with a melee weapon, adds +3 AC against that attack using her main gauche. If this causes the attack to miss, she can immediately riposte (no action cost, +6 to hit, 1d8+3 damage).
***Political Leverage.*** :: When threatened, can invoke her noble connections. Attackers must succeed DC 15 Wisdom save or hesitate (disadvantage on their next attack). Only works once per encounter per enemy.
...
### Connections
- **Domain:** Riverbrook territory (12,000 residents)
- **Husband:** Lord Gareth Riverbrook (supportive, handles military)
- **Rival:** Lord Aldris Goldshore (political opponent)
...
2. **The Marriage Arrangement:** Her marriage is purely political. Gareth prefers men; they're friends, not lovers.
3. **The Cousin Problem:** The cousin who contested her inheritance hasn't given up. She's watching him.
4. **The Adopted Heir:** Secretly looking to adopt an heir since she and Gareth will have no children.
5. **The Information Network:** Has built an intelligence network to rival any spy master's.
}}

### Plot Hooks
1. **The Political Alliance:** Offers the party patronage in exchange for services.
2. **The Cousin Crisis:** The cousin is making moves. Needs investigation or counteraction.
...
- Makes eye contact that forces honesty
- Uses "we" when speaking about estate matters
- Quotes father: "Father always said..."
- Signs documents with elaborate flourish
- Touches rapier hilt when threatened
- Speaks firmly but never shouts

**Key Details:**
- Controls water rights for 50-mile section of river
- Manages 500-acre estate with 300+ tenant farmers
- Mediates land disputes between nobles and commoners
- Trained in swordplay since childhood (family tradition)
- Opposed to her family's arranged marriage plan
- Advocates for tenant farmers' rights (controversial)
...
![Captain Marcus Frontiersman](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-captain-marcus-frontiersman.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 14 (+2) | 16 (+3) | 12 (+1) | 14 (+2) | 15 (+2) |
___
**Saving Throws** :: Strength +7, Constitution +6, Wisdom +5
**Skills** :: Athletics +7, Insight +5, Intimidation +5, Perception +5, Survival +8 (expertise)
**Damage Immunities** :: Bludgeoning, Piercing, and Slashing from nonmagical attacks not made with silvered weapons (in hybrid or wolf form)
**Senses** :: Darkvision 60 ft. (in wolf or hybrid form), Passive Perception 15
**Languages** :: Common, Frontier dialect
**Challenge** :: 8 (3,900 XP)
___
***Shapechanger.*** :: Can use an action to polymorph into a wolf-humanoid hybrid or into a Large wolf, or back into human form. Statistics are the same in each form, except as noted. Equipment melds into new form. Reverts to human if reduced to 0 HP.
***Keen Hearing and Smell.*** :: Has advantage on Wisdom (Perception) checks that rely on hearing or smell (in wolf or hybrid form).
***Pack Tactics.*** :: Has advantage on attack rolls against a creature if at least one ally is within 5 ft. of the creature and isn't incapacitated.
***Lycanthropy Control (Partial).*** :: Can resist transformation during normal full moons with DC 15 Wisdom save. On failure, transforms and retains vague awareness but is aggressive. Always transforms during blood moons (no save).
***Silver Vulnerability.*** :: Takes normal damage from silvered weapons (bypasses immunity).
***Military Tactician.*** :: Grants +2 to initiative rolls for all allies within 30 ft. Can use bonus action to grant ally advantage on their next attack.
***Frontier Survival Expert.*** :: Has advantage on Survival checks in wilderness. Cannot become lost in natural terrain.
***Multiattack.*** :: Makes three attacks with longsword or two with longbow.
***Longsword +1.*** :: Melee Weapon Attack: +8 to hit, reach 5 ft., one target.
***Hit.*** :: 1d8+5 slashing damage (1d10+5 versatile).
***Longbow.*** :: Ranged Weapon Attack: +5 to hit, range 150/600 ft., one target.
***Hit.*** :: 1d8+2 piercing damage.
***Leadership (Recharge 5-6).*** :: For 1 minute, all allies within 30 ft. gain +1 to attack rolls and saving throws.
***Multiattack.*** :: Makes one bite attack and two claw attacks, or three claw attacks.
***Bite.*** :: Melee Weapon Attack: +7 to hit, reach 5 ft., one target.
***Hit.*** :: 1d8+4 piercing damage. Target must succeed DC 14 Constitution save or be cursed with werewolf lycanthropy.
***Claw.*** :: Melee Weapon Attack: +7 to hit, reach 5 ft., one target.
***Hit.*** :: 2d4+4 slashing damage.
***Longsword +1 (Two-Handed).*** :: Melee Weapon Attack: +8 to hit, reach 5 ft., one target.
***Hit.*** :: 1d10+5 slashing damage. (Can wield weapons in hybrid form with difficulty)
***Howl of the Hunt (1/Day).*** :: Releases a terrifying howl. All creatures within 60 ft. that can hear must succeed DC 14 Wisdom save or be frightened for 1 minute. Allies gain advantage on their next attack.
***Bite.*** :: Melee Weapon Attack: +7 to hit, reach 5 ft., one target.
***Hit.*** :: 2d6+4 piercing damage. Target must succeed DC 14 Constitution save or be cursed with werewolf lycanthropy.
***Pounce.*** :: If the wolf moves at least 20 ft. straight toward a creature and hits with bite, target must succeed DC 14 Strength save or be knocked prone. If prone, wolf can make another bite attack as bonus action.
### Actions
***Protective Transformation.*** :: When ally within 10 ft. is attacked by creature that would kill them, Marcus can transform into hybrid form as reaction and intercept the attack (becomes new target).
***Silver Sensitivity.*** :: If hit by silvered weapon, must succeed DC 15 Wisdom save or revert to human form immediately.
### Reactions
***Protective Transformation.*** :: When ally within 10 ft. is attacked by creature that would kill them, Marcus can transform into hybrid form as reaction and intercept the attack (becomes new target).
***Silver Sensitivity.*** :: If hit by silvered weapon, must succeed DC 15 Wisdom save or revert to human form immediately.
...
- **Control:** "I will master this curse or die trying. I will not endanger innocents."
- **Duty:** "I swore an oath to protect this frontier. The curse doesn't change that."
- **Redemption:** "Maybe by protecting others, I can atone for what I've become."

**Bonds:**
- His frontier militia (30 volunteers he commands)
- Westmarch settlement (200 people relying on his protection)
- Lady Seraphina Riverbrook (secret love, fears revealing curse)
- His late mentor Captain Aldric (infected him while dying)
- The memory of his first kill as a werewolf (still haunts him)
- His younger sister in Silverpine (hasn't seen her in 2 years)

**Flaws:**
- Increasingly isolated, pushes people away
- Guilty about curse transmission (has accidentally infected two people)
- Suicidal thoughts during full moons (considers silver to the heart)
- Drinks heavily to cope with curse
- Refuses magical help (fears making it worse)
- Doesn't sleep well (nightmares of transformation kills)
- Secret meetings with The Silver Wolf (who understands)

### Background & History
Marcus was a promising young captain in the border guard when the werewolf pack attacked. Most of his patrol died; he was bitten and left for dead. He survived, changed, and faced a choice: surrender to the beast or master it.
...
{{descriptive
#### Secrets (DM Only)
1. **The Pack Hunt:** Has been systematically hunting the werewolves who turned him. Three left.
2. **The Control Secret:** His control isn't natural—it's a ritual Morganna developed. Requires monthly renewal.
3. **The Bite Risk:** Has accidentally bitten two people. Found them and ensured they received help.
4. **The Retirement Dream:** Wants to find a cure and live normally. Knows it probably doesn't exist.
5. **The Silver Wolf Connection:** The Silver Wolf is his turned mentor. They're linked but on opposite paths.
}}

### Plot Hooks
1. **The Hunt Continues:** Has located another werewolf from the original pack. Needs help taking it down.
2. **The Control Crisis:** Something is interfering with his control ritual. Needs investigation.
3. **The New Victim:** Someone has been bitten. He needs help getting them to Morganna.
4. **The Silver Wolf Conflict:** The confrontation with his mentor is coming. Needs allies.
5. **The Cure Rumor:** Heard of a possible cure. Needs someone to investigate while he stays hidden.

### Roleplaying Notes
- Touches moonstone amulet when stressed
- Checks moon phase calendar constantly
- Refuses to eat rare meat (reminds him of curse)
- Volunteers for dangerous missions (death wish)
- Growls unconsciously when angry
- Sniffs air when suspicious (hybrid sense memory)
- Keeps silver dagger visible (warning to himself)

**Key Details:**
- Commands Westmarch frontier garrison (30 militia)
- Infected with lycanthropy 3 years ago
- Has partial control during most full moons
- Secretly meets Silver Wolf for advice/support
- In love with Lady Seraphina Riverbrook (terrified to tell her)
- Has infected 2 people accidentally (deep guilt)
- Considers suicide regularly but duty prevents it
- Knows Elder Thalindra suspects his curse
...
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 16 (+3) | 18 (+4) | 14 (+2) | 16 (+3) | 12 (+1) |
___
**Saving Throws** :: Strength +9, Dexterity +7, Constitution +8, Wisdom +7
**Skills** :: Acrobatics +7, Athletics +9, Intimidation +5, Perception +11 (expertise), Stealth +11 (expertise), Survival +11 (expertise)
**Damage Immunities** :: Bludgeoning, Piercing, and Slashing from nonmagical attacks not made with silvered weapons
**Senses** :: Darkvision 120 ft., Blindsight 30 ft. (hearing/smell based), Passive Perception 21
...
***Pack Lord.*** :: Other lycanthropes view him with respect/fear. Has advantage on Charisma checks with lycanthropes. Can sense other lycanthropes within 100 ft.
***Regeneration.*** :: Regains 10 HP at start of his turn if he has at least 1 HP. Doesn't regenerate damage from silvered weapons.
***Legendary Resistance (2/Day).*** :: If fails saving throw, can choose to succeed instead.
***Moon-Blessed.*** :: During full moons, gains +2 to all ability scores and his regeneration increases to 15 HP per turn.
***Pack Tactics.*** :: Advantage on attack rolls against creatures if at least one ally is within 5 ft.
***Ambush Predator.*** :: Has advantage on attack rolls against creatures that haven't taken a turn in combat yet.
***Trackless.*** :: Leaves no trail in wilderness. Can't be tracked by normal means.
***Multiattack.*** :: Makes three unarmed strikes or weapon attacks.
***Unarmed Strike.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target.
***Hit.*** :: 1d6+5 bludgeoning damage.
***Multiattack.*** :: Makes one bite attack and three claw attacks.
***Bite.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target.
***Hit.*** :: 2d8+5 piercing damage. Target must succeed DC 16 Constitution save or be cursed with werewolf lycanthropy (but only if Aldren wishes it).
***Claw.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target.
***Hit.*** :: 2d6+5 slashing damage.
***Rending Claws.*** :: If both claw attacks hit same target, deal extra 3d6 slashing damage.
***Alpha's Howl (Recharge 5-6).*** :: Releases a primal howl. Effects depend on target:
***- Allied lycanthropes.*** :: Gain 20 temp HP, advantage on attacks for 1 minute
***- Enemies.*** :: DC 16 Wisdom save or frightened for 1 minute
***- Range.*** :: 300 ft.
***Pounce.*** :: If moves at least 20 ft. toward target and hits with claw, target must succeed DC 17 Strength save or be knocked prone. Can make bite attack as bonus action against prone targets.
***Savage Maul (Recharge 6).*** :: Focuses all attacks on single target. Makes four claw attacks. If two or more hit, also makes bite attack. If bite hits, deals double damage.
***Bite.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target.
...
**Detect (Costs 1).** :: Makes Perception check or senses all lycanthropes within 100 ft.
**Howl (Costs 2).** :: Uses Alpha's Howl if available.
...
Unlike Marcus, she didn't fight the beast—she embraced it. The Wolf offered freedom from human frailty, from pain, from the slow decline of aging. She disappeared into the wilderness and built a pack of werewolves who live as she does: hunting, running, wild and free.
...
{{descriptive
#### Secrets (DM Only)
1. **The Original Guilt:** She led the patrol into the ambush deliberately. Had already made a deal with the pack.
2. **The Marcus Obsession:** Wants Marcus to join her willingly. Has been slowly manipulating circumstances.
3. **The Fey Alliance:** Made deals with unseelie fey for territorial protection.
4. **The Pack Instability:** Some pack members are growing too wild. She's losing control.
5. **The Cure Fear:** Knows a cure exists. Terrified that if Marcus finds it, she'll want it too.
}}

### Plot Hooks
1. **The Pack Contact:** Reaches out to the party as neutral intermediaries.
2. **The Territory Dispute:** Her pack is encroaching on human lands. Negotiate or fight.
3. **The Cure Information:** Has information about a cure. Might trade it—for the right price.
4. **The Marcus Trap:** Has set a trap for Marcus. The party might be able to intervene.
5. **The Pack Rebellion:** Some werewolves have gone feral. She needs help stopping them before hunters blame her pack.

### Roleplaying Notes
- Sniffs air constantly
- Tilts head like a wolf when confused
- Growls low when threatened
- Uses minimal words, maximum meaning
- Makes eye contact that feels predatory
- Comfortable on all fours in hybrid form
- Howls at the moon (celebration, not compulsion)

**Speech Patterns:**
- "We smell fear on you. Unnecessary."
- "The moon calls. We answer freely."
...
![Forester Galen Sustainharvest](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-forester-galen-sustainharvest.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 14 (+2) | 16 (+3) | 14 (+2) | 14 (+2) | 18 (+4) | 13 (+1) |
___
**Saving Throws** :: Strength +5, Dexterity +6, Wisdom +7
**Skills** :: Animal Handling +7, Athletics +5, Nature +8 (expertise), Perception +10 (expertise), Stealth +6, Survival +10 (expertise), Woodcarver's Tools +5
**Senses** :: Darkvision 60 ft., Passive Perception 20
**Languages** :: Common, Elvish, Sylvan, Druidic (honorary), can speak with animals and plants
**Challenge** :: 6 (2,300 XP)
___
***Fey Ancestry.*** :: Advantage against being charmed, immune to magic sleep.
***Trance.*** :: Meditates 4 hours instead of sleeping.
***Favored Enemy (Aberrations, Undead).*** :: +2 damage against these creature types. Advantage on tracking them and Intelligence checks to recall information about them.
***Natural Explorer (Forest).*** :: In forest terrain:
***Spellcasting.*** :: 8th-level ranger. Spell save DC 15, +7 to hit with spell attacks.
***1st level (4 slots).*** :: Cure Wounds, Entangle, Goodberry, Speak with Animals
***2nd level (3 slots).*** :: Pass without Trace, Spike Growth, Locate Plants or Animals
***Sustainable Forestry Expert.*** :: Can assess forest health, tree ages, and sustainable harvest rates with perfect accuracy. Knows exactly which trees can be safely harvested without damaging ecosystem.
***Tree Speaker.*** :: Can communicate with trees (as *speak with plants* spell) without expending spell slot. Trees willingly share information about recent events with him.
***Forest Network.*** :: Maintains relationships with druids, rangers, and forest spirits across 100-mile radius. Can send messages through the trees (takes 24 hours).
***Animal Companion - Moss the Bear.*** :: Always accompanied by an old brown bear (CR 1) that trusts him completely.
### Actions
***Multiattack.*** :: Makes two attacks with Longbow or Handaxe, or three with Hunting Knife (melee).
***Forestkeeper's Longbow +1.*** :: Ranged Weapon Attack: +7 to hit, range 150/600 ft., one target. ***Hit.*** 1d8+4 piercing damage plus 1d6 poison damage (arrows tipped with natural toxins).::
***Special.*** :: Can choose nonlethal damage. Poisoned creatures have disadvantage on Perception checks (toxin affects senses).
***Hunting Knife.*** :: Melee Weapon Attack: +6 to hit, reach 5 ft., one target. ***Hit.*** 1d6+3 piercing damage.::
***Handaxe +1.*** :: Melee or Ranged Weapon Attack: +7 to hit, reach 5 ft. or range 20/60 ft. ***Hit.*** 1d6+4 slashing damage.::
***Entangling Roots (Recharge 5-6, replaces spell slot).*** :: Causes roots to erupt from ground in 20-foot radius centered on point within 60 ft. Creatures in area must succeed DC 15 Strength save or be restrained. Lasts 1 minute or until destroyed (AC 10, 20 HP per 10-foot square).
***Call Animal Ally (1/Day).*** :: Summons 1d4 forest animals (wolves, bears, boars, or elk) that arrive in 1d4 rounds and obey commands for 1 hour.
***Mark the Violator (1/Day).*** :: Marks creature that has harmed the forest unnecessarily. Marked creature:
- Has disadvantage on Stealth checks in forests
- Animals are hostile toward them
- Druids and rangers can sense the mark
- Lasts until they atone for the damage
### Reactions
***Forest's Warning.*** :: When ally within 30 ft. is about to trigger natural hazard (falling branch, hidden pit, dangerous plant), can shout warning granting +5 to their saving throw or check to avoid.
***Defensive Retreat.*** :: When hit by attack, can immediately move up to half speed without provoking opportunity attacks (bonus action next turn)
.
*"Cut three, plant ten. That's how the forest survives, and so do we."*
}}
{{pageNumber,auto}}
{{footnote Part IV: NPCs}}
\page
...
- Guilty about trees felled under his authority
- Can't walk past sick tree without stopping to help
- Increasingly tired (age catching up)

### Background & History
Galen's family has managed this section of forest for twelve generations, carefully harvesting timber while maintaining the woodland's health. He learned the craft from his father, who learned from his father, an unbroken chain of knowledge stretching back centuries.

He's developed sustainable harvesting to a science: which trees to cut, which to preserve, how to encourage regrowth, when to let areas lie fallow. His forest produces steady timber while remaining healthy. Other foresters study his methods; lumber companies resent his restrictions.

Recently, he's noticed troubling changes. Trees are growing strangely, animals behaving oddly, and the forest's... feeling has shifted. Something is wrong at a level he can't quite identify, and it frightens him.

### Connections
- **Territory:** Three thousand acres of managed forest
- **Ally:** Miller Tobias Waterwheel (shares concerns)
- **Enemy:** Quickcut Lumber Company (wants his land)
...
2. **The Buried Thing:** Found something buried in a clearing. Ancient, magical, and getting warmer.
3. **The Lumber Company:** They've tried bribing, threatening, and sabotaging him. He has evidence.
...
3. **The Lumber Fight:** Ready to move against Quickcut. Needs allies and legal help.
4. **The Forest Defense:** Something is coming. Needs help preparing.
5. **The Knowledge Share:** Willing to teach sustainable forestry to those who'll use it.

### Roleplaying Notes
- Runs hand along tree bark while talking
- Moss the bear is always nearby
- Knows every tree in hundred-mile radius by sight
- Offers fresh fruit from "forest gifts"
- Refers to trees by personality ("Old Grandfather Oak")
- Stops conversations to listen to forest sounds
- Makes gifts from carved wood

**Key Details:**
- 40+ years experience in sustainable forestry
- Honorary druid circle member (respects their teachings)
- Mediates between loggers and druids
- Trained 50+ foresters across his career
- Maintains seedling nursery (thousands of saplings)
- Maps every tree in managed territory
- Personal friend of Druid Thornwood
- Moss the bear saved his life 20 years ago
...
**Speed** :: 30 ft.
![Druid Thornwood](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-druid-thornwood.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
### Equipment
- **Staff:** Thornwood Staff (legendary, carved from ancient oak, grows thorns, never breaks)
- **Armor:** Living Bark Armor (AC 16 with barkskin, regenerates daily)
- **Robes:** Druidic robes woven from living vines (deep green, always fresh)
- **Cloak:** Leaf Cloak (changes color with seasons, grants advantage on Stealth in forests)
- **Belt:** Rope of Entanglement (can animate as bonus action)
- **Pouch:** Component pouch with rare herbs, crystals, and seeds
- **Amulet:** Wooden Amulet (carved with druidic symbols, glows near unnatural magic)
- **Seeds:** Emergency goodberries (always has 10 fresh berries)
- **Book:** Personal journal of forest observations (50 years)
- **Tools:** Herbalism kit (expertly maintained)

### Personality
Traits
- Speaks in slow, measured tones
- Often pauses mid-sentence to listen to forest
- Refers to trees and animals by name
- Patient but can be terrifyingly angry when forest is threatened
- Quotes ancient druidic wisdom
- Makes decisions based on long-term forest health
- Treats all living things with respect

**Ideals:**
- **Balance:** "Life and death, growth and decay—all part of the cycle."
- **Protection:** "The forest shelters us. We shelter the forest. This is the way."
- **Ancient Ways:** "The old ways preserved forests for millennia. Modern ways threaten them."
- **Debt:** "The forest remembers all debts—those paid and those owed."

**Bonds:**
- The entire forest (considers it a living entity)
- The druid circle (12 members under his guidance)
- Elder Thalindra Oakheart (ally in protecting nature)
- His sacred grove (contains 500-year-old trees)
- Ancient forest spirits (maintains communication with them)
- His apprentice druids (currently training 6 young druids)

**Flaws:**
- Sometimes prioritizes forest over sentient life
- Holds grudges for decades (forest memory is long)
- Struggles to forgive those who harm nature
- Can be terrifyingly violent toward forest destroyers
- Inflexible about druidic traditions
- Doesn't trust civilization or technology
...
### Connections
- **Domain:** The entire old-growth forest (100 square miles)
- **Ally:** Forester Galen Sustainharvest (respects sustainable practices)
- **Circle:** Connection to other nature spirits
- **Enemy:** Quickcut Lumber Company (eternal vendetta)
- **Memory:** His human life (fading)
...
{{descriptive
#### Secrets (DM Only)
1. **The Fading Humanity:** Will be entirely tree within twenty years. Unsure how to feel about it.
2. **The Logger Massacre:** What happened sixty years ago was worse than rumors suggest. Thirty-seven died.
3. **The Forest Heart:** Protects a grove that contains the forest's spiritual center. Would die for it.
4. **The Blight Knowledge:** Knows what's causing the blight but not how to stop it.
5. **The Successor Need:** Needs to pass his role to someone before he loses the ability. Looking for candidates.
}}

### Plot Hooks
1. **The Blight Cure:** Has partial information about stopping the blight. Needs help with the rest.
2. **The Forest Heart Defense:** Something is moving toward the grove. Needs powerful allies.
3. **The Successor Test:** Tests party members as potential successors to his role.
4. **The Quickcut War:** The lumber company is escalating. Needs help ending them permanently.
5. **The Humanity Question:** Reaches out about possibly regaining his human form. Conflicted about it.

### Roleplaying Notes
- Staff plants in ground during conversations (roots sprout)
- Small animals frequently around him
- Speaks to trees when alone (and they respond)
- Makes decisions agonizingly slowly
- Touches earth to sense disturbances
- Offers healing to injured animals reflexively
- Eyes glow green when angry

**Key Details:**
- Leader of western forest druid circle
- 127 years old, considered young for firbolgs
- Maintains sacred groves across 100-mile territory
- Can sense forest disturbances through root network
- Personal ally of Elder Thalindra
- Trained 30+ druids across his lifetime
...
**Speed** :: 30 ft.
![Bard Finnegan Storyteller](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-bard-finnegan-storyteller.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 16 (+3) | 14 (+2) | 16 (+3) | 14 (+2) | 20 (+5) |
___
**Saving Throws** :: Dexterity +6, Wisdom +5, Charisma +8
**Skills** :: Acrobatics +6, Deception +8, History +9 (expertise), Insight +5, Perception +8 (expertise), Performance +11 (expertise), Persuasion +11 (expertise), Musical Instruments +9 (expertise)
**Senses** :: Darkvision 60 ft., Passive Perception 18
**Languages** :: Common, Elvish, Dwarvish, Halfling, Sylvan, Draconic (sings in all)
**Challenge** :: 7 (2,900 XP)
___
***Fey Ancestry.*** :: Advantage against being charmed, immune to magic sleep.
***Spellcasting.*** :: 13th-level bard (College of Lore). Spell save DC 16, +8 to hit with spell attacks.
***Cantrips (at will).*** :: Light, Mage Hand, Message, Vicious Mockery
***1st level (4 slots).*** :: Charm Person, Comprehend Languages, Cure Wounds, Disguise Self, Heroism
***2nd level (3 slots).*** :: Detect Thoughts, Hold Person, Invisibility, Suggestion
***3rd level (3 slots).*** :: Dispel Magic, Hypnotic Pattern, Major Image, Sending
***4th level (2 slots).*** :: Confusion, Dimension Door, Greater Invisibility
***5th level (1 slot).*** :: Modify Memory, Raise Dead (rare)
***6th level (1 slot).*** :: Mass Suggestion, True Seeing
***7th level (1 slot).*** :: Teleport
***Bardic Inspiration (d10, 5/Long Rest).*** :: As bonus action, grants ally inspiration die they can add to ability check, attack roll, or saving throw within next 10 minutes.
***Jack of All Trades.*** :: Adds +2 to any ability check that doesn't already include proficiency bonus.
***Song of Rest.*** :: During short rest, allies regain extra 1d10 HP when using Hit Dice.
***Magical Secrets.*** :: Knows spells from other classes (included in spell list).
***Cutting Words (5/Long Rest).*** :: When creature he can see within 60 ft. makes attack roll, ability check, or damage roll, can use reaction to subtract 1d10 from the roll.
***Living Chronicle.*** :: Has personally witnessed and chronicled 200+ years of history. Can recall any historical event he witnessed perfectly. Has advantage on all History checks.
***Master Performer.*** :: Has advantage on Performance and Persuasion checks. Can earn 10 gp per day performing in taverns minimum, 100+ gp for noble performances.
***Legendary Storyteller.*** :: When telling stories, can enchant audience. Listeners must succeed DC 16 Wisdom save or be captivated, unable to take hostile actions while he performs.
***Memory Keeper.*** :: Can perfectly recall any story, song, poem, or historical account he's heard. His mind is a living library.
***Tongues Master.*** :: Can perform in any language he knows, translating on the fly.
### Actions
***Multiattack.*** :: Makes two attacks with Rapier or casts a cantrip and makes one rapier attack.
***Storyteller's Rapier +1.*** :: Melee Weapon Attack: +7 to hit, reach 5 ft., one target. ***Hit.*** 1d8+4 piercing damage.::
***Special.*** :: This slender blade is covered in etched stories. On critical hit, target must succeed DC 16 Charisma save or be charmed for 1 minute.
***Vicious Mockery.*** :: Target within 60 ft. that can hear him must succeed DC 16 Wisdom save or take 3d4 psychic damage and disadvantage on next attack roll.
***Hand Crossbow.*** :: Ranged Weapon Attack: +6 to hit, range 30/120 ft. ***Hit.*** 1d6+3 piercing damage.::
***Enthralling Performance (1/Day).*** :: Performs for at least 1 minute. At end, up to 10 creatures who watched must succeed DC 16 Wisdom save or be charmed for 1 hour. Charmed creatures regard him as friendly acquaintance.
***Tale of Heroes (Recharge 5-6).*** :: Tells inspiring battle story. All allies within 30 ft. gain:
- +2 to attack rolls
- +2 to AC
- Temp HP equal to 2d10+5
- Lasts 1 minute
### Reactions
***Countercharm.*** :: As reaction when ally within 30 ft. must make save against being frightened or charmed, can grant them advantage on save.
***Cutting Words.*** :: See special abilities above.
...
- Collects stories like others collect coins
...
- **Joy:** "In dark times, songs and stories are lights against the shadow."
- **Truth:** "Every story has truth in it, even the lies reveal character."
- **Connection:** "Through stories, we're all connected—past, present, future."

**Bonds:**
- His journals (200+ years of chronicles, irreplaceable)
- "Memoir" his legendary lute (gift from elven queen 150 years ago)
- The memory of loved ones long dead
- Every place he's performed (considers them home)
- Students he's taught the bardic arts
- The responsibility to preserve history

**Flaws:**
- Can't resist telling a story (even when inappropriate)
- Nostalgic to the point of melancholy
- Drinks too much when remembering sad tales
- Survivor's guilt (everyone he loved is dead)
- Lonely despite crowds (immortal among mortals)
- Secretly fears being forgotten
- Sometimes confuses memories across centuries

### Background & History
Finnegan has been collecting stories for forty years, traveling from village to village, tavern to tavern, gathering tales both true and legendary. He has one of the most comprehensive collections of folklore in Thaldros, and more importantly, he understands how to separate fact from fiction.

He was a soldier in his youth, then a failed merchant, before discovering his true calling: preserving oral tradition. He's not a great musician or performer—merely competent—but his knowledge of stories is encyclopedic. People invite him to perform because his tales are accurate and complete, even when the truth is uncomfortable.

Now sixty and slowing down, he's looking for a place to record his collection properly. He fears dying with his head full of stories that will be lost forever.
...
2. **The Pattern Recognition:** Has noticed patterns in stories that suggest current events echo past catastrophes.
3. **The Hero's Secret:** Knows embarrassing truths about a famous hero's legend. Never told.
4. **The Dying Man's Confession:** Was told a deathbed confession that implicates a powerful family. Burden of proof.
5. **The Story Magic:** Some stories he tells have minor magical effects. Never examined why.
}}

### Plot Hooks
1. **The Recording Project:** Needs help establishing a proper archive before his memory fails.
2. **The Pattern Investigation:** Shares his pattern observations, hoping the party can investigate.
3. **The Dangerous Knowledge:** Has information about someone the party is investigating.
4. **The Confession Dilemma:** Wants advice on what to do with the deathbed confession.
5. **The Story Quest:** Heard of a legendary tale in a dangerous location. Needs escorts to collect it.

### Roleplaying Notes
- Strums lute while thinking
- Starts every statement with "I remember when..."
- Weeps during emotional stories (unashamed)
- Makes everything dramatic (even grocery shopping)
- Calls people "dear friend" after one meeting
- Breaks into relevant songs constantly
- Quotes his own compositions

**Speech Patterns:**
- "Ah, but that reminds me of a story from the Year of Falling Stars..."
- "As I sang to Queen Elara in '98, 'The past is never dead, it lives in song'..."
- "*strums lute* Let me tell you a tale..."
- "I was there, you know. I remember it well. *distant look*"
...
![Hermit Sage Morganna Whisperwind](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-morganna-whisperwind.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
### Equipment
- **Staff:** Ancient Quarterstaff (simple, but has been with her 200+ years)
- **Robes:** Sage's Robes (AC 11, dusty gray, countless pockets)
- **Ring:** Ring of Mind Shielding (protects from thought reading, holds her soul if killed)
- **Amulet:** Amulet of Proof Against Detection and Location
- **Glasses:** Spectacles of True Seeing (allows true seeing 1/day)
- **Headband:** Headband of Intellect (already included in stats)
- **Cloak:** Cloak of Elvenkind (advantage on Stealth, Perception can't see her)
- **Belt:** Belt of Many Pouches (contains spell components)
- **Books:** Personal grimoire (1,000 pages, 200+ years of notes)
- **Scrolls:** 10 scrolls of various divination spells
- **Potions:** 2 potions of longevity, 3 potions of healing
- **Library Key:** Master key that opens her hermitage library (3,000+ books)
- **Sending Stones:** 5 sending stones linked to other scholars
- **Telescope:** Astrological telescope (for star divination)

### Personality
Traits
- Speaks in slow, whispery voice
- Frequently forgets she's speaking aloud vs. thinking
- Quotes obscure texts constantly
- Forgets to eat unless reminded
- Obsessively organizes knowledge
- Intolerant of intellectual laziness
- Values truth above all else (even painful truth)

**Ideals:**
- **Knowledge:** "All knowledge must be preserved, even dangerous knowledge."
- **Truth:** "Truth is truth, whether comfortable or devastating."
- **Memory:** "I am the keeper of what was, so others may learn what will be."
- **Neutrality:** "I observe and record, I do not judge or interfere."

**Bonds:**
- Her library (3,000+ books, some unique copies)
- The truth about the Worldrend (obsessed with discovering)
- Her apprentices (she's trained 8 scholars across centuries)
- Ancient texts she hasn't finished reading
- The fey who granted her extended life (complicated relationship)
- Memories of everyone she's known (all dead now)

**Flaws:**
- Socially inept after centuries alone
- Values knowledge over people's feelings
- Hoards dangerous information
- Refuses to share certain secrets (even if it would help)
...
She's lived in her remote cottage for thirty years, visited only by those who need what she uniquely provides: healing for curses, potions that normal apothecaries can't make, and counsel from someone who hears both sides of the living and dead.

She's not mad—the whispers are real. She communes with spirits, ghosts, and stranger things. This has made her invaluable for certain problems and terrifying for most people. She's content with solitude; the living are exhausting, and the dead are usually more polite.
...
{{descriptive
#### Secrets (DM Only)
1. **The Bound Ghost:** Bound a dangerous ghost years ago. It's been working to escape.
2. **The Death Knowledge:** Has learned things about what lies beyond death. It's changed her.
3. **The Living Reluctance:** Has developed abilities that could help cities. Refuses to return.
4. **The Ritual Collection:** Has developed rituals for communicating with various entities. Some are dangerous.
5. **The Coming Dead:** The whispers are telling her about a massive influx of spirits soon. Mass death approaches.
}}

### Plot Hooks
1. **The Ghost Consultation:** Can contact specific dead for information. Services available.
2. **The Bound Ghost Crisis:** The imprisoned ghost is breaking free. Needs help reinforcing the binding.
3. **The Mass Death Warning:** Shares her warning about coming death. Needs help investigating.
4. **The Ritual Teaching:** Might teach spirit communication to those who prove worthy.
5. **The Marcus Emergency:** Something's wrong with Captain Marcus's ritual. Needs urgent ingredients.

### Roleplaying Notes
- Touches books lovingly
- Forgets people's names but remembers obscure facts
- Falls asleep mid-conversation (advanced age)
- Speaks to herself constantly
- Quotes book titles and page numbers
- Makes tea obsessively (has 40+ varieties)
- Writes notes constantly in margins

**Speech Patterns:**
- "As stated in Volume XII of Arcturus's Compendium, page 247..."
- "*mutters* Where did I put that reference...oh, you're still here?"
...
**Speed** :: 30 ft.
![Archmage Veridian Starweaver (Expanded)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-archmage-veridian-starweaver.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 16 (+3) | 16 (+3) | 22 (+6) | 18 (+4) | 18 (+4) |
___
**Saving Throws** :: Intelligence +12, Wisdom +10, Charisma +10
**Skills** :: Arcana +18, History +12, Insight +10, Investigation +12, Perception +10
**Damage Resistances** :: Damage from spells (Magic Resistance)
**Senses** :: Darkvision 60 ft., Passive Perception 20
**Languages** :: Common, Elvish, Draconic, Celestial, Infernal, Sylvan, Dwarvish, Deep Speech
**Challenge** :: 18 (20,000 XP)
___
***Fey Ancestry.*** :: Advantage against being charmed, immune to magic sleep.
***Trance.*** :: Meditates 4 hours instead of sleeping.
***Spellcasting.*** :: 18th-level wizard. Spell save DC 20, +12 to hit with spell attacks.
...
***7th level (2 slots).*** :: Teleport, Plane Shift, Forcecage
***8th level (1 slot).*** :: Mind Blank*, Maze
***9th level (1 slot).*** :: Time Stop, Wish (rarely used)
***Magic Resistance.*** :: Advantage on saving throws against spells and magical effects.
***Arcane Recovery (1/Day).*** :: During a short rest, recovers expended spell slots up to 9th level combined.
***Signature Spells.*** :: Can cast Counterspell and Dispel Magic without expending spell slots (each 1/short rest).
***Scrying Network.*** :: Maintains 12 crystal balls across both kingdoms, can use as bonus action to switch views.
***Starweaver Bloodline.*** :: Once per day, can cast any divination spell without expending a spell slot.
### Actions
***Multiattack.*** :: Casts a cantrip and uses his Starlight Staff, or casts two cantrips.
***Starlight Staff (Quarterstaff +3).*** :: Melee Weapon Attack: +9 to hit, reach 5 ft., one target. ***Hit.*** 1d6+3 bludgeoning damage (1d8+3 versatile) plus 2d10 force damage.::
***Special.*** :: Functions as Staff of Power. Can cast wizard spells through the staff as a bonus action.
***Fire Bolt.*** :: Ranged Spell Attack: +12 to hit, range 120 ft., one target. ***Hit.*** 4d10 fire damage.::
***Cast a Spell.*** :: Casts a spell from prepared list.
***Teleportation Circle (Special).*** :: Can teleport party to any permanent circle he knows (costs 5,000 gp in materials, usually charges 1,000 gp per person).
### Reactions
***Shield.*** :: Casts Shield to increase AC by 5 until start of next turn.
***Counterspell.*** :: Automatically counters spells of 5th level or lower, makes check for higher levels (+12 bonus).
***Absorb Spell (Staff of Power, 3/Day).*** :: When targeted by a spell, absorb it into staff and regain spell slot equal to spell's level.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Casts a cantrip.
**Detect Magic.** :: Uses detect magic sense (knows presence of magic within 30 ft.).
**Teleport (Costs 2).** :: Uses misty step without expending a spell slot.
**Cast Spell (Costs 3).** :: Casts a spell of 3rd level or lower from prepared list.
...
- **Balance:** "Neither kingdom should dominate - equilibrium preserves peace."

**Bonds:**
- King Aldric IV (advised him since he was a child)
- The Kingdom of Thaldros
...
- Struggles to trust others with important tasks
...
**Expanded Role in Campaigns:**
**Primary Function:** High-level quest giver, magical expertise, investigation coordinator
...
- Can teleport party to mission locations
- Maintains magical communication crystals
...
**Rewards Offered:**
- Spell scrolls and magical items
- Access to his personal library
- Training in advanced magic
- Teleportation services
- Introductions to other powerful allies
- Information about party's personal quests
...
- Knows The Frost Seer's visions are accurate
...
His specialty is divination, but his true mastery lies in the intersection of magical schools. He developed the Starweaver Synthesis—a technique for combining spells of different schools into hybrid effects. The technique is now taught at every major magical academy, though few can replicate his fluency.

He has served as headmaster of the Silverpine Arcanum for seventy-five years, overseeing its expansion from regional school to continental institution. Under his leadership, enrollment has tripled, and the school has produced three archmages and dozens of notable wizards.

Despite his power, Veridian is approachable and patient with students. He remembers what it was like to struggle with concepts, even if it was four hundred years ago. His office door is always open, and he teaches at least one introductory class per term "to remember where magic begins."

### Connections
- **Sage Thelmar Runescribe:** His most promising former student, now serving the crown
- **Professor Elara Moonwhisper:** Faculty colleague who shares his interest in celestial phenomena
...
2. **The Prophecy:** Has foreseen something catastrophic approaching within the next decade, but the vision is unclear and he fears acting on incomplete information.
3. **Aetherian Contact:** His correspondence with Archmage Eldrin involves more than research—they're developing a way to safely cross the Sundering Sea.
4. **Mortality's Approach:** Despite elven longevity, he can feel his time ending within the century. He's quietly preparing for succession.
5. **The Forbidden Research:** Keeps a sealed section in the library containing knowledge too dangerous to destroy but too dangerous to share.
}}

### Plot Hooks
1. **The Prophecy:** Veridian needs help investigating his unclear vision. The party might be pieces of the puzzle.
2. **The Crossing:** The Aetherian passage project is reaching a critical phase. He needs brave souls to test it.
3. **Succession Planning:** Time to identify and test the next headmaster. The candidates are all flawed in different ways.
...
**Hit Points** :: 78 (12d8 + 24)
**Speed** :: 30 ft.
![Professor Miranda Questseeker](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-professor-miranda-questseeker.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
___
**Saving Throws** :: Intelligence +9, Wisdom +7
**Skills** :: Arcana +13, History +13, Investigation +13, Insight +7, Perception +7, Persuasion +6
**Senses** :: Passive Perception 17
**Languages** :: Common, Elvish, Dwarvish, Draconic, Ancient Common (pre-Worldrend dialect)
**Challenge** :: 9 (5,000 XP)
___
***Spellcasting.*** :: 9th-level wizard (Divination school). Spell save DC 17, +9 to hit with spell attacks.
***Cantrips (at will).*** :: Light, Mage Hand, Message, Prestidigitation
***1st level (4 slots).*** :: Comprehend Languages, Detect Magic, Identify, Mage Armor*
***2nd level (3 slots).*** :: Detect Thoughts, Locate Object, See Invisibility
***3rd level (3 slots).*** :: Clairvoyance, Dispel Magic, Tongues
...
***Expert Knowledge.*** :: Has advantage on all Intelligence checks related to history, arcana, and investigation. On a failed check, can reroll once per day.
***Researcher's Network.*** :: Can send messages to student assistants across both kingdoms. Within 24 hours, receives information as if casting Legend Lore (no spell slot needed, 1/day).
***Quick Study.*** :: Can learn one new language by studying for 1 week, or decipher unknown writing with 1 hour of study (DC 15 Intelligence check).
***Academic Authority.*** :: Has advantage on Persuasion checks when dealing with scholars, nobility, or in academic settings.
***Encyclopedic Memory.*** :: Can perfectly recall any text she's read. Has access to knowledge equivalent to a library in her mind.
### Actions
***Multiattack.*** :: Makes two dagger attacks or casts a cantrip and uses a dagger.
***Dagger +1.*** :: Melee or Ranged Weapon Attack: +7 to hit, reach 5 ft. or range 20/60 ft. ***Hit.*** 1d4+3 piercing damage.::
***Light Crossbow.*** :: Ranged Weapon Attack: +6 to hit, range 80/320 ft. ***Hit.*** 1d8+2 piercing damage.::
***Cast a Spell.*** :: Casts a prepared spell.
***Share Knowledge (Recharge 5-6).*** :: Grants one ally advantage on their next Intelligence, Wisdom, or Charisma check as she provides relevant historical context or tactical advice.
### Reactions
***Defensive Scholar.*** :: When hit by an attack, can impose disadvantage on the attack roll (3/day). Represents ducking behind cover or using an object as a shield.
***Counterspell (3rd level).*** :: Can counter a spell of 3rd level or lower, or make a check (+9) for higher levels.
...
2. **The Tomb Raiders:** More than just a buyer—she founded the guild thirty years ago to fund her research, then "left" while keeping a controlling interest.
3. **Personal Tragedy:** Lost her husband and daughter on an expedition fifteen years ago. Threw herself into work to avoid dealing with grief she's never processed.
...
2. **The Guild Problem:** Someone is using her Tomb Raiders for something she didn't authorize. Time to investigate.
3. **Family Ghosts:** Evidence suggests her family might have survived the expedition. Or something wearing their faces has.
4. **The Publication:** She's decided to publish her Worldrend theory. Multiple parties want to stop her.
5. **Rival's Revenge:** Yasmin has discovered something Miranda wants desperately and is making her work for it.

### Roleplaying Notes
- Constantly adjusts her spectacles
- Mutters to herself when thinking
- Pulls out notebooks to reference previous findings
- Gets excited and talks faster
- Apologizes for going off on tangents
- Makes connections others miss

**Expanded Role in Campaigns:**
**Primary Function:** Investigation coordinator, research quest-giver, mystery solver
...
3. **Retrieval:** "Specific text/artifact needed for research"
4. **Protection:** "My research threatened - need guards"
5. **Investigation:** "Follow these leads - report findings"

**Research Topics (Quest Hooks):**
- House Blackwood's true fate and heir survival
...
- Academic credentials (advantage on social interactions)
- Access to university restricted archives
- Letters of recommendation to nobility
- Payment in gold (university funded)
- Credit in published papers (fame)
...
**Speed** :: 40 ft.
![Master Hunter Kael Dragonsbane](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-master-hunter-kael-dragonsbane.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
### Equipment
- **Armor:** Dragon Scale Mail (AC 14 + Dex, max +2, fire resistance) - Made from black dragon scales
- **Primary Weapon:** Dragonpiercer (Longsword +2, legendary, dragon fang hilt, glows near dragons)
- **Ranged Weapon:** Dragonbone Bow (Longbow +1, fires flaming arrows, 20 arrows)
- **Secondary:** Silvered Shortsword (magical, silvered)
- **Utility:** 3 adamantine nets, hunter's trap kit, climbing gear
- **Eye Patch:** Goggles of Night (darkvision 60 ft.) - covers missing left eye
- **Cloak:** Cloak of Elvenkind (advantage on Stealth)
- **Boots:** Boots of Speed (double speed as bonus action, 10 rounds/day)
- **Pouch:** Bag of dragon parts (scales, claws, teeth for crafting)
- **Potions:** 3 potions of superior healing, 1 potion of fire resistance, 1 potion of invulnerability
- **Tools:** Hunting traps, caltrops, manacles (masterwork)
- **Trophy:** Preserved ancient dragon claw (proof of his legend)

### Personality
Traits
- Speaks in short, efficient sentences
- Constantly assesses threats in any room
- Respectful to worthy opponents (including monsters)
- Patient and observant
- Dry, dark humor about injuries
- Never boasts - his scars speak for him

**Ideals:**
- **Balance:** "Nature needs predators. We're one of them."
- **Respect:** "Killing should be for protection or survival, never sport."
- **Mentorship:** "Knowledge dies with us unless we pass it on."

**Bonds:**
- The wilds and natural world
- His students and apprentices
- The memory of his original hunting party (all dead)
- Captain Marcus (friend, lycanthropy cases)
- The people threatened by monsters

**Flaws:**
- Survivor's guilt over lost companions
- Sometimes treats people like prey to be studied
- Underestimates non-physical threats
- Haunted by the dragon that took his eye
- Drinks heavily after difficult hunts
...
### Connections
- **Warden Commander Thalia Moonbow:** His commanding officer and one of the few people he considers a peer
- **Scout Captain Finn Quickfoot:** The halfling has discovered something Kael needs to investigate
- **Master Smith Durgan Forgefire:** Creates his specialized dragon-hunting equipment
...
{{descriptive
#### Secrets (DM Only)
1. **Infernalix's Deal:** Knows about the old king's bargain with the dragon. Suspects it's coming due soon.
2. **The Ninth Dragon:** There's one he's never spoken about—a dragon he befriended rather than killed, who shares information about dragonkind.
3. **Failing Body:** His injuries are worse than he lets on. Some days he can barely grip a sword.
4. **The Survivor's Guilt:** Three of his students died because of his decisions. He replays those moments constantly.
5. **Dragon Blood:** During one fight, he was bathed in dragon blood. It changed him subtly—better senses, resistance to fire, and dreams he doesn't understand.
}}

### Plot Hooks
1. **The Final Hunt:** One last dragon needs killing before Kael retires. The most dangerous one yet.
2. **Finn's Discovery:** The halfling scout has found tracks that suggest something ancient is awakening.
3. **Dragon Friend:** His dragon contact has sent a warning—others of its kind are planning something.
4. **Student's Legacy:** One of his dead students had a child who's now old enough to demand answers about how their parent died.
5. **The Blood's Call:** His dragon-blood changes are intensifying. He needs to understand what's happening before it's too late.

### Roleplaying Notes
- Touches his eye patch when thinking
- Checks escape routes instinctively
- Speaks about dragons with mixture of respect and hatred
- Offers tactical advice mid-combat
- Tells hunting stories with lessons embedded

**Expanded Role in Campaigns:**
**Primary Function:** Monster hunting quests, dangerous creature expert, combat mentor

**Key Details (Expanded):**
- Survived encounter with ancient dragon
- Trains aspiring monster hunters
- Travels between both continents
- Knows weaknesses of all major monster types
- Can be hired for specific hunts
- Respects worthy prey (won't hunt unnecessarily)
- Missing eye, scarred extensively, still formidable

**Campaign Quest Types:**
1. **Hunting:** "Dangerous creature threatening settlement - eliminate it"
2. **Capture:** "Rare specimen needed alive for study"
3. **Training:** "Learn proper techniques for hunting [monster type]"
4. **Investigation:** "Unusual monster behavior - determine cause"
5. **Escort:** "Transporting dangerous cargo - need protection"

**Specialization by Monster Type:**
- **Dragons:** Knows habits, lairs, weaknesses (signature)
- **Giants:** Diplomacy and combat tactics
- **Aberrations:** Identification and elimination
- **Undead:** Tracking and destruction methods
- **Fey:** Negotiation and counter-magic
- **Lycanthropes:** Non-lethal containment (works with Captain Marcus)

**Training Services:**
- Combat technique improvements (+1 to attack rolls vs. specific creature type)
- Monster lore (advantage on knowledge checks)
- Tracking skills (advantage on survival checks)
- Tactical planning (bonus to initiative vs. large creatures)
- Survival in hostile terrain

**Rewards Offered:**
- Gold payment (standard rates)
- Monster parts and crafting materials
- Magical weapons from his collection
- Training and skill improvement
- Reputation among hunter guilds
- Connections to wealthy clients

**Character Arc:**
- Initially just doing job
- Recognizes party's potential
- Becomes mentor figure
- May sacrifice himself protecting party from dragon
- Or aids in final confrontation with ancient threat
...
**Connections:**
- Works with Captain Marcus (lycanthropy expert)
- Hired by both royal courts
- Knows Silver Wolf's identity (respects the choice)
...
**Speed** :: 30 ft.
![Captain Thalia Lightbringer](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-captain-thalia-lightbringer.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
**Skills** :: Athletics +8, Insight +7, Intimidation +9, Medicine +7, Persuasion +9, Religion +5
**Damage Resistances** :: Radiant (divine blessing)
**Condition Immunities** :: Frightened (Aura of Courage)
**Senses** :: Passive Perception 13, Divine Sense 60 ft.
...
***Extra Attack.*** :: Attacks twice when taking Attack action.
***Aura of Protection (10 ft.*** :: ): She and allies within 10 ft. gain +5 to all saving throws.
***Aura of Courage (10 ft.*** :: ): She and allies within 10 ft. are immune to being frightened.
***Aura of Devotion (10 ft.*** :: ): She and allies within 10 ft. can't be charmed.
***Divine Health.*** :: Immune to disease.
***Spellcasting.*** :: 11th-level paladin. Spell save DC 17, +9 to hit with spell attacks.
***1st level (4 slots).*** :: Bless, Command, Cure Wounds, Detect Evil and Good, Protection from Evil and Good*, Sanctuary
***2nd level (3 slots).*** :: Aid, Lesser Restoration, Zone of Truth* (at will, special)
***3rd level (3 slots).*** :: Beacon of Hope, Dispel Magic, Revivify
***Sacred Weapon (1/Day).*** :: As action, Dawnbreaker emits bright light (20 ft. radius), adds +5 to attack rolls for 1 minute. Can end early to cast Dispel Magic.
***Turn the Unholy (1/Day).*** :: As action, each fiend or undead within 30 ft. must make DC 17 Wisdom save or be turned for 1 minute.
***Radiant Presence.*** :: She glows faintly with golden light (dim light 5 ft.). Increases to bright light 20 ft. when using divine abilities.
***Champion of the Iron Council.*** :: Advantage on Persuasion checks with lawful good creatures and disadvantage on Deception checks (can't lie convincingly - too honest).
### Actions
***Multiattack.*** :: Makes two attacks with Dawnbreaker.
***Dawnbreaker (Longsword +2).*** :: Melee Weapon Attack: +10 to hit, reach 5 ft., one target. ***Hit.*** 1d8+6 slashing damage (1d10+6 versatile) plus 2d6 radiant damage.::
...
***Shield Bash.*** :: Melee Weapon Attack: +8 to hit, reach 5 ft., one target. ***Hit.*** 1d4+4 bludgeoning damage, target must succeed DC 16 Strength save or be knocked prone.::
***Javelin.*** :: Ranged Weapon Attack: +8 to hit, range 30/120 ft. ***Hit.*** 1d6+4 piercing damage.::
...
{{descriptive
#### Secrets (DM Only)
1. **The Tomb's Voice:** Something from the Tomb of Shadows still whispers to her sometimes. She's told no one, fearing they'll think her corrupted.
2. **Doubts About Gareth:** Questions some of the Lord Commander's decisions but lacks evidence of actual wrongdoing.
3. **The Survivor's Secret:** The seven survivors made a pact to never speak of exactly what they saw in the tomb's deepest chambers.
4. **Prosthetic Limitations:** The arm malfunctions occasionally, especially near strong undead. She hides this.
5. **Personal Vow:** Swore to eventually return and destroy what's in the tomb, when she's powerful enough.
}}

### Plot Hooks
1. **The Whispers Return:** The voice from the tomb is getting louder, saying something important.
2. **Survivor's Reunion:** One of the other survivors has been acting strangely. Investigation needed.
3. **The Return:** She's finally ready to go back to the Tomb of Shadows. She needs a capable team.
4. **Gareth's Orders:** She's been given orders she finds troubling. Obey or investigate?
5. **Arm's Secret:** The prosthetic has started glowing near certain locations. What is it detecting?

### Roleplaying Notes
- Glows brighter when emotional
- Grips sword hilt when uncertain
- Kneels to pray before major decisions
- Speaks in inspirational phrases
- Can't tell convincing lies

**Campaign Role:**
**Primary Function:** Righteous quest-giver, divine support, moral compass

**Quest Types:**
1. **Justice:** "Corrupt officials must be exposed and tried"
2. **Protection:** "Innocents threatened - provide sanctuary"
3. **Redemption:** "Fallen paladin seeks to make amends - supervise"
4. **Purification:** "Unholy site must be consecrated"
5. **Investigation:** "Evil hidden among nobility - unmask it"
...
- Divine blessings and consecrations
- Safe havens in Iron Council temples
- Letters of authority (legal backing)
- Training in paladin techniques
- Spiritual guidance
...
2. Paladin Radiant's spirit guides her sometimes
3. She's destined to face Lich of Raven's Keep
4. Secretly dating someone from "wrong" faction
5. Questions whether reunification is justice or conquest

**Connections:**
- Wields Paladin Radiant Dawnbringer's sword
- Coordinates with Archmage Veridian
- Reports to Iron Council leadership
...
**Hit Points** :: 99 (18d8 + 18)
**Speed** :: 25 ft. (reduced by age)
![Sage Cornelius the Elder](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-sage-cornelius-the-elder.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
- **Staff:** Ancient walking staff (mundane, needed for mobility)
...
### Personality
Traits
- Speaks urgently, as if time is running out (it might be)
- References historical parallels constantly
- Patient teacher despite internal panic
- Frustrated when ignored or dismissed
- Treats mistakes as learning opportunities
- Touches forehead when concentrating

**Ideals:**
- **Knowledge:** "History must be preserved so mistakes aren't repeated."
- **Warning:** "Those who ignore the past are condemned to repeat it."
- **Legacy:** "My knowledge must outlive me."

**Bonds:**
- His library (life's work)
- Professor Miranda (favorite student)
- Preventing Second Worldrend (obsession)
- The truth about history
- Future generations

**Flaws:**
- Sometimes seems paranoid (but he's usually right)
- Fragile health limits mobility
- Frustrated by political inaction
- Workaholic despite age
- Fears dying before sharing crucial knowledge

### Background & History
Cornelius has been ancient for as long as anyone can remember. Records from a hundred years ago describe him as "the elderly sage Cornelius," and records from two hundred years ago say the same thing. Either he's found a way to extend his life considerably, or there have been multiple people using the name. He claims the former.

His specialty is ancient civilizations—not the recent ancient, but the truly old. Pre-Worldrend cultures, the Primordials, the First Age. He reads languages no one else can identify, recognizes artifacts others dismiss as rocks, and occasionally references events from millennia ago as if he'd witnessed them.
...
- **Archmage Veridian Starweaver:** Old friend—how old, neither will say
- **Merchant Princess Yasmin:** She brings him artifacts; he tells her their histories
...
3. **Identity Exposed:** Someone has connected his various historical identities. What do they want?
4. **Succession:** He's finally contemplating death. Time to pass on his knowledge—but to whom?
5. **The Worldrend Truth:** Events are unfolding that relate to what caused the original catastrophe.

### Roleplaying Notes
- Constantly references historical events
- Makes prophetic statements that seem odd until later
...
**Quest Types:**
1. **Research:** "Verify this historical account's accuracy"
...
**Mid Campaign:** Patterns become clear, proves accuracy
**Late Campaign:** Precise predictions, prevention methods
**Climax:** Crucial knowledge for stopping Second Worldrend

**Rewards:**
- Historical context for party's discoveries
- Advance warning of dangers
- Interpretation of prophecies and omens
- Letters of introduction to other scholars
- Access to his library (20,000 volumes)
- Eventually: location of game-changing artifact

**Character Arc:**
- Dismissed as paranoid old scholar
- Predictions start coming true
- Becomes crucial ally
- May sacrifice himself to delay/prevent Worldrend
- Or survives to document party's heroism
...
**Speed** :: 30 ft., swim 40 ft.
![Admiral Marcus Truewind](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-admiral-marcus-truewind.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 14 (+2) | 18 (+4) | 14 (+2) | 16 (+3) | 18 (+4) |
___
**Saving Throws** :: Strength +8, Constitution +8, Wisdom +7
**Skills** :: Athletics +12, Intimidation +8, Insight +7, Navigation +10 (expertise), Perception +11 (expertise), Persuasion +12 (expertise)
**Senses** :: Passive Perception 21
**Languages** :: Common, Aquan, Elvish, Dwarvish
**Challenge** :: 12 (8,400 XP)
___
***Master Navigator.*** :: Has advantage on all checks related to navigation, ship handling, and maritime knowledge. Cannot become lost at sea.
***Sea Legs.*** :: Advantage on saving throws against being knocked prone on ships. Ignores difficult terrain on ships and docks.
***Hold the Line.*** :: Allies within 30 ft. gain +2 to AC and saving throws while Marcus is conscious. This increases to +3 on ships he commands.
***Commander's Presence.*** :: Can use bonus action to grant one ally within 60 ft. advantage on their next attack roll or saving throw.
***Rallying Cry (Recharge 5-6).*** :: As action, all allies within 60 ft. who can see or hear him gain 2d10+4 temporary HP and advantage on their next attack roll.
***Maritime Combat Expert.*** :: Advantage on attack rolls while on ships or near water.
***Extra Attack (2).*** :: Attacks three times when taking Attack action.
***Indomitable (3/Day).*** :: Can reroll a failed saving throw.
***Action Surge (2/Rest).*** :: Can take one additional action on his turn.
### Actions
***Multiattack.*** :: Makes three attacks with his cutlass or two attacks and uses Commander's Presence or Rallying Cry.
***Truewind's Cutlass (Scimitar +2).*** :: Melee Weapon Attack: +10 to hit, reach 5 ft., one target. ***Hit.*** 1d6+6 slashing damage plus 1d6 lightning damage.::
***Special.*** :: This enchanted naval blade can cast Control Water once per day. Named after his ship and family motto.
***Naval Pistol +1 (x2).*** :: Ranged Weapon Attack: +7 to hit, range 30/90 ft., one target. ***Hit.*** 1d10+3 piercing damage. (Has two pistols, both shots as one action)::
***Heavy Crossbow.*** :: Ranged Weapon Attack: +6 to hit, range 100/400 ft., one target. ***Hit.*** 1d10+2 piercing damage.::
***Tactical Command.*** :: Issues complex orders. All allies within 60 ft. can use their reaction to either move up to half their speed or make one weapon attack with advantage.
***Inspire Courage (3/Day).*** :: All allies within 60 ft. gain advantage on attack rolls and saving throws against being frightened for 1 minute.
### Reactions
***Protective Commander.*** :: When an ally within 5 ft. is hit, can use reaction to impose disadvantage on the attack roll or add +5 to ally's AC against that attack.
***Parry and Counter.*** :: When hit by melee attack, adds +4 to AC against that attack. If attack misses as result, can make one melee attack against attacker.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Move.** :: Moves up to his speed without provoking opportunity attacks.
**Attack.** :: Makes one weapon attack.
**Command (Costs 2).** :: Uses Commander's Presence on up to two allies.
...
### Connections
- **Guildmaster Theron Clearwater:** Civilian counterpart who handles merchant interests
- **Captain Mira Wavecrest:** His best combat captain, commanding the inland lake patrol
...
### Plot Hooks
1. **The Traitor Hunt:** Evidence of the information leak has surfaced. Time for a quiet investigation.
2. **Final Chase:** One last chance to catch Vex Darkwater. The admiral is committed regardless of cost.
3. **The Health Crisis:** His condition worsens at an inopportune moment. Who takes command?
4. **Clearwater's Exposure:** Someone threatens to reveal the Guildmaster's arrangement. Managing the fallout.
5. **Family Reconciliation:** One of his children reaches out—genuine, or manipulation?

### Roleplaying Notes
- Touches his cutlass hilt when thinking
- Checks horizon habitually
- Uses sailing terms in everyday speech
- Stands with feet apart (ship balance)
- Weather-predicting statements

**Campaign Role:**
**Primary Function:** Maritime quests, diplomatic missions, transport provider
- Weathered, commanding presence
- Ship is The Unity (symbolic name)
- Political moderate, voices of reason

**Personality:**
- Pragmatic, diplomatic, strategic
- Believes actions speak louder than words
- Tired of political deadlock
- Protective of civilian shipping
...
3. **Rescue:** "Ship in distress - mount rescue operation"
4. **Investigation:** "Smuggling operation needs exposure"
5. **Transport:** "Deliver crucial supplies to besieged port"

**Fleet Resources:**
- 12 warships under his command
- Network of informants in every port
- Can provide fast transport between continents
- Naval combat support for coastal missions
- Intelligence about Syndicate operations

**Diplomatic Influence:**
- Trusted by both royal courts
- Can arrange audiences with nobility
- Provides neutral meeting grounds
- Mediates disputes between kingdoms
- Has backing of Merchant League

**Rewards:**
- Gold payment from both kingdoms
- Free passage on his ships
- Introduction to both royal courts
- Naval support for missions
...
**Connections:**
- Coordinates with Captain Thalia (shared values)
- Reports to both King Aldric and Queen Aelindra
- Knows all major port masters
...
*Large humanoid (giant), neutral*
___
**Armor Class** :: 18 (natural armor, Barkskin)
**Hit Points** :: 195 (17d12 + 85)
**Speed** :: 30 ft.
![Druid Elder Silvaris](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-druid-elder-silvaris.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 14 (+2) | 20 (+5) | 14 (+2) | 22 (+6) | 16 (+3) |
___
**Saving Throws** :: Intelligence +7, Wisdom +11, Charisma +8
**Skills** :: Animal Handling +11, Insight +11, Medicine +11, Nature +12, Perception +11, Survival +11
...
***1st level (4 slots).*** :: Cure Wounds, Entangle, Goodberry, Speak with Animals*
***2nd level (3 slots).*** :: Barkskin*, Lesser Restoration, Pass without Trace
***3rd level (3 slots).*** :: Call Lightning, Plant Growth, Speak with Plants
***4th level (3 slots).*** :: Blight, Grasping Vine*, Stoneskin
***5th level (2 slots).*** :: Commune with Nature, Tree Stride*
***6th level (1 slot).*** :: Heroes' Feast, Transport via Plants
***7th level (1 slot).*** :: Fire Storm, Regenerate
***8th level (1 slot).*** :: Animal Shapes, Sunburst
***9th level (1 slot).*** :: Foresight, Shapechange
***Wild Shape (Unlimited).*** :: Can transform into beasts of CR 5 or lower. Can use as bonus action. No limit on uses. Can speak in beast form.
***Nature's Ward.*** :: Immune to poison and disease. Can't be charmed or frightened by fey or elementals.
***Nature's Sanctuary.*** :: Beasts and plants must pass DC 19 Wisdom save to attack him.
...
***Master of Beasts.*** :: All beasts within 1 mile are aware of his presence and will come to his aid if called.
### Actions
***Multiattack.*** :: Makes two attacks with Quarterstaff or casts two cantrips.
***Living Wood Quarterstaff +2.*** :: Melee Weapon Attack: +10 to hit, reach 5 ft., one target. ***Hit.*** 1d6+5 bludgeoning damage (1d8+5 versatile) plus 2d8 poison damage.::
***Cast a Spell.*** :: Casts a prepared spell.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Casts a cantrip.
...
**Speed** :: 25 ft.
![Artificer Tobias Gearwise](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-artificer-tobias-gearwise.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 16 (+3) | 16 (+3) | 22 (+6) | 14 (+2) | 12 (+1) |
___
**Saving Throws** :: Constitution +7, Intelligence +10
**Skills** :: Arcana +14, Investigation +14, Perception +6, Sleight of Hand +7, Tinker's Tools +14 (expertise)
**Senses** :: Darkvision 60 ft., Passive Perception 16
**Languages** :: Common, Gnomish, Dwarvish, Draconic, plus can understand any language through devices
**Challenge** :: 10 (5,900 XP)
___
***Gnome Cunning.*** :: Advantage on Int/Wis/Cha saves vs. magic.
***Artificer's Lore.*** :: Add double proficiency to History checks about magic items, alchemical objects, or tech.
***Spellcasting.*** :: 10th-level artificer. Spell save DC 18, +10 to hit with spell attacks.
***Cantrips (at will).*** :: Fire Bolt, Mending, Prestidigitation
***1st level (4 slots).*** :: Cure Wounds, Detect Magic, Identify, Sanctuary
***2nd level (3 slots).*** :: Aid, Heat Metal, See Invisibility
***3rd level (2 slots).*** :: Dispel Magic, Fly, Revivify
...
***Enhanced Hand Crossbow +2.*** :: Ranged Weapon Attack: +9 to hit, range 30/120 ft. ***Hit.*** 1d6+5 piercing damage plus 1d8 force damage.::
***Cast a Spell.*** :: Casts a spell using tools.
***Deploy Device (3/Day).*** :: Deploys one of his inventions as action.
### Reactions
***Flash of Genius.*** :: Adds +6 to ally's check or save.
***Shield (from Ring).*** :: Casts Shield to gain +5 AC.
...
3. **Kidnapping Attempt:** A kingdom decides to acquire him forcibly. Escape and countermeasures required.
...
*Medium humanoid (elf), chaotic good (formerly evil)*
___
**Armor Class** :: 19 (studded leather +2, Dex, defense bonus)
**Hit Points** :: 143 (22d8 + 44)
**Speed** :: 35 ft., climb 35 ft.
![Spy-Master Kaelen Shadowleaf](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-kaelen-shadowleaf.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 12 (+1) | 22 (+6) | 14 (+2) | 18 (+4) | 16 (+3) | 16 (+3) |
___
**Saving Throws** :: Dexterity +11, Intelligence +9, Wisdom +8
**Skills** :: Acrobatics +11, Deception +13 (expertise), Insight +8, Investigation +9, Perception +8, Persuasion +8, Sleight of Hand +11, Stealth +16 (expertise)
**Damage Resistances** :: Poison
**Senses** :: Darkvision 60 ft., Passive Perception 18
**Languages** :: Common, Elvish, Thieves' Cant, Undercommon, 8 more languages
**Challenge** :: 14 (11,500 XP)
___
***Assassinate.*** :: Advantage on attacks vs. creatures that haven't acted. Any hit on surprised creature is critical hit.
***Evasion.*** :: Dex save for half damage = no damage on success, half on failure.
***Sneak Attack.*** :: Once per turn, deals extra 8d6 damage with finesse weapon if has advantage.
***Uncanny Dodge.*** :: Halve damage from one attack he can see.
...
***Cunning Action.*** :: Bonus action to Dash, Disengage, or Hide.
### Reactions
***Uncanny Dodge.*** :: Halve damage from attack he can see.
***Riposte.*** :: When enemy misses him with melee attack, make one attack against that enemy.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Move.** :: Use Shadow Step or move normally.
**Attack.** :: Make one weapon attack.
**Hide.** :: Attempt to hide even without cover (needs dim light).
**Gather Intel (Costs 2).** :: Learn one piece of information about target creature (type, resistances, or special ability).
...
![The Guardian of Thresholds](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-the-guardian-of-thresholds.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 18 (+4) | 20 (+5) | 20 (+5) | 22 (+6) | 22 (+6) |
___
**Saving Throws** :: Wisdom +11, Charisma +11
**Skills** :: Insight +16 (expertise), Perception +11
...
**Challenge** :: 16 (15,000 XP)
___
***Angelic Weapons.*** :: Weapon attacks are magical and deal extra 4d8 radiant damage.
***Divine Awareness.*** :: Knows if it hears a lie.
***Innate Spellcasting.*** :: Charisma-based. DC 19.
***At will.*** :: Detect Evil and Good, Invisibility (self)
***3/day each.*** :: Commune, Dispel Magic, Lesser Restoration
***1/day each.*** :: Blade Barrier, Commune with Nature, Greater Restoration, Heroes' Feast
***Magic Resistance.*** :: Advantage on saves vs. spells and magical effects.
***Threshold Sense.*** :: Automatically appears at moments of great destiny or choice. Cannot be summoned or controlled.
***Ethereal Sight.*** :: Can see into Ethereal Plane.
### Actions
***Multiattack.*** :: Makes two melee attacks.
***Starlight Mace.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft. ***Hit.*** 1d6+4 bludgeoning plus 4d8 radiant damage.::
***Healing Touch (3/Day).*** :: Touch one creature to heal 4d8+6 HP and end all diseases and poisons.
***Destiny's Weight.*** :: Shows target visions of possible futures based on their choice. Target makes DC 19 Wisdom save or gains Inspiration and disadvantage on all rolls for 1 minute as they process visions.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Teleport.** :: Teleports up to 120 ft.
**Healing Touch.** :: Uses Healing Touch if available.
**Divine Guidance (Costs 2).** :: Grants one ally advantage on next roll and resistance to all damage until start of next turn.
**Prophetic Vision (Costs 3).** :: Reveals one important truth about current situation to party.
...
### Connections
- **The Circle of Eight:** They have an arrangement. The details are unclear.
- **Sage Cornelius the Elder:** One of the few mortals who can communicate with it reliably
- **The Frost Witch:** Her connection to the Feywild makes her relevant to the Guardian's watch
...
2. **The Original Guardians:** There were others once. The Guardian is the last.
3. **The Coming Storm:** Senses something approaching through the planes. Has been quietly preparing countermeasures.
...
3. **Pattern Disruption:** The design it serves is being interfered with. Investigation and intervention required.
...
![Colony-Mind K'Thrax (Mind Flayer Elder Brain)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-colony-mind-kthrax.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 15 (+2) | 10 (+0) | 20 (+5) | 24 (+7) | 20 (+5) | 20 (+5) |
___
**Saving Throws** :: Intelligence +13, Wisdom +11, Charisma +11
**Skills** :: Arcana +13, Deception +11, Insight +11, Intimidation +11, Perception +11
**Damage Immunities** :: Psychic
**Condition Immunities** :: Charmed, Frightened, Prone
**Senses** :: Blindsight 120 ft., Passive Perception 21
**Languages** :: Telepathy 5 miles, Deep Speech, Undercommon
**Challenge** :: 18 (20,000 XP)
___
***Legendary Resistance (3/Day).*** :: If it fails a saving throw, it can choose to succeed instead.
***Magic Resistance.*** :: Advantage on saving throws against spells and magical effects.
***Telepathic Hub.*** :: Can communicate telepathically with any creature within 5 miles that has an Intelligence of 3 or higher.
***Innate Spellcasting (Psionics).*** :: DC 21. At will: detect thoughts, levitate; 3/day each: dominate monster, plane shift (self only).
### Actions
***Mind Blast (Recharge 5-6).*** :: 60-foot cone. DC 21 Int save or 5d10+5 psychic damage and stunned for 1 minute.
***Psychic Link.*** :: One creature within 120 ft. DC 21 Int save or dominated for 1 hour.
***Tentacle.*** :: Melee Weapon Attack: +8 to hit, reach 30 ft., one target. ***Hit.*** 3d8+2 bludgeoning damage plus 4d10 psychic damage.::
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Tentacle.** :: Makes one tentacle attack.
**Break Concentration.** :: Target creature within 120 ft. must succeed DC 21 Con save or lose concentration.
**Psychic Pulse (Costs 2).** :: Each creature within 60 ft. takes 3d10 psychic damage.
...
{{descriptive
#### Secrets (DM Only)
1. **The Thrall Network:** Has touched the dreams of at least forty surface dwellers, including three nobles and a Lightbringer captain. They don't know they're compromised.
...
![Morveth Shadowmane (Ancient Black Dragon)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-morveth-shadowmane.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
***Frightful Presence.*** :: DC 19 Wis save or frightened for 1 minute (120 ft.).
### Actions
***Multiattack.*** :: Frightful Presence, then one bite and two claws.
***Bite.*** :: Melee Weapon Attack: +15 to hit, reach 15 ft. ***Hit.*** 2d10+8 piercing plus 2d8 acid damage.::
***Claw.*** :: Melee Weapon Attack: +15 to hit, reach 10 ft. ***Hit.*** 2d6+8 slashing damage.::
***Tail.*** :: Melee Weapon Attack: +15 to hit, reach 20 ft. ***Hit.*** 2d8+8 bludgeoning damage.::
***Acid Breath (Recharge 5-6).*** :: 90-foot line, 15 ft. wide. DC 22 Dex save. 15d8 acid damage on failed save, half on success.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Detect.** :: Makes Perception check.
**Tail Attack.** :: Makes tail attack.
**Wing Attack (Costs 2).** :: Each creature within 15 ft. DC 23 Dex save or 2d6+8 bludgeoning and knocked prone. Dragon can fly up to half speed.
...
{{descriptive
#### Secrets (DM Only)
1. **The Current Disguise:** Currently poses as "Mother Marsh," an elderly healer in a village near Marshaven. Her "medicines" cause as many problems as they solve.
2. **The Morgana Project:** Has been visiting Morgana in dreams, suggesting improvements to her undead. The noblewoman thinks they're her own ideas.
3. **The Thornmire Heart:** The swamp's corruption centers on her lair, which sits on a corrupted ley line node. Cleansing it could heal the entire region.
...
3. **The Morgana Warning:** Someone needs to tell Lady Blackwater about her "dreams" before her experiments go too far.
4. **The Dragon Revealed:** Morveth's true form is spotted. Now she's hunting whoever saw her.
...
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 12 (+1) | 18 (+4) | 13 (+1) | 16 (+3) | 20 (+5) |
___
**Saving Throws** :: Wisdom +9, Charisma +11
**Skills** :: Athletics +11, Insight +9, Intimidation +11, Religion +7
...
**Challenge** :: 15 (13,000 XP)
___
***Divine Aura.*** :: Allies within 30 ft. gain +5 to saving throws.
***Divine Smite.*** :: Can expend spell slots to deal extra radiant damage (up to 5d8).
***Legendary Resistance (2/Day).*** :: Can choose to succeed on a failed save.
***Divine Health.*** :: Immune to disease.
### Actions
***Multiattack.*** :: Makes three attacks with Holy Avenger.
***Holy Avenger.*** :: Melee Weapon Attack: +14 to hit, reach 5 ft. ***Hit.*** 1d8+8 slashing plus 2d10 radiant damage.::
***Lay on Hands (100 points).*** :: Restores hit points by touch.
***Divine Light (Recharge 5-6).*** :: 60-foot radius. All undead and fiends take 8d8 radiant damage (DC 19 Con half).
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Attack.** :: Makes one weapon attack.
...
{{descriptive
#### Secrets (DM Only)
1. **The Living Spirit:** Radiant's spirit truly does exist, bound to the material plane by her duty. She can manifest to Lightbringers in crisis.
2. **The Unfinished Victory:** Maltharok wasn't destroyed—merely banished. Her death prevented the final blow. He's been gathering strength ever since.
3. **The Code's Hidden Meaning:** The Lightbringer code contains hidden wisdom, readable only by those who've proven worthy. Most members don't know it exists.
...
3. **Maltharok's Return:** The demon lord is stirring. Radiant's unfinished battle must be completed.
...
**Hit Points** :: 99 (18d8 + 18)
**Speed** :: 30 ft.
![Wizard Merrick the Wise (The Last Scholar)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-wizard-merrick-the-wise.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 9 (-1) | 14 (+2) | 12 (+1) | 22 (+6) | 18 (+4) | 14 (+2) |
___
**Saving Throws** :: Intelligence +12, Wisdom +10
**Skills** :: Arcana +12, History +12, Investigation +12
**Damage Resistances** :: Force
**Senses** :: Passive Perception 14
**Languages** :: Common, Draconic, Elvish, Primordial, Celestial, Infernal
**Challenge** :: 14 (11,500 XP)
___
***Spellcasting.*** :: 18th-level wizard. Spell save DC 20, +12 to hit.
***Cantrips.*** :: Fire Bolt, Light, Mage Hand, Prestidigitation, Ray of Frost
***Slots.*** :: 4/3/3/3/3/1/1/1/1
***Signature Spells.*** :: Counterspell, Dispel Magic, Teleport, Maze
***Arcane Recovery.*** :: Recovers spell slots on short rest.
***Spell Mastery.*** :: Can cast Shield and Misty Step at will.
### Actions
***Arcane Bolt.*** :: Ranged Spell Attack: +12 to hit, range 120 ft. ***Hit.*** 4d10 force damage.::
***Staff of Power.*** :: Melee Weapon Attack: +5 to hit, reach 5 ft. ***Hit.*** 1d6-1 bludgeoning plus 3d6 force damage.::
...
- **The Knowledge Crystals:** Scattered repositories of critical information
- **High Mage Celestine:** They were colleagues; he helped her escape during the Worldrend
- **Sage Cornelius:** One of the few living people who knows the library's location
...
{{descriptive
#### Secrets (DM Only)
1. **The Library Lives:** The Grand Library exists outside normal space, containing knowledge from before the Worldrend.
2. **The Destroyed Knowledge:** Merrick eliminated information about certain magical techniques and historical events. He had good reasons.
3. **The Crystal Network:** The knowledge crystals he scattered can be connected to form a complete picture of pre-Worldrend civilization.
...
3. **The Visitor's Knowledge:** Someone who visited the library centuries ago left clues about what they learned.
...
**Hit Points** :: 136 (16d10 + 48)
**Speed** :: 35 ft.
![Ranger-Lord Silvanus (Vampire Slayer)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-ranger-lord-silvanus.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 16 (+3) | 20 (+5) | 16 (+3) | 14 (+2) | 18 (+4) | 12 (+1) |
___
**Saving Throws** :: Strength +8, Dexterity +10, Wisdom +9
**Skills** :: Nature +7, Perception +9, Stealth +10, Survival +9
**Damage Resistances** :: Necrotic
**Senses** :: Darkvision 60 ft., Passive Perception 19
**Languages** :: Common, Elvish, Sylvan
**Challenge** :: 12 (8,400 XP)
___
***Favored Enemy (Undead).*** :: Advantage on Survival checks and +4 damage against undead.
***Natural Explorer.*** :: Ignores difficult terrain, advantage on initiative.
***Vampire Slayer.*** :: Attacks count as magical and silvered. Advantage against vampires.
***Hunter's Sense.*** :: Can detect undead within 120 ft.
### Actions
***Multiattack.*** :: Makes three attacks with longbow or two with silver stake.
***Longbow +2.*** :: Ranged Weapon Attack: +12 to hit, range 150/600 ft. ***Hit.*** 1d8+7 piercing plus 2d6 radiant damage.::
***Silver Stake.*** :: Melee Weapon Attack: +10 to hit, reach 5 ft. ***Hit.*** 1d6+5 piercing plus 4d6 radiant damage (8d6 vs vampires).::
***Hunter's Mark.*** :: Bonus action. Extra 1d6 damage per hit against marked target.
...
{{descriptive
#### Secrets (DM Only)
1. **Still Active:** Silvanus survived the coalition's attack, though barely. He's been rebuilding his strength for centuries, hunting in secret.
2. **The Curse's Burden:** He still requires blood to survive. He feeds only on criminals and monsters, but the hunger never truly fades.
3. **The Technique Legacy:** He's trained a small number of hunters over the centuries, passing on knowledge no book contains.
...
3. **The Lost Techniques:** Silvanus's hunting methods could transform the fight against undead. Finding someone he trained is the key.
...
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 14 (+2) | 20 (+5) | 16 (+3) | 14 (+2) | 20 (+5) | 16 (+3) |
___
**Saving Throws** :: Strength +7, Dexterity +10, Wisdom +10
**Skills** :: Acrobatics +10, Athletics +7, Insight +10, Stealth +10
**Damage Resistances** :: All (Empty Body)
**Condition Immunities** :: Charmed, Frightened, Poisoned
**Senses** :: Passive Perception 15
**Languages** :: Common, plus 3 others
**Challenge** :: 13 (10,000 XP)
___
***Ki (20 points).*** :: Fuels special abilities.
***Unarmored Defense.*** :: AC = 10 + Dex + Wis.
***Unarmored Movement.*** :: +30 ft. movement, can move on vertical surfaces and water.
***Evasion.*** :: No damage on successful Dex save.
***Stillness of Mind.*** :: End charmed or frightened as action.
***Tongue of Sun and Moon.*** :: Understands all languages, all can understand him.
***Empty Body.*** :: Invisible and resistant to all damage (4 ki).
***Perfect Self.*** :: Regains 4 ki if starting combat with none.
### Actions
***Multiattack.*** :: Makes four unarmed strikes.
***Unarmed Strike.*** :: Melee Weapon Attack: +10 to hit, reach 5 ft. ***Hit.*** 1d10+5 bludgeoning.::
***Stunning Strike (1 ki per strike).*** :: Target must DC 18 Con save or be stunned.
***Quivering Palm (3 ki).*** :: Sets up vibrations. Later, can kill target (DC 18 Con or drop to 0 HP).
...
- **Enlightened Students:** Those who've touched similar states through her teachings
...
{{descriptive
#### Secrets (DM Only)
1. **The Ascended State:** Serenity didn't die—she transcended, becoming a spiritual entity that can still interact with the devoted.
2. **The Cosmic Warning:** During her enlightenment, she received knowledge of a coming threat. She spent her life preparing defenses.
3. **The Forbidden Technique:** She developed a method for accelerated enlightenment. It's incredibly dangerous and hidden in her most secure teachings.
...
3. **The Cosmic Threat:** What she foresaw is approaching. Her preparations need to be activated.
...
![Demon Prince Maltharok (The Burning Legion)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-demon-prince-maltharok.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 26 (+8) | 16 (+3) | 22 (+6) | 20 (+5) | 18 (+4) | 24 (+7) |
___
**Saving Throws** :: Strength +15, Constitution +13, Wisdom +11, Charisma +14
**Skills** :: Deception +14, Intimidation +14, Perception +11
...
___
***Legendary Resistance (3/Day).*** :: Can choose to succeed on failed saves.
***Magic Resistance.*** :: Advantage on saves against spells.
***Magic Weapons.*** :: Attacks are magical.
***Fire Aura.*** :: Creatures starting turn within 10 ft. take 3d6 fire damage.
***Innate Spellcasting.*** :: DC 22. At will: detect magic, fireball, wall of fire; 3/day: fire storm, power word stun; 1/day: meteor swarm.
### Actions
***Multiattack.*** :: Makes two attacks with Hellfire Blade and one with tail.
***Hellfire Blade.*** :: Melee Weapon Attack: +15 to hit, reach 15 ft. ***Hit.*** 3d8+8 slashing plus 4d6 fire damage.::
***Tail.*** :: Melee Weapon Attack: +15 to hit, reach 20 ft. ***Hit.*** 2d10+8 bludgeoning. Target grappled (escape DC 23).::
***Summon Demons (1/Day).*** :: Summons 2d6 vrocks or 1d4 glabrezus.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Attack.** :: Makes one weapon attack.
**Teleport.** :: Teleports up to 120 ft.
**Fire Storm (Costs 2).** :: Casts Fire Storm.
...
{{descriptive
#### Secrets (DM Only)
1. **The Return Gate:** His cultists have been building a stable portal for decades. It's nearly complete.
2. **The Weakness:** Radiant's final blow left a permanent wound. Weapons blessed in her name deal enhanced damage to him.
3. **The Cult Network:** His followers have infiltrated major institutions—including, possibly, the Lightbringers themselves.
...
3. **The Blessed Weapons:** Radiant's relics could hurt Maltharok. Acquiring and preparing them becomes priority.
...
**Speed** :: 30 ft., fly 90 ft.
![Saint Celestine the Pure (The Ascended)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-saint-celestine-the-pure.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 18 (+4) | 20 (+5) | 18 (+4) | 24 (+7) | 26 (+8) |
___
**Saving Throws** :: Wisdom +13, Charisma +14
**Skills** :: Insight +13, Perception +13, Religion +10
...
___
***Legendary Resistance (3/Day).*** :: Can succeed on failed saves.
***Magic Resistance.*** :: Advantage on saves against spells.
***Divine Awareness.*** :: Knows if someone lies in her presence.
***Innate Spellcasting.*** :: DC 22. At will: detect evil and good, invisibility (self); 3/day: blade barrier, dispel evil and good, raise dead; 1/day: commune, resurrection.
### Actions
***Multiattack.*** :: Makes two attacks with Divine Blade.
***Divine Blade.*** :: Melee Weapon Attack: +11 to hit, reach 5 ft. ***Hit.*** 2d8+4 slashing plus 5d8 radiant damage.::
***Healing Touch (4/Day).*** :: Touches creature, restoring 8d8+4 HP and ending any curse, disease, poison, blindness, or deafness.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Teleport.** :: Teleports up to 120 ft.
**Divine Gaze (Costs 2).** :: Target within 60 ft. DC 22 Wis save or blinded and frightened until end of next turn. Fiends and undead also take 5d10 radiant damage.
**Healing Light (Costs 3).** :: Casts Mass Cure Wounds at 5th level.
...
{{descriptive
#### Secrets (DM Only)
1. **The Manifestation Cost:** Each physical appearance weakens her; too many in succession could destroy her permanently.
2. **The Plague Source:** She knows where supernatural plagues originate—a corrupted realm she cannot enter alone.
3. **The Healer's Network:** Those who receive her blessing form a psychic network she can access, though she rarely does without permission.
...
3. **The Weakening:** Too many crises have required her manifestation. She's fading and needs help to recover.
4. **The Network Vision:** Someone in her healer network has seen something important. Finding them requires investigation.
...
**Speed** :: 30 ft.
![Lord Garrett Blackwood (Founder of Blackwood)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lord-garrett-blackwood.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 14 (+2) | 16 (+3) | 14 (+2) | 18 (+4) | 14 (+2) | 18 (+4) |
___
**Saving Throws** :: Intelligence +8, Charisma +8
**Skills** :: Deception +12, History +8, Insight +6, Intimidation +8, Persuasion +8
**Senses** :: Darkvision 60 ft. (shadow-touched), Passive Perception 12
**Languages** :: Common, Infernal
**Challenge** :: 9 (5,000 XP)
___
***Shadow-Touched.*** :: Has darkvision 60 ft. Can cast Darkness (1/day) without components.
***Whispered Secrets.*** :: Advantage on Insight checks. Can cast Detect Thoughts (3/day).
***Cunning Action.*** :: Can Dash, Disengage, or Hide as bonus action.
***Sneak Attack (4d6).*** :: Extra damage with advantage or ally nearby.
### Actions
***Multiattack.*** :: Makes two attacks with rapier.
***Rapier +1.*** :: Melee Weapon Attack: +8 to hit, reach 5 ft. ***Hit.*** 1d8+4 piercing plus 1d6 necrotic damage.::
***Shadow Step.*** :: Teleports up to 60 ft. to a space in dim light or darkness. Has advantage on first attack before end of turn.
***Command (3/Day).*** :: DC 16 Wis save or follow one-word command.
### Reactions
***Uncanny Dodge.*** :: Halves damage from one attack he can see.
...
{{descriptive
#### Secrets (DM Only)
1. **The Patron's Identity:** The Whispering Patron was a fragment of something sealed during the Worldrend—something that wants to be whole again.
2. **The Curse's Nature:** Every Blackwood hears whispers in moments of crisis. Those who listen gain power but lose themselves. Those who resist often die young.
3. **The Hidden Journal:** Garrett's complete journals are hidden in Raven's Keep, detailing every murder and the patron's demands.
...
**Hit Points** :: 112 (15d8 + 45)
**Speed** :: 30 ft., swim 30 ft.
![Admiral Caspian Goldshore (Maritime Dynasty Founder)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-admiral-caspian-goldshore.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
**Skills** :: Athletics +7, Intimidation +7, Navigation +6, Perception +5, Persuasion +7
**Senses** :: Passive Perception 15
**Languages** :: Common, Aquan
**Challenge** :: 10 (5,900 XP)
___
***Sea Legs.*** :: Advantage on checks and saves to resist being knocked prone on ships.
***Admiral's Command.*** :: Allies within 30 ft. gain +2 to attack rolls on ships.
***Legendary Captain.*** :: Can take 3 legendary actions.
### Actions
***Multiattack.*** :: Makes three attacks with cutlass or two with pistol.
***Cutlass +2.*** :: Melee Weapon Attack: +10 to hit, reach 5 ft. ***Hit.*** 1d6+6 slashing plus 1d6 lightning (enchanted blade).::
***Flintlock Pistol.*** :: Ranged Weapon Attack: +8 to hit, range 30/90 ft. ***Hit.*** 1d10+4 piercing.::
***Rally the Crew (Recharge 5-6).*** :: Each ally within 60 ft. gains 15 temporary HP and advantage on attacks until end of next turn.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Attack.** :: Makes one weapon attack.
**Command.** :: One ally within 60 ft. can make an attack as reaction.
**Tactical Repositioning (Costs 2).** :: Up to 3 allies can move up to half their speed without provoking opportunity attacks.
...
3. **The Deep Contact:** The things Caspian bargained with want to renegotiate. The party might be intermediaries.
...
![High Mage Celestine Starweaver (Arcane Dynasty)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-high-mage-celestine-starweaver.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 14 (+2) | 14 (+2) | 24 (+7) | 18 (+4) | 16 (+3) |
___
**Saving Throws** :: Intelligence +13, Wisdom +10
...
**Challenge** :: 17 (18,000 XP)
___
***Spellcasting.*** :: 20th-level wizard. Spell save DC 21, +13 to hit.
***Arcane Mastery.*** :: Can cast Shield and Counterspell without slots (3/day each).
***Signature Spells.*** :: Meteor Swarm, Time Stop, Wish (1/day each).
***Spell Weaving.*** :: Can combine two spells of 3rd level or lower into one action.
### Actions
***Arcane Lance.*** :: Ranged Spell Attack: +13 to hit, range 120 ft. ***Hit.*** 6d10 force damage.::
***Staff of the Magi.*** :: Melee Weapon Attack: +6 to hit, reach 5 ft. ***Hit.*** 1d6 bludgeoning plus 4d10 force damage.::
***Power Word Kill (1/Day).*** :: Target with fewer than 100 HP dies.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Cantrip.** :: Casts a cantrip.
**Teleport.** :: Teleports up to 60 ft.
**Spell (Costs 2).** :: Casts a spell of 5th level or lower.
...
**Speed** :: 30 ft.
![Matriarch Seraphina Silverleaf (The Ancient Elf)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-matriarch-seraphina-silverleaf.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 10 (+0) | 16 (+3) | 16 (+3) | 20 (+5) | 22 (+6) | 20 (+5) |
___
**Saving Throws** :: Intelligence +11, Wisdom +12, Charisma +11
**Skills** :: Arcana +11, History +11, Insight +12, Nature +11, Perception +12
**Damage Resistances** :: Necrotic, Psychic
**Condition Immunities** :: Charmed, Frightened
**Senses** :: Darkvision 120 ft., Passive Perception 22
**Languages** :: Common, Elvish, Sylvan, Celestial, Primordial, Draconic
**Challenge** :: 15 (13,000 XP)
___
***Ancient Knowledge.*** :: Knows all history of elves and can cast Legend Lore at will.
***Fey Ancestry.*** :: Immune to magical sleep, advantage against charm.
***Ageless.*** :: Doesn't age and can't be aged magically.
***Spellcasting.*** :: 15th-level druid/wizard. DC 20, +12 to hit.
***Innate Spells.*** :: At will: druidcraft, speak with plants; 3/day: awaken, commune with nature, scrying.
### Actions
***Staff of the Woodlands.*** :: Melee Weapon Attack: +9 to hit, reach 5 ft. ***Hit.*** 1d6+3 bludgeoning plus 2d8 radiant damage.::
***Nature's Wrath (Recharge 5-6).*** :: 60-foot radius. DC 20 Dex save or restrained by grasping plants. 4d10 piercing damage.
***Summon Ancient Treant (1/Day).*** :: Summons a treant that serves for 1 hour.
...
**Speed** :: 25 ft.
![Thane Durgan Ironforge (Mountain Lord)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-thane-durgan-ironforge.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 20 (+5) | 12 (+1) | 20 (+5) | 14 (+2) | 16 (+3) | 16 (+3) |
___
**Saving Throws** :: Strength +11, Constitution +11, Wisdom +9
**Skills** :: Athletics +11, History +8, Intimidation +9, Perception +9
...
***Stone Cunning.*** :: Advantage on History checks related to stonework.
***Mountain Lord.*** :: Allies within 30 ft. gain resistance to bludgeoning damage.
***Indomitable (3/Day).*** :: Can reroll a failed saving throw.
### Actions
***Multiattack.*** :: Makes three attacks with warhammer.
***Warhammer +3 (Defender).*** :: Melee Weapon Attack: +14 to hit, reach 5 ft. ***Hit.*** 1d8+8 bludgeoning plus 1d8 thunder damage. Can transfer up to +3 to AC instead of attack.::
***Shield Bash.*** :: Melee Weapon Attack: +11 to hit, reach 5 ft. ***Hit.*** 1d4+5 bludgeoning. Target DC 19 Str save or knocked prone.::
***Rally the Clan (1/Day).*** :: Each dwarf ally within 60 ft. gains 20 temporary HP and advantage on all attacks for 1 minute.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Attack.** :: Makes one weapon attack.
**Bolster.** :: One ally within 30 ft. gains +2 AC until start of Durgan's next turn.
**Earthshaker (Costs 2).** :: Each creature within 20 ft. DC 19 Dex save or knocked prone and 4d8 bludgeoning damage.
...
3. **The Armory Access:** Durgan's legendary weapons might be needed. Retrieving them requires his ghost's permission.
...
**Speed** :: 30 ft.
![Lord Aldric Blackwood (The Rebel)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lord-aldric-blackwood.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
**Hit Points** :: 91 (14d8 + 28)
**Speed** :: 30 ft.
![Lady Corvina Blackwood (The Survivor)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lady-corvina-blackwood.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
**Speed** :: 30 ft.
![King Thandris V (The Dragon's Debtor)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-king-thandris-v.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 12 (+1) | 18 (+4) | 16 (+3) | 14 (+2) | 18 (+4) |
___
**Saving Throws** :: Strength +9, Constitution +9, Wisdom +7, Charisma +9
**Skills** :: Athletics +9, History +8, Insight +7, Intimidation +9, Persuasion +9
**Damage Resistances** :: Fire (dragon blessing)
**Senses** :: Passive Perception 12
**Languages** :: Common, Draconic
**Challenge** :: 13 (10,000 XP)
___
***Dragon's Bargain.*** :: Has resistance to fire and can speak Draconic. However, bound by oath to dragon Infernalix.
***Royal Authority.*** :: Advantage on Charisma checks when in his realm.
***Action Surge (1/Rest).*** :: Can take additional action.
***Indomitable (2/Rest).*** :: Can reroll failed save.
### Actions
***Multiattack.*** :: Makes three attacks with Dragon's Fang.
***Dragon's Fang (Longsword +2).*** :: Melee Weapon Attack: +11 to hit, reach 5 ft. ***Hit.*** 1d8+6 slashing plus 2d6 fire damage.::
***Command (3/Day).*** :: DC 17 Wis save or follow one-word command.
***Summon Dragon Fire (1/Day).*** :: 60-foot cone. DC 17 Dex save. 8d6 fire damage on failed save, half on success.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Attack.** :: Makes one weapon attack.
**Royal Command.** :: One ally within 60 ft. can attack as reaction.
...
{{descriptive
#### Secrets (DM Only)
1. **The True Terms:** Thandris promised the dragon his bloodline's service when the bargain came due. Every living Thandris will feel compelled to serve Infernalix.
2. **The Loophole Attempt:** Thandris spent years trying to find a way out of the bargain. His notes suggest possibilities but no solutions.
3. **The Contingency:** He created something—a weapon, a ritual, a failsafe—hidden somewhere in Kaer Thandros. Finding it requires understanding his journals.
...
3. **The Warning Signs:** The activation signs are appearing. Understanding what they mean requires investigation.
...
**Hit Points** :: 136 (16d8 + 64)
**Speed** :: 30 ft.
![Lord Emberthorn the Defiant (The Martyr)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-lord-emberthorn-the-defiant.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
| 18 (+4) | 10 (+0) | 18 (+4) | 12 (+1) | 16 (+3) | 18 (+4) |
___
**Saving Throws** :: Wisdom +8, Charisma +9
**Skills** :: Athletics +9, History +6, Insight +8, Persuasion +9, Religion +6
**Damage Immunities** :: Fire (martyr's blessing)
**Condition Immunities** :: Frightened
**Senses** :: Passive Perception 13
**Languages** :: Common, Celestial
**Challenge** :: 12 (8,400 XP)
___
***Martyr's Blessing.*** :: Immune to fire. When reduced to 0 HP, explodes in holy fire (30 ft., 8d8 radiant, DC 17 Dex half) and is truly dead.
***Defiant Stand.*** :: When below half HP, gains +2 to attack and damage rolls.
***Aura of Courage.*** :: Allies within 30 ft. can't be frightened.
***Divine Smite.*** :: Can deal extra 2d8 radiant damage on hit (5/day).
### Actions
***Multiattack.*** :: Makes three attacks with flaming sword.
***Flaming Greatsword +1.*** :: Melee Weapon Attack: +10 to hit, reach 5 ft. ***Hit.*** 2d6+5 slashing plus 2d6 fire damage.::
***Lay on Hands (50 points).*** :: Restores HP by touch.
***Burning Sacrifice (1/Day).*** :: Takes 30 fire damage (can't be reduced). All allies within 60 ft. regain 30 HP and gain advantage on attacks for 1 minute.
...
**Speed** :: 40 ft., fly 80 ft.
![Dragon Infernalix (The Vanished Flame)](https://raw.githubusercontent.com/mixologee/tirvandor/main/tirvandor-project/core-rules/dungeon-masters-guide/images/npcs/tirvandor-npc-dragon-infernalix.jpg){width:325px,mix-blend-mode:multiply}
___
|STR|DEX|CON|INT|WIS|CHA|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
___
***Legendary Resistance (3/Day).*** :: Can succeed on failed saves.
***Vanishing Flame.*** :: Can become invisible and intangible as an action (concentration, up to 1 hour). Can't attack while vanished.
***The Debt.*** :: Bound by ancient pact to House Thandris. Can't directly harm the ruling Thandris.
### Actions
***Multiattack.*** :: Frightful Presence, then one bite and two claws.
***Bite.*** :: Melee Weapon Attack: +17 to hit, reach 15 ft. ***Hit.*** 2d10+10 piercing plus 4d6 fire damage.::
***Claw.*** :: Melee Weapon Attack: +17 to hit, reach 10 ft. ***Hit.*** 2d6+10 slashing.::
***Tail.*** :: Melee Weapon Attack: +17 to hit, reach 20 ft. ***Hit.*** 2d8+10 bludgeoning.::
***Frightful Presence.*** :: DC 21 Wis save or frightened (120 ft.).
***Fire Breath (Recharge 5-6).*** :: 90-foot cone. DC 24 Dex save. 26d6 fire damage on failed save, half on success.
### Legendary Actions
Can take 3 legendary actions, choosing from options below. Only one legendary action can be used at a time and only at end of another creature's turn. Regains spent legendary actions at start of turn.
**Detect.** :: Makes Perception check.
**Tail Attack.** :: Makes tail attack.
**Wing Attack (Costs 2).** :: DC 25 Dex save or 2d6+10 bludgeoning and knocked prone. Dragon flies up to half speed.
**Vanish (Costs 3).** :: Activates Vanishing Flame ability.
...
# Part V: DM Tools
# Chapter 9: Creating Custom Content

## Creating Creatures

### Step-by-Step

1. Choose Base Stat Block:
Find existing creature that's close to your concept.

2. Modify:
- Change damage types
- Adjust HP (±20% keeps same CR)
- Adjust AC (±2 keeps same CR)
- Add/remove abilities

3. Reflavor:
Change appearance and description, keep mechanics.

Example:
Base: Thug (CR 1/2)
Concept: Thaldros Soldier
Changes: +2 HP, add spear, replace Intimidation with Athletics
Reflavor: Military uniform, disciplined tactics
...
|----|-----|-----|--------------|--------------|---------|
| 0 | 13 | 1-6 | +3 | 0-1 | 13 |
| 1/4 | 13 | 7-35 | +3 | 2-3 | 13 |
| 1/2 | 13 | 36-49 | +3 | 4-5 | 13 |
| 1 | 13 | 71-85 | +3 | 6-8 | 13 |
| 2 | 13 | 86-100 | +3 | 9-14 | 13 |
| 3 | 13 | 101-115 | +4 | 15-20 | 13 |
| 4 | 14 | 116-130 | +5 | 21-26 | 14 |
| 5 | 15 | 131-145 | +6 | 27-32 | 15 |
| 6-20 | (See DMG p.274) | | | |
...
By Level:
- Cantrip: 1d8-1d10 damage, minor utility
- 1st: 2d6-3d6 damage, significant utility
...
- Material: Requires object (consumed if expensive)

Duration:
- Instantaneous: Happens immediately
- Concentration: Up to duration if concentrating
- Non-concentration: Lasts full duration

Range:
- Touch: Must touch target
- 30-120 ft: Most common
- Self: Only affects caster
- Sight: Can see target anywhere
...
Casting Time: [1 action, 1 bonus action, 1 minute, etc.]
Range: [Touch, 30 ft, etc.]
Components: [V, S, M (materials)]
Duration: [Instantaneous, Concentration up to X, X minutes, etc.]

Description: What the spell does.

At Higher Levels: How spell improves when cast at higher slot.
...
[Item Name]
*[Type], [Rarity] (requires attunement by [restrictions if any])*

Properties:
- List mechanical benefits
...
- Deals extra 1d6 damage to members of opposing faction (Thaldros or Aethoria)
- Blade remembers all it has slain (DM tracks)

Description:
This steel blade has names etched along its length - soldiers killed in border conflicts. Each kill adds another name in glowing script.
...
Effect: DC 10 Constitution save each hour or gain one exhaustion level.
Protection: Cold weather gear, endure elements spell, or natural resistance.
Tirvandor: Mountains, northern regions in winter.

### Extreme Heat

Effect: DC 10 Constitution save each hour (no water) or DC 5 (with water) or gain exhaustion.
Protection: Water, shade, endure elements spell.
Tirvandor: Sundara desert, Border wastelands in summer.

### Falling

Damage: 1d6 per 10 feet, maximum 20d6 (200 feet).
Reaction: Can attempt DC 15 Dexterity save to grab ledge if within 5 feet.
Water: Half damage if falling into water from 60+ feet.

### Drowning

Hold Breath: Minutes equal to 1 + Con modifier (minimum 30 seconds).
After: Death saves each round until air or death.

### Poison and Disease

Poison Types:
- Contact: Touch exposed skin
- Ingested: Swallowed
- Inhaled: Breathed in
- Injury: Through wound

Effect: Constitution save, various effects on failure.

Diseases: Require Constitution saves to recover, magic can cure.
...
Stage 1: Touched (DC 15 Wis save/day to avoid advancing)
- Physical: Eye color shifts, skin temperature changes
- Mental: Advantage on saves vs fear
- Penalty: Disadvantage on Wisdom saves
- Mechanical: +10 max HP
- Cure: Remove Curse

Stage 2: Corrupted (DC 10 Wis save/day, auto-advance in 1 week)
- Physical: Tentacles, extra eyes, unnatural growths
- Mental: Personality traits fade, aggression increases
- Penalty: Automatically fail Wisdom saves
- Mechanical: Additional +20 max HP
- Cure: Greater Restoration + Remove Curse
...
Collapsing Ceiling:
- Trigger: Remove treasure
- Effect: 4d10 bludgeoning, DC 15 Dex save for half, fills room with rubble
- Detect: DC 20 Perception
- Disarm: DC 20 Sleight of Hand or Arcana (magical trigger)

### Deadly Traps (CR 11+)

Sphere of Annihilation:
- Trigger: Specific word spoken
- Effect: 4d10 force damage, DC 20 Dex save or disintegrated
- Detect: DC 25 Arcana (magical sense)
- Disarm: Dispel Magic (DC 19) or Disintegrate

---

## Using This Chapter

Reference when creating custom content. Balance is approximate - playtest and adjust. The goal is fun, not perfect balance.
-e 
...
# Chapter 10. Faction Strongholds

## Gaining a Stronghold

At level 5 or higher, characters with Faction Influence +8 or higher can establish or be granted a stronghold by their faction.

Requirements:
- Character level 5+
- Faction Influence +8 or higher with a major faction
- Initial investment (5,000-50,000 gp depending on type)
- Faction approval/quest completion
...
Size: Garrison for 50-100 soldiers

Features:
- Fortified walls (AC 19, 500 HP)
- Armory (equipment for 100 soldiers)
- Training grounds
- Barracks
- Command center
- Supply depot
...
Benefits:
- Train militia (+10 soldiers per month, max 100)
- Military intelligence (advantage on checks about enemy movements)
- Requisition equipment (20% discount on weapons/armor)
- Safe rest for party and allies
- Faction missions (+2 bonus to Faction Influence from military quests)

Complications:
- Target for Resistance raids (roll d20 monthly: 1-3 = attack)
- Supply chain issues
- Desertion problems
- Command disputes
...
### Resistance Safehouse (Aethoria Resistance)
...
- False identities workshop

Benefits:
- Information network (advantage on Investigation/Insight in region)
- Smuggling access (move goods/people past checkpoints)
- Safe houses in nearby settlements
- Resistance contacts (+1d4 allies available per session)
- Faction missions (+2 bonus to Faction Influence from covert ops)

Complications:
- Discovery risk (Thaldros Intelligence checks monthly)
...
### Guild Hall (Iron Guild)

Cost: 30,000 gp initial, 400 gp/month maintenance
Location: Border towns, trade hubs
Size: Workshop + storage + living quarters

Features:
- Master workshop
- Extensive storage
- Meeting rooms
- Living quarters (10-15 members)
- Vault (secure storage)
- Training facilities

Benefits:
- Crafting facilities (craft items at 50% time/cost)
- Trade contacts (buy/sell at 10% better rates)
- Contract board (1d4 mercenary jobs per week)
- Guild resources (borrow up to 5,000 gp, repay within month)
- Faction missions (+2 bonus to Faction Influence from guild contracts)

Complications:
- Rival guild interference
...
Cost: 20,000 gp initial, 250 gp/month maintenance
Location: Towns, cities, pilgrimage sites
Size: Chapel + library + healing ward
...
- Meditation gardens
- Reliquary
- Living quarters (10-15 clergy)

Benefits:
- Free healing (cure wounds 1/day per party member)
- Divine research (access to religious texts, advantage on Religion checks)
- Sanctuary (safe rest, enemy must make DC 18 Wisdom save to attack)
- Pilgrim donations (100-500 gp per month)
- Faction missions (+2 bonus to Faction Influence from church quests)
...
Cost: 50,000 gp initial, 1,000 gp/month maintenance
Location: Cities, productive lands
Size: Manor + grounds + farmland

Features:
- Manor house
- Servant quarters (20-30 staff)
- Stables
- Gardens
- Farmland or income property
- Guard posts

Benefits:
- Income (500-2,000 gp per month from rents/trade)
- Political influence (advantage on Persuasion with nobility)
- Staff (butler, servants, guards)
- Social events (host gatherings for political benefit)
- Faction missions (+2 bonus to Faction Influence from noble quests)
...
# Chapter 11. Encounter Building: Creating Balanced, Memorable Encounters

---

## Encounter Basics

Encounter: Any scene where players face meaningful challenge: combat, social interaction, exploration puzzle, or environmental hazard.
...
| Roll | Result |
|-----|--------|
| 1 | Determine Party Level: Average level of all PCs |
| 2 | Count Players: Number of PCs (adjust for NPCs) |
| 3 | Find XP Threshold: |
...
| 4 | 125 | 250 | 375 | 500 |
| 5 | 250 | 500 | 750 | 1,100 |
| 6-10 | Multiply by level | x2 | x3 | x4 |
| 11-15 | Multiply by level | x3 | x4.5 | x6 |
| 16-20 | Multiply by level | x4 | x6 | x8 |

4. Select Monsters: Add up monster XP until you reach threshold
Example:
- Party: 4 PCs, level 5
...
Difficult Terrain:
- Rubble, mud, thick vegetation
- Costs 2 feet of movement per 1 foot moved
- Use for 25-50% of battlefield

Cover:
- Half cover: +2 AC, +2 Dex saves
- Three-quarters cover: +5 AC, +5 Dex saves
- Full cover: Can't be targeted
- Place cover strategically for both sides

High Ground:
- Advantage on melee attacks from high ground
- Disadvantage on attacks from low ground
- Changes tactical positioning

Hazards:
- Pits (10-30 feet deep, 1d6/10 feet fall damage)
- Lava/fire (2d10 fire per turn)
- Acid pools (2d6 acid per turn)
- Unstable floors (DC 15 Dex save or fall through)

Interactive Elements:
- Chandeliers to drop (2d10 damage, DC 15 Dex save)
- Pillars to collapse (creates cover or blocks path)
...
Kill Zone: Open area, no cover (dangerous to cross)
Defensive Positions: Cover and high ground
Objective Point: Important location (prisoner, artifact, control point)
Hazard Zone: Environmental danger
...
- Fight to defend territory/young
- Flee when bloodied (50% HP)
- Simple tactics
- Use natural abilities

Undead:
- No morale, fight to destruction
- Mindless: attack nearest
- Intelligent: tactical, use abilities
- No self-preservation unless commanded
...
Ideal combat: 3-5 rounds

Too Short (1-2 rounds):
...
- Players bored
- Slog, not challenge
- Resource drain without payoff

Extending Combat:
- Reinforcements arrive (round 3)
- Environment changes
- Boss transforms/powers up
- New objective appears

Ending Combat:
- Enemies retreat (not every fight to death)
- Players achieve objective (don't need to kill everything)
- Environmental change forces end
- Negotiation mid-combat
...
Setup: Establish NPC goals and stakes
Roleplay: Players interact, make checks
...
Indifferent NPC: DC 10-15 (medium)
Friendly NPC: DC 5-10 (easy)
Helpful NPC: DC 5 or auto-succeed

### Success Levels

Critical Success (beat DC by 10+): Major concession, enthusiasm
Success: Get what you want
Partial Success (miss by 1-5): Get something, with condition
Failure: Refuse, worsen relationship
Critical Failure (fail by 10+): Insult, permanent damage

### Multiple Participants

Aid Another: DC 10 check grants advantage to lead player
Different Approaches: Each player can try once with different skill
Group Check: All participate, majority determines outcome
...
Good Puzzles:
- Have logical solution
- Multiple approaches possible
- Can be solved with info/clues
...
- Always have bypass option (break door, find key, etc.)
...
- Escalating danger
- Initiative rolls
- Requires multiple actions to disable

---

## Mixed Encounters

Combine encounter types:

Combat + Social:
- Negotiate while fighting
- Convince enemy to switch sides
- Intimidate to surrender

Combat + Exploration:
- Environmental puzzles during combat
- Need to activate device while defending
- Chase through dangerous terrain

Social + Exploration:
- Gather info while investigating
- Persuade NPC to reveal secret location
- Deceive guards while searching

---

## Dynamic Encounters

Make encounters evolve:
...
- If players kill guards quietly: alarm not raised

Consequences:
- Quick victory: Surprise next enemies
- Slow victory: Enemies prepared
- Retreat: Enemies regroup, harder next time
- Creative solution: Bypass combat entirely
...
- 1 rest/roleplay scene

Per Arc, Include:
- Several easy combats (build confidence)
...
- All combat, no variety
- Identical encounters repeated
...
Mechanics:
- Dash action each turn
- Athletics/Acrobatics checks to navigate obstacles
- Quarry gets 60-foot head start
- Ends when caught or escaped (5 rounds ahead)

### Stealth Mission

Mechanics:
- Group Stealth check
- Failure: Spotted (not immediate combat)
- Complications: Patrols, alarms, locked doors
- Success levels: Clean (undetected), Messy (detected after), Compromised (alerted)

### Siege

Mechanics:
- Attackers need to breach defenses
- Defenders hold position
- Siege weapons, battering rams
...
- DC 15 Wisdom save or take 1d6 psychic + corruption stage
- Corrupted terrain (difficult terrain, hazards)
- Must complete objective before corruption spreads
- Success: Seal breach, failure: evacuation

---

## Balancing for Party Size

Adjusting Difficulty:

Small Party (2-3 PCs):
- Reduce monster count by 1-2
- Or: Lower monster HP by 25%
- Give friendly NPC ally

Large Party (6+ PCs):
- Add 1-2 monsters per extra PC
- Or: Increase monster HP by 25%
- Add battlefield complications

Mixed Levels:
- Calculate XP for each PC separately
...
- Enemies: 1 Bandit Captain (CR 2), 4 Bandits (CR 1/8 each)
...
- NPC: Warlord Karash (hostile, DC 20)
- Stakes: Safe passage through territory vs tribute/service
- Complications: Warlord's advisor (friendly, can help), warlord's rival (wants him overthrown)
- Multiple Approaches: Intimidation (show force), Persuasion (mutual benefit), Deception (false promise), Insight (leverage secret)
- Outcomes: Full cooperation, limited cooperation, tribute demanded, combat

---

Well-designed encounters create memorable moments and challenge players meaningfully without overwhelming or boring them.
...
|------|-----------|--------|
| Fast | 30 miles | -5 penalty to Passive Perception |
| Normal | 24 miles | Normal Perception |
| Slow | 18 miles | Can use Stealth |

Modifiers:
- Mounted: +50% distance
- Road/path: No penalty
- Difficult terrain: Half distance
- Forced march: +8 hours = +8 miles, DC 10+hours Constitution save or exhaustion

### Time Tracking

Travel Time = Distance ÷ Daily Miles

Example: 120 miles at normal pace = 5 days

Hourly Breakdown:
- 8 hours travel
- 1 hour breaks (spread throughout day)
- 1 hour setting camp
- 8 hours rest (6 sleep + 2 watch)
- 6 hours other (foraging, exploring, etc.)
...
When to Check:
- No clear path/road
- Poor visibility (fog, storm, night)
- Confusing terrain (forest, swamp)

Check: Wisdom (Survival) DC varies by terrain

| Terrain | DC | Frequency |
|---------|-----|-----------|
| Road/trail | Auto-succeed | Never lost |
| Plains, coast | DC 10 | Once per day |
...
Failure: Off course by 1d6 miles in random direction

Advantages:
- Ranger in favored terrain: Auto-succeed
...
Creating Map:
- Passive Perception 15+: Accurate map
- Passive Perception 10-14: Rough map
- Below 10: Inaccurate map

Using Existing Map:
- Quality map: Advantage on navigation
- Rough map: No bonus/penalty
- Outdated map: Disadvantage
...
Activity: 1 hour while traveling, or dedicated effort

Check: Wisdom (Survival) DC varies by terrain

| Terrain | DC | Food/Water per Success |
|---------|----|-----------------------|
| Abundant (forest, coast) | DC 10 | 1d6 rations |
| Moderate (plains, hills) | DC 15 | 1d4 rations |
| Scarce (desert, mountains) | DC 20 | 1d2 rations |
| Barren (wasteland) | DC 25 | 1 ration |

Modifiers:
- Proficiency in Nature: Advantage
- Ranger: Advantage in favored terrain
- Druid: Advantage anywhere natural
- Spring/Summer: +5 food
- Fall: Normal
- Winter: -5 food, only preserved food

### Hunting

Activity: 4 hours minimum

Check: Wisdom (Survival) to track, Dexterity (Stealth) to approach, attack to kill

Success:
- Small game: 1d4 rations
- Medium game: 2d6 rations
- Large game: 4d6 rations

Complications:
- Attract predators
- Encounter territorial creatures
- Spring trap
...
Finding Water:
- River, lake, stream: Auto-succeed
- Forest, jungle: DC 10
- Plains: DC 15
...
- Purify Food and Drink spell: Safe
- Alchemy kit: DC 15, makes safe
...
| 1-12 | Clear |
| 13-15 | Overcast |
| 16-17 | Light rain/snow |
| 18-19 | Heavy rain/snow |
| 20 | Extreme weather |
...
| 9 | Supernatural Storm: Primordial-influenced, random magic effects |
...
- Light clothing: Advantage

### Weather and Travel

Clear: Normal travel
Overcast: Normal travel
Light Rain/Snow: Normal travel, disadvantage on Perception
Heavy Rain/Snow: Difficult terrain, lightly obscured
Extreme Weather: Half speed or stop, heavily obscured, additional effects
...
Quicksand:
- DC 10 Wisdom (Survival) to spot
- Enter: DC 10 Strength save or restrained, sinking
- Escape: DC 15 Strength check, advantage if helped
- Sink completely: 1d4 rounds, then suffocating

Avalanche/Rockslide:
- Warning: DC 15 Perception
- Avoid: DC 15 Dexterity save or buried
- Buried: 1d6 bludgeoning per round, suffocating
- Dig out: DC 15 Strength, 1 minute per 5 feet

Cliff Fall:
- Spot edge: DC 10 Perception
- Avoid: DC 10 Dexterity save
- Fall: 1d6 per 10 feet (max 20d6)
- Catch self: DC 15 Strength or Dexterity

Forest Fire:
- Smoke: Lightly obscured, DC 12 Constitution save or poisoned
- Flames: 2d10 fire damage per round
- Spread: 30 feet per round in direction of wind
- Escape: Outrun or find water

Sinkhole:
- DC 15 Perception to notice
- Collapse: 30-foot diameter, 40 feet deep
- Fall: 4d6 bludgeoning
- Climb out: DC 15 Athletics, 10 minutes
...
- Escape: Leave area (corruption stops advancing)

Ley Line Nexus:
- Wild Magic: Spells trigger surge (d20, 1-3 = surge)
- Enhanced Magic: +1 spell attack, +1 save DC
...
- Madness risk: DC 15 Wisdom save or short-term madness

Border Badlands:
- Radiation: DC 12 Constitution save per day or exhaustion
- Mutated creatures: Hostile, aggressive
- No natural food/water
- Equipment degradation: 10% chance per day item damaged
...
Roll d20 once per travel segment (morning, afternoon, night):

| d20 | Result |
|-----|--------|
| 1-15 | No encounter |
| 16-17 | Minor encounter |
| 18-19 | Standard encounter |
| 20 | Major encounter |
...
| Roll | Result |
|-----|--------|
| 1 | Hostile Creatures: Combat |
| 2 | Neutral Creatures: May interact or ignore |
| 3 | Friendly NPCs: Information, trade, quest |
| 4 | Environmental Hazard: Natural danger |
| 5 | Discovery: Interesting location or item |
| 6 | Faction Patrol: Social/combat depending on relations |


### Encounter Tables by Region

#### Thaldros Mainland (d12)


| d6 | Result |
|-----|--------|
| 1 | Military patrol (2d6 soldiers) |
| 2 | Tax collectors (4 guards, 1 official) |
| 3 | Refugees (2d6 civilians) |
| 4 | Bandits (1d6+2 bandits) |
| 5 | Wild beasts (1d4 wolves/bears) |
| 6 | Traveling merchant (1 merchant, 2 guards) |
| 7 | Pilgrims (1d6 civilians) |
| 8 | Deserters (1d4 soldiers, desperate) |
...
| Roll | Result |
|-----|--------|
| 1 | Resistance scouts (2d4 scouts) |
| 2 | Thaldros raiders (1d6+2 soldiers) |
| 3 | Guerrilla fighters (1d6 resistance) |
| 4 | Refugees fleeing (2d6 civilians) |
| 5 | Wild beasts (1d4 wolves/bears) |
| 6 | Smugglers (1d6 smugglers) |
| 7 | Villagers suspicious of strangers (1d8 militia) |
| 8 | Resistance supply caravan (2d4 soldiers) |
...
| Roll | Result |
|-----|--------|
| 1 | Iron Guild patrol (2d4 mercenaries) |
| 2 | Bandits (2d6+2 bandits) |
| 3 | Deserters from both sides (1d8 desperate soldiers) |
| 4 | Refugees (2d6 civilians) |
| 5 | Slavers (1d6 slavers, 1d4 prisoners) |
| 6 | Treasure hunters (1d4 adventurers) |
| 7 | Mutated creatures (1d6 corrupted beasts) |
| 8 | Nomads (1d8 nomads, traders) |
...
Time: 1 hour to set up, 1 hour to break down

Requirements:
- Shelter (tent or natural)
- Fire (if cold or cooking)
- Watch schedule
- Security perimeter
...
8-hour Long Rest:
- 6 hours sleep
- 2 hours light activity (watch)

Watch Rotation:
- 4 PCs: 2-hour watches each
- 3 PCs: 2 sleep, 1 watch, rotate
- 2 PCs: 4-hour watches each (exhausting)
- 5+ PCs: Multiple watches, some sleep full 8 hours

### Camp Security

Perception Checks:
- On watch: Active Perception
- Sleeping: Passive Perception -5

Spotting Threats:
- Stealthy approach: Contested (enemy Stealth vs watcher Perception)
- Obvious threat: Automatic

Camp Improvements:
- Alarm spell: Alerts when entered
- Tiny hut: Protection from elements/attacks
- Traps/caltrops: 1d4 damage, alert
- Concealment: Advantage on Stealth to hide camp

### Interrupted Rest

Short Rest (1 hour):
- Interrupted: Lose benefit, no healing

Long Rest (8 hours):
- Interrupted <1 hour: Continue rest
- Interrupted >1 hour: Must start over
...
Food Requirements: 1 pound per day

Missed Days:
- 3 + Constitution modifier days without food: 0 HP
- Each day after: Auto-fail death saves (can't be stabilized)

Half Rations: After (3 + Con mod) days, counts as no food

### Dehydration

Water Requirements: 1 gallon per day (2 in hot weather)

Missed Days:
- After 1 day: 1 level exhaustion
- Each additional day: +1 exhaustion

Half Water: Disadvantage on Strength/Constitution checks
...
Recovery: 1 level removed per long rest (with food and water)
...
Mechanics:
- Incubation: 1d4 days
- Onset: Constitution save (DC varies)
- Failure: Disease effects
- Recovery: Save each long rest, 3 successes cured

Example Diseases:

Sewer Plague:
- DC 12 Constitution save
- Fatigue (1 exhaustion) + can't regain HP
- Recovery: 3 successful saves

Border Rot (Tirvandor-Specific):
...
## Wilderness Survival Tips for DMs

Keep It Moving:
- Don't track every ration and water
- Abstract unless relevant
- Skip boring travel days

Make It Matter:
- Use encounters to advance story
- Weather affects plans
- Resource scarcity creates tension

Player Agency:
- Let rangers/druids shine
- Reward preparation
- Allow creative solutions

Balance:
- Not every journey needs complications
- Save challenges for dramatic moments
...
| d20 | Weather | Effect |
|-----|---------|--------|
| 1-12 | Clear | Normal travel |
| 13-15 | Overcast | Normal travel |
| 16-17 | Light rain/snow | Disadvantage on Perception (sight) |
| 18-19 | Heavy rain/snow | Lightly obscured, difficult terrain |
| 20 | Extreme weather | Roll on Extreme Weather table |

### Extreme Weather

| d10 | Weather | Effect |
|-----|---------|--------|
| 1-2 | Thunderstorm | Lightning (DC 15 Dex save, 3d10 damage), heavy rain |
| 3-4 | Blizzard | Heavily obscured, extreme cold, half speed |
| 5-6 | Heatwave | Extreme heat, double water consumption |
| 7-8 | Thick Fog | Heavily obscured, easy to get lost (DC +5) |
| 9 | Tornado/Hurricane | 50 ft push, 4d10 bludgeoning, structures damaged |
| 10 | Supernatural Storm | Primordial-influenced, roll on Wild Magic table |
...
| d12 | Encounter | Quantity | Attitude |
|-----|-----------|----------|----------|
| 1 | Military patrol | 2d6 soldiers | Suspicious |
| 2 | Tax collectors | 4 guards, 1 official | Demanding |
| 3 | Refugees | 2d6 civilians | Desperate |
| 4 | Bandits | 1d6+2 bandits | Hostile |
| 5 | Wild beasts | 1d4 wolves/bears | Hostile if hungry |
| 6 | Traveling merchant | 1 merchant, 2 guards | Friendly |
| 7 | Pilgrims | 1d6 civilians | Friendly |
| 8 | Deserters | 1d4 soldiers | Fearful |
...
| d12 | Encounter | Quantity | Attitude |
|-----|-----------|----------|----------|
| 1 | Resistance scouts | 2d4 scouts | Cautious |
| 2 | Thaldros raiders | 1d6+2 soldiers | Hostile |
| 3 | Guerrilla fighters | 1d6 resistance | Suspicious |
| 4 | Refugees fleeing | 2d6 civilians | Desperate |
| 5 | Wild beasts | 1d4 wolves/bears | Hostile if hungry |
| 6 | Smugglers | 1d6 smugglers | Neutral |
| 7 | Villagers | 1d8 militia | Suspicious |
| 8 | Supply caravan | 2d4 soldiers | Cautious |
...
| d12 | Encounter | Quantity | Attitude |
|-----|-----------|----------|----------|
| 1 | Iron Guild patrol | 2d4 mercenaries | Neutral |
| 2 | Bandits | 2d6+2 bandits | Hostile |
| 3 | Deserters | 1d8 desperate soldiers | Fearful |
| 4 | Refugees | 2d6 civilians | Desperate |
| 5 | Slavers | 1d6 slavers, 1d4 prisoners | Hostile |
| 6 | Treasure hunters | 1d4 adventurers | Cautious |
| 7 | Mutated creatures | 1d6 corrupted beasts | Hostile |
| 8 | Nomads | 1d8 nomads | Friendly |
...
| CR | Coins (gp) | Magic Items | Special | Avg Total Value |
|----|-----------|-------------|---------|-----------------|
| 0-4 | 50-200 | Common (1d4) | Minor potion/scroll | 300-500 gp |
| 5-7 | 500-1,000 | Uncommon (1d3) | Potion/scroll | 1,500-2,500 gp |
| 8-10 | 1,000-2,500 | Uncommon (1d4), Rare (1d2) | Faction token | 5,000-8,000 gp |
| 11-13 | 2,500-7,500 | Rare (1d3) | Map/intelligence | 12,000-20,000 gp |
...
| d100 | Result |
|------|--------|
| 01-30 | Coins: 1d6 x 10 gp |
| 31-60 | Gems: 1d4 x 50 gp value |
| 61-70 | Art object: 1d4 x 100 gp value |
| 71-80 | Minor magic item (consumable) |
| 81-90 | Trade goods worth 1d6 x 50 gp |
| 91-95 | Uncommon magic item |
...
| d20 | Size | Population | Features |
|-----|------|------------|----------|
| 1-5 | Hamlet | 20-100 | Inn, shrine, few shops |
| 6-12 | Village | 100-500 | Inn, temple, market, militia |
| 13-17 | Town | 500-2,000 | Multiple inns, temples, guilds |
| 18-19 | City | 2,000-10,000 | Walls, government, multiple districts |
| 20 | Metropolis | 10,000+ | Major hub, diverse, heavily defended |

### Settlement Attitude Toward Strangers

| d20 | Attitude | Effect |
|-----|----------|--------|
| 1-5 | Hostile | Guards posted, strangers questioned |
| 6-10 | Suspicious | Watched carefully, higher prices |
| 11-15 | Neutral | Professional, normal prices |
| 16-19 | Friendly | Helpful, information freely shared |
| 20 | Welcoming | Eager to trade, reduced prices |

### Settlement Problem

| d20 | Problem | Quest Hook |
|-----|---------|------------|
| 1 | Bandit raids | Hire guards, track bandits |
| 2 | Disease outbreak | Find cure, quarantine |
| 3 | Corrupt official | Investigation, expose corruption |
| 4 | Monster attacks | Hunt creature, defend settlement |
| 5 | Food shortage | Secure supplies, find cause |
| 6 | Haunting | Investigate ghost, lay to rest |
| 7 | Rival settlement | Diplomacy, sabotage, war |
| 8 | Cult activity | Infiltrate, expose, confront |
...
| 16 | Refugee influx | Housing, resources, integration |
| 17 | Crime wave | Track criminals, reform system |
| 18 | Religious schism | Mediate, choose side, investigation |
...
| d20 | Occupation | Attitude | Quirk |
|-----|------------|----------|-------|
| 1 | Blacksmith | Friendly | Always whistling |
| 2 | Merchant | Greedy | Obsessed with cleanliness |
| 3 | Farmer | Suspicious | Speaks in rhymes |
| 4 | Guard | Stern | Collects unusual items |
| 5 | Innkeeper | Gossipy | Tells terrible jokes |
| 6 | Priest | Devout | Has pet that sits on shoulder |
| 7 | Scholar | Distracted | Counts everything |
| 8 | Beggar | Desperate | Actually wealthy in disguise |
| 9 | Noble | Arrogant | Secretly kind-hearted |
| 10 | Thief | Cunning | Compulsive liar |
| 11 | Sailor | Superstitious | Missing body part |
| 12 | Hunter | Quiet | Speaks to animals |
| 13 | Healer | Caring | Prophetic dreams |
| 14 | Soldier | Disciplined | War-traumatized |
| 15 | Mage | Eccentric | Afraid of something common |
| 16 | Artisan | Proud | Perfectionist |
| 17 | Bureaucrat | Officious | Actually helpful |
| 18 | Performer | Dramatic | Hiding from someone |
...
### Getting Lost (Navigation DC)

| Terrain | DC | Check Frequency |
|---------|-----|-----------------|
| Road/trail | Auto-succeed | Never |
| Plains, coast | DC 10 | Once per day |
| Forest, hills | DC 15 | Twice per day |
| Mountains, jungle, swamp | DC 20 | Three times per day |
| Desert, underground | DC 25 | Three times per day |
...
|------------|-----|-------------|
| Very Easy | 5 | Almost everyone succeeds |
| Easy | 10 | Most people succeed |
| Medium | 15 | Trained people succeed reliably |
| Hard | 20 | Only skilled people succeed |
| Very Hard | 25 | Experts have difficulty |
| Nearly Impossible | 30 | Legendary feats |

### Contested Actions

| Action | Primary Skill | Opposed By |
|--------|--------------|------------|
| Hiding | Stealth | Perception |
| Lying | Deception | Insight |
| Sneaking | Stealth | Perception |
...
| Condition | Effect |
|-----------|--------|
| Blinded | Can't see, attack at disadvantage, attacks against at advantage |
...
| Prone | Disadvantage on attacks, attacks against at advantage (melee), disadvantage (ranged) |
...
|--------|--------------|----------|---------------|
| -10 or lower | Open Enemies | None | Attacked on sight, bounties placed |
| -5 to -9 | Hostile | None | Refused service, active sabotage |
| -1 to -4 | Unfriendly | None | Overcharged, no help, spread rumors |
| 0 | Neutral | Standard services | No special treatment |
| +1 to +4 | Friendly | Minor discounts, info | Occasional favors requested |
...
| Action | FIP Gained/Lost |
|--------|-----------------|
| Complete mission | +1 to +3 |
| Save member's life | +2 |
| Deliver valuable intelligence | +1 to +3 |
| Recruit new members | +1 each |
| Publicly support faction | +1 |
| Fail mission | -1 to -3 |
| Member dies under watch | -2 |
| Betray secrets | -5 |
| Work for rival faction | -1 to -3 |
| Public opposition | -2 |
...
|-------|----------|------------------|----------------|---------|------|
| 1: Touched | +10 max HP | Minor (eye color, temperature) | Advantage vs fear, Disadvantage Wis saves | DC 15 Wis/day | Remove Curse |
| 2: Corrupted | +30 max HP total | Major (tentacles, eyes) | Personality fading, Auto-fail Wis saves | DC 18 Wis/day | Greater Restoration + Remove Curse |
| 3: Spawn | +60 max HP total | Complete transformation | No self-awareness, under control | Auto-fail | Wish or divine intervention |
...
|---------------------|---------|
| Within 500 ft | +2 spell attack, +2 save DC, Concentration disadvantage, Wild Magic (nat 1) |
| 501-1,000 ft | +1 spell attack, +1 save DC, Wild Magic (nat 1 on damage spells) |
| 1,001-5,280 ft (1 mile) | +1 spell attack, +1 save DC |
| Beyond 1 mile | No effect |
...
|----|--------|--------|------|----------|
| 0-4 | 1d6 x 100 | 1d6 x 10 | 1d6 x 1 | — |
| 5-10 | — | 1d6 x 100 | 1d6 x 10 | 1d6 x 1 |
| 11-16 | — | — | 1d6 x 100 | 1d6 x 10 |
| 17+ | — | — | 1d6 x 1,000 | 1d6 x 100 |
\column
### Gemstone Values

| d20 | Value | Examples |
|-----|-------|----------|
| 1-10 | 10 gp | Quartz, agate, turquoise |
| 11-16 | 50 gp | Moonstone, onyx, jasper |
| 17-19 | 100 gp | Amber, jade, tourmaline |
| 20 | 500 gp | Emerald, ruby, sapphire, diamond |
