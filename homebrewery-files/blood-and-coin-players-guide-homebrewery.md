...
{{footnote
Everything you need to join the profession
}}
...
- ### [{{ Blood & Coin: Player’s Guide}}{{ 1}}](#p4)
  ...
  - #### [{{ Who You Are}}{{ 1}}](#p4)
    - [{{ The Iron Guild}}{{ 1}}](#p4)
  - #### [{{ Character Creation Guide}}{{ 1}}](#p4)
    - [{{ Step 1: Pick Your Mercenary Type}}{{ 1}}](#p4)
    - [{{ Step 2: Choose Race}}{{ 1}}](#p4)
    - [{{ Step 3: Select Class & Subclass}}{{ 2}}](#p5)
    - [{{ Step 4: Select a Background}}{{ 2}}](#p5)
    - [{{ Step 5: Motivations}}{{ 2}}](#p5)
    - [{{ Step 6: Squad Bonds}}{{ 3}}](#p6)
  - #### [{{ Iron Guild Reputation System}}{{ 3}}](#p6)
    - [{{ How It Works}}{{ 3}}](#p6)
  - #### [{{ Contract Types}}{{ 3}}](#p6)
  ...
  - #### [{{ Starting the Campaign}}{{ 4}}](#p7)
    - [{{ Session Zero Topics}}{{ 4}}](#p7)
    - [{{ Starting Scenario Options}}{{ 4}}](#p7)
  - #### [{{ Character Hooks & Connections}}{{ 5}}](#p8)
    - [{{ Personal Ties to Tirvandor}}{{ 5}}](#p8)
    - [{{ Iron Guild Contacts}}{{ 5}}](#p8)
  - #### [{{ Equipment & Starting Gear}}{{ 5}}](#p8)
    - [{{ Beyond Standard Starting Equipment}}{{ 5}}](#p8)
  - #### [{{ House Rules & Campaign Mechanics}}{{ 5}}](#p8)
    - [{{ Special Rules for Blood & Coin}}{{ 5}}](#p8)
  - #### [{{ Tips for Players}}{{ 6}}](#p9)
    - [{{ How to Succeed in Blood & Coin}}{{ 6}}](#p9)
  - #### [{{ Setting Information}}{{ 6}}](#p9)
    - [{{ The Border Region}}{{ 6}}](#p9)
    - [{{ The Iron Guild}}{{ 6}}](#p9)
  - #### [{{ Frequently Asked Questions}}{{ 7}}](#p10)
  - #### [{{ Adventure Awaits}}{{ 7}}](#p10)
    - [{{ You Are Ready}}{{ 7}}](#p10)
  - #### [{{ Blood & Coin Motto}}{{ 7}}](#p10)
    - [{{ OPEN GAME LICENSE Version 1.0a}}{{ 8}}](#p11)
}}
...
- Moral ambiguity and gray choices
- Reputation and consequences
- Gold and contracts over idealism
- Tactical combat and strategic thinking
- Inter-party dynamics and trust

**Campaign Tone** ::
- Gritty and pragmatic
- Dark humor and gallows wit
- Action-focused with intrigue
- Morally complex situations
- High combat, medium role play, medium exploration
...
- You can refuse any contract before signing
- Once you sign, you fulfill it (or face consequences)
- You can work for anyone: Thaldros, Aethoria, merchants, nobles, criminals
- Your reputation affects future contracts and pay rates

\column

## Character Creation Guide

### Step 1: Pick Your Mercenary Type
What kind of mercenary are you?

**The Bruiser** ::
Front-line fighter who takes hits and deals damage ::
Classes: Barbarian, Fighter, Paladin ::
Role: Tank, damage dealer ::
Personality: Tough, reliable, intimidating ::

**The Professional** ::
Trained soldier with tactical expertise ::
Classes: Fighter, Ranger, Monk ::
Role: Versatile combatant, leader ::
Personality: Disciplined, strategic, respected ::

**The Specialist** ::
Expert in a specific combat role ::
Classes: Rogue, Ranger, Monk ::
Role: Scout, assassin, infiltrator ::
Personality: Skilled, precise, valuable ::

**The Support** ::
Keeps the team alive and effective ::
Classes: Cleric, Bard, Druid ::
Role: Healer, buffer, utility ::
Personality: Pragmatic, essential, respected ::

**The Mystic** ::
Magic user for hire ::
Classes: Wizard, Sorcerer, Warlock ::
Role: Artillery, problem-solver, trump card ::
Personality: Educated, powerful, expensive ::

**The Face** ::
Negotiator and information gatherer ::
Classes: Bard, Rogue, Warlock ::
Role: Social skills, contracts, intel ::
Personality: Charming, clever, connected ::
...
**Possible custom Tirvandor backgrounds** *(details in Player's Guide)*

**Mercenary Veteran** ::
- Already been doing this for years
- Feature: *Mercenary Network* - Find work anywhere
- Skills: Athletics, Intimidation
- Perfect for: Any class

**War Refugee** ::
- Lost everything to the conflict, need coin to survive
- Feature: *Sympathetic Ear* - Common folk help you
- Skills: Survival, Stealth
- Perfect for: Any class seeking redemption

**Border Trader** ::
- You know the gray markets and smuggling routes
- Feature: *Black Market Contacts* - Find illegal goods
- Skills: Persuasion, Insight
- Perfect for: Rogues, Bards, anyone taking shady contracts

**Caravan Guard** ::
- Professional escort, now looking for better pay
- Feature: *Well-Traveled* - Know the roads and dangers
- Skills: Perception, Survival
- Perfect for: Fighters, Rangers, Monks

**Thornwood Syndicate Operative** ::
- Former criminal organization member
- Feature: *Criminal Connections* - Underworld access
- Skills: Deception, Intimidation
- Perfect for: Rogues, Warlocks, morally flexible types

**Spy** ::
- You worked intelligence for someone powerful
- Feature: *Cover Identity* - Established false persona
- Skills: Deception, Stealth
- Perfect for: Rogues, Bards, anyone doing covert contracts
...
### How It Works
Starting Reputation: 0 (Unproven)

You earn Reputation Points by: ::
- Completing contracts successfully (+2 to +5)
- Exceeding contract expectations (+1 to +3 bonus)
- Refusing immoral contracts (+1, but no pay)
- Exceptional combat/skill performance (+1)
- Saving squad members (+1)

You lose Reputation Points by: ::
- Failing contracts (-3 to -10)
- Betraying employers (-10, possible expulsion)
- Betraying squad (-20, definite expulsion)
- Breaking Guild Code (-5 to -15)
- Cowardice or incompetence (-1 to -5)

\column

Reputation Tiers: ::

| Tier | Rep Points | Title | Effects |
|------|------------|-------|---------|
| -20 or below | -20+ | **Outcast** | Expelled from Guild, hunted |
| -10 to -19 | -10 to -19 | **Disgraced** | No contracts, watched |
| -1 to -9 | -1 to -9 | **Suspect** | Limited contracts, low pay |
| 0 to 9 | 0 to 9 | **Unproven** | Basic contracts only |
| 10 to 19 | 10 to 19 | **Reliable** | Standard contracts, fair pay |
| 20 to 29 | 20 to 29 | **Trusted** | Good contracts, +10% pay |
| 30 to 39 | 30 to 39 | **Veteran** | Premium contracts, +20% pay |
| 40 to 49 | 40 to 49 | **Elite** | Choice contracts, +30% pay, Guild backing |
| 50+ | 50+ | **Legend** | Any contract, +50% pay, full Guild resources |

Reputation affects: ::
- Contract availability
- Pay rates
- NPC reactions
- Guild support and resources
- Plot opportunities

## Contract Types

### What Kinds of Jobs Will You Take?
Combat Contracts (High Pay, High Risk) ::
- Caravan escort through bandit territory
- Assault on fortified position
- Monster extermination
- Bodyguard for VIP in war zone
- Siege warfare (offensive or defensive)

Covert Contracts (Medium Pay, Medium Risk) ::
- Sabotage enemy supplies
- Assassination (be careful who you kill)
- Intelligence gathering
- Infiltration and theft
- Message delivery through hostile territory

Support Contracts (Medium Pay, Low Risk) ::
...
Shady Contracts (High Pay, Reputation Risk) ::
- Working for criminals
- Morally questionable targets
- Contracts that violate laws
- Jobs from untrustworthy clients
- Missions with hidden agendas

{{pageNumber,auto}}
{{footnote Blood & Coin Player's Guide}}
\page

Special Contracts (Variable) ::
- Guild internal missions
- Rescue operations
- Artifact recovery
- Investigation work
...
**The Slaver Contract** ::
- Well-paying client wants you to recapture escaped slaves
- Legal in Thaldros, profitable, but morally wrong
- Refuse = lost money + possible reputation hit
- Accept = good pay + moral stain

**The Civilian Question** ::
- Contract to raid an enemy supply depot
- Depot is in a civilian town
- Collateral damage likely
- How far do you go?

**The Better Offer** ::
- Mid-contract, enemy offers double to switch sides
- No one would know...
- But your reputation...

**The Squad vs. Contract** ::
- Contract demands you leave wounded squad mate
- Saving them means failing contract
- What matters more?

*There Are No Perfect Answers
Every choice has consequences
Your character's values will be tested
The DM won't judge your choices
But the world will react to them*
...
- Levels 5-8: Regional contracts, factional involvement
- Levels 9-12: Major contracts, caught in war, final arc

Combat Frequency: HIGH
- Expect combat every session
- Tactical challenges, not just brawls
- Resource management important

Role play Opportunities: MEDIUM-HIGH
- Squad dynamics and banter
- Moral dilemmas and choices
- NPC employer interactions
- Downtime activities

Exploration: MEDIUM
- Traveling between contracts
...
**Lines and Veils**
- What content is off-limits? (torture, SA, etc.)
- What should fade to black?
- What are you comfortable with?

**Party Composition**
- Do we have balanced roles?
- Who's the face for contract negotiations?
- Who's the tactical leader in combat?

**Squad Dynamics**
- How do we know each other?
- Do we trust each other?
- What's our squad name?

**Moral Boundaries**
- What contracts will we refuse?
- Are we "noble" mercenaries?
- Where do we draw the line?

**Goals**
- Short-term: What's our first goal?
- Long-term: What do we want to achieve?
- Personal: Individual character goals?

### Starting Scenario Options

**Option A: The Rookie Contract** ::
- You're fresh recruits on first real mission
- Simple escort contract
- Things go wrong (they always do)
- Prove yourselves to the Guild

{{pageNumber,auto}}
{{footnote Blood & Coin Player's Guide}}
\page

**Option B: The Reunion** ::
- You're veterans reuniting after months apart
- Each had different contracts
- New mission brings you back together
- Jump right into action

**Option C: The Trial** ::
- You're accused of breaking the Guild Code
- Must complete impossible mission to prove innocence
- High stakes from the start
- Establishes squad bond through adversity
- DM will choose or let group vote

## Character Hooks & Connections

### Personal Ties to Tirvandor
#### Connection to Nations:

**Thaldros Ties** ::
- Former soldier in Thaldros military
- Family still living there
- Fled Thaldros oppression
- Owe debt to Thaldros noble
- Hunted by Thaldros authorities

**Aethoria Ties** ::
- Revolutionary who turned mercenary
- Family in Aethoria resistance
- Sympathetic to their cause (but need money)
- Former Aethorian militiaman
- Smuggled people out of Thaldros

**Border Ties** ::
- Born and raised in the Border
- Know the smuggling routes
- Have criminal contacts
...
### Beyond Standard Starting Equipment

**Iron Guild Members Get** ::
- Guild tabard/insignia (marks you as professional)
- Basic mercenary contract template
- Access to Guild safe houses in major towns
...
- Forgery kit (papers and passes)
- Merchant's scale (verify payment)
- Signet rings (fake identities)

## House Rules & Campaign Mechanics

### Special Rules for Blood & Coin

**Reputation System** ::
- Tracked numerically (see above)
- Affects all social interactions
- Changes quest availability
- Impacts income

**Contract Negotiation** ::
- Group can negotiate pay before accepting
- Charisma checks can increase payment
- Taking dangerous contracts = higher pay
- Can walk away from any unsigned contract

**Injury & Recovery** ::
- Dropped to 0 HP = injury/scar (optional)
- Adds to character history
- Purely cosmetic unless you want mechanics

**Downtime Activities** ::
- Training (improve skills)
- Carousing (gather info, make contacts)
- Working (earn extra coin)
- Crime (risky, can damage reputation)

**Squad Tactics** ::
- Bonus to Help action when assisting squad
- Flanking rules in effect
...
#### Role Play
- Have a personality beyond "I hit things"
- Develop squad dynamics and banter
...
- Squad Leaders: Experienced mercs who lead teams
- Members: You (regular mercenaries)
- Prospects: Trainees earning membership

**Guild Services** ::
- Contract mediation and enforcement
- Legal protection
- Equipment at cost
- Healing and recovery
- Training and advancement
- Safe houses and contacts
...
**Guild Locations** ::
- HQ: Crossroads (the Border)
- Chapter houses: Major cities in both nations
- Safe Houses: Scattered throughout region

## Frequently Asked Questions
:
**Q: Can I be a good person in this campaign?** ::
A: Yes! Many mercenaries have moral codes. You choose which contracts to take.

**Q: Will we be forced to do evil things?** ::
A: No. You can refuse any contract. But refusing loses potential income and some contracts may test your morals.

**Q: Can we switch sides during a contract?** ::
A: Technically yes, but expect severe reputation consequences. The Guild Code forbids it.

**Q: What if my character wouldn't take a contract?** ::
A: Then don't! But have an in-character reason and accept the consequences.

**Q: Can we work for both Kingdom forces and frontier territories?** ::
A: Absolutely. The Guild is neutral. Your only loyalty is to gold and the current contract.

**Q: How lethal is this campaign?** ::
A: Moderately lethal. Combat is dangerous but healers are available. Smart play keeps you alive.

**Q: Can I play a pacifist?** ::
A: Very difficult in a mercenary campaign. Consider a support role (healer, face) instead.

**Q: What if we want to eventually pick a side?** ::
A: That's an option! The campaign can evolve based on your choices.
...
You now know: ::
- Who you are (mercenaries)
- How the campaign works (contracts & reputation)
- What to expect (moral complexity, tactical combat)
- How to create a character (races, classes, motivations)
- The world you're entering (Border, Guild, war)

Now it's time to: ::

1. Create your mercenary
2. Join your squad
3. Take your first contract
4. Earn your gold
5. Build your legend
...
{{quote
:
"In war, there are no heroes. Only survivors. And we plan to survive very well."
}}
**- Iron Guild Saying**
:
Welcome to the Iron Guild, mercenary.
Your first contract awaits. 
Ready to fight? Ready to earn? Ready to survive? ::
Then grab your weapon, sign the contract, and let's get to work. 
Good hunting. 
...
___
:
You've come to the **Crossroads** because you had no other choice. Maybe you're running from something. Maybe you're running toward something. Either way, you need money, and you're willing to work for it. 
:
This guide tells you everything you need to know to survive:
- How to build a character who fits this world
- How the reputation system works
- What kinds of jobs you'll take
- What moral choices you'll face

:

Remember the rules:
1. **Contracts are sacred.**
2. **Don't kill clients before they pay.**
3. **Survive first, moralize later.**
