...
- ### [{{ Who You Are}}{{ 5}}](#p5)
- ### [{{ Character Creation}}{{ 7}}](#p7)
- ### [{{ The Reputation System}}{{ 12}}](#p12)
- ### [{{ Contract Types}}{{ 14}}](#p14)
- ### [{{ Moral Choices}}{{ 16}}](#p16)
- ### [{{ Campaign Structure}}{{ 18}}](#p18)
...
IDEAL BACKGROUNDS:
Soldier ⭐⭐⭐
Former military, now a sellsword
Knows tactics, discipline, chain of command
Perfect for: Any martial class
Criminal ⭐⭐⭐
Reformed (or not) lawbreaker
Knows the underworld, good for shady contracts
Perfect for: Rogues, some Fighters
Mercenary Veteran (Custom) ⭐⭐⭐
Already been doing this for years
High starting reputation
Perfect for: Any class
Folk Hero ⭐⭐
Local hero turned professional
Respected by common folk
Perfect for: Fighters, Rangers
Outlander ⭐⭐
Wilderness survivor, now guides/scouts
Good for Border operations
Perfect for: Rangers, Barbarians, Druids
Guild Artisan ⭐
Craftsperson now selling skills with steel
Weapon/armor smith very valuable
Perfect for: Fighters, Clerics
Sage ⭐
Scholar turned magical mercenary
Research and lore specialist
Perfect for: Wizards, Warlocks
...
Only survivors.
And we plan to survive very well."
- Iron Guild Saying
Welcome to the Iron Guild, mercenary.
Your first contract awaits.
END OF BLOOD & COIN PLAYER'S GUIDE
...
You've come to **Crossroads** because you had no other choice. Maybe you're running from something. Maybe you're running toward something. Either way, you need money, and you're willing to work for it.
