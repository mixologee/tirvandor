...
## Adventure Seeds Across All Conflicts

### The Continental Summit (Epic Campaign)
- All houses with pre-Worldrend conflicts invited
- Neutral mediator (party?) tries to resolve ancient grudges
- Could end in peace treaty or war declaration
- Secrets revealed, alliances formed/broken
- Reshape continental politics

### The Worldrend Anniversary (1250 CR approaching)
- 1,250 years since the cataclysm
- All houses planning commemorations
- Ancient curses/blessings ending
- Magical phenomena increasing
- Perfect time for dramatic revelations
- Is second Worldrend coming?

### The Reunification Plot
- Secret society trying to reunite continents
- Manipulating houses toward cooperation
- Methods: arranged marriages, artifact recovery, revealing truths
- Goal: Restore unified realm
- Opposition from those profiting from division

### The Artifact Hunt (Multi-House Competition)
- Major pre-Worldrend artifact discovered
- Multiple houses have legitimate claims
- Race to recover it
- Could unite or divide continents
- Party caught in middle

### The Historical Truth
- Scholar discovers actual records from before Worldrend
- Truth contradicts everyone's beliefs
- Could resolve conflicts OR make them worse
- Multiple parties trying to suppress/publicize
- What if no one was right?

---

## Summary: Pre-Worldrend Conflicts

**Active Conflicts:** 4 major, multiple minor  
**Houses Involved:** 7 directly, more indirectly  
**Years Active:** 1,247 years  
**Resolution Difficulty:** Extreme (no living witnesses, distorted history, genuine grievances)

**Campaign Potential:**
These conflicts provide:
- Cross-continental adventures
- High-stakes diplomacy
- Ancient mysteries to unravel
- Moral complexity (no clear villains)
- World-shaping consequences
- Personal drama (forbidden love, family secrets)
- Artifact quests with meaning
- Potential to literally reshape the world
